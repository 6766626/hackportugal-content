export default {
  ...
  tldr: 'Fuel station prices in mainland Portugal in 2026: petrol 95 (gasolina) €1.70–1.90/l, diesel (gasóleo) €1.55–1.75/l. Prices are free on the mainland; ERSE publishes a weekly “preço eficiente” — a reference, non-binding guide, not a maximum cap. In Madeira and the Azores, prices may be administratively regulated. The difference between expensive networks (Galp / BP / Repsol) and cheaper ones (Prio, Intermarché, Continente, Cepsa/Moeve) is up to €0.15/l. The ComboMais / IdealGás / Tankpreise apps help you find the cheapest filling station. Loyalty cards give a discount of €0.05–0.12/l.',
  tags: ['petrol', 'filling station', 'saving', 'fuel'],
  estimatedReadMinutes: 5,
  steps: [
    {
      id: 'prices',
      title: '⛽ Prices and differences between networks',
      content: [
        { kind: 'paragraph', text: 'Prices in Portugal are free, but governed by the market. The state publishes recommended maximum prices weekly — all filling stations stay below them.' },
        { kind: 'substeps', items: [
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'a1', title: 'Best apps', content: [
            { kind: 'checklist', items: [
              '**ComboMais** — Portuguese app, real-time prices from all networks, user updates',
          ...
          { id: 'a2', title: 'How to use them', content: [
            { kind: 'checklist', items: [
              ...
              'Is it worth driving for €0.05? → for a full 50 l tank = €2.50 saving. If you have to drive an extra 5 km, you will use roughly €3 of petrol — not worth it',
        ...
        { kind: 'substeps', items: [
          { id: 'l1', title: 'Filling station loyalty cards', content: [
            { kind: 'checklist', items: [
              ...
              'Sign-up: at the filling station or online, free'
            ]}
          ]},
          { id: 'l2', title: 'Supermarket discounts at filling stations (best option!)', content: [
            { kind: 'checklist', items: [
              ...
              '**Intermarché** filling stations are cheap in themselves; can be combined with the Intermarché card = another -€0.03',
          ...
          { id: 'l3', title: 'Corporate cards and fleet cards', content: [
            { kind: 'checklist', items: [
              ...
              'Self-employed people (recibos verdes) can also apply with turnover > €10000/year',
              'Monthly bill (no cash payment each time), easier for invoices with IVA'
            ]}
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '⛽ **Full tank** vs frequent refuelling: a full tank = fewer trips to the filling station. But if it is cheap now — fill up now, it may be more expensive later',
          '🚗 **Your consumption**: **eco-driving** (smooth starting/braking, cruise control, correct tyres) — 10–20% less consumption',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Night home tariff (tarifa bi-horária): €0.15–0.20/kWh (the cheapest!)',
          'Tesla Supercharger: €0.35–0.45/kWh (for non-Tesla), -10% for Tesla owners',
          '💡 Saving: with a bi-horária tariff + home wallbox — the cost of 100 km is around €2–3, versus €8–10 for an internal combustion engine'
        ]}
      ]
    }
  ],
