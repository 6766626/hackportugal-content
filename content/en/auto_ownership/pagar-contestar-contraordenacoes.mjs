  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Portal das Contraordenações is the Autoridade Nacional de Segurança Rodoviária account for road traffic administrative cases: speeding, parking, alcohol, using a phone while driving, running a red light, missing documents and other contraordenações rodoviárias.' },
        { kind: 'checklist', items: [
          ...
          'Obtain payment details: entidade, referência, montante for Multibanco / homebanking',
        ...
        { kind: 'warning', text: 'The portal only works for ANSR road traffic contraordenações. EMEL fines, municipal parking, Via Verde / portagens, IMT, Finanças or court fines may be payable through other systems.' }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Match the case number with the paper notification: auto / processo / data da infração',
        ...
        { kind: 'warning', text: 'If you do not have CMD/Cartão de Cidadão, online access may not work. In that case, use the details from the paper notification and contact ANSR using the contacts in the letter: by registered post, email/form or in person through available service points. Do not wait until the deadline expires just because of login problems.' }
      ]
    },
    {
      id: 'pay-online',
      ...
      content: [
        { kind: 'paragraph', text: 'The notification and/or portal show the entidade, referência and montante. You can pay at Multibanco, through homebanking or in a banking app under “Pagamentos ao Estado / Pagamento de Serviços”, depending on the bank and the type of reference.' },
        { kind: 'substeps', items: [
          ...
          { id: 'pay', title: '2. Pay and save proof', content: [
            { kind: 'checklist', items: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Write how many prestações you are requesting and why you need instalments',
        ...
        { kind: 'warning', text: 'Do not assume that instalments are approved automatically. Until ANSR has issued a despacho/decision, the original payment deadline may still matter. If the deadline is close, submit the requerimento as soon as you receive the notification.' }
      ]
    },
    {
      id: 'contest-defense',
      ...
      content: [
        { kind: 'paragraph', text: 'Defesa is a written objection in the case. The typical deadline under the Código da Estrada is 15 working days from the date of notification. Count working days specifically; weekends and official public holidays are not included. If the notification was received by registered letter, the date is usually the delivery date or the legally established deemed delivery date.' },
        { kind: 'checklist', items: [
          ...
          'Describe the facts: why the offence was not committed, radar/place/number plate error, incorrect driver identification, breach of the notification procedure',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'In Portugal, a driver usually has 12 pontos da carta. Points are deducted after a final decision, not simply at the moment of the radar record. On Portal das Contraordenações you can check your current saldo de pontos and sanction history.' },
        { kind: 'checklist', items: [
          ...
          'A road traffic crime may deduct 6 points',
          ...
          'Check the portal after payment or decision: status updates are not always immediate',
          'Keep all comprovativos at least until the case is finally closed'
        ] },
        { kind: 'paragraph', text: 'If you receive a decisão condenatória and disagree, the next step is impugnação judicial within the established deadline, usually through the tribunal competente. This is no longer a simple online complaint: check the prazo in the ANSR decision and obtain legal advice.' }
      ]
    }
  ],
  costs: [
