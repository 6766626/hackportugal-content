export default {
  ...
  categoryId: 'animals',
  title: 'Adopting an animal in Portugal — shelters and process',
  tldr: 'In Portugal, adopting from a shelter is free or involves a symbolic fee (€10-50) to cover sterilisation and the microchip. Main sources: municipal CRO (Centro de Recolha Oficial), private associations (União Zoófila, ANIMAL, Bianca, CB), Animais de Rua (Lisboa), Casa dos Animais Lisboa. The adopt.cao.pt website is a national database. The law requires a microchip + registration in SIAC + insurance (for dogs of dangerous breeds). Sterilisation is usually included.',
  ...
  steps: [
        ...
        { kind: 'substeps', items: [
          { id: 'w1', title: 'Municipal shelters (CRO)', content: [
            { kind: 'checklist', items: [
              ...
              '📍 Sintra: Sintra municipal shelter',
          ...
          { id: 'w4', title: 'Chance finds',
            content: [
            { kind: 'checklist', items: [
              '🚨 Stray animal on the street — call 112 (if in danger) or the local CRO',
              '⚖️ Found animal — the law requires you to try to find the owner (photo on social media, notice)',
              '🔢 Scan the microchip at any veterinary clinic (ID — pet-id.pt)',
              '⏰ If no owner is found within 30 days — you can officially adopt'
            ]}
          ]}
        ]}
      ]
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'p3', title: 'Step 3 — Home check (for dogs)', content: [
            { kind: 'checklist', items: [
              ...
              '⚖️ Potentially dangerous breeds (see below): require a licença especial at the Junta, seguro de responsabilidade civil of at least €50,000 and special identification requirements',
              '🚫 If the home check is not passed — they may refuse',
              '⏱️ Decision within 1-3 days'
            ]}
          ]},
          { id: 'p4', title: 'Step 4 — Contract and collection', content: [
            { kind: 'checklist', items: [
              ...
              '💰 Pay the fee (if any)',
              '📋 Receive documents: animal passport, Caderneta Sanitária, microchip card',
              '🪪 The microchip is already registered in SIAC in your name (or is transferred to you for re-registration)',
          ...
          { id: 'p5', title: 'Step 5 — Registration in SIAC', content: [
            { kind: 'checklist', items: [
              ...
              '📝 Transfer/change of titular in SIAC — within the legal deadline (usually 15 days after transfer). Check whether the CRO/associação does this immediately or whether you need to go to a veterinário',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '🎓 **First 30 days of adjustment**: keep things quiet, do not invite many guests, give time',
          '🩺 First routine check-up with a vet (your own, not the shelter’s) — 2 weeks after adoption',
          '💪 **Behaviour specialist** (for dogs with trauma): a dog trainer using a positive approach',
          '🐾 Walks 2-3 times a day (dogs), play (cats)',
          '📸 Social media: help the shelter — post photos, recommend it',
          '🎁 Return to the shelter (if it did not work out): there is usually a 30-day return period; do not abandon the animal on the street!',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          '🚶 **On walks**: muzzle + short lead ≤1 m + adult ≥ 16 years old',
