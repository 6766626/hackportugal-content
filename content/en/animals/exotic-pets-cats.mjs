    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Purchase: pet shops, breeders, online — OLX has many listings',
          'Exotic-animal vet: specialised vets are available in every major city',
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'b3', title: 'Wild birds: birds of prey, owls, etc.', content: [
            { kind: 'paragraph', text: 'It is forbidden to buy or keep them as pets without ICNF authorisation. Falconry requires a licence. If you find an injured bird, contact Centro de Recuperação RIAS / LPN.' }
          ]}
        ]}
      ]
    },
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'r1', title: 'Allowed without a licence', content: [
            { kind: 'checklist', items: [
              'Bearded dragons, leopard geckos, corn snakes, small royal pythons, tortoises — Hermann’s and Central Asian — are often sold in pet shops',
          ...
          { id: 'r3', title: 'Vivariums', content: [
            { kind: 'checklist', items: [
              ...
              'Exotic-animal vet: €50–80 per appointment; specialised clinics are available in Lisboa and Porto',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Pet shops: tropicalfish.pt, Petline, Fauna&Flora, specialised aquarium retailers',
          ...
          'Aquarium services: companies offer installation and subscription maintenance for €30–100/month',
