  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'An EU pet passport is an EU-standard booklet for dogs, cats and ferrets. In Portugal, it is issued by a veterinário autorizado. The passport is needed for movement between EU countries and for returning to the EU from some third countries, provided all entries were made correctly before departure.' },
        { kind: 'paragraph', text: 'The passport is not a “visa” for the animal and does not replace the rules of an airline, ferry, hotel or rental accommodation. It confirms the animal’s identification, rabies vaccinations and, sometimes, parasite treatments and clinical examinations.' },
        { kind: 'checklist', items: [
          'Who needs it: dog, cat, ferret',
          'Where to get it in Portugal: from a vet who has access to issue an EU pet passport',
          'Mandatory database for resident animals: registration in SIAC by microchip',
          'The passport is valid as long as the microchip can be read and the vaccination records are up to date',
          'Different rules apply for birds, rabbits, rodents and reptiles — the EU pet passport is not used for them'
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'For standard non-commercial travel within the EU, the animal must be identified with an ISO 11784/11785 microchip or a readable tattoo applied before 03/07/2011. The rabies vaccination must be given after the chip is implanted or on the same day, but not before it.' },
        { kind: 'checklist', items: [
          ...
          'Booster without lapse: valid immediately if the previous vaccine was still valid',
          'Booster after a lapse: treated as a primary vaccination — another 21-day waiting period',
        ...
        { kind: 'warning', text: 'Do not buy a ticket before checking the dates. The most common mistake is a rabies vaccination given before the microchip, or a flight scheduled earlier than the 21st day after primary vaccination. At the border, this can result in refusal of entry, quarantine or return at your expense.' }
      ]
    },
    {
        ...
        { kind: 'substeps', items: [
          { id: 'vet-check', title: '1. Veterinary check', content: [
            { kind: 'checklist', items: [
              ...
              'Ask the vet to correct entries only in the lawful way: no erasures, with signature/stamp where required',
          ...
          { id: 'carrier-check', title: '2. Carrier', content: [
            { kind: 'paragraph', text: 'Airlines and ferries have their own limits on weight, carriers, brachycephalic breeds, the number of animals in the cabin and the season of transport. These are commercial rules and may be stricter than EU legislation.' }
          ] },
          { id: 'route-check', title: '3. Route', content: [
            { kind: 'paragraph', text: 'If you are flying in transit through a non-EU country or returning from one to the EU, check not only the final country, but also all connections, leaving the transit area, airport changes and baggage.' }
          ] }
        ] }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Take the animal’s passport in your hand luggage; do not put it in a suitcase',
        ...
        { kind: 'warning', text: 'Do not treat a domestic flight to the islands “like a bus within Portugal”. In practice, boarding is more often refused not because of DGAV, but because airline requirements have not been met: the wrong carrier, no confirmed animal booking, an expired vaccine or no fresh veterinary declaration if one was requested.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'A rabies titre is a blood test for rabies antibodies. For entry into the EU, it is mandatory when returning from countries not on the EU safe lists for rabies. The minimum result is 0.5 IU/ml. The sample is taken no earlier than 30 days after vaccination, then entry from such countries usually requires a 3-month waiting period.' },
        { kind: 'paragraph', text: 'If the test is done in the EU before departure, the result ≥0.5 IU/ml is entered in the EU pet passport, and rabies vaccination is then maintained without lapses, the 3-month wait on return usually does not apply. This is the best option for long trips outside the EU.' },
        { kind: 'checklist', items: [
          ...
          'If the animal received a new rabies booster in the UK, check whether the EU passport recognises it; sometimes an animal health certificate is needed for return',
          'From an unlisted non-EU country without a titre done in advance, delay, quarantine or refusal of entry to the EU is possible',
          'The laboratory for the titre must be EU-approved',
          'A route through a country with a high rabies risk can change the requirements, even if the final country is “safe”'
        ] },
        { kind: 'warning', text: 'The UK is not in the EU. Do not confuse the rules for entering the UK with the rules for returning to the EU. For the UK, British requirements matter, including tapeworm for dogs; for return to Portugal, EU/DGAV rules and the status of the country of departure matter.' }
      ]
    },
    {
      id: 'day-of-travel',
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '21 days have passed after the primary vaccine if this is the first vaccination or a booster was overdue',
          'The animal booking has been confirmed by the carrier in writing',
          'The carrier meets the airline’s size requirements',
          'You have a lead, harness and muzzle for dogs, if required',
          'For Madeira/Açores or the carrier — a fresh declaração de saúde, if requested',
        ...
        { kind: 'paragraph', text: 'At the border or when boarding, you may be asked to show the animal and scan the chip. If the chip cannot be read, the documents are not effectively linked to the animal — this is a risk of refusal of transport.' }
      ]
    }
  ],
  costs: [
    { label: 'EU pet passport from a vet', amountEURMin: 10, amountEURMax: 30, note: 'Indicative cost at private clinics; the price does not include vaccination and chip' },
