export default {
  ...
  tldr: 'For EU travel with a dog, cat or ferret from Portugal, you need an EU pet passport, an ISO microchip and a valid rabies vaccination. A primary vaccination only starts to count after 21 days; the animal must usually be over 12 weeks old. Up to 5 animals counts as non-commercial travel. Madeira/Açores may require additional health documents from the carrier/region. For returning from “high-risk” non-EU countries, a rabies titre ≥0.5 IU/ml is required; for the UK in 2026, a titre is usually not needed.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'The passport is not a “visa” for the animal and does not replace the rules of the airline, ferry, hotel or rented accommodation. It confirms the animal’s identification, rabies vaccinations, sometimes parasite treatments and clinical examinations.' },
        { kind: 'checklist', items: [
          'Who needs one: dog, cat, ferret',
          'Where to get one in Portugal: from a vet who has access to issuing EU pet passports',
          'Mandatory database for resident animals: registration in SIAC by microchip',
          'The passport remains valid as long as the microchip can be read and the vaccination records are up to date',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'For standard non-commercial travel within the EU, the animal must be identified by an ISO 11784/11785 microchip or a readable tattoo applied before 03/07/2011. The rabies vaccination must be given after the chip is implanted or on the same day, but not before it.' },
        { kind: 'checklist', items: [
          ...
          'Booster without a lapse: valid immediately if the previous vaccination was still valid',
        ...
        { kind: 'warning', text: 'Do not buy a ticket before checking the dates. The most common mistake is a rabies vaccination given before the microchip, or a flight scheduled before the 21st day after the primary vaccination. At the border this can result in refusal of entry, quarantine or return at your expense.' }
      ]
    },
    {
        ...
        { kind: 'substeps', items: [
          { id: 'vet-check', title: '1. Veterinary check', content: [
            { kind: 'checklist', items: [
              ...
              'Check the rabies vaccination validity for the date of entry and re-entry',
          ...
          { id: 'carrier-check', title: '2. Carrier', content: [
            { kind: 'paragraph', text: 'Airlines and ferries have their own limits on weight, carriers, brachycephalic breeds, number of animals in the cabin and transport season. These are commercial rules and may be stricter than EU legislation.' }
          ] },
          { id: 'route-check', title: '3. Route', content: [
            { kind: 'paragraph', text: 'If you fly in transit through a non-EU country or return from one to the EU, check not only the final country but also all connections, leaving the transit zone, airport changes and baggage.' }
          ] }
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Madeira and Açores are Portugal, but they are island autonomous regions with their own health procedures and carrier control practices. For dogs, cats and ferrets, the basic requirements are a microchip, EU pet passport and valid rabies vaccination, even if you are flying from Lisboa or Porto.' },
        { kind: 'checklist', items: [
          ...
          'On the return flight to the mainland, keep the same documents: passport, vaccination, chip, animal booking with the carrier'
        ] },
        { kind: 'warning', text: 'Do not treat an internal flight to the islands as “like taking a bus within Portugal”.\n\nIn practice, denied boarding more often happens not because of DGAV, but because airline requirements have not been met: the wrong carrier, no confirmed animal booking, an expired vaccination or no recent veterinary declaration if one was requested.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'A rabies titre is a blood test for rabies antibodies. For entry into the EU it is mandatory when returning from countries that are not on the EU safe lists for rabies. The minimum result is 0.5 IU/ml. The sample is taken no earlier than 30 days after vaccination; for entry from such countries, a 3-month waiting period is then usually required.' },
        ...
        { kind: 'checklist', items: [
          'UK / Great Britain in 2026 usually does not require a rabies titre for return to the EU because it is among the listed third countries',
          'For travelling to the UK with a dog, tapeworm treatment by a vet is usually required 24–120 hours before entry',
          'If a new rabies booster was given to the animal in the UK, check whether the EU passport recognises it; sometimes an animal health certificate is needed for return',
          'From an unlisted non-EU country without a titre done in advance, delay, quarantine or refusal of entry into the EU are possible',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'The carrier complies with the airline’s dimensions',
        ...
        { kind: 'paragraph', text: 'At the border or during boarding, you may be asked to show the animal and have the chip read. If the chip cannot be read, the documents are effectively not linked to the animal — this is a risk for refusal of transport.' }
      ]
    }
  ],
  costs: [
    ...
    { label: 'Rabies vaccination', amountEURMin: 20, amountEURMax: 45, note: 'Usually annually or for the period stated by the manufacturer and vet' },
  ...
  sources: [
    { title: 'DGAV — Travelling? FAQ (companion animals)', url: 'https://www.dgav.pt/faq/conteudo/vai-viajar/', kind: 'official', language: 'pt', lastRetrieved: '2026-05-04' },
