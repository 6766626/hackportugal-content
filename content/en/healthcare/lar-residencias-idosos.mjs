export default {
  ...
  title: 'Lar de Idosos / ERPI — care homes for older people in Portugal',
  tldr: 'ERPI is the official name for care homes for older people in Portugal: Estruturas Residenciais para Pessoas Idosas. In 2026, places are divided into social places via Segurança Social/IPSS and fully private places. A social place usually costs roughly €600–€1,500/month and depends on family income; IPSS without full subsidisation costs €800–€2,500/month; private ERPI cost €1,500–€4,500/month. Waiting lists are long: 12–36 months in Lisbon, Porto and coastal areas. Check the licence via Carta Social.',
  tags: ['erpi', 'elderly', 'health', 'social care'],
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Lar de Idosos in everyday speech almost always means ERPI — Estrutura Residencial para Pessoas Idosas. This is a residential institution with accommodation, meals, care, basic medical support and social activities for older people who cannot safely live alone or need constant assistance.' },
        { kind: 'paragraph', text: 'An ERPI is not a hospital and not a unidade de cuidados continuados. If someone needs rehabilitation after a stroke, palliative care or round-the-clock medical supervision, the first step is to check referral through SNS/RNCCI. ERPI is suitable for long-term day-to-day care: meals, hygiene, medication, supervision and help with mobility.' },
        { kind: 'checklist', items: [
          ...
          'Santa Casa da Misericórdia — a common operator of social ERPI in municipalities',
          'RNCCI — long-term care network after illness; this is not a normal care home'
        ] }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'Social place via Segurança Social/IPSS: roughly €600–€1,500/month; the amount is calculated according to the income of the older person and the family',
          'IPSS with partial payment or without an available subsidised place: roughly €800–€2,500/month',
          'Private ERPI / residência sénior: roughly €1,500–€4,500/month',
          ...
          'Medication, incontinence pads, transport, physiotherapy, hairdressing, dentistry and private consultations may be charged extra'
        ] },
        { kind: 'warning', text: 'Do not rely only on the advertised price “desde €1,200”. Ask for the minuta do contrato and a list of extras before signing. In an ERPI, €1,400/month can easily become €1,700–€1,900/month because of medication, incontinence pads, laundry or transport.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Start with Carta Social — this is Portugal’s official catalogue of social institutions. There you can search for ERPI by distrito, concelho and freguesia, see the resposta social type, capacity and contacts. Then call the institutions directly and, in parallel, contact Segurança Social in the area of residence.' },
        { kind: 'substeps', items: [
          {
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'If the older person has dementia and no longer understands the consequences of the contract, an ordinary signature may not be enough. A power of attorney arranged in advance, or legal representation through the court, is needed. Do not postpone this until a crisis.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'In 2026, demand for ERPI is higher than supply. In large cities and on the coast, the typical waiting list for a social place is 12–36 months. It can be faster in inland areas, but this makes family visits and quality control more difficult.' },
        { kind: 'checklist', items: [
          'Join several waiting lists at the same time: IPSS, Misericórdia, private ERPI',
          'Do not wait for the “perfect” place next to home — check neighbouring concelhos',
          'Ask an assistente social to prepare a relatório social if the situation is urgent',
          ...
          'Visit the institution in person without warning at different times, if possible'
        ] },
        { kind: 'warning', text: '“There is a place tomorrow, pay the deposit by MB WAY” is a red flag. Check the legal entity, licence, address, contrato de prestação de serviços and whether the institution is listed in Carta Social. Do not transfer the caução to a private individual without a contract and recibo.' }
      ]
    },
    {
      id: 'quality-check',
      ...
      content: [
        { kind: 'paragraph', text: 'Price does not guarantee quality. More important are the licence, staff, a transparent contract, family access, the care plan and the response to falls, infections, dementia and medication.' },
        { kind: 'checklist', items: [
          ...
          'Check for an enfermeiro, médico assistente, fisioterapia, plano individual de cuidados',
          'Look at the smell, cleanliness, condition of bathrooms, call buttons and food',
          'Clarify the rules on visits, video calls and going out for walks',
        ...
        { kind: 'paragraph', text: 'For expats, an important practical question is language. In private homes in Lisbon, Cascais, Porto and the Algarve, staff with English are more common; Russian is rare. If the older person does not speak Portuguese, prepare a card in advance with diagnoses, medication, allergies and basic phrases.' }
      ]
    }
  ],
  costs: [
    { label: 'Social place via Segurança Social / IPSS', amountEURMin: 600, amountEURMax: 1500, note: 'Monthly guide figure; the actual comparticipação depends on the income of the older person and the family.' },
    { label: 'IPSS without full subsidisation', amountEURMin: 800, amountEURMax: 2500, note: 'Monthly guide figure; the price depends on the region, room and level of dependency.' },
    { label: 'Private ERPI / residência sénior', amountEURMin: 1500, amountEURMax: 4500, note: 'Monthly guide figure; premium facilities in Cascais, Lisboa, Porto and the Algarve may be higher.' },
