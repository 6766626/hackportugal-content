export default {
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'An important detail: a hearing-aid seller can do a test and choose a device, but the medical diagnosis is made by an ORL doctor — otorrinolaringologista. For the SNS, comparticipação and serious symptoms, you specifically need ORL.' },
        { kind: 'checklist', items: [
          ...
          'If the hearing loss is age-related and gradual, you can also book a free test with a private chain at the same time',
          'For children, the route is only via a paediatrician/ORL; do not buy a device without a medical report'
        ] },
        { kind: 'warning', text: 'Sudden sensorineural hearing loss is a medical urgency. The earlier the treatment, the better the chance of recovery. Do not wait for a “free test next week”.' }
      ]
    },
    {
      id: 'sns-route',
      ...
      content: [
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'orl', title: '2. Consulta de ORL', content: [
            { kind: 'paragraph', text: 'ORL examines the ear and rules out wax plugs, otitis, perforation, tumoral and neurological causes. After that, they prescribe audiometria and other tests.' }
          ] },
          { id: 'tests', title: '3. Audiometria and relatório', content: [
            { kind: 'paragraph', text: 'The result must show the type and degree of hearing loss. For an application for support, a relatório médico/prescrição stating the need for a hearing aid is usually required.' }
          ] },
          { id: 'support', title: '4. Pedido de produto de apoio', content: [
            { kind: 'paragraph', text: 'Hearing aids are included in the produtos de apoio system. Applications can go through entidades prescritoras/financiadoras, including the SNS and Segurança Social, depending on the situation. In practice, ask ORL and the hospital administrative service which exact route applies in your ACES/ULS.' }
          ] }
        ] },
        { kind: 'checklist', items: [
          'Número de utente SNS',
          'NIF',
          'Document: residence permit, Cartão de Cidadão, passport with visa or another document proving lawful stay',
        ...
        { kind: 'warning', text: 'Comparticipação does not mean an automatic discount at the till. A prior application, orçamento and waiting for a decision are often required. Do not buy a device for €3,000 assuming that the SNS “will definitely reimburse it later” until you have written confirmation of the route and conditions.' }
      ]
    },
    {
      id: 'private-route',
      ...
      content: [
        { kind: 'paragraph', text: 'The private route is convenient if you need to understand quickly whether a device is needed and test models. Audiology chains and practices operate in Portugal: Acustimedi, Minisom, GAES/Amplifon, MultiOpticas Audiologia, as well as local audiologistas. The name Acoustimedi appears in searches and on individual pages, but before a visit check the legal name, address and reviews: the most recognisable brand is Acustimedi.' },
        { kind: 'paragraph', text: 'A free test in a shop is not a substitute for ORL, but it is a good start. Normal practice: test, trial period, fitting, follow-up after 2-4 weeks, then regular readjustment.' },
        { kind: 'checklist', items: [
          'Ask for a printout of the audiogram, not just a verbal “you need a device”',
          ...
          'Ask about rechargeable battery: convenient, but replacing the battery later costs money',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Widex and Oticon are solid premium brands, available in Portugal through partner practices. Both have modern RIC/BTE models, rechargeable versions, Bluetooth, apps and noise reduction. The difference is usually not the logo, but how well the audiologista fits the device to your audiometria and real-life situations: work, the street, restaurants, Portuguese speech.' },
        { kind: 'checklist', items: [
          ...
          'ITE/ITC — in-ear models are less noticeable, but are not suitable for everyone in terms of anatomy and power',
          ...
          'Tinnitus programme — may help with noise in the ears, but does not treat the cause',
        ...
        { kind: 'paragraph', text: 'For comparison, ask not for “the best hearing aid”, but for 2-3 orçamento options: basic, mid-range and premium. For many people, the mid-range class provides almost all the practical benefit if the fitting is done well.' }
      ]
    },
    {
      id: 'money',
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Do not take out credit on the spot until you have compared the SNS option and a second opinion'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The first few weeks almost always feel unfamiliar: you hear the fridge, footsteps, dishes, wind. This does not mean the device is bad. Ajustes are needed — usually the 1st follow-up after 2-4 weeks, then another 1-2 adjustments.' },
        { kind: 'checklist', items: [
          'Wear the device every day, otherwise the brain will not adapt',
          'Write down situations where things are bad: restaurant, car, Zoom, street',
          'Bring these notes to the ajuste, rather than just saying “I hear badly”',
          'Clean filters and earmoulds according to the instructions',
          ...
          'Have a repeat audiometria once a year, or earlier if things worsen',
  ...
  costs: [
    { label: 'Private audiometria without a promotion', amountEURMin: 30, amountEURMax: 80, note: 'In many chains, the test is done free of charge when choosing a device; in an ORL clinic it may be paid.' },
    ...
    { label: 'Mid-range/premium hearing aid', amountEURMin: 1500, amountEURMax: 3500, note: 'Indicative price per ear in a private sale with fittings; a pair is usually €3,000-7,000.' },
    { label: 'Co-payment after comparticipação', amountEURMin: 500, amountEURMax: 1500, note: 'Typical practical range with approved support, but the amount is not guaranteed and depends on the budget, model and application route.' },
  ...
  sources: [
    ...
    { title: 'Acustimedi — private audiology and hearing-aid network', url: 'https://www.acustimedi.pt', kind: 'company', language: 'pt', lastRetrieved: '2026-04-28' }
  ],
