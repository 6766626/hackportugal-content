export default {
  ...
  tldr: 'In Portugal, hearing aids are usually bought after a consulta de ORL and audiometria. The private route is quick: the test is often free, a Widex/Oticon/Phonak/Signia device costs roughly €1,500–€3,500 per ear, and fitting is included. Through the SNS the route is slower: médico de família → ORL → relatório/prescrição → pedido de produto de apoio; if comparticipação is approved, the final co-payment often drops to €500–€1,500, but it depends on the budget, clinic and model.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'An important nuance: a hearing-aid seller can carry out a test and fit a device, but the medical diagnosis is made by an ORL doctor — an otorrinolaringologista. For the SNS, comparticipação and serious symptoms, you specifically need ORL.' },
        { kind: 'checklist', items: [
          'Go to ORL urgently if hearing loss appeared suddenly over hours/days',
          'Pain, discharge from the ear, fever — start with médico de família/ORL, not a hearing-aid shop',
        ...
        { kind: 'warning', text: 'Sudden sensorineural hearing loss is a medical emergency. The earlier the treatment, the higher the chance of recovery. Do not wait for a “free test next week”.' }
      ]
    },
    {
      id: 'sns-route',
      ...
      content: [
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'tests', title: '3. Audiometria and relatório', content: [
            { kind: 'paragraph', text: 'The result should show the type and degree of hearing loss. For an application for support, a relatório médico/prescrição stating the need for a hearing aid is usually required.' }
          ] },
        ...
        { kind: 'checklist', items: [
          ...
          'Referral from médico de família or booking with ORL',
          ...
          'Proof of income may be needed for social-support routes'
        ] },
        { kind: 'warning', text: 'Comparticipação does not mean an automatic discount at the till. Often a prior application, orçamento and waiting for a decision are required. Do not buy a €3,000 device assuming that the SNS will “definitely refund it later” until you have written confirmation of the route and conditions.' }
      ]
    },
    {
      id: 'private-route',
      ...
      content: [
        { kind: 'paragraph', text: 'The private route is convenient if you need to understand quickly whether you need a device and to test models. Networks and audiologia practices operate in Portugal: Acustimedi, Minisom, GAES/Amplifon, MultiOpticas Audiologia, as well as local audiologistas. The name Acoustimedi appears in search results and on individual pages, but before visiting, check the legal name, address and reviews: the most recognisable brand is Acustimedi.' },
        { kind: 'paragraph', text: 'A free test in a shop is not a substitute for ORL, but it is a good starting point. Normal practice is: test, trial period, fitting, check-up after 2–4 weeks, then regular readjustment.' },
        { kind: 'checklist', items: [
          'Ask for a printout of the audiograma, not just a verbal “you need a device”',
          ...
          'Ask about rechargeable battery: convenient, but later battery replacement costs money',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Widex and Oticon are reputable premium brands, available in Portugal through partner practices. Both have modern RIC/BTE models, rechargeable versions, Bluetooth, apps and noise reduction. The difference is often not in the logo, but in how well the audiologista fits the device to your audiometria and real-life situations: work, the street, restaurants, Portuguese speech.' },
        { kind: 'checklist', items: [
          ...
          'ITE/ITC — in-ear models are less visible, but do not suit everyone in terms of anatomy and power',
          ...
          'Moisture protection does not mean you can swim or shower wearing the device'
        ] },
        { kind: 'paragraph', text: 'For comparison, ask not for “the best device”, but for 2–3 orçamento options: basic, mid-range and premium. For many people, the mid-range gives almost all the practical benefit if the fitting is done well.' }
      ]
    },
    {
      id: 'money',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The first weeks are almost always unfamiliar: you hear the fridge, footsteps, dishes, wind. This does not mean the device is bad. Ajustes are needed — usually the 1st check-up after 2–4 weeks, then another 1–2 fittings.' },
        { kind: 'checklist', items: [
          'Wear the device daily, otherwise the brain will not adapt',
          'Write down the situations where things are poor: restaurant, car, Zoom, street',
          ...
          'Remove it before showering, swimming pools, saunas and hair dyeing',
          'Have repeat audiometria once a year, or earlier if things worsen',
          'If pain, rubbing, whistling or inflammation appears, go for readjustment/an examination'
        ] }
      ]
    }
  ],
  costs: [
    { label: 'Private audiometria without a promotion', amountEURMin: 30, amountEURMax: 80, note: 'In many networks, the test is done free of charge when fitting a device; in an ORL clinic it may be paid.' },
    ...
    { label: 'Mid-range/premium hearing aid', amountEURMin: 1500, amountEURMax: 3500, note: 'Indicative price for one ear in a private sale with fittings; a pair is usually €3,000–€7,000.' },
    ...
    { label: 'Batteries/consumables per year', amountEURMin: 30, amountEURMax: 120, note: 'Lower for rechargeable devices, but paid battery replacement may be needed later.' }
  ],
  sources: [
    ...
    { title: 'Acustimedi — private network for audiologia and aparelhos auditivos', url: 'https://www.acustimedi.pt', kind: 'company', language: 'pt', lastRetrieved: '2026-04-28' }
  ],
