  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'S1 is needed by British pensioners and some recipients of UK benefits who live in Portugal and want to use the SNS on the same terms as residents of Portugal. The costs of state treatment are paid by the UK, but care is provided through the Portuguese system.' },
        { kind: 'checklist', items: [
          'You receive the UK State Pension — the most common scenario.',
          'Or you receive certain exportable benefits from the UK that give you the right to an S1.',
          'You are moving to live in Portugal or are already a resident of Portugal.',
          'You do not work in Portugal as an empregado/recibos verdes with standard contributions to Segurança Social.',
          ...
          'S1 may cover some dependants, but this is checked by NHS BSA individually.',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The form is issued by the NHS Business Services Authority, Overseas Healthcare Services. You must request S1 from the UK, not from the Portuguese SNS. This is usually done after a decision to move has been made or after arrival, once your address in Portugal is clear.' },
        { kind: 'checklist', items: [
          'Contact NHS Overseas Healthcare Services using the contacts on GOV.UK.',
          'Prepare your National Insurance number.',
          'State your moving date or the date you start living in Portugal.',
          'Provide your Portuguese address, if you already have one.',
          'Provide details of your spouse/partner and dependants if you want to check their entitlement to cover.',
          'Check that the name on the S1 matches your passport and Portuguese documents.',
          'Keep the original S1 and make scans: Segurança Social often takes or stamps copies.'
        ] },
        { kind: 'paragraph', text: 'Timescales depend on NHS BSA and the post. In practice, allow several weeks, especially if dependants or the address need to be checked.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'After receiving S1, you need to register it with the Instituto da Segurança Social in Portugal. Without this registration, the Centro de Saúde may refuse full registration in the SNS as an S1-holder.' },
        { kind: 'checklist', items: [
        ...
        { kind: 'warning', text: 'Do not confuse S1 registration with standard Segurança Social contributions. An S1 pensioner usually does not pay Portuguese social security contributions solely because of access to the SNS. But if you start working in Portugal, the cover rules may change.' }
      ]
    },
    {
      id: 'get-utente',
      ...
      content: [
        { kind: 'paragraph', text: 'After Segurança Social, go to the Centro de Saúde for your address. There you are registered in the SNS and assigned a número de utente — an SNS patient number.' },
        { kind: 'checklist', items: [
          'Confirmation of S1 registration with Segurança Social.',
          'Passport.',
          'Residence permit/resident card.',
          'NIF.',
          'Proof of address in the Centro de Saúde catchment area.',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Does not cover private clinics unless they operate under an agreement with the SNS for a specific referral.',
          'Does not replace travel insurance for trips, repatriation, flight cancellations and private medicine.',
          'Does not mean automatic allocation of a family doctor — in some areas there is a waiting list.',
          ...
          'If moving from Portugal to another country, you need to check S1 and registration again.'
        ] },
        { kind: 'paragraph', text: 'In the SNS, most standard user charges have been abolished, but in certain cases, for example urgência without a referral from SNS 24/INEM/family doctor, taxas moderadoras may apply. Medicine discounts depend on the medicine and the comparticipação scheme.' }
      ]
    },
    {
      id: 'common-problems',
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'S1 has not arrived yet: temporarily use private insurance or paid access; emergency care via 112/SNS remains available.',
          'Your address has changed: update the address with Finanças, Segurança Social and the Centro de Saúde.',
          'Spouse below pension age: do not assume automatic cover — check with NHS BSA.',
          'You have started working in Portugal: notify NHS BSA and Segurança Social because the country responsible for healthcare cover may change.',
        ...
        { kind: 'warning', text: 'Do not postpone S1 until a serious illness. Registration with Segurança Social and the SNS can take time, and private medicine in Portugal quickly becomes expensive in the event of hospitalisation or chronic treatment.' }
      ]
    }
  ],
  costs: [
    ...
    { label: 'Private insurance for the waiting period', amountEURMin: 30, amountEURMax: 150, note: 'Indicative monthly cost for an older person depends heavily on age, excess and exclusions.' }
  ],
  sources: [
    {
