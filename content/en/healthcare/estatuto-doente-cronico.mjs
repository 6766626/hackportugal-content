export default {
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Most often this concerns diabetes mellitus, hipertensão arterial, asma/DPOC, doenças oncológicas, doenças reumáticas, neurological and cardiovascular diseases, chronic kidney failure and other conditions where treatment lasts for months or for life.' },
        { kind: 'warning', text: 'Not every chronic illness automatically gives 100% payment for all medicines. The state pays under the special regime only for medicines, devices or active substances included in a specific protocol/Despacho/Portaria and correctly prescribed by the doctor.' }
      ]
    },
    {
      id: 'benefits',
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Receita sem papel for long-term treatment: the doctor can issue repeat prescriptions so you do not have to go every month just for renewal.',
          ...
          'For diabetes: insulin is usually fully covered; needles, lancets and syringes for self-monitoring may have 100% coverage, while test strips follow a separate regime.',
          'For oncological diseases: many medicines are dispensed through hospitalar pharmacy SNS at no cost to the patient if the treatment is prescribed by a hospital público.',
          ...
          'Isenção de taxas moderadoras in cases where they are still charged, if your category falls within SNS rules or a separate benefit has been registered.',
          'Easier access to follow-up: consultas de vigilância, tests, prescription renewal, vaccination where indicated.'
        ] },
        { kind: 'paragraph', text: 'Since 2022, taxas moderadoras in the SNS have almost been abolished. In 2026 they mainly remain for urgência hospitalar without referral from SNS 24, INEM, médico de família or without subsequent hospitalisation. As a guide: Serviço de Urgência Básica — €14, Médico-Cirúrgica — €16, Polivalente — €18, plus possible exames.' }
      ]
    },
    {
      id: 'how-to-get',
        ...
        { kind: 'substeps', items: [
          { id: 'prepare-documents', title: '1. Prepare documents and medical history', content: [
            { kind: 'checklist', items: [
              ...
              'NIF — often needed for administrative records and prescriptions.',
              'List of current medicines: name, dosage, how many times per day.',
              'Discharge summaries, tests, specialist reports from Portugal or another country.',
              'If the documents are not in Portuguese/English — a brief translation of the diagnosis and treatment regimen.',
          ...
          { id: 'medical-declaration', title: '3. Obtain a declaração médica and update prescriptions', content: [
            { kind: 'paragraph', text: 'Ask the doctor to record the diagnosis as chronic, state the need for long-term treatment and issue a Receita sem papel with the correct comparticipação regime. For some diseases, the doctor selects a special regime in the prescription system; without this, the pharmacy will apply the ordinary discount rather than the preferential one.' }
          ]},
          { id: 'confirm-exemption', title: '4. Check the isenção in the administrative section', content: [
            { kind: 'paragraph', text: 'After the consultation, go to the secretaria of the Centro de Saúde and ask whether the isenção de taxas moderadoras is active in the Registo Nacional de Utentes. Sometimes the medical note and the administrative benefit are separate actions.' }
          ]}
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'At the pharmacy, show the prescription number/SMS, Cartão de Cidadão or a document with the número de utente. The discount is applied automatically if the prescription was issued as comparticipado and the correct regime was selected.' },
        { kind: 'checklist', items: [
          'Check the receipt: it shows preço total, comparticipação do Estado and valor a pagar.',
          'If a medicine should be 100% covered but the pharmacy asks for payment, first check whether the ordinary regime was prescribed instead of the special one.',
          'Ask the médico de família to prescribe by active substance if genéricos suit you — this is often cheaper and more available.',
          ...
          'Keep faturas with NIF: part of medical expenses goes into e-Fatura and is considered in IRS.'
        ] },
        { kind: 'warning', text: 'The benefit is not automatically refunded “retroactively”. If the prescription was issued incorrectly and you paid, you usually need to ask the doctor to reissue the prescription before purchase, not after.' }
      ]
    },
    {
      id: 'common-cases',
      ...
      content: [
        { kind: 'checklist', items: [
          'Diabetes: ask to arrange insulin/tablets, self-monitoring materials, an análises HbA1c plan and diabetes enfermagem consultations straight away.',
          ...
          'Oncologia: treatment is usually managed by an SNS hospital; prescriptions and dispensing of medicines often go through the hospital pharmacy, not an ordinary farmácia.',
          'Chronic pain/rheumatology: some medicines require a specialist and hospitalar prescription; a médico de família can manage basic medicines, but not everything.',
        ...
        { kind: 'paragraph', text: 'If you arrived in Portugal with an existing diagnosis, do not wait until your medicines run out. Book at the Centro de Saúde as soon as you obtain a número de utente: selecting an equivalent and confirming the benefit may take several weeks.' }
      ]
    },
    {
      id: 'problems',
      title: 'If you were refused or nothing was activated',
      content: [
        { kind: 'checklist', items: [
          ...
          'Ask the médico de família to issue a declaração médica de doença crónica with the diagnosis and permanent treatment.',
          'If you do not have a family doctor, ask for a consulta aberta and registration on the lista de utentes sem médico.',
          'If the issue is the medicine, ask the doctor for the comparticipação regime code and whether the medicine is on the Infarmed list.',
  ...
  costs: [
    ...
    { label: 'Urgência Básica without referral', amountEUR: 14, note: 'Only if there is no referral from SNS/INEM/doctor and no subsequent hospitalisation; with isenção — €0.' },
