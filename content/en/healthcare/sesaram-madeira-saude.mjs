export default {
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Açores: SRS-Açores operates island by island; primary care is through Unidade de Saúde de Ilha.',
          'The número de utente may remain the national identifier, but local registration is still required.',
          'Having a family doctor on the mainland does not mean an automatic family doctor in Madeira or Açores.',
          'Referrals for tests, consultations and operations usually need to go through local primary care.',
          'Private clinics exist, but the choice is narrower than in Lisboa/Porto; on smaller islands it is minimal.',
          'If a service is not available on the island, the region organises a referral and sometimes medical transport.'
        ] }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'Do not assume that an old referral from the mainland will automatically work on the islands. Often a doctor in Madeira/Açores has to enter the pedido again in the regional system or confirm clinical necessity.' }
      ]
    },
    {
      id: 'madeira-sesaram',
      ...
      content: [
        { kind: 'paragraph', text: 'SESARAM is the main public healthcare operator in Madeira. It covers primary care, hospital care, urgência, specialist consultations and part of diagnostics. The central workload is in Funchal, so residents of other municipalities sometimes have to travel to the regional capital.' },
        { kind: 'checklist', items: [
          'For ordinary issues, go to your Centro de Saúde, not straight to urgência.',
          ...
          'Porto Santo has a limited network: some specialisms require a trip to Madeira.',
        ...
        { kind: 'paragraph', text: 'Practical hack: when registering, ask for a printout or confirmation of your número de utente/inscrição. It will be useful at the pharmacy, in a private clinic, when booking exames and if you need to explain your status after a recent move.' }
      ]
    },
    {
      id: 'azores-srs',
      ...
      content: [
        { kind: 'paragraph', text: 'In Açores, healthcare is distributed across 9 islands. The primary entry point is Unidade de Saúde de Ilha. The hospital network is concentrated around three hospitals: Hospital do Divino Espírito Santo de Ponta Delgada on São Miguel, Hospital de Santo Espírito da Ilha Terceira and Hospital da Horta on Faial.' },
        { kind: 'checklist', items: [
          'On São Miguel and Terceira, access to specialists is broader than on smaller islands.',
          'On Santa Maria, Graciosa, São Jorge, Pico, Flores and Corvo, some care requires an inter-island referral.',
          'Planned trips for consultations/operations are arranged through SRS-Açores, not directly through the mainland SNS.',
          'Weather delays are a real factor: keep at least 2-4 weeks of medicines in reserve.',
          'If you have a chronic condition, ask in advance where the nearest specialist is and how deslocação is arranged.',
          'For pregnancy, oncology, dialysis, cardiology and complex diagnostics, clarify the route before moving to a smaller island.',
          'Private insurance is useful, but it does not replace the SRS: on smaller islands, a private doctor in the required specialism may simply not exist.'
        ] },
        { kind: 'warning', text: 'In Açores, distance is measured not in kilometres, but in flights and weather. If you are choosing an island to live on with a serious diagnosis, first check the actual availability of the care you need, not just the presence of a beautiful rental.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Before moving, put together a medical folder. Portuguese systems are increasingly digital, but exchange between the mainland, Madeira and Açores may be incomplete. A doctor in your new location will make a decision faster if you have the documents in hand.' },
        { kind: 'checklist', items: [
          'Ask your old médico de família for a resumo clínico.',
          'Download recent blood tests, exames de imagem, discharge summaries and operation reports.',
          'Check active receitas sem papel and their expiry dates.',
          'Take a list of medicines with dosages in Portuguese or English.',
          'If you are waiting for a consultation/operation on the mainland, check whether the queue will be preserved after changing region.',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Private healthcare on the islands covers some quick consultations, dentistry, physiotherapy, dermatologia, ginecologia and basic diagnostics. But it does not always cover complex hospital care, intensive care, high-risk births or rare specialisms.' },
        { kind: 'checklist', items: [
          'Emergency: 112.',
          'Medical advice by phone: SNS 24 — 808 24 24 24; the operator may direct you to urgência or to a doctor.',
          ...
          'If the doctor mentions deslocação, peça por escrito: referral, date, place, who pays for transport and whether autorização prévia is needed.'
        ] },
        { kind: 'warning', text: 'Do not postpone registration until the first attack. In urgência you will be seen, but chronic prescriptions, a family doctor and referrals without local inscrição turn into a quest.' }
      ]
    }
  ],
  costs: [
    ...
    { label: 'Basic private insurance', amountEURMin: 25, amountEURMax: 80, note: 'Indicative monthly cost for an adult; check the network in Madeira/Açores before buying.' },
  ...
  sources: [
    ...
    {
      title: 'Government of Açores — Serviço Regional de Saúde',
    ...
    {
      title: 'ITIJ — overview of the Portugal and Madeira healthcare system',
