export default {
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Serviço de Apoio Domiciliário is a social service where a person continues living at home but receives regular support.\n\nIn Portugal, SAD is usually provided by IPSS, Santa Casa da Misericórdia, parish/municipal bodies or licensed private companies.' },
        { kind: 'paragraph', text: 'It is a good option for an older parent, someone after surgery, in cases of disability, early-stage dementia, limited mobility, or when the family needs relief for a few hours a day.' },
        { kind: 'checklist', items: [
          ...
          'social contact: visits, condition monitoring, alerting the family',
          'sometimes teleassistência or an alarm button, if the provider offers the service'
        ] },
        { kind: 'warning', text: 'SAD does not replace the SNS, a doctor, a nurse or the Serviço de Urgência. Dressings, injections, palliative care and rehabilitation are provided through the SNS, UCC/ECCI or private healthcare. In case of a fall, chest pain, stroke, acute confusion — 112.' }
      ]
    },
    {
      id: 'where-to-apply',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The set of documents depends on the institution, but they almost always check identity, address, income and degree of dependency. For foreigners, NIF, address and legal stay are important; a residence permit helps, but the social service may also consider other proof of lawful residence.' },
        { kind: 'checklist', items: [
          ...
          'NISS, if available; for pensioners from another country, proof of pension may be requested',
        ...
        { kind: 'warning', text: 'Do not sign a contrato de prestação de serviços if it does not specify the visit schedule, services included, price, cancellation rules and responsibility for keys/access to the home. Ask for a copy of the regulamento interno.' }
      ]
    },
    {
      id: 'pricing',
      ...
      content: [
        { kind: 'paragraph', text: 'For SAD through an IPSS, the price is called comparticipação familiar. It is calculated by the institution based on income per person, expenses and the internal regulamento. In 2026, the typical range for a basic package is around €100-400/month: for example, meal delivery + morning hygiene + light cleaning several times a week.' },
        { kind: 'paragraph', text: 'If income is very low, the price may be symbolic or below €100/month. If income is high, two daily visits are needed, weekends, a diet, transport and accompaniment are required — the total may exceed €400/month, especially with private providers.' },
        { kind: 'checklist', items: [
          'ask whether meals are included in the price or charged separately per refeição',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'SAD is often faster than an ERPI — lar/residência for older people. In popular concelhos, ERPI waiting lists can be months or longer; SAD is easier to scale if the route already passes nearby.' },
        { kind: 'checklist', items: [
          ...
          'in cases of dementia, attach a relatório médico: this affects visit frequency',
          ...
          'for medical care at home, also ask the family doctor for referenciação para ECCI, if indicated'
        ] },
        { kind: 'warning', text: 'Do not wait for a crisis. When there are already falls, refusal to eat or night wandering, SAD may be insufficient: an assessment by a médico de família, neurologia/psiquiatria, apoio informal estruturado or ERPI may be needed.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'A proper SAD works according to an individual plano de cuidados: days, hours, tasks, meals, risks, family contact. Ask for the plan to be reviewed after 30 days: the real need often becomes clear only after the service has started.' },
        { kind: 'checklist', items: [
          'leave a list of medicines, allergies, diagnoses and doctor’s contacts in a visible place',
  ...
  costs: [
    ...
    { label: 'Private home help', amountEURMin: 15, amountEURMax: 25, note: 'Indicative hourly rate in cities; nights, weekends and high-dependency care are more expensive.' },
