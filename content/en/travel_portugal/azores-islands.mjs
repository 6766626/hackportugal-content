  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'The climate is mild subtropical (+14-24°C all year round), but changeable: “there can be 4 seasons in one day”. Plenty of greenery, lakes, waterfalls.' }
      ]
    },
    {
      id: 'sao-miguel',
      title: 'São Miguel — “Green Island”',
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          '🌋 Lagoa do Fogo — crater lake at 575 m. Walking trails',
    ...
    {
      id: 'pico',
      title: 'Pico — island of mountain and wine',
      content: [
        { kind: 'checklist', items: [
          '⛰️ Montanha do Pico — the highest mountain in Portugal (2,351 m). 5-8 h ascent with a certified guide',
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'o2', title: 'Faial — Ilha Azul', content: [
            { kind: 'paragraph', text: 'The “Blue Island” because of its hydrangeas. Capelinhos — 1957-58 volcano, lunar landscape. Port of Horta — a stop for yachtspeople.' }
          ]},
          { id: 'o3', title: 'São Jorge', content: [
            { kind: 'paragraph', text: 'An elongated island with cliffs (fajãs — plateaus by the sea). São Jorge DOP cheese, Verdelho grapes, gastronomic festivals.' }
          ]},
          ...
          { id: 'o5', title: 'Santa Maria', content: [
            { kind: 'paragraph', text: 'The oldest island (8.2 million years), red sand — a rarity in the Azores. The Santa Maria festival every 5 years.' }
          ]},
          { id: 'o6', title: 'Graciosa', content: [
            { kind: 'paragraph', text: 'UNESCO Biosphere Reserve. Its main feature is that it is the driest island. Furna do Enxofre — a cave with a sulphurous lake.' }
          ]},
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '✈️ TAP Lisboa → Ponta Delgada: 2 h 30 min, from €60 when booked early',
