export default {
  ...
  title: 'Domestic flights and ferries — Madeira, Azores, mainland',
  tldr: 'For trips between the mainland and the islands, flying is essential. TAP and Ryanair fly Lisbon/Porto → Madeira (Funchal) / Azores (Ponta Delgada).\n\nIn the Azores, subsidised fares apply for residents. Soflusa/Transtejo ferries cross the Tagus in Lisbon, Douro cruises operate in Porto, and in the Azores there are ferries between islands.',
  ...
  steps: [
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'a1', title: 'TAP Air Portugal', content: [
            { kind: 'paragraph', text: 'The national carrier. Lisbon/Porto → Funchal: 4–8 flights per day, 1.5 h. Lisbon → Ponta Delgada: daily, 2 h 30 min. Prices from €50 with early booking to €300 in peak season.' }
          ]},
          { id: 'a2', title: 'Ryanair', content: [
            { kind: 'paragraph', text: 'Cheap tickets from €20 on Lisbon — Funchal and Porto — Faro flights. But there are extra charges for luggage and seat selection. It is important to read the small print.' }
          ]},
          { id: 'a3', title: 'SATA / Azores Airlines', content: [
            { kind: 'paragraph', text: 'The Azores regional carrier. Inter-island flights: 10–30 min, €40–€80. Lisbon → Azores flights are also available.' }
          ]},
          { id: 'a4', title: 'Porto → Lisbon', content: [
            { kind: 'paragraph', text: 'TAP flies 8–10 times per day, 50 min. But the train or coach is often more economical once travel to the airport is taken into account. The train is recommended.' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Residents of the Azores and Madeira receive subsidised fares on domestic flights — up to -80%. Proof of residence is required.' },
        { kind: 'paragraph', text: 'Buy via the “tarifa residente” fare on SATA or TAP, indicating a Madeira/Azores residence permit.' }
      ]
    },
    {
      id: 'ferries',
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'f2', title: 'Douro — Porto', content: [
            { kind: 'paragraph', text: 'Short cruises (6 bridges, 45 min, €18–€25) and long cruises (to Régua, full day, €60–€100). For Porto residents — rabelo catamarans from Cais da Ribeira.' }
          ]},
          { id: 'f3', title: 'Azores islands — between islands', content: [
            { kind: 'paragraph', text: 'Atlânticoline — ferries between the islands. In season (April–October), all lines operate. In winter, there are restrictions. Between neighbouring islands 1–2 h, €15–€30. Discounts for residents.' },
