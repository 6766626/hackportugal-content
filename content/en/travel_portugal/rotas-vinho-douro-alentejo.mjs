  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Book visits on the quinta/adega website or by email — walk-in in 2026 is not guaranteed',
          'Check the tour language: PT/EN almost always, RU rarely',
          'Clarify whether tour + tasting is included or only prova',
          'Plan 2, maximum 3 tastings per day',
          'Allow 60–120 minutes for one quinta',
          'Do not drive after tastings: Uber/Bolt outside cities are inconsistently available',
          'You can buy wine on site; delivery within Portugal is often available for an extra charge'
        ] }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Rota do Vinho do Porto/Douro brings together 60+ quintas and wine-related sites. In 2026, the typical price for a visit with tasting is €15–50 per person: a basic prova is cheaper, while a vineyard tour, aged Port/Tawny or lunch pairing costs more.' },
        { kind: 'checklist', items: [
          ...
          'Route by car: the N222 is beautiful, but narrow and tiring; allow extra time',
          'For Port wine: include Vila Nova de Gaia if you live near Porto or are going for the first time',
          'For landscapes: Pinhão and São João da Pesqueira give the most “postcard” Douro',
        ...
        { kind: 'warning', text: 'Douro looks compact on the map, but the roads are slow. Do not put Régua, Pinhão, São João da Pesqueira and Vila Nova de Foz Côa into one day with tastings — it will become a race, not a wine route.' }
      ]
    },
    {
      id: 'alentejo',
      ...
      content: [
        { kind: 'paragraph', text: 'Rota dos Vinhos do Alentejo is one of the most convenient wine routes for a weekend. Key centres: Évora, Reguengos de Monsaraz, Estremoz, Borba, Redondo, Vidigueira. The region is known for its warm climate, red blends, talha wine and wineries with good visitor infrastructure.' },
        { kind: 'checklist', items: [
          ...
          'For talha wine, ask for tastings in Vidigueira, Vila de Frades and the surrounding area',
          'Restaurants in Alentejo are popular at weekends — book lunch in advance',
          'Between adegas, it is better to go by car with a sober driver or take a private tour'
        ] },
        { kind: 'paragraph', text: 'Alentejo is good for those who want to combine wine, gastronomy and a calm rural stay. There are fewer dramatic roads here than in Douro, but the distances between places are large, and public transport for wine tourism is almost useless.' }
      ]
    },
    {
      id: 'tejo-lisboa',
      ...
      content: [
        { kind: 'paragraph', text: 'If you live in Lisbon and do not want to stay overnight, look at the Tejo and Lisboa regions. Tejo is convenient via Santarém, Cartaxo, Almeirim, Tomar and the Ribatejo area; Lisboa is via Bucelas, Colares, Torres Vedras, Óbidos and the surrounding area.' },
        { kind: 'paragraph', text: 'Rota dos Vinhos do Tejo and Rota dos Vinhos de Lisboa are usually simpler logistically than Douro: fewer mountain roads, more options for a day tour, and a lower average bill for basic tastings.' },
        { kind: 'checklist', items: [
          'From Lisbon to Tejo it is convenient to travel by car; Santarém is a clear first stop',
          ...
          'Do not confuse Tejo as a wine region with the tourist waterfront in Lisboa — this is a separate DOC/IG geography'
        ] }
      ]
    },
    {
      id: 'booking-safety',
      title: 'How to book and avoid spoiling the trip',
      content: [
        { kind: 'substeps', items: [
          { id: 'choose-region', title: '1. Choose the region for the format', content: [
          ...
          { id: 'plan-transport', title: '3. Transport first, then tastings', content: [
            { kind: 'paragraph', text: 'The main mistake is booking 3 tastings in different valleys and then discovering that there is no taxi. In rural Portugal, transport must be planned before paying for visits.' }
          ] }
        ] },
        { kind: 'checklist', items: [
          'Have booking confirmation in email/WhatsApp',
          'Arrive 10 minutes before the tour starts',
          'Take water, sun protection and comfortable shoes for the vineyards',
          'Give advance notice of pregnancy, alcohol intolerance or food restrictions',
        ...
        { kind: 'warning', text: 'In Portugal, the permitted drink-driving limit is low, and for new drivers and professionals it is even stricter. Practical rule for a wine route: the driver does not taste, or uses a spit bucket without “I’ll just try a little”.' }
      ]
    }
  ],
  costs: [
    ...
    { label: 'Private wine tour with transport', amountEURMin: 90, amountEURMax: 250, note: 'Guide price per person in a small group; the price depends heavily on the region, language and included lunch.' }
  ],
  sources: [
