export default {
  ...
  tldr: 'Braga is the “Portuguese Rome”, the religious capital, with an 11th-century cathedral and the famous Bom Jesus do Monte (UNESCO). Guimarães (UNESCO) is where Portugal was born in 1128, with the castle of the first king, Afonso Henriques. From Porto — 1 hour by train. Both cities can be seen in a day with Porto as your base.',
  tags: ['braga', 'guimarães', 'north', 'unesco'],
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🚌 Between Braga and Guimarães: there is practically no direct CP train (a change via Porto Urbanos hubs is needed, which takes a long time). Better by bus ~40–50 min (Rede Expressos / GetBus, ~€5–7) or by car ~30 min (A3+A11)',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The country’s oldest city (Roman Bracara Augusta, 2nd century BC). An archiepiscopal capital, with 35+ churches. Religious festivals (Semana Santa, processions) are the best season.' },
        { kind: 'checklist', items: [
          '⛪ Sé de Braga — the oldest cathedral in the country (11th century), combining Romanesque, Gothic and Manueline styles. €5',
          '⛪ Bom Jesus do Monte (UNESCO) — a Baroque sanctuary on a hill 5 km from the centre. The legendary “stairway of the 5 senses”, and an 1882 water-balanced funicular. Funicular — €3',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          '🏰 Castelo de Guimarães (10th century) — the castle where Afonso Henriques, the first king, was born. €2',
          '🏛️ Paço dos Duques de Bragança (15th century) — a castle-palace in Burgundian style, residence of the dukes. €5',
          ...
          '🚡 Teleférico da Penha — cable car to Mount Penha, views. €5 return',
          '🏛️ Museu Alberto Sampaio — medieval art in monastic galleries'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '14:00 — train Braga → Guimarães (35 min)',
          '15:00–18:00 — castle, Palace of the Dukes, historic centre, Largo da Oliveira',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🥟 Pudim do Abade de Priscos — Braga’s famous dessert with pork lard',
          '🥖 Bola de Berlim — a doughnut, but in Braga it is special',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🎪 São João de Braga (23-24 June) — Saint John festival',
          '🎭 Guimarães Capital Europeia da Cultura 2012 — a legacy in the form of exhibition spaces',
