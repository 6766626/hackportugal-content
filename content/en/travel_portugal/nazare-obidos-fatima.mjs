export default {
  ...
  tldr: 'Three different faces of central Portugal: Nazaré — giant waves for surfing (up to 30 m), Óbidos — a medieval town within 11th-century walls, Fátima — a global centre of Catholic pilgrimage. All 3 places can be visited in one long trip from Lisbon by car (circular route 150-200 km).',
  tags: ['nazare', 'obidos', 'fatima', 'surfing', 'pilgrimage'],
  estimatedReadMinutes: 8,
  steps: [
    {
      id: 'nazare',
      title: 'Nazaré — capital of giant waves',
      content: [
        { kind: 'paragraph', text: 'A fishing town on the Atlantic. In autumn and winter — a spot for surfing monster waves: Garrett McNamara’s record 23.8 m (2017), unofficially — up to 30 m. The famous Praia do Norte.' },
        { kind: 'checklist', items: [
          '🌊 Praia do Norte — giant waves from October to March. Nazaré Tow Surfing Challenge festival',
          '🏰 Forte de São Miguel Arcanjo — 16th-century fort on the headland, the best view of the waves',
    ...
    {
      id: 'obidos',
      title: 'Óbidos — a medieval jewel',
      content: [
        { kind: 'paragraph', text: 'A town 85 km from Lisbon, completely surrounded by 12th-century walls. Traditionally — a “wedding gift” from kings to queens. Compact: 2-3 hours is enough.' },
        { kind: 'checklist', items: [
          '🏰 Castelo de Óbidos — now Pousada do Castelo (historic hotel)',
          '🏛️ Muralha — medieval walls around the town perimeter (you can walk along the top)',
          ...
          '📚 FOLIO — international book festival (October)',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'In 1917, the Virgin Mary appeared to three children in Fátima. It is one of the most important Catholic pilgrimage sites in the world. Every year, 5-7 million pilgrims come here.' },
        { kind: 'checklist', items: [
          '⛪ Basílica de Nossa Senhora do Rosário — the main basilica with the tombs of the 3 child visionaries',
          '⛪ Basílica da Santíssima Trindade — modern basilica from 2007, 8633 seats',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🏰 Castelo de Leiria — 12th-century castle, 20 km from Fátima',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🎫 Óbidos — entry to the town is free; the paid sites are Castelo Pousada and individual museums',
          '🙏 Fátima — on the anniversaries (13 May, 13 October) there are VERY many people, accommodation must be booked months ahead',
