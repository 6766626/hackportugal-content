export default {
  ...
  title: 'Berlengas — nature reserve and island fortress',
  tldr: 'Arquipélago das Berlengas is a group of granite islands 10 km from Peniche. A UNESCO Biosphere Reserve. The main island, Berlenga Grande, is open from May to September, with a limit of 550 visitors per day (booking required). On the island: São João Baptista fort (17th century, you can stay overnight in the “cells”), beaches, diving, trekking, sea caves. 45 min by fast boat, 1:15 by regular boat.',
  tags: ['berlengas', 'islands', 'peniche', 'nature'],
  estimatedReadMinutes: 6,
  steps: [
    {
      id: 'booking',
      title: 'Booking your visit — required',
      content: [
        { kind: 'paragraph', text: 'Since 2011, ICNF (Instituto da Conservação da Natureza e das Florestas) has limited visits — 550 people per day on Berlenga Grande, to preserve the ecosystem.' },
        { kind: 'substeps', items: [
          { id: 'b1', title: '1. Reserve ICNF access', content: [
            { kind: 'paragraph', text: 'berlengareservas.icnf.pt → choose the date and number of people. Registration (free of charge) opens ≥ 30 days before the visit. For July-August, book on the day the window opens: places run out within hours.' }
          ]},
          ...
          { id: 'b3', title: '3. On the day of the trip', content: [
            { kind: 'checklist', items: [
              ...
              'Porto de Recreio pier (large car park nearby)',
              'Show the ICNF booking on paper or on your phone',
              'Buy sunscreen, water and snacks in Peniche (on the island it is expensive and there is little choice)'
            ]}
          ]}
        ]}
      ]
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'v1', title: '🏰 São João Baptista fort', content: [
            { kind: 'paragraph', text: 'Built in 1651 on a separate islet, connected to the main island by a stone bridge. You can stay overnight in the fort guest house (from €40/night, book 6 months ahead). A sunset photo with the bridge is the archipelago’s signature image.' }
          ]},
          ...
          { id: 'v3', title: '🌊 Sea caves + Furado Grande', content: [
            { kind: 'paragraph', text: 'Tour on a local small boat (€10-15, 45 min): they circle the island, enter Gruta Azul, Cova do Sonho and the huge Furado Grande tunnel. You can book with the fishermen directly on the beach.' }
          ]},
          { id: 'v4', title: '🥾 Trekking', content: [
            { kind: 'paragraph', text: 'The only road from the pier to the fort is 1.5 km on foot, a trail over granite cliffs. There is no transport on the island. Routes: to the Duque de Bragança lighthouse (summit, 85 m), to the Farol lighthouse, 3 km circular trail.' }
          ]}
        ]}
      ]
    },
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Season: mid-May — end of September. Out of season, boats do not run',
          'Weather: July-August — warm, but many tourists. May/June and September — ideal',
          'Sunday — fewer people',
          ...
          '☀️ A day on Berlengas = 5-6 hours (arrival from 11:00, return at 16:00-17:00)'
        ]}
      ]
    },
    {
  ...
  costs: [
    ...
    { label: 'Guest house in the fort', amountEURMin: 40, amountEURMax: 60, note: '€/night' },
    { label: 'Camping', amountEURMin: 10, amountEURMax: 15, note: '€/night' }
  ],
  sources: [
    { title: 'ICNF — Berlengas Reservations', url: 'https://berlengareservas.icnf.pt/', kind: 'official', language: 'pt', lastRetrieved: '2026-04-22' },
