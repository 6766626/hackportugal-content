export default {
  ...
  steps: [
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'r3', title: 'Algarve — Rota Vicentina', content: [
            { kind: 'checklist', items: [
              '**Trilho dos Pescadores** — coastal trail, 230 km along the south-west coast',
              '**Caminho Histórico** — inland route, 263 km through villages',
              'You can walk it in day sections of 10-20 km and stay overnight in rural houses',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '**Trilhos de Portugal** (official FCMP app) — 150+ PR with GPX',
