export default {
  ...
  tldr: 'Portugal has 300+ marked trails (PR, GR, levadas).\n\nThe most popular: levadas in Madeira (350 km), Rota Vicentina in south-western Alentejo (450 km), PR trails in Serra da Estrela, Gerês, Açores. Short day routes (3-15 km, PR) are available in every natural park; multi-day GR trails are marked with red-and-white waymarks, with overnight stays in albergues and rural houses. Entry is free, but some parks require online registration.\n\nSeason: April-October on the mainland; Madeira — all year round.',
  tags: ['hiking', 'eco-trails', 'trails', 'levadas'],
  estimatedReadMinutes: 7,
  steps: [
    {
      id: 'types',
      title: '🥾 Types of trails in Portugal',
      content: [
        { kind: 'substeps', items: [
    ...
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'r2', title: 'Parque Nacional da Peneda-Gerês (north-west)', content: [
            { kind: 'checklist', items: [
        ...
        { kind: 'substeps', items: [
          { id: 'g1', title: 'Basic (for a one-day PR)', content: [
            { kind: 'checklist', items: [
              ...
              'SPF 50 + cap',
              'Phone with the GPX route, power bank',
  ...
  costs: [
    { label: 'Entry to parks (NP Gerês, Estrela)', amountEUR: 0 },
