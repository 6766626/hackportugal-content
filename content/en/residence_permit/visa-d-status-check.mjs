export default {
  ...
  sources: [
    ...
    { title: 'ePortugal — Obtain a residence permit', url: 'https://www.gov.pt/cidadaos/-/informacoes/obter-autorizacao-de-residencia', kind: 'official', language: 'pt', lastRetrieved: '2026-04-22' }
  ],
