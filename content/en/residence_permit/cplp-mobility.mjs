export default {
  ...
  changeSummary: 'Decreto-Lei 37-A/2024 ended the acceptance of new Manifestação de Interesse applications from June 2024; Lei 61/2025 (in force from 23.10.2025) changed/tightened the subsequent regime, including CPLP procedures — for CPLP citizens except Brazilians, a visa before entry is now mandatory. The new citizenship law (Decreto AR 48/XVII, promulgated by President António José Seguro on 03.05.2026; will enter into force after publication in the DRE) will increase the residence period for citizenship from 5 to 7 years for all CPLP citizens.',
  variants: [
    {
      id: 'brazil',
      audience: { countryCodes: ['BR'] },
      tldr: 'Brazilians: visa-free entry for up to 90 days + application for a residence permit inside the country at AIMA. If a close family member is a Portuguese/EU citizen, a separate family route may be available (this is NOT an automatic acceleration of the CPLP procedure).'
    },
    {
      id: 'other-cplp',
      audience: { countryCodes: ['AO', 'MZ', 'CV', 'GW', 'ST', 'TL', 'GQ'] },
      tldr: 'Angola, Mozambique, Cape Verde and other CPLP countries: a consular visa to Portugal is required BEFORE entry. After entry — apply for a residence permit at AIMA. Lei 61/2025 prohibited applications via Manifestação de Interesse.'
    }
  ],
  steps: [
    {
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'b1', title: '1. Enter without a visa', content: [
            { kind: 'paragraph', text: 'Brazilians may enter without a visa for up to 90 days if they meet the short-stay entry conditions. If you plan to apply later under the CPLP route inside Portugal, you need to have documents confirming lawful entry and the basis for the application; the final decision on admission at the border remains with the border authorities.' }
          ]},
          ...
          { id: 'b3', title: '3. Book an appointment with AIMA', content: [
            { kind: 'paragraph', text: 'Check the current booking channel on the official AIMA website for "Acordo de Mobilidade CPLP" — do not confuse the first application with the renewals portal (portal-renovacoes — this is for renewals). If the online channel is unavailable, use the official AIMA contact centre and the instructions on aima.gov.pt.' }
          ]},
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'o1', title: '1. Consular visa', content: [
            { kind: 'paragraph', text: 'Apply to the Portuguese embassy or consulate in your country. Category — CPLP mobility or type D depending on the situation. Document types — see vistos.mne.gov.pt.' }
          ]},
          { id: 'o2', title: '2. Enter with the visa', content: [
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Validity period and renewals depend on the type of document issued: early/electronic CPLP certificates may have been issued for 1 year; card-based temporary residence permits under art. 75 usually follow the scheme of 2 years initial + 3 years renewal — check the period printed on the card/AIMA decision',
          ...
          'Brazilian residents may separately request Estatuto de Igualdade de Direitos e Deveres; political rights require a separate status and usually 3 years of residence',
    ...
    },
    {
      ...
      content: [
        { kind: 'warning', text: 'New Manifestação de Interesse applications were ended by Decreto-Lei 37-A/2024 from June 2024. Lei 61/2025, in force from 23.10.2025, changed/tightened the subsequent regime and transitional rules, including CPLP procedures. 31.12.2025 — the deadline for the transitional period for applications already submitted. All new procedures go through AIMA or via a consular visa.' },
  ...
  documents: [
    ...
    { title: 'NIF', note: 'NISS — if applicable/if already held, especially when employed or self-employed' },
    { title: 'Proof of address', note: 'format depends on the current AIMA checklist' },
    { title: 'Proof of funds', note: 'may be required by the consulate or AIMA in a specific scenario' },
