export default {
  ...
  costs: [
    ...
    { label: 'AIMA application fee', amountEUR: 708, note: 'indicative according to tabela AIMA from 01.03.2026; check against the current Portaria/table' },
    { label: 'AIMA residence permit (upon approval, for the main applicant)', amountEUR: 7097, note: 'indicative according to tabela AIMA from 01.03.2026; the exact amount is in the current fee table' },
  ...
  sources: [
    ...
    { title: 'Portaria 480-A/2025/1 — tabela de taxas AIMA from 01.03.2026', url: 'https://diariodarepublica.pt/dr/detalhe/portaria/480-a-2025', kind: 'law', language: 'pt', lastRetrieved: '2026-05-17' }
  ],
