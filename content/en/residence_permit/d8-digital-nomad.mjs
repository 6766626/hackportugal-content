export default {
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'Income must come from outside Portugal. If your clients are Portuguese companies, this is not D8 (it is D2 / Recibo Verde).' }
      ]
    },
    {
      id: 'income',
      ...
      content: [
        { kind: 'paragraph', text: 'Legal requirement: average monthly income over the last 3 months must be at least 4× SMN. In 2026 this is 4 × €920 = €3,680/month. The law does not say “net” — in practice the consulate may assess whether funds are sufficient after taxes/expenses, so it is better to show a buffer.' },
        { kind: 'paragraph', text: 'Proven by: an employment contract for remote work + payslips for 3 months OR client contracts + bank receipts for 3–6 months.' }
      ]
    },
    {
      id: 'versions',
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'v2', title: 'Long-stay D8 (residence visa)', content: [
            { kind: 'paragraph', text: 'Gives the right to obtain a full residence permit for 2 years, then renewals. Path to citizenship — under the current Lei 37/81 after 5 years of legal residence. **Decreto AR 48/XVII was promulgated by President Seguro on 03.05.2026**; as of 13.05.2026 the law has STILL NOT been published in the DRE (10 days from promulgation). After publication in the Diário da República, the naturalisation period will increase to 10 years for third countries. The text of the law contains a transitional provision: cases in progress are subject to the previous version of Lei 37/81 (5 years).' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '2. Open an account with a Portuguese bank. It is advisable to show funds for living expenses: often at least 12× SMN is used as a guideline for the main applicant (€11,040 in 2026). This does NOT replace the income requirement of €3,680/month and depends on the consulate/VFS',
          '3. Prove accommodation in Portugal: a rental contract, invitation/termo de responsabilidade or another document accepted by the consulate. For a residence visa, a long-term lease is often safer, but the 12-month requirement must be checked at the place of application',
          '4. Book a visa appointment at the consulate → submit documents',
          '5. Wait for the visa (60–90 days)',
          '6. Enter on the residence visa → check the AIMA appointment/instructions stated in the visa/notification, or independently seek an appointment through the current AIMA channel → submit biometrics/documents → receive the residence permit'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'IFICI is the NEW regime that replaced NHR only partially (with a narrower scope): 20% may apply to certain income from eligible activities for up to 10 years, but D8 by itself does NOT grant entitlement to IFICI. You must separately meet the list of professions/activities (Portaria 352/2024/1; EBF art. 58-A) and apply on time. For the conditions, see the “IFICI regime” guide.' },
  ...
  costs: [
    ...
    { label: 'Recommended account balance (NOT an expense, liquid funds)', amountEUR: 11040, note: 'Guideline 12× SMN = €11,040 in 2026; does not cancel the 4× SMN income requirement; requirements may differ by consulate' }
  ],
  timelineDaysMin: 60,
  timelineDaysMax: 120,
  sources: [
