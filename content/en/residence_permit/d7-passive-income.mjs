export default {
  ...
  tldr: 'D7 is a visa for those with stable passive income (pension, rent, dividends). The baseline used in consular practice is **1× SMN (Portugal’s minimum wage) for the applicant, which in 2026 = €920/month** (Portaria 1563/2007 art. 16-A is applied by analogy to sufficiency of means; the Lisboa/Rio/Moscow consulates use SMN, not IAS). The standard coefficient for a family: +50% SMN for a spouse (€460), +30% SMN for each child (€276). A deposit/reserve in a Portuguese account is usually **12× SMN = €11,040** for the main applicant (in case income temporarily stops); this is consular practice, not a strict legal requirement. After 5 years of legal residence, permanent residence permit or citizenship may be possible (under the current Lei 37/81; the new law Decreto AR 48/XVII was promulgated on 03.05.2026 and will increase the period to 10 years for third-country nationals after publication in the DRE — check the current publication status).',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The minimum income for D7 in consular practice is linked to **SMN (Salário Mínimo Nacional)**, not to IAS. SMN for 2026 = **€920/month** (DL 112/2025). Baseline figures:' },
        { kind: 'checklist', items: [
          'Applicant: ≥ 1× SMN = **€920/month** passive income',
        ...
        { kind: 'paragraph', text: 'In addition, the consulate / AIMA usually asks for proof of a deposit in a Portuguese account of **12× SMN = €11,040** for the applicant — as a reserve in case income temporarily stops. This is practice, not a strict legal requirement; for a family, the same 50%/30% coefficients are added.' },
        { kind: 'checklist', items: [
          'Sources of passive income: pension, rent, dividends, royalties, deposit interest, licensing payments',
        ...
        { kind: 'warning', text: 'Do not use IAS (€537.13) as the basis for D7 — it understates the requirement by about €400/month for the main applicant. IAS is used for social benefits and tax deductions, but NOT for the D7 minimum. Before applying, check the current SMN on the gov.pt website — it is reviewed annually.' }
      ]
    },
    {
      id: 'process',
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'd2', title: '2. Open an account with a Portuguese bank', content: [
            { kind: 'paragraph', text: 'Transfer the reserve deposit **12× SMN = €11,040** (2026). For a spouse +50% (€5,520), for a child +30% (€3,312). An alternative is proof of stable monthly incoming payments over 6–12 months. Do not use 12×IAS — this understates the reserve.' }
          ]},
          ...
          { id: 'd4', title: '4. Book an appointment at the consulate', content: [
            { kind: 'paragraph', text: 'Vistos.mne.gov.pt → choose the country → book online. Queues can be 2–4 months in the Russian Federation/Belarus.' }
          ]},
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Initial residence permit for 2 years, renewal for 3 years → 5 years in total. After that, it is possible to request permanent residence permit or citizenship (under the current Lei 37/81 — after 5 years; **Decreto AR 48/XVII was promulgated by President Seguro on 03.05.2026** and will increase the period to 10 years for third-country nationals after publication in the DRE).' },
  ...
  costs: [
    ...
    { label: 'Deposit into Portuguese account (reserve)', amountEUR: 11040, note: '12× SMN = 12 × €920, refundable; for a family, 50%/30% is added for spouse/children' }
  ],
  timelineDaysMin: 90,
  timelineDaysMax: 180,
  sources: [
