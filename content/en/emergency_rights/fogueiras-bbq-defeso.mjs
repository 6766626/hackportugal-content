export default {
  ...
  title: 'Fire, barbecues, fireworks in summer — período crítico and fines',
  tldr: 'From 1 July to 30 September, Portugal has the período crítico (period of increased fire risk).\n\nAny open fire outside specially equipped places is prohibited: barbecues in the yard, fireworks, bonfires, burning rubbish and plant residues. Fines for individuals: €280-€10,000. If your fire causes a forest fire — criminal liability up to 5 years in prison. When it is allowed: a) at municipal picnic areas with grills (Parques de Merendas with authorisation), b) in hearths inside restaurants, c) at home — in a properly equipped kitchen. Fireworks require a separate licence from the Câmara Municipal (municipality) all year round. Important: even in winter, a licence is needed to burn plant residues.',
  ...
  steps: [
    ...
    {
      id: 'what-banned',
      title: 'What is prohibited during the período crítico',
      content: [
        { kind: 'checklist', items: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'A gas or electric barbecue on your own terrace is not automatically legal. Cascais, Sintra, Mafra, and Odemira have local rules prohibiting any outdoor “churrasco” during the período crítico, except in specially equipped municipal areas.' }
      ]
    },
    {
      id: 'fines',
      ...
      content: [
        { kind: 'checklist', items: [
          'Bonfire/barbecue in nature during the período crítico (individual): €280-€10,000',
          'Bonfire in nature at red risk level: €1,500-€10,000 + criminal liability',
          'Fireworks during the período crítico: €1,500-€3,000',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'During the período crítico, licences are generally not issued',
          'Wedding/celebration in August with fireworks — not allowed. In October after the end of the período crítico — possible with a licence',
          'Categories F3/F4 — only for licensed companies, not for private individuals',
          'Without a licence: €1,000-€3,000 + confiscation'
        ] },
        { kind: 'paragraph', text: 'Where to buy F1/F2: tobacconists, specialist shops, supermarkets before New Year and Carnival. Sparklers (estrelinhas) are only acceptable indoors and with fire safety measures; outdoors during the período crítico — not allowed.' }
      ]
    },
    {
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'In winter (October—June), a home barbecue on a terrace is usually allowed if safety measures are followed',
