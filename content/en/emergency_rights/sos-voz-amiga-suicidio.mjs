export default {
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          kind: 'warning',
          text: '808 numbers in Portugal are usually charged as chamadas de valor acrescentado/operator tariff or a local call; 112, 144 and 116 111 should be free. If you have no credit, use 112.'
        }
      ]
    },
    {
      id: 'what-to-say',
      title: '3. What to say to the operator',
      content: [
        {
          kind: 'paragraph',
  ...
  costs: [
    ...
    },
    {
      ...
      amountEUR: 0,
      note: 'Free social emergency helpline.'
    },
    {
