  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Bombeiros Voluntários are volunteer fire brigades operating through local associações humanitárias. They fight fires, respond to road accidents, rescue people, help during floods, landslides, storms and gas leaks, and provide first aid before handing the patient over to SNS/INEM.' },
        ...
        { kind: 'checklist', items: [
          ...
          'Flooding, tree on the road, dangerous cables',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'If there is a risk to life, health, property or public safety, do not look for the number of the local quartel. Call 112. The operator will decide whom to send: Bombeiros, INEM, PSP, GNR, Proteção Civil or several services at once.' },
        { kind: 'checklist', items: [
          ...
          'Whether there are children, older people, disabled people or animals',
          'Whether there is fire, smoke, gas, electricity or a risk of explosion',
        ...
        { kind: 'warning', text: 'Do not drive a person with signs of a stroke, heart attack, serious injury or loss of consciousness in your own car if you can call 112. Transporting them yourself may lose time and deprive the patient of early care.' }
      ]
    },
    {
      id: 'what-is-free',
      ...
      content: [
        { kind: 'paragraph', text: 'Emergency operations via 112 are not paid for on the spot by the public: firefighting, rescue, response to road accidents, urgent medical care, evacuation where there is a threat to life. You should not be billed because the bombeiros came for a genuine emergência.' },
        { kind: 'paragraph', text: 'Services without emergency urgency are usually chargeable: transporte de doentes não-urgente, medical cover for events, a fire engine on standby at a private event, preventive safety cover, and some technical services on request.' },
        { kind: 'checklist', items: [
          'Free: fire, road accident, rescue, urgent medical care via 112',
          'Free: evacuation during flooding, collapse or forest fire by decision of Proteção Civil',
          'Chargeable: non-emergency transport of a patient home, to a clinic or to an examination',
          ...
          'Chargeable: on-request services not linked to immediate danger',
          'May be paid by SNS: non-emergency medical transport prescribed by a doctor and meeting SNS criteria'
        ] },
        { kind: 'warning', text: 'If the situation is borderline, call 112 anyway. Do not try to decide in advance whether it is “urgent enough”. Erring on the side of calling the emergency service is safer than a delay in a stroke, fire or gas leak.' }
      ]
    },
    {
      id: 'non-urgent-transport',
      title: 'Transporte de doentes não-urgente: how to arrange it',
      content: [
        { kind: 'paragraph', text: 'Non-emergency transport is when a patient needs transport seated, lying down or with an escort, but there is no immediate threat to life. For example: a trip for haemodialysis, physiotherapy, an examination, discharge from hospital to home, or transporting an older person between home and a clinic.' },
        { kind: 'substeps', items: [
          { id: 'check-sns', title: '1. Check whether SNS can pay', content: [
            { kind: 'paragraph', text: 'If the transport is medically necessary, ask the SNS doctor or hospital about a requisição de transporte. Without a prescription, the trip is usually paid for by the patient.' }
          ] },
          ...
          { id: 'confirm-price', title: '3. Confirm the price before the journey', content: [
            { kind: 'paragraph', text: 'A typical guide price for private payment in 2026 is €40–80 for a local trip, but the tariff depends on distance, waiting time, stretcher, oxygen, night-time service and the rules of the specific associação.' }
          ] }
        ] },
        { kind: 'checklist', items: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'The price is calculated individually: duration, number of participants, risk, distance, whether an ambulância, fire engine, bombeiros sapadores/voluntários, enfermeiro or médico is needed. Request an orçamento in writing from the local corporação in advance, ideally 2–4 weeks ahead.' },
        { kind: 'checklist', items: [
          'Name and type of event',
          'Date, set-up, operating and dismantling hours',
          'Address and planta do recinto, if available',
          'Expected number of participants',
          'Alcohol, pyrotechnics, gas, generators, stage',
          'Requirements of the Câmara Municipal or licence',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'In an emergency, speak briefly. The address and type of incident matter more than perfect grammar.' },
        { kind: 'checklist', items: [
        ...
        { kind: 'warning', text: 'A false emergency call may lead to liability. But a good-faith call when there is a genuine fear for life, fire, gas or a road accident is normal and the right thing to do.' }
      ]
    }
  ],
  costs: [
    { label: 'Emergency call via 112', amountEUR: 0, note: 'Fire, road accident, rescue, urgent medical care; not paid for on the spot.' },
