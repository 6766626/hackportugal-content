export default {
  ...
  tldr: 'Portugal has a qualified electronic signature — Assinatura Digital Qualificada (QES): an electronic signature with the same legal force as a handwritten signature. Two official tools: Chave Móvel Digital (mobile signature) and Cartão de Cidadão (Portuguese citizen ID card) + USB reader/NFC. With QES you can sign tenancy agreements, notarial documents, and submit documents to AIMA/Finanças/IRN without paper.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Electronic signatures in the EU are regulated by the eIDAS Regulation (Regulation (EU) 910/2014). In Portugal, Decreto-Lei (decree-law) 12/2021 adapts eIDAS into national legislation.' },
        { kind: 'checklist', items: [
          ...
          '  • Qualified (QES) — AES + QTSP certificate + QSCD device. Legally equivalent to a handwritten signature throughout the EU',
    ...
    {
      id: 'cmd-signature',
      title: 'Signature via Chave Móvel Digital (CMD)',
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'c3', title: '3. Verifying the signature', content: [
            { kind: 'paragraph', text: 'Anyone can verify the signature at autenticacao.gov.pt/validacao-de-assinaturas — it shows the signatory’s name, time and status.' }
          ]}
        ]}
      ]
    },
    {
      id: 'cc-signature',
      title: 'Signature via Cartão de Cidadão',
      content: [
        { kind: 'paragraph', text: 'For Portuguese citizens with Cartão de Cidadão (this option is not available to non-residents — they have a residence permit without a signature chip). A USB reader or phone with NFC is required.' },
        { kind: 'substeps', items: [
          { id: 'cc1', title: '1. Activating the signature function', content: [
            { kind: 'paragraph', text: 'When Cartão de Cidadão is first issued, the signature function is often switched off. Activation is done at any Espaço Cidadão or online through Autenticação.gov with a USB reader.' }
          ]},
          { id: 'cc2', title: '2. Installing the software', content: [
            { kind: 'paragraph', text: 'Download the “Autenticação.gov” desktop application (macOS/Windows/Linux) — the official Portuguese government software.' }
          ]},
          { id: 'cc3', title: '3. Signing', content: [
            { kind: 'paragraph', text: 'Insert Cartão de Cidadão into the reader → open the PDF in the Autenticação.gov application → sign → enter the Cartão de Cidadão PIN → done.' }
          ]},
          { id: 'cc4', title: '4. PIN codes', content: [
            { kind: 'checklist', items: [
              ...
              'Forgotten PIN → up to 3 attempts → blocked → unblock on ePortugal.gov.pt with PUK'
            ]}
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '📄 Contrato de arrendamento (housing tenancy agreement) — without attending a notary',
          '💼 Employment contracts',
          '📋 IRS declaration and other tax returns',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Verification: a signed PDF can be validated on any EU portal (European Commission DSS Validator — dss.nowina.lu).' },
  ...
  sources: [
    ...
    { title: 'Decreto-Lei 12/2021 (adaptation of eIDAS in Portugal)', url: 'https://diariodarepublica.pt/dr/detalhe/decreto-lei/12-2021', kind: 'law', language: 'pt', lastRetrieved: '2026-04-22' },
