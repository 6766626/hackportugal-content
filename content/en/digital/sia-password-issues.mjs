export default {
  ...
  tldr: 'If you have forgotten your AT password (Portal das Finanças / SIA): go to portaldasfinancas.gov.pt → “Recuperar Senha” → SMS or letter by post (5-7 days). Alternative: in person at an Espaço Cidadão or Finanças office. With CMD (Chave Móvel Digital), you can log in WITHOUT a password. To reset CMD — ePortugal.gov.pt → reissue ONE-TIME codes. If you have lost everything — Conservatória/Espaço Cidadão with CC.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The most common scenario. AT (the tax authority) uses a “Senha de Acesso” — an 8-digit password to log in to Portal das Finanças.' },
        { kind: 'substeps', items: [
          { id: 'p1', title: 'Method 1 — SMS (quick, if you have a number)', content: [
          ...
          { id: 'p2', title: 'Method 2 — by post (if AT does not have your mobile number)', content: [
            { kind: 'checklist', items: [
          ...
          { id: 'p3', title: 'Method 3 — in person at a Finanças office', content: [
            { kind: 'checklist', items: [
              ...
              '🔐 Receive a temporary password on paper, then change it after the first login',
              '✅ Immediate, without waiting for post'
            ]}
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'CMD is the government “single key” for accessing all public services. Forgetting the code = waiting for recovery.' },
        { kind: 'substeps', items: [
          ...
          { id: 'c2', title: 'Resetting the PIN or changing the phone', content: [
            { kind: 'checklist', items: [
              '🌐 ePortugal.gov.pt → “Chave Móvel Digital” → “Recuperar PIN”',
              '🆔 Authorisation via CC + CC PIN code (not CMD!)',
              '🔢 Create a new PIN',
              '📱 If you have lost your phone: go in person to Espaço Cidadão / Loja CTT — change the linked number'
            ]}
          ]},
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          '📤 **Full reset** (if the PIN is forgotten and blocked): Loja CC, around €10, on the day of the visit',
          '⚠️ The code letter (“carta de PINs”) — arrives when the CC is issued. Keep it!',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🏛️ In Lisboa, the fastest Espaço Cidadão are: Saldanha (Loja de Cidadão Saldanha) and Marvila (Loja de Cidadão das Laranjeiras)',
          '⏰ Booking on agendamentos.gov.pt — usually 1-2 weeks ahead',
          '💼 If business/Lda: a representative (lawyer) can act on your behalf with power of attorney',
          '⏰ Prevention: check your address and mobile number in Portal das Finanças every 6 months',
