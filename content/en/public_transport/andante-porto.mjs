export default {
  ...
  tldr: 'Andante is the unified travel pass for Porto metro, STCP buses and CP suburban trains in the metropolitan area. Zone-based system: the further you go, the more expensive it is. For tourists — Andante Tour for 1/3 days (€7–15). For residents — monthly Z2 pass for €30/month, unlimited regional MetroPorto — €40/month. You can buy the card from a metro ticket machine (Andante Azul = occasional card, €0.60) or PayShop. Andante eTransit is also available in the app.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          '🟦 Z2 — 1–2 zones: central Porto (Trindade, Bolhão, São Bento), Vila Nova de Gaia',
          '🟩 Z3 — 3 zones: Maia, Matosinhos, Gondomar, Senhora da Hora',
          '🟧 Z4 — 4 zones: Vila do Conde, Espinho',
          '🟨 Z5+ — more distant suburbs: Aveiro, Trofa',
          '⚠️ The fare depends on the departure zone and destination zone. The system is not simple, but ticket machines calculate the cost automatically'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'occasional', title: 'Occasional tickets — for tourists and infrequent journeys', content: [
            { kind: 'checklist', items: [
              ...
              '🎟️ You can buy it and validate it immediately at the gate or on the bus'
            ]}
          ]},
          { id: 'monthly', title: 'Monthly passes (for residents)', content: [
            { kind: 'checklist', items: [
              '👤 **Andante Mensal Z2** (central Porto): €30/month',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '🎫 At the metro station — tap the card at the gate and check the colour: green — all OK, red — no ticket or wrong zone',
          ...
          '⏰ The ticket is time-limited — after the first validation it is valid for 1–2 hours depending on the number of zones',
          '🔁 Within this time, you can make transfers without paying again',
          '⚠️ Inspections at stations and on buses — fine €60–120 if travelling without a ticket or with an expired ticket'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🛒 Buying an Andante Branca (personalised) is better value in the long run if you plan to live here',
          '🚲 BUGA — Porto city bikes, free with a deposit',
          '🚜 Aveiro / Espinho are accessible with Andante Z5 — beach for €2 a day!',
          '📅 1st day of the month — crowds at Trindade metro for pass applications; go on the 5th–10th'
        ]}
      ]
    }
  ],
