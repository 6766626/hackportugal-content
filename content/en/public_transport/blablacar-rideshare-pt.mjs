  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'BlaBlaCar is carpooling: the driver is travelling along their own route and sells spare seats, usually cheaper than the train and sometimes faster than a bus with connections. In Portugal it works best on popular corridors: Lisboa—Porto, Lisboa—Coimbra, Porto—Braga, Porto—Viseu, Lisboa—Algarve, Porto—Aveiro.' },
        { kind: 'checklist', items: [
          ...
          'Plus: you can leave from areas outside stations; sometimes the driver picks up at the metro or a shopping centre',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'search', title: '1. Find the route', content: [
            { kind: 'paragraph', text: 'Open blablacar.pt or the BlaBlaCar app. Enter the departure city, destination city, date and number of passengers. For large cities, look not only at “Lisboa” or “Porto”, but also at specific points: Oriente, Sete Rios, Aeroporto, Campanhã, Casa da Música.' }
          ] },
          { id: 'compare', title: '2. Compare more than just the price', content: [
            { kind: 'checklist', items: [
              ...
              'Number of free seats in the back: 2 people on the rear row is more comfortable than 3',
              'Driver reviews and rating'
            ] }
          ] },
          { id: 'reserve', title: '3. Book and message the driver', content: [
            { kind: 'paragraph', text: 'After booking, immediately write a short message: “Olá, vou com uma mala pequena. O ponto de encontro é mesmo em Oriente?” This lets you check that the driver is active and agree luggage in advance.' }
          ] }
        ] }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'Choose drivers with a photo, verified phone/e-mail and several reviews',
          'Check recent reviews from the last few months, not only the overall rating',
          'Check whether the driver’s name, car and number plate match in the app',
          'Do not agree to pay far outside the platform if the trip was listed with online booking',
          ...
          'Wear a seat belt in any seat: fines and the risk in Portugal are real',
        ...
        { kind: 'warning', text: 'BlaBlaCar is not a replacement for official transport for critical deadlines: AIMA appointment, exam, international flight, operation in SNS. For these cases, allow a margin or take CP/Rede Expressos with clear passenger rights.' }
      ]
    },
    {
      id: 'payment-cancel',
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'If paying online: save the booking confirmation and cancellation rules from the app',
          'If paying in cash/MB WAY by agreement: confirm the amount before the trip',
        ...
        { kind: 'warning', text: 'The exact refund percentages depend on the version of BlaBlaCar rules, account country and payment method. Before an expensive trip, open the BlaBlaCar Help Centre and check the cancellation/refund section specifically for your booking.' }
      ]
    },
    {
      id: 'alternatives',
      title: 'Alternatives: CP, buses, Tabuna, Carzz',
      content: [
        { kind: 'paragraph', text: 'BlaBlaCar is not the only option. In Portugal, intercity transport depends heavily on the route: in some places the train is more convenient, in others the bus is cheaper, and elsewhere rideshares fill the “gaps” between cities.' },
        { kind: 'checklist', items: [
          ...
          'Facebook/WhatsApp city groups: work for short routes, but the risk is higher — there is no proper rating or support',
          'For regular commutes, check the passe intermodal/metropolitano: in Lisboa and Porto monthly passes are often better value than any rideshare'
        ] },
        { kind: 'warning', text: 'Local services and groups have less protection: no unified refund standard, weaker moderation, and it is harder to prove what was agreed. For a first trip in the country, BlaBlaCar or an official carrier is safer.' }
      ]
    },
    {
      id: 'covid-etiquette',
      ...
      content: [
        { kind: 'paragraph', text: 'In 2026 in Portugal there is no general mandatory mask regime for private BlaBlaCar trips. But the driver is entitled to ask for a mask, ventilation, or to refuse to take a passenger with obvious symptoms — it is a private trip.' },
        { kind: 'checklist', items: [
          ...
          'Sit in the agreed seat, do not take up the entire boot',
