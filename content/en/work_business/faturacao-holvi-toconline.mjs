export default {
  ...
  tldr: 'A self-employed person in Portugal can issue recibos verdes for free in Portal das Finanças. But if you need proper client records, recurring invoices, SAF-T export, QR and ATCUD, use certified software: ToConline, Visee, Faturalia, MOLONI.\n\nBudget in 2026: from €0 to €30/month. Holvi is convenient as a bank account + invoices, but a fiscal invoice for AT must come from Portal das Finanças or software with AT certification.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Faturas must be submitted to AT via SAF-T/PT or webservice within the set deadlines.',
          'Portal das Finanças itself generates the recibo verde eletrónico — separate software is not needed.',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'If you have 1–5 clients per month, provide services without complex stock, and work as a trabalhador independente, Portal das Finanças is usually enough. You go to Finanças → Faturas e Recibos Verdes → Emitir, choose the client, atividade, IVA, retenção na fonte and document type.' },
        { kind: 'checklist', items: [
          ...
          'Data goes straight to AT — there is no need to submit SAF-T separately.',
        ...
        { kind: 'paragraph', text: 'If you are on isenção de IVA under art. 53 CIVA, you indicate the relevant exemption basis in the document. For 2026, the small-regime reference point is €15,000 annual turnover; if you are approaching the limit, discuss the transition to IVA with a contabilista in advance.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'toconline', title: 'ToConline — the most “Portuguese” option', content: [
            { kind: 'paragraph', text: 'ToConline is a popular Portuguese platform for faturação, gestão and communication with a contabilista. Its strength is local tax logic: séries, ATCUD, QR, SAF-T, IVA, retenção, exports for the accountant.' },
            { kind: 'checklist', items: [
              ...
              'Check the plan: some features may be in paid plans.',
          ...
          { id: 'holvi', title: 'Holvi — bank + invoices, but check fiscal compliance', content: [
            { kind: 'paragraph', text: 'Holvi should be treated only as a banking/expense tool — and only if your type of business and country of registration are supported by Holvi at all. For a tax document in Portugal, use Portal das Finanças or software which, for that specific product, is listed in the programas de faturação certificados da AT; a Holvi invoice by itself does not replace a fatura/fatura-recibo for AT. The key issue here is not the PDF design, but the AT certificate, ATCUD, QR and comunicação à AT.' },
            { kind: 'warning', text: 'If the specific Holvi product for your account is not listed in the programas de faturação certificados AT, use Holvi for banking records and reminders, and issue the fiscal invoice/recibo in Portal das Finanças or in certified software.' }
          ] },
          { id: 'visee-faturalia-moloni', title: 'Visee, Faturalia, MOLONI — low-cost PT services', content: [
            { kind: 'paragraph', text: 'Visee, Faturalia and MOLONI are usually chosen for simple faturação, a quick start and pricing in the €0–€30/month range. For self-employed people, what matters is not “pretty invoices” but the existence of AT certification, correct tax fields and SAF-T export.' },
            { kind: 'checklist', items: [
              ...
              'Check exactly which documents are supported: fatura, recibo, fatura-recibo, nota de crédito. Do not confuse them with the official recibo verde eletrónico in Portal das Finanças; if what you need is specifically emissão de recibos verdes eletrónicos through AT, use Portal das Finanças.',
              'Check support for retenção na fonte for recibos verdes.',
              'Check SAF-T/PT export and automatic comunicação à AT.',
              'Check whether you can give access to a contabilista without sharing your Finanças password.'
            ] }
          ] }
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Before the first document, set up the tax parameters, not the logo. An error in IVA or retenção later has to be corrected with a nota de crédito or cancellation, and the client will have to change their own accounting.' },
        { kind: 'checklist', items: [
          ...
          'Set up retenção na fonte: since 2025 the standard rate for many professional services is 23% (you can opt for 25%), but there are exceptions and dispensa (for example, with turnover up to €15,000/year).',
          ...
          'Give the accountant access to the software or export SAF-T/Excel every month.',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'For most expat freelancers, the choice is simple: up to a few invoices per month — Portal das Finanças for €0. If you have many clients, IVA, EU clients, recurring invoices or an accountant asking for SAF-T — take Portuguese certified software.' },
        { kind: 'checklist', items: [
          '€0/month: Portal das Finanças — enough for simple recibos verdes.',
          '€5–€15/month: basic plans from PT services for poucas faturas and simple accounting.',
        ...
        { kind: 'paragraph', text: 'Faturação software does not replace IRS, IVA and Segurança Social declarations. It helps issue documents and submit data, but responsibility for the IVA regime, withholdings, Modelo 3 IRS and quarterly declaração trimestral remains with you.' }
      ]
    }
  ],
  costs: [
