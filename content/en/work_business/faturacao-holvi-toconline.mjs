export default {
  ...
  tldr: 'A self-employed person in Portugal can issue recibos verdes for free in Portal das Finanças. But if you need proper client records, recurring invoices, SAF-T export, QR and ATCUD, you use certified software: ToConline, Visee, Faturalia, MOLONI.\n\nBudget in 2026: from €0 to €30/month. Holvi is convenient as a bank account + invoices, but the fiscal invoice for AT must come from Portal das Finanças or software with AT certification.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'If the software is not certified by AT, do not treat it as a fiscal replacement for Portal das Finanças.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'If you are under isenção de IVA according to art. 53 CIVA, you state the relevant exemption basis in the document. For 2026, the small-regime reference point is €15,000 annual turnover; if you are approaching the limit, discuss the move to IVA with a contabilista in advance.' }
      ]
    },
    {
        ...
        { kind: 'substeps', items: [
          { id: 'toconline', title: 'ToConline — the most “Portuguese” option', content: [
            ...
            { kind: 'checklist', items: [
              ...
              'Check the tariff: some functions may be in paid plans.',
              'The best choice if you want minimum “foreign exoticism” and maximum PT compliance.'
            ] }
          ] },
          { id: 'holvi', title: 'Holvi — bank + invoices, but check fiscal compliance', content: [
            ...
            { kind: 'warning', text: 'If the specific Holvi product for your account is not listed among the programas de faturação certificados AT, use Holvi for banking records and reminders, and issue the fiscal invoice/recibo in Portal das Finanças or in certified software.' }
          ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Before the first document, set up the tax parameters, not the logo. A mistake in IVA or retenção is later corrected with a nota de crédito or cancellation, and the client will have to change their own accounting.' },
        { kind: 'checklist', items: [
          'Check the start of atividade in Finanças: CAE/CIRS, regime de IVA, regime de contabilidade.',
          'Enter NIF, name, morada fiscal exactly as in Finanças.',
          ...
          'Check clients: NIF português, EU VAT ID through VIES, address, country.',
          ...
          'Keep PDFs and data for at least the tax inspection period; do not rely only on the client’s email.'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'For most expat freelancers, the choice is simple: up to a few invoices per month — Portal das Finanças for €0. If you have many clients, IVA, EU clients, recurring invoices or an accountant asks for SAF-T — use Portuguese certified software.' },
        { kind: 'checklist', items: [
          '€0/month: Portal das Finanças — enough for simple recibos verdes.',
          '€5–€15/month: basic tariffs from PT services for poucas faturas and simple accounting.',
  ...
  costs: [
    ...
    { label: 'Extended faturação/gestão tariff', amountEURMin: 15, amountEURMax: 30, note: 'More users, reports, automation, integrations and accountant support.' },
  ...
  sources: [
    ...
    {
      title: 'Decreto-Lei 28/2019: rules for processing faturas and preserving documents',
