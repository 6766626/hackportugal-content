export default {
  ...
  title: 'AGSE (ex-DGAE): recognition of teacher qualification and Habilitação Própria',
  tldr: 'There are two different routes for working as a teacher in a Portuguese state school. Reconhecimento de Qualificação Profissional is recognition of an existing teaching qualification under DL 227/2005: you prove that you have the right to teach in the country where you studied. Habilitação Própria is not recognition of the profession, but academic suitability for a subject when there is no full formação profissional under DL 79/2014. Note: since 1 February 2026, the DGAE is extinct (Despacho n.º 919-A/2026; Decreto-Lei n.º 99/2025) and its competencies passed to the new Agência para a Gestão do Sistema Educativo (AGSE, I.P.); handle everything through agse.pt, Portal E72 and SIGRHE. In 2026 this is especially important because of the teacher shortage, but priority in concursos remains with profissionalizados.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'In Portugal, “I taught in my country” and “I have a degree in the subject” are legally different things. AGSE (which since 1 February 2026 took over the functions of the extinct DGAE) looks not only at the diploma, but at whether it gives the professional right to teach a specific level and subject.' },
    ...
    },
    {
      ...
      title: '2. Reconhecimento de Qualificação Profissional through AGSE (ex-DGAE)',
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Have a sworn/certified translator translate into Portuguese if the documents are not in PT/EN/FR/ES and AGSE requires a translation.',
          'For documents from non-EU countries, an Apostille Hague or consular legalisation is usually needed, where applicable.',
          'Submit the application according to the AGSE instructions and forms for “Reconhecimento de Qualificação Profissional” (via agse.pt and Portal E72).'
        ] },
        { kind: 'paragraph', text: 'AGSE compares your training with Portuguese requirements. Possible outcomes: recognition of the qualification for a specific level/group, a request for additional documents, refusal, or a requirement for compensation measures if substantial differences are identified.' }
      ]
    },
    {
      id: 'habilitacao-propria',
      title: 'Add a clear caveat near the start: “Habilitação Própria is usually not a separate procedure for recognising the profession and does not grant profissionalizado status; it is a check that academic training meets the requirements of a specific grupo de recrutamento during candidacy/recruitment. Check the current Guia/Lista de Habilitações da AGSE (ex-DGAE) for the specific group.”',
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Monitor AGSE notices, contratação de escola and the SIGRHE platform if the vacancy goes through the state system.',
        ...
        { kind: 'warning', text: 'Do not present Habilitação Própria as “recognition of a foreign teaching licence”. If you specifically have a teaching qualification, the correct first address is Reconhecimento de Qualificação Profissional at AGSE (ex-DGAE).' }
      ]
    },
    {
      id: 'documents',
      ...
      content: [
        { kind: 'paragraph', text: 'The main delay is not AGSE itself, but collecting evidence from the country of study. In 2026, schools and authorities increasingly require detailed supplements: subjects, hours, ECTS, practice, internship, teaching component.' },
        { kind: 'checklist', items: [
        ...
        { kind: 'warning', text: 'Do not limit yourself to a notarised translation of the diploma. Without a transcript and description of teaching practice, AGSE or the school will often be unable to understand whether the qualification matches the Portuguese grupo de recrutamento.' }
      ]
    },
    {
      id: 'after-decision',
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'Create or update access to SIGRHE / Portal E72 (AGSE) if you are taking part in state concursos.',
        ...
        { kind: 'paragraph', text: 'If AGSE recognised the qualification partially or indicated restrictions, do not ignore the wording. For a concurso, what matters is the specific níveis de ensino and grupos de recrutamento, not the general status of “teacher”.' }
      ]
    },
    {
      id: 'common-mistakes',
      ...
      content: [
        { kind: 'checklist', items: [
          'Confusing DGE and AGSE (ex-DGAE): DGE deals with equivalências estrangeiras for school education, while AGSE deals with staffing and qualification matters for teachers.',
  ...
  costs: [
    { label: 'Application to AGSE', amountEUR: 0, note: 'The official AGSE page (agse.pt) does not state a government fee for the reconhecimento de qualificação profissional procedure itself; check the current form before applying.' },
  ...
  sources: [
    { title: 'AGSE: Agência para a Gestão do Sistema Educativo (successor to DGAE)', url: 'https://www.agse.pt/', kind: 'official', language: 'pt', lastRetrieved: '2026-05-30' },
    { title: 'DGAE: notice of extinction and transfer of competencies to AGSE', url: 'https://www.dgae.medu.pt/noticias/conc-a-ext-dgae-transf-comp-agse', kind: 'official', language: 'pt', lastRetrieved: '2026-05-30' },
    { title: 'Decreto-Lei 99/2025: creates AGSE, I.P. and extinguishes DGAE/DGEstE', url: 'https://diariodarepublica.pt/dr/detalhe/decreto-lei/99-2025', kind: 'law', language: 'pt', lastRetrieved: '2026-05-30' },
