export default {
  ...
  tldr: 'Subsídio de Refeição is a daily meal allowance. In the private sector it is not mandatory under the general Código do Trabalho, but it is often set out in the contrato de trabalho or CCT; for Administração Pública civil servants, €6 per working day applies. In 2026, cash is exempt from IRS/Segurança Social up to €6, and cartão/vale refeição up to €10.20. Anything above the limit is treated as salary and is subject to tax and contributions.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'In Administração Pública, the base amount for April 2026 is €6 per day. This figure is often used as a benchmark in private companies too, but a private employer is only obliged to pay subsídio de refeição if it is written in your contrato de trabalho, internal regulations or applicable CCT — contrato coletivo de trabalho.' },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'For IRS and Segurança Social, what matters is not the mere fact of payment, but the payment method and the daily limit. As of April 2026, these practical limits apply: cash — up to €6 per day; cartão/vale refeição — up to €10.20 per day.' },
        { kind: 'checklist', items: [
          'Cash €6 per day: €0 IRS and €0 Segurança Social.',
          'Cash €7 per day: €6 is exempt, €1 is treated as salary.',
          'Cartão refeição €10.20 per day: €0 IRS and €0 Segurança Social.',
          'Cartão refeição €11 per day: €10.20 is exempt, €0.80 is treated as salary.',
        ...
        { kind: 'warning', text: 'The old cash limit of €5.20 is no longer a relevant benchmark for 2026. For current practice, use €6 cash and €10.20 cartão/vale.' }
      ]
    },
    {
      id: 'cash-vs-card',
      ...
      content: [
        { kind: 'paragraph', text: 'If the employer is willing to pay more than €6 per day, a card is almost always better: the tax-free ceiling is higher — €10.20 instead of €6. With 22 working days, that is up to €224.40 per month without IRS and Segurança Social via cartão refeição versus €132 cash.' },
        { kind: 'checklist', items: [
          'Cash is more convenient: the money arrives in your normal bank account.',
          'Cash above €6 quickly loses its advantage because of IRS and Segurança Social.',
          'Cartão refeição is more advantageous for amounts of €6.01–€10.20 per day.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Daily rate: for example €6, €7.63, €9.60 or €10.20.',
          ...
          'Tributável: only the excess above €6 cash or €10.20 cartão should be taxed.',
  ...
  costs: [
    { label: 'Tax-free cash limit', amountEUR: 6, note: 'Per day, if the payment is made in cash together with salary.' },
    { label: 'Tax-free cartão/vale refeição limit', amountEUR: 10.20, note: 'Per day, if a meal card or voucher with a restricted purpose is used.' },
    { label: 'Example for 22 working days cash', amountEUR: 132, note: '22 × €6 without IRS and Segurança Social.' },
    { label: 'Example for 22 working days cartão', amountEUR: 224.40, note: '22 × €10.20 without IRS and Segurança Social.' }
  ],
  sources: [
    {
    ...
    {
      title: 'DRE — Portaria n.º 107-A/2023: update of subsídio de refeição in Administração Pública to €6',
