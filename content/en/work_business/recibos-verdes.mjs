export default {
  ...
  tldr: 'Recibos Verdes are digital self-employed receipts in Portal das Finanças. They are used by freelancers and sole traders. Under the simplified regime, the IRS base depends on the type of income: for most professional services — 75% of turnover, for other activities — other coefficients under CIRS art. 31. Social contributions are 21.4% of relevant income (usually 70% of services or 20% of sales). IVA (VAT): isenção art. 53 CIVA for annual turnover ≤ €15,000.',
  ...
  steps: [
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'o2', title: '2. Cidadão → Alterar Atividade → Abrir Atividade', content: [
            { kind: 'paragraph', text: 'Choose an activity code: CAE and/or a code from the tabela do artigo 151.º CIRS. For professional services (IT, consulting, design), the CIRS code is often the important one; if in doubt, check with a contabilista — the choice affects IRS coefficients and retenção.' }
          ]},
          { id: 'o3', title: '3. Choose the regime', content: [
            { kind: 'checklist', items: [
              ...
              'Contabilidade Organizada — for larger turnovers or by voluntary choice, requires a contabilista certificado'
            ]}
          ]},
          { id: 'o4', title: '4. IVA (VAT)', content: [
            { kind: 'checklist', items: [
              'Regime de isenção (CIVA art. 53) — for annual/expected turnover ≤ €15,000 and where the conditions are met; when opening atividade, expected turnover is calculated proportionally to the year',
          ...
          { id: 'o5', title: '5. Segurança Social (social security)', content: [
            { kind: 'paragraph', text: 'When opening atividade for the first time, enquadramento in Segurança Social usually only takes effect after an initial period (usually the first 12 months — exemption).\n\nAfter that, the rate is 21.4% on rendimento relevante: 70% of services or 20% of sales/production/hotel/restaurant, based on the quarterly declaration, with the possibility to adjust the base within the rules.' }
          ]}
        ]}
      ]
    },
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'i1', title: '1. In Portal das Finanças', content: [
            { kind: 'paragraph', text: 'Cidadão → Recibos e Faturas → Emitir Fatura-Recibo (if the service has already been paid), Fatura (if you are issuing the invoice first) or Recibo (when payment has been received). This does not depend directly on whether you are under the IVA regime or isenção.' }
          ]},
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'For many professional services, the IRS base = 75% of turnover; for other types of income, other coefficients apply under CIRS art. 31',
        ...
        { kind: 'paragraph', text: 'For IFICI subjects (the new regime, which replaced NHR from 2024): a fixed 20% rate on qualifying activity from approved lists, provided the regime conditions are met.' }
      ]
    },
    {
      id: 'tips',
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'The first year without social contributions is an excellent opportunity to start'
        ]}
      ]
    }
  ],
