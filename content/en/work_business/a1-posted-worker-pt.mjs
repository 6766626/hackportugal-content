  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The A1 Portable Document confirms that Portuguese social security continues to apply to the employee during a period of temporary work abroad. It is not a work visa and not a work permit; it is a certificate of the applicable Segurança Social legislation.' },
        { kind: 'paragraph', text: 'Typical case: you live and work in Portugal under an employment contract, and your employer sends you to another EU country, EEA country or Switzerland for a project, installation, audit, consultancy, a conference with work tasks, or temporary work.' },
        { kind: 'checklist', items: [
          ...
          'A labour inspectorate, client, host company payroll team, or project organiser may ask for the A1',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The basic rule in Reg. (EC) 883/2004 art. 12: a person who is employed in one EU country and is sent by their employer to work temporarily in another country may remain in the system of the first country if the expected duration of work abroad does not exceed 24 months and they are not sent to replace another posted worker.' },
        { kind: 'checklist', items: [
          'The employer normally carries out substantial activity in Portugal and is not a “letterbox” company',
          'A direct employment relationship remains between the employee and the Portuguese employer',
          ...
          'The standard maximum period is up to 24 months',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'For an employee, the request is usually submitted by the employer in Segurança Social Direta. It is useful for the employee to check in advance that they have a NISS and that the employer correctly files remunerações and contributions.' },
        { kind: 'substeps', items: [
          ...
          { id: 'submit-ssd', title: '2. Submit the Pedido de destacamento', content: [
            { kind: 'paragraph', text: 'The employer logs in to Segurança Social Direta and selects the service related to destacamento de trabalhadores / pedido de A1. It is better to submit the application before the trip starts: the A1 is often needed already on entry to the site or before the client allows work to begin.' }
          ] },
          { id: 'download-a1', title: '3. Download it and give it to the employee', content: [
            { kind: 'paragraph', text: 'After approval, the A1 is available digitally. The employee should have a PDF on their phone and a printed copy: in some countries, inspectors on construction sites, factories and at events still ask for a paper copy.' }
          ] }
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'A1 only deals with the social security question. It does not override the host country’s rules on minimum pay, working time, health and safety, posted worker registration, and tax risks.' },
        { kind: 'checklist', items: [
          'Keep the A1 with you throughout the whole period of work abroad',
          'Check whether the employer needs to make a posted worker notification in the destination country',
          ...
          'It is better to cover healthcare during the trip with EHIC/CESD and work insurance, because A1 is not health insurance'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Leaving without an A1 and trying to obtain it “retroactively” — sometimes possible, but the risk of fines and refusal of site access is higher',
          'Confusing A1 with the cartão europeu de seguro de doença: these are different documents',
          ...
          'Not updating the A1 when the country, dates or employer change',
