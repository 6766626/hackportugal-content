export default {
  ...
  title: 'Employment rights in Portugal — what workers need to know',
  tldr: 'Employment relationships in Portugal are governed by the Código do Trabalho (Lei 7/2009). The essentials: a 40-hour week (max. 48 hours with overtime), 22 working days of holiday + 13 public holidays, parental leave of 120-180 days paid at 90-100%, dismissal requires justification + compensation (cap of 12-20 months’ salary), minimum wage €920/month in 2026. Probation period: 90 days (general), 180 (positions of responsibility), 240 (management roles). Trade unions are active: CGTP-IN and UGT. Complaints about breaches of employment rights are submitted to ACT (Autoridade para as Condições do Trabalho).',
  tags: ['employment', 'workers rights', 'code'],
  ...
  steps: [
        ...
        { kind: 'substeps', items: [
          { id: 'c1', title: 'Contrato sem termo (open-ended)', content: [
            { kind: 'checklist', items: [
              ...
              'Probation period: 90 days (ordinary), 180 (responsibility), 240 (management roles, high qualification)',
              'Dismissal by the employer: requires justification (despedimento por justa causa, extinção, inadequação) + compensation',
              'Resignation by the worker: 30 days’ notice (up to 2 years in the company) or 60 days (more)'
            ]}
          ]},
          { id: 'c2', title: 'Contrato a termo certo (fixed-term with a fixed date)', content: [
            { kind: 'checklist', items: [
              'Specific end date. After the Agenda do Trabalho Digno (Lei 13/2023): the general maximum is **2 years** (including renewals). The minimum depends on the justification; for typical cases, it is 6 months',
              ...
              'At the end of the term, if not converted into an open-ended contract — compensation under Lei 13/2023 (general rate of 24 days of basic salary + diuturnidades for each year); the specific calculation depends on the situation'
            ]}
          ]},
          ...
          { id: 'c4', title: 'Contrato de prestação de serviços / Recibo Verde', content: [
            { kind: 'paragraph', text: 'A format similar to self-employment. You pay taxes yourself through Anexo B. NO employment rights (holiday, sick leave, parental leave). For protection, the contract must reflect genuine independent status; otherwise it is a “falso recibo verde”, punishable by a fine of up to €6,000.' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '**Subsídio de alimentação** (meal allowance): not mandatory, but common. €6-9/working day. Up to €6/day is not subject to IRS',
          '**Overtime (horas extras)**: +25% in the first hour, +37.5% afterwards',
          '**Night work** (22:00-07:00): +25% extra',
          '**Work at weekends/public holidays**: +100% supplement OR compensatory day off',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Weekly day off: 1 mandatory + 1 additional (usually Saturday+Sunday)',
          'Flexible working: possible by agreement',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'l1', title: 'Férias (annual leave)', content: [
            { kind: 'checklist', items: [
              '**22 working days** (standard) = roughly 31 calendar days',
          ...
          { id: 'l2', title: 'Sick leave', content: [
            { kind: 'checklist', items: [
              'The first 3 days are not paid (as a general rule)',
          ...
          { id: 'l3', title: 'Parental leave', content: [
            { kind: 'checklist', items: [
              ...
              '**150 days**: 80% (if shared with a partner)',
              ...
              'Breastfeeding: 2 × 30 min per day of paid breaks until the child is one'
            ]}
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'd1', title: 'Despedimento por justa causa (for fault by the worker)', content: [
            { kind: 'paragraph', text: 'The employer must prove a serious breach: absenteeism, theft, serious conflict, systematic breach of duties. Written notice + right of defence (direito de audiência prévia). If the court finds the dismissal unlawful — compensation + reinstatement.' }
          ]},
          { id: 'd2', title: 'Despedimento colectivo / extinção (redundancy)', content: [
            { kind: 'checklist', items: [
              ...
              'Subsídio de desemprego: after dismissal for a reason not attributable to the worker'
            ]}
          ]},
          { id: 'd3', title: 'Abandono do trabalho', content: [
            { kind: 'paragraph', text: 'If a worker disappears for > 10 working days without a valid reason — the employer may treat this as resignation by the worker. This removes the right to compensation + Subsídio de desemprego.' }
          ]}
        ]}
      ]
    },
  ...
  costs: [
    ...
    { label: 'Dismissal compensation', amountEUR: 0, note: '14 days × years of service' },
