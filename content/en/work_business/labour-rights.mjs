    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '**Remote work (teletrabalho)**: regulated by Lei 83/2021 — written contract, electricity/connectivity paid by the employer, right to disconnect'
        ]}
      ]
    },
    {
