        ...
        { kind: 'substeps', items: [
          { id: 'h1', title: '1. Gather evidence', content: [
            { kind: 'checklist', items: [
              ...
              'Photo of the departures board showing the delay / screenshot of email',
              'Receipts for food / transfer / hotel (for reimbursement of care expenses)',
