export default {
  ...
  tldr: 'In a crisis: **SNS 24 → option 4** (SNS psychological support, 24/7) or **SOS Voz Amiga 213 544 545** (suicide prevention hotline, 16:00-24:00). ⚠️ 808 numbers are charged at the subscriber’s tariff (mobile/foreign SIM cards may incur charges). Through SNS — your family doctor will refer you to a psychologist/psychiatrist (free, waiting list 1-3 months). Private psychologist €50-90/session, psychiatrist €80-150. English-speaking specialists — at CUF, Lusíadas, Luz. Online: BetterHelp, ePsicólogos. Linha Vida 1414 — for addictions, has opening hours (NOT 24/7).',
  tags: ['psychology', 'psychiatrist', 'crisis', 'mental health'],
  estimatedReadMinutes: 5,
  steps: [
    {
      id: 'crisis',
      title: '🆘 Crisis — who to call now',
      content: [
        { kind: 'checklist', items: [
          '☎️ **112** — emergency services, for suicidal intent / threat to life',
          ...
          '☎️ **Linha Vida (ICAD/SICAD): 1414** — for addictions (drugs/alcohol). Has opening hours — NOT 24-hour. Free',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '**BetterHelp** — a more international platform, €60-90/week (subscription)',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '**Adjustment stress**: moving country = top 5 stressful life events. It is normal to feel lonely and frustrated in the first 6-12 months',
          '**Language barrier with the doctor**: significant for quality mental healthcare. An English-speaking psychologist is more expensive, but more effective',
          ...
          '**Isolation**: weak social network in the first months. The solution — meetups, language exchanges, expat groups',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '**Internations Lisbon Mental Health** — meetups, free',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Prescription medicines from the pharmacy also count',
