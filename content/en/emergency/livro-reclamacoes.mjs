export default {
  ...
  tldr: 'Livro de Reclamações (Complaints Book) — every establishment in Portugal is required to have it and provide it on request. The complaint is automatically sent to the regulator (ANAC, ASAE, ERSE, BdP, ANACOM — depending on the sector) — this is a powerful tool, unlike Google reviews. Electronic version: livroreclamacoes.pt — file online, without visiting. A response is mandatory within 15 days. Fines for establishments: up to €25,000 for legal entities. Very effective — many breaches are corrected after a complaint.',
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '🍽️ Restaurant: spoiled food, refusal to accept Multibanco / a valid means of payment, extra “service” charges not in the contract',
          '🏨 Hotel: not the room you booked, faulty amenities, misleading advertising',
          ...
          '✈️ Airlines: cancellation, delay, baggage problems — a separate EU 261/2004 procedure also applies',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '📅 Day 5-10: the business receives a notice from the regulator and must prepare a response',
          '📅 Day 15: the business is required to write a response to you (or the regulator starts an investigation)',
          ...
          '⚖️ Civil/criminal proceedings are separate: if you want personal financial compensation beyond a nominal amount — also file with Tribunal de Pequena Causa or an ordinary court'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '✅ Specifics: “I did not like the service” — weak. “At 14:35 the manager refused to accept MB WAY, which was shown on the receipt, and demanded cash, which I did not have” — strong',
          '✅ Documentary evidence: receipts, photos, screenshots — attach them',
          '✅ Specific request: “I request a €50 refund” / “waiter training”',
          '✅ Professional tone, without emotion',
          '✅ Reference to the relevant law: “under DL 24/2014 I have the right to return within 14 days for an online purchase”',
        ...
        { kind: 'substeps', items: [
          ...
          { id: 's2', title: 'Public services', content: [
            { kind: 'checklist', items: [
              ...
              'Provedor de Justiça (Portuguese ombudsman): provedor-jus.pt — main escalation route',
              'Inspeção-Geral: each ministry has an inspectorate',
              'Reclamação ao superior hierárquico: official complaint to the higher-ranking manager in the same structure'
            ]}
          ]},
