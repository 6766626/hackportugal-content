export default {
  ...
  tldr: 'Urgência in Portugal works according to the Manchester Triage System — the colour depends on how urgent the condition is. Red — immediately, orange — ≤ 10 min, yellow — ≤ 60 min, green — ≤ 120 min, blue — ≤ 240 min. To reduce waiting time: (1) first call SNS 24 (**808 24 24 24**) — nurse triage based on clinical algorithms (not a doctor on the phone), they will direct you to the right level; (2) Atendimento Complementar at a Centro de Saúde (at night/weekends); (3) private urgências (CUF, Lusíadas, Luz) — €20–80; (4) the “Tempos de Espera SNS” app to check the queue. ⚠️ 808 numbers are charged according to the subscriber’s tariff: mobile and foreign SIM cards may be charged.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'SNS 24 (**808 24 24 24**) is the public health helpline, available 24/7. Nurse triage based on clinical algorithms (this is not a conversation with a doctor). The service itself is free, but the 808 number is charged according to the subscriber’s tariff: mobile and foreign SIM cards may be charged per minute:' },
        { kind: 'checklist', items: [
          ...
          '💡 SNS 24 is often less busy than urgência: 15 min for diagnosis'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'When you arrive at urgência, the first thing that happens is that a nurse triages you: 3–5 min interview → a colour is assigned.' },
        { kind: 'checklist', items: [
        ...
        { kind: 'substeps', items: [
          { id: 's1', title: '1. Centro de Saúde — Atendimento Complementar', content: [
            { kind: 'checklist', items: [
              ...
              'Book through SNS 24 (call / app) — arrive at the appointed time',
          ...
          { id: 's2', title: '2. Hospital urgência — less busy', content: [
            { kind: 'checklist', items: [
              ...
              '💡 Check before setting off — go to the less busy place'
            ]}
          ]},
          { id: 's3', title: '3. Morning from Monday to Thursday', content: [
            { kind: 'checklist', items: [
              ...
              'Avoid: Sunday evening (everything that did not open at the weekend goes there)',
          ...
          { id: 's5', title: '5. Specialised urgência', content: [
            { kind: 'checklist', items: [
              '**Pediátrica** (children up to 15–18): separate departments. In Lisbon — Hospital Dona Estefânia. In Porto — Centro Materno-Infantil do Norte (CHUSJ/ULS Santo António, after integration of the former Maria Pia)',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '💳 **Bank card**: in case paid medicines are prescribed (part is covered by SNS, the rest is paid)',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '📞 **SNS 24 first, always** — they will decide themselves whether urgência is needed',
          ...
          '🌙 **Night hours in urgência**: if you can wait until morning — wait. 2–4 in the morning is the most difficult time'
        ]}
      ]
    }
  ],
