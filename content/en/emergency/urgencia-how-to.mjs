export default {
  ...
  tldr: 'Urgência in Portugal uses the Manchester Triage System — the colour depends on how urgent the condition is. Red — immediately, orange — ≤ 10 min, yellow — ≤ 60 min, green — ≤ 120 min, blue — ≤ 240 min. To reduce waiting time: (1) call SNS 24 (**808 24 24 24**) first — nurse triage using clinical algorithms (not a doctor on the phone), which will direct you to the right level of care; (2) Atendimento Complementar at a Centro de Saúde (at night/weekends); (3) private urgências (CUF, Lusíadas, Luz) — €20–80; (4) the “Tempos de Espera SNS” app to check the queue.\n\n⚠️ 808 numbers are charged according to the subscriber’s tariff: mobile and foreign SIM cards may incur charges.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'SNS 24 (**808 24 24 24**) — the public medical helpline, available 24/7. Nurse triage using clinical algorithms (this is not a conversation with a doctor).\n\nThe service itself is free, but the 808 number is charged according to the subscriber’s tariff: mobile and foreign SIM cards may be charged by the minute:' },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'When you arrive at urgência, the first step is triage by a nurse: 3–5 min questions → a colour is assigned.' },
        { kind: 'checklist', items: [
          ...
          '⚪ **Branco** — does not require emergency care (you need to see your family doctor) — you are sent home'
        ]},
        { kind: 'warning', text: '80% of patients in Portugal arrive with yellow/green/blue triage — and wait 2–4 hours. If you are assigned blue, it is more realistic to book at the Centro de Saúde or go to a private clinic.' }
      ]
    },
    {
      id: 'shortcuts',
        ...
        { kind: 'substeps', items: [
          { id: 's1', title: '1. Centro de Saúde — Atendimento Complementar', content: [
            { kind: 'checklist', items: [
              ...
              'Book via SNS 24 (call / app) — arrive at the appointed time',
          ...
          { id: 's2', title: '2. Hospital urgência — a less busy one', content: [
            { kind: 'checklist', items: [
              ...
              '💡 Check before you leave — go to the less busy place'
            ]}
          ]},
          { id: 's3', title: '3. Morning from Monday to Thursday', content: [
            { kind: 'checklist', items: [
              ...
              'Avoid: Sunday evening (everything that did not get seen over the weekend ends up there)',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '📄 **Medical history**: chronic conditions, allergies, operations',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '📝 **Prescription**: médico de família issues prescriptions for 3–6 months for chronic conditions — no need to go to urgência every time',
          ...
          '🌙 **Night hours in urgência**: if you can wait until morning — wait. 2–4 am is the hardest time'
        ]}
      ]
    }
  ],
