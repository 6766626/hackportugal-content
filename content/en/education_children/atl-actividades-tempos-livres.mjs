  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'In Portuguese primary school, a child’s day is divided into compulsory lessons and additional services. Parents often call everything “ATL”, but legally and organisationally these may be different things.' },
        { kind: 'checklist', items: [
          ...
          'Refeições escolares — school lunch; usually arranged separately through the município/school portal, but often within the same application package.',
          'Transportes escolares — school transport; rules depend on distância casa-escola, age and the municipality.',
          'For children aged 6–10, the key service is CAF/ATL, because lessons and AEC usually finish before the parents’ working day ends.'
        ] }
      ]
    },
    {
      id: 'where-to-enrol',
      title: 'Where to enrol your child 📝',
      content: [
        { kind: 'paragraph', text: 'The first entry point is Portal das Matrículas. For 2026, this is the main government portal for matrícula and renovação de matrícula. When submitting or renewing the school enrolment, check the sections on Ação Social Escolar, refeições, transportes and atividades de apoio à família. However, payment and final confirmation of the place often happen later through the município, agrupamento de escolas or IPSS.' },
        { kind: 'substeps', items: [
          { id: 'portal', title: '1. Portal das Matrículas', content: [
            { kind: 'checklist', items: [
              'Log in through autenticação.gov.pt: Chave Móvel Digital, Cartão de Cidadão or the representative’s details.',
              'Select matrícula/renovação for 1.º ciclo.',
              'Check whether there are items for Ação Social Escolar, refeições, transportes, AAAF/CAF or atividades.',
              'Upload documents if the portal or school requests them.',
              'Save the comprovativo da matrícula — the município or IPSS may ask for it.'
            ] }
          ] },
          ...
          { id: 'operator', title: '3. IPSS / associação / ATL', content: [
            { kind: 'paragraph', text: 'If the after-school care is run by an IPSS or associação de pais, they may have their own form, contract, mensalidade and list of documents. Do not expect automatic enrolment just because you indicated interest in Portal das Matrículas.' }
          ] }
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'There is no single national list: the school and município may request different documents. For expats, it is important to gather the Portuguese identifiers for the child and parents in advance.' },
        { kind: 'checklist', items: [
          ...
          'Escalão do abono de família: A, B or another — this affects Ação Social Escolar.',
          ...
          'Declaração médica or informação de saúde: allergies, medicines, dietary restrictions.',
        ...
        { kind: 'warning', text: 'If the family has only just arrived and does not yet have escalão do abono de família, do not postpone ATL enrolment. Submit the application with the documents available and arrange NISS/Segurança Social in parallel. Ask the school or município to assess the situação socioeconómica — in some places, a temporary assessment by the social service is possible.' }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'Priority is usually given to children with escalão A/B da Ação Social Escolar.',
          'Social cases flagged by the Comissão de Proteção de Crianças e Jovens, Segurança Social or the school social service are considered as a priority.',
          ...
          'Lunch for escalão A is usually free; for escalão B, 50% is often paid; without a subsidy, the full municipal price is paid.',
          'CAF/ATL may cost €0 for escalão A, a subsidised amount for escalão B and the full mensalidade for everyone else.',
          'School holidays, extra manhãs/tardes and extended horário may be charged separately.'
        ] },
    ...
    {
      id: 'practical-timing',
      title: 'Practical calendar for 2026',
      content: [
        ...
        { kind: 'warning', text: 'Places in ATL near popular schools run out quickly. If you are moving to Portugal in the summer, write to the agrupamento, Câmara Municipal and nearby IPSS at the same time — do not wait to obtain a residence permit if the child already has a NIF, address and school matrícula.' }
      ]
    },
    {
      id: 'questions-to-ask',
      ...
      content: [
        { kind: 'paragraph', text: 'Before agreeing to a particular ATL/CAF, ask questions in writing. This is especially important if the child does not yet speak Portuguese well.' },
        { kind: 'checklist', items: [
          ...
          'How do you report the child’s absence so as not to pay for lunch?',
          ...
          'How is the autorização de saída and the list of people who may collect the child handled?',
          'What happens in the event of a school strike or canteen closure?'
        ] }
      ]
    }
  ],
  costs: [
    { label: 'AEC in a state school', amountEUR: 0, note: 'Free optional activities for 1.º ciclo; they do not replace full ATL until the evening.' },
    ...
    { label: 'Private ATL without subsidies', amountEURMin: 100, amountEURMax: 250, note: 'Indicative figure for large cities; holidays and meals are often paid separately.' }
  ],
  sources: [
