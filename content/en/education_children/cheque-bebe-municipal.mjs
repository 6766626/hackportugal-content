export default {
  ...
  title: 'Cheque-Bebé and municipal benefits for newborns',
  tldr: 'Cheque-Bebé is not a national payment, but municipal support: a voucher or reimbursement of child-related expenses. In 2026 Cascais gives €500, Oeiras gives €350, and in small municípios €250-1,000 is common. The application is usually submitted to the Câmara Municipal within 6 months after birth or adoption. Key conditions: the child and at least one parent must have a NIF and actual residência fiscal/address in the município, with no debts to the Câmara or Finanças.',
  tags: ['cheque-bebé', 'município', 'children', 'câmara'],
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Cheque-Bebé, Incentivo à Natalidade, Apoio à Natalidade or Bebé+ is a local payment from the Câmara Municipal. It is not a Segurança Social benefit and does not directly depend on your D1-D8 visa, AIMA residence permit or citizenship, unless the municipal rules introduce separate restrictions.' },
        { kind: 'paragraph', text: 'The format depends on the município: bank transfer, cartão/vale for purchases from local traders, reimbursement against recibos/faturas or a mixed scheme. The money can usually be spent on baby products, pharmacies, clothes, equipment, and sometimes saúde/educação services.' },
        { kind: 'checklist', items: [
          'Cascais: Cheque-Bebé of €500 per child, under the municipal Cascais Baby programme.',
          'Oeiras: Apoio à Natalidade of €350 per child.',
          'Small municípios: often €250-1,000, sometimes more for the 2nd/3rd child.',
          'The application deadline is most often 6 months after birth or adoption.',
          'This is a separate measure: it does not replace abono de família, licença parental or IRS tax deductions.'
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The exact conditions are set out in the Regulamento Municipal of the relevant Câmara. For expats, the main risk is not the amount, but proving a link to the município: address, NIF, residência fiscal and no debts.' },
        { kind: 'checklist', items: [
          ...
          'The parent has a NIF; residência fiscal in this município in Finanças is often required.',
          'The child also has a NIF, or it must be obtained before payment.',
          ...
          'The application is submitted on time: usually within 6 months after birth, but in some municípios the deadline is 90 days or 12 months.',
          'Purchases, if reimbursement is required, were made after the child’s birth and issued as a fatura with the applicant’s or child’s NIF.'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The list varies slightly, but the basic set is almost the same. It is better to prepare it before the birth: after the maternity hospital, deadlines are easily missed, especially if you need to obtain the child’s NIF and certidão.' },
        { kind: 'checklist', items: [
          ...
          'Comprovativo de morada: atestado de residência from the Junta de Freguesia, rental contract, escritura, água/luz/telecom bill.',
          ...
          'Formulário municipal, signed by hand or through Chave Móvel Digital (CMD), if applying online.'
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'confirm-deadline', title: '2. Check the application deadline', content: [
            { kind: 'paragraph', text: 'A typical deadline is 6 months from the date of birth or adoption. If the child was born on 10 April 2026, the safe deadline is 10 October 2026, unless the regulamento of your município gives a different deadline.' }
          ] },
          { id: 'submit', title: '3. Apply online or in person', content: [
            { kind: 'paragraph', text: 'Larger Câmara offices accept applications through balcão online/serviços online with CMD or by email with PDF files. In small municípios it is often easier to go in person to the Balcão Único/Atendimento Municipal.' }
          ] },
          { id: 'track', title: '4. Track Câmara requests', content: [
            { kind: 'paragraph', text: 'If a document is missing, the Câmara usually gives a deadline to correct it. Check your email and caixa postal. Not replying is a common reason for refusal.' }
          ] }
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The amounts below are reference points from current municipal programmes as of April 2026. Before applying, still open your own Câmara website: benefits are approved locally and may depend on the orçamento, family registration and absence of debts.' },
        { kind: 'checklist', items: [
          ...
          'Inland areas and small towns — often €500-1,000, sometimes with an increase for the 2nd/3rd child.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Subsídio parental — payments during licença parental, if there are Segurança Social contributions.',
          'Dedução à coleta IRS for a dependente — tax deduction in the annual IRS return.',
          ...
          'Municipal discounts on transportes, piscina, ATL, escola or manuais — check separately on the Câmara website.'
        ] },
        { kind: 'warning', text: 'If you have moved recently, sort out your address first: NIF with the correct residência fiscal in Finanças, contrato/atestado and registration of the child. Many refusals are not related to citizenship, but to the Câmara not seeing you as a resident of the município.' }
      ]
    }
  ],
  costs: [
    { label: 'Cascais — Cheque-Bebé', amountEUR: 500, note: 'Municipal support per child; conditions and form of payment under the rules of Câmara Municipal de Cascais.' },
