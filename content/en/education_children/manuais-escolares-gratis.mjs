  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Programa Manuais Escolares Gratuitos is a state scheme for providing school textbooks free of charge. For a family, it works through electronic MEGA vouchers: each voucher corresponds to a specific textbook on the school’s list.' },
        { kind: 'checklist', items: [
          'The main textbooks approved by the school for the specific ano and turma are covered.',
          'For 1.º-9.º ano in a state school, the programme applies regardless of the family’s income.',
          'This is not an ASE benefit: entitlement to free manuais does not require low-income family status.',
          ...
          'New or used books are issued via voucher — the family does not choose the format.',
          ...
          'Pre-school education is not included: 1.º ano usually starts at age 6, not age 4.',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'matricula', title: '1. Make sure the matrícula has been accepted', content: [
            { kind: 'paragraph', text: 'First, the child must be enrolled for the school year. For transition years and first enrolment, Portal das Matrículas on ePortugal is used; in other cases, renewal is often automatic, but the school may ask for the data to be confirmed.' },
            { kind: 'checklist', items: [
              'The child’s NIF, if they already have one.',
              'NIF of the encarregado de educação — the parent or guardian who handles school matters.',
              ...
              'Parent’s contact details: email and telephone.',
          ...
          { id: 'mega-registration', title: '2. Register on the MEGA platform', content: [
            { kind: 'paragraph', text: 'After the school processes the matrícula and uploads the lists, the parent goes to the MEGA / Manuais Escolares platform and links the pupil to their NIF. Login is usually via NIF and the details of the encarregado de educação; the school must see the same responsible adult.' },
          ...
          { id: 'download-vouchers', title: '3. Download the vouchers', content: [
            ...
            { kind: 'checklist', items: [
              'Download the PDF or show the voucher from your phone.',
              'Check the pupil’s name, ano, escola and subject.',
              'There will be a separate code for each textbook.',
              'Do not buy books in advance unless the school has confirmed that a voucher will not be issued.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Check that you have been given the exact textbook for the correct ano and subject.',
          'If the book is used, check that there are no torn-out pages or serious markings.',
          'If the textbook is not in stock, the shop may order it; the timeframe depends on the publisher and the season.',
          'Do not hand over a voucher for another textbook or an “equivalent” without confirmation from the school.',
          'Keep the receipt or confirmation of issue until the end of September.'
        ] },
        { kind: 'warning', text: 'A voucher cannot really be “cashed in”: it is not money, but the right to receive a specific manual. If you bought a textbook with your own money before the voucher was issued, reimbursement is usually not guaranteed.' }
      ]
    },
    {
      id: 'return-books',
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'The school sets the return deadline, usually after classes end or after exams.',
          'Textbooks must be returned without serious damage, torn-out pages or unusable markings.',
          'Write in pencil or use bookmarks if the school warns that the books must be returned.',
          'Do not permanently glue pages together and do not cut out exercises.',
          ...
          'If a book is lost or damaged, the school may require you to replace it or pay its cost.'
        ] },
        { kind: 'warning', text: 'Do not ignore the return process. If books are not returned or are damaged, the school may block the issue of new vouchers until the situation is resolved.' }
      ]
    },
    {
      id: 'expat-edge-cases',
      ...
      content: [
        { kind: 'paragraph', text: 'Foreign families follow the same rules for free textbooks if the child is enrolled in a Portuguese state school. Citizenship and having a Cartão de Cidadão are not conditions for manuais; what matters more is the matrícula, the pupil’s details and the NIF of the responsible parent.' },
        { kind: 'checklist', items: [
          ...
          'If MEGA has outdated parent details, the school must update the encarregado de educação.',
          'If there is a dispute, write an email to the school secretaria: a written trail helps correct the matrícula or voucher more quickly.'
        ] }
      ]
    }
  ],
  costs: [
    { label: 'Textbooks for 1.º-9.º ano via MEGA vouchers', amountEUR: 0, note: 'For state school pupils; issued as new or used under the reutilização system.' },
    { label: 'Workbooks and stationery', amountEURMin: 30, amountEURMax: 150, note: 'Indicative cost per child per year; depends on the year group, school and teachers’ requirements.' }
  ],
  sources: [
    { title: 'DGE — Free School Textbooks', url: 'https://www.dge.mec.pt/manuais-escolares-gratuitos', kind: 'official', language: 'pt', lastRetrieved: '2026-04-28' },
    ...
    { title: 'Portal MEGA — School Textbooks', url: 'https://manuaisescolares.pt/', kind: 'official', language: 'pt', lastRetrieved: '2026-04-28' }
  ],
