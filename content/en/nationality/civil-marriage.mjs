export default {
  ...
  tldr: 'Civil marriage registration takes place at the Conservatória do Registo Civil. It is available to residents and non-residents. Timeline: depends on the workload of the Conservatória and the completeness of the documents; there is no fixed “30-day notice period”. After the preliminary procedure (processo preliminar) is opened, the registrar checks for marriage impediments (impedimentos matrimoniais); after a favourable decision (despacho favorável), the marriage must be concluded within 6 months. Casamento urgente is NOT an expedited tourist procedure, but an exceptional procedure for perigo iminente de morte or parto iminente. Requirements: passport, birth certificate (with apostille + translation for foreigners), certificado de capacidade matrimonial from your country (if you are not a Portuguese citizen). Same-sex marriage has been permitted since 2010 (Lei 9/2010). Religious marriage — with civil-law effects through the Concordata (Catholic) or Lei 16/2001 (other denominations).',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '👨‍👩‍👧 Children: legal protection across all parental rights and responsibilities (shared custody, inheritance, insurance)'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'r1', title: 'Step 1: Filing the preliminary procedure (processo preliminar)', content: [
            { kind: 'checklist', items: [
              'At the Conservatória do Registo Civil (anywhere in Portugal)',
              'Documents:',
          ...
          { id: 'r2', title: 'Step 2: Checking marriage impediments (impedimentos matrimoniais)', content: [
            { kind: 'paragraph', text: 'The registrar opens the processo preliminar and checks impedimentos matrimoniais (absolute and relative impediments: age, legal capacity, kinship, existing marriage, etc.). This is NOT a fixed 30-day public notice period — the timeline depends on the workload of the Conservatória and the completeness of the documents. At the end of the analysis — despacho favorável. The marriage must be concluded within 6 months after the despacho.' },
          ...
          { id: 'r3', title: 'Step 3: Civil ceremony', content: [
            { kind: 'checklist', items: [
              ...
              'The registrar performs the registration — 15-20 minutes',
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'f2', title: 'Birth certificate', content: [
            { kind: 'checklist', items: [
              ...
              'From Brazil: cartório civil → apostille at MRE'
            ]}
          ]},
          ...
          { id: 'f4', title: 'No residence? Marriage for tourists', content: [
            { kind: 'checklist', items: [
              ...
              'Portugal does not provide an expedited procedure for wedding tourism like Las Vegas',
    ...
    },
    {
      ...
      content: [
        { kind: 'warning', text: 'Casamento urgente is NOT an expedited tourist procedure and NOT a choice of an “urgent” route. It is an **exceptional** marriage procedure without the ordinary processo preliminar in legally defined situations.' },
        { kind: 'checklist', items: [
          ...
          '⚠️ Not for “weekend” weddings, beach weddings, or speeding up the process. To speed up the ordinary procedure, discuss the completeness of documents with the specific Conservatória',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Precondition: the same processo preliminar at the Conservatória with verification of impedimentos (the timeline depends on workload and completeness of documents; there is no fixed 30-day period)',
          ...
          'Same-sex religious ceremonies — only in denominations that perform them (some Methodists, Quakers, secular humanists)'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🆔 Update Cartão de Cidadão / residence permit — change of surname (optional in Portugal, common among women, but not mandatory)',
          ...
          '👶 Children: for different-sex spouses, the presumption of the husband’s paternity applies to children born or conceived during the marriage (Código Civil arts. 1796–1838). For same-sex couples, assisted reproduction/IVF, surrogacy, adoption, and foreign birth certificates — a separate legal analysis/registration is required',
          '💰 IRS: married couples choose between tributação separada and tributação conjunta in the annual Modelo 3 return. Englobamento is a separate mechanism for specific categories of income (for example, capital gains or investment income), not the joint filing option itself'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Convenção Antenupcial is a prenuptial agreement. It defines the property regime.' },
        { kind: 'checklist', items: [
          '**Default (without a prenuptial agreement)**: comunhão de adquiridos — property acquired after marriage is shared; property acquired before marriage is separate',
          '**Comunhão geral**: everything is shared, even property acquired before marriage',
          '**Separação total**: nothing is shared, each person owns their own property',
  ...
  costs: [
    ...
    { label: 'Off-site ceremony surcharge (in addition to the official emolumento)', amountEURMin: 50, amountEURMax: 150, note: 'Venue/transfer costs; depends on the Conservatória' },
