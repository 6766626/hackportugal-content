export default {
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🎂 ≥ 18 years old; 16-17 — with parental permission',
          ...
          '🌍 A marriage celebrated in Portugal is recognised in most countries after an apostille',
    ...
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'r2', title: 'Step 2: Checking marriage impediments (impedimentos matrimoniais)', content: [
            { kind: 'paragraph', text: 'The Conservadora opens the processo preliminar and checks the impedimentos matrimoniais (absolute and relative impediments: age, legal capacity, kinship, existing marriage, etc.). This is NOT a fixed 30-day public notice period — the timeframe depends on the workload of the Conservatória and the completeness of the documents. At the end of the analysis — despacho favorável. The marriage must be celebrated within 6 months after the despacho.' },
            { kind: 'paragraph', text: 'If there is an impediment — the Conservatória will notify you; an impediment dispensável can be removed by application, while an impediment dirimente prevents the marriage.' }
          ]},
      ...
      content: [
        ...
        { kind: 'substeps', items: [
          { id: 'f1', title: 'Certificado de Capacidade Matrimonial', content: [
            { kind: 'checklist', items: [
              'Certificate of capacity to marry from your country',
              ...
              'Valid for 6 months',
              'Apostille (if the issuing country is a party to the Hague Convention) or consular legalisation + translation into Portuguese. Portugal has no unified system of “sworn translators”: an acceptable translation is one certified by a Portuguese lawyer/solicitador, notary, chamber of commerce or Portuguese consulate abroad (CN art. 38)',
              '⚠️ If the source country does not issue such a certificate — the Conservatória may accept equivalent documents (status extract, document from the competent authority), plus, if necessary, a sworn declaração of freedom to marry'
            ]}
          ]},
          { id: 'f2', title: 'Birth certificate', content: [
            { kind: 'checklist', items: [
              ...
              'From Brazil: actual cartório de registro civil → the apostille is affixed by **authorised cartórios** within the CNJ system (under Resolução CNJ 228/2016). NOT Brazil’s Ministry of Foreign Affairs; not “MINRE”'
            ]}
          ]},
          { id: 'f3', title: 'Divorce / death certificate', content: [
            { kind: 'paragraph', text: 'Apostille + translation to confirm the absence of a current marriage. Timeframe ≤ 6 months.' }
          ]},
          { id: 'f4', title: 'No residency? Marriage for tourists', content: [
            { kind: 'checklist', items: [
              'Possible — a foreign tourist can marry in Portugal',
    ...
    },
    {
      ...
      content: [
        { kind: 'warning', text: 'Casamento urgente is NOT a tourist fast-track procedure and NOT a choice of “urgent” mode. It is an **exceptional** marriage procedure without the usual processo preliminar in situations established by law.' },
        { kind: 'checklist', items: [
          '🩺 **Perigo iminente de morte** of one of the spouses-to-be',
          '👶 **Parto iminente** (imminent childbirth)',
          '⚖️ Regulated by art. 1622 Código Civil',
          'May be performed by any person in the presence of 4 witnesses and is then registered at the Conservatória',
          '⚠️ Not for “weekend” weddings, beach weddings or speeding up the process. To speed up the ordinary procedure — discuss the completeness of the documents with the specific Conservatória',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Precondition: the same processo preliminar at the Conservatória with a check of impedimentos (timeframe depends on workload and document completeness; there is no fixed 30-day period)',
          'After the religious ceremony: the minister sends the signed book back to the Conservatória → registration in the civil register',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '👶 Children: for different-sex spouses, the presumption of the husband’s paternity applies to children born or conceived within the marriage (Código Civil arts. 1796–1838). For same-sex couples, assisted reproduction/IVF, surrogacy, adoption and foreign birth certificates — separate legal analysis/registration',
          '💰 IRS: married couples choose between tributação separada and tributação conjunta in the annual Modelo 3 tax return. Englobamento is a separate mechanism for particular categories of income (for example, capital gains or investment income), not the joint filing option itself'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Convenção Antenupcial — a prenuptial agreement. It defines the property regime.' },
        { kind: 'checklist', items: [
          '**Default (without a prenuptial agreement)**: comunhão de adquiridos — property acquired after marriage is joint; property acquired before marriage is separate',
          ...
          '⚠️ After marriage, the property regime usually does NOT change (princípio da imutabilidade convenção antenupcial). Change is possible only in cases strictly limited by law. Choose the regime BEFORE the wedding'
        ]}
      ]
    }
  ],
  costs: [
    ...
    { label: 'Surcharge for an off-site ceremony (in addition to the official emolumento)', amountEURMin: 50, amountEURMax: 150, note: 'Venue/transfer costs; depends on the Conservatória' },
