export default {
  ...
  tldr: '🆕 Lei Orgânica n.º 1/2026 was published in the DR on 18/05/2026, in force from 19/05/2026. The basic route under the new law:\n\n📅 Residence period: 7 years for CPLP and EU/EEA/Swiss citizens; 10 years for third countries. Only periods of legal residence count (with a valid título/visa); waiting time before the first legal status no longer counts.\n\n🗣️ Portuguese A2 knowledge (CIPLE or equivalent certificate). For CPLP — not required.\n\n📝 Mandatory test on knowledge of Portuguese culture, citizens’ rights and duties, and the political system.\n\n⚖️ A final conviction to effective imprisonment of more than 3 years for serious crimes (terrorism, violent and especially violent crime, highly organised crime, crimes against state security, aiding illegal immigration) creates an impediment — but this is a REBUTTABLE presumption (art. 6.º n.º 14): the Ministério Público weighs gravity, time elapsed, recidivism and genuine integration, and the applicant may seek judicial removal of the effect (n.º 15). Criminal-record certificates are required for convictions of 2 years or more (n.º 11). The previous threshold was more than 5 years.\n\n🏠 Real physical presence — simply holding a residence permit is not enough.\n\n🚫 The Sephardic route has been completely abolished.\n\n⚖️ Transitional provision (for those who applied BEFORE 19/05/2026): the previous Lei 37/81 applies — 5 years’ residence for all nationalities, no mandatory cultural test, criminal conviction threshold of 5 years. IRN confirmed on 07–08/05/2026: the key cut-off is the submission date on the Portal da Nacionalidade online platform; everything submitted before 19/05/2026 is assessed under the old rules.\n\n🔴 Related Decreto 49/XVII (loss of citizenship as a criminal penalty): on 08/05/2026 the TC UNANIMOUSLY found it unconstitutional; on 12/05/2026 President Seguro returned it to Parliament (art. 279.º of the Constitution). On 03/07/2026 Parliament DEFINITIVELY rejected the decree (152 votes to 56) — loss of citizenship as a criminal penalty did NOT become law. The governing coalition may retry with a narrower list of crimes — we are watching.\n\n📋 The regulamentação of the law (amendments to the Regulamento da Nacionalidade, DL 237-A/2006) has not yet been published as of 01/08/2026: under art. 4, the Government has 90 days from 18/05/2026 — deadline ≈ 16 August. Until then, some practical details (for example, the culture-test procedure) are not yet operational.',
  tags: ['citizenship', 'naturalisation', 'cplp'],
  estimatedReadMinutes: 10,
  changeSummary: 'Clarified the residence-counting rules (sum of periods of legal residence, 9/12-year look-back window) and the status of a criminal conviction as a rebuttable presumption under Lei Orgânica 1/2026. Base periods: 7 years for CPLP+EU, 10 years for third countries; a mandatory cultural test has been added, the Sephardic route abolished, and for children born in PT the parents must have 5 years of residence permit. Transitional provision: all applications submitted on Portal da Nacionalidade BEFORE 19/05/2026 are assessed under the previous Lei 37/81 (5 years). 🔴 Related Decreto 49/XVII (loss of citizenship as a criminal penalty) — the TC UNANIMOUSLY found it unconstitutional on 08/05/2026; President Seguro returned it to Parliament on 12/05/2026; on 03/07/2026 Parliament definitively rejected the decree (152–56) — loss of citizenship as a penalty did not become law.',
  variants: [
    {
      id: 'cplp',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          '📅 Legal residence in Portugal: 7 years for CPLP and EU/EEA/Swiss citizens; 10 years for third-country citizens. The SUM of all periods of legal residence counts (with a valid título/visa/autorização) — art. 15.º n.º 1/3 — within a look-back window (9 years for CPLP/EU, 12 years for third countries); time before the first legal status, including manifestação de interesse and waiting for the first residence permit, is NOT counted',
          ...
          '⚖️ A final conviction to effective imprisonment of more than 3 years for serious crimes (terrorism, violent and especially violent crime, highly organised crime, crimes against state security, aiding illegal immigration — as punishable under Portuguese law) creates an impediment in the form of a REBUTTABLE presumption (art. 6.º n.º 14): the Ministério Público weighs gravity, time elapsed, recidivism and genuine integration, and the applicant may seek judicial removal of the effect (n.º 15). Criminal-record certificates are required for convictions of 2 years or more (n.º 11). Threshold tightened: previously more than 5 years',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Under the new version (for applications from 19/05/2026 and later), the SUM of all periods of legal residence counts — i.e. time with a valid título de residência, visa or autorização (art. 15.º n.º 1 and n.º 3) — within a look-back window: 9 years for CPLP/EU citizens and 12 years for third countries. This is a tightening: time before the first legal status (including Manifestação de Interesse and waiting for the first residence permit) no longer counts.' },
        { kind: 'checklist', items: [
          '✅ The SUM of all periods of legal residence counts (with a valid título/visa/autorização) — art. 15.º n.º 1/3',
          '⏳ Counted within a look-back window: 9 years for CPLP/EU, 12 years for third countries',
          '🚫 Time before the first legal status (from submitting the residence permit application until its issue) — does NOT count',
