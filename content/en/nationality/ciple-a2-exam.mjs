export default {
  ...
  tldr: 'An A2-level certificate is needed only for naturalisation by residence (under the current Lei 37/81 — 5 years; **03/05/2026 President Seguro promulgated Decreto AR 48/XVII** — after publication in the DRE, the period will increase to 7 years for CPLP/EU and 10 years for others, plus a mandatory test on knowledge of Portuguese culture, rights and the system of government will be introduced). For marriage, união de facto, Reagrupamento Familiar — it is NOT needed. IMPORTANT: for naturalisation, IRN accepts only an official A2+ level certificate (CIPLE / PLA / Centros Qualifica / DEPLE / DAPLE) — a simple attendance statement for 150 course hours WITHOUT level assessment is NOT accepted. The cheapest routes: PLA (€0), IEFP (€0 + training allowance, but with obligations as an unemployed person), state adult schools ~€20/semester. The CIPLE exam — €85 (2026), monthly sessions.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          '✅ **Naturalisation by residence** (art. 6 Lei 37/81 + art. 25 Decreto-Lei 237-A/2006): under current law — after 5 years. **03/05/2026 President Seguro promulgated Decreto AR 48/XVII** — after publication in the DRE: 7 years for CPLP/EU, 10 years for others, plus a mandatory test on knowledge of Portuguese culture, rights and the system of government. Until publication in the DRE, the old rules apply',
          '✅ For admission to certain IEFP programmes, state colleges and Centros Qualifica'
        ]},
        { kind: 'paragraph', text: 'When the certificate is NOT required:' },
        { kind: 'checklist', items: [
          '❌ Citizenship by marriage / união de facto — Lei 37/81 does not require language knowledge (only “effective ties”)',
          '❌ Citizenship by origin (Portuguese grandfather/grandmother) — not required',
          '❌ Family reunification (Reagrupamento Familiar) — AIMA does not ask for language knowledge',
        ...
        { kind: 'warning', text: 'When applying for citizenship, IRN accepts only an OFFICIAL certificate stating the specific level A2 or higher. A course attendance statement (frequência) without level assessment is NOT suitable.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Under art. 25 Decreto-Lei 237-A/2006 and IRN instructions, the following are accepted as proof of Portuguese language knowledge:' },
        { kind: 'checklist', items: [
          ...
          '✅ **PLNM school certificate** (Português Língua Não Materna) — if it states the level achieved as A2+',
          '✅ **Certificate of completion of a Portuguese school** (9th/12th year) — automatically considered C1',
          '✅ **Course/degree from a higher education institution in Portuguese** — usually accepted',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'iefp', title: '1. IEFP — job centre: course + allowance (for registered unemployed people)', content: [
            { kind: 'paragraph', text: 'IEFP (iefp.pt) organises Portuguese courses for residents. If you are registered as unemployed/a jobseeker — the course is free + a training allowance.' },
            { kind: 'warning', text: 'Registration with IEFP imposes OBLIGATIONS: attending appointments, taking part in active employment measures, accepting suitable job/internship offers. It is not suitable for those who are not genuinely looking for work — failure to attend may lead to deregistration and withdrawal of benefits.' },
            { kind: 'checklist', items: [
          ...
          { id: 'pla', title: '2. PLA — Português Língua de Acolhimento (usually free)', content: [
            ...
            { kind: 'checklist', items: [
              ...
              'Enrol via the Centro Qualifica for your place of residence (qualifica.gov.pt) or AIMA',
          ...
          { id: 'public-school', title: '3. State adult schools (Escola Secundária)', content: [
            ...
            { kind: 'checklist', items: [
              ...
              '🎓 IMPORTANT: ask whether the school issues a certificate with level A2 (not just an attendance statement)',
          ...
          { id: 'junta', title: '4. Junta de Freguesia — informal courses', content: [
            { kind: 'paragraph', text: 'Some Junta de Freguesia offices organise free conversation courses with volunteers. They usually do NOT issue a certificate (not suitable for IRN), but they are excellent for speaking practice. Ask in your area.' }
          ]},
          ...
          { id: 'private', title: '6. Private language schools', content: [
            { kind: 'paragraph', text: 'Only if you need maximum speed / an individual approach. From €300 for an intensive course; full A1→A2 course ~€700–1200. CIAL, CLIC, Fast Forward. A private school certificate is usually NOT accepted by IRN — you need CIPLE or a state certificate.' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'CIPLE (Certificado Inicial de Português Língua Estrangeira) — an A2-level exam from CAPLE (Universidade de Lisboa). Accepted by all Portuguese authorities.' },
        { kind: 'substeps', items: [
          { id: 'e1', title: 'Reading + writing (75 min)', content: [
            { kind: 'paragraph', text: '4 texts with questions (multiple choice + short answers). A short written task (70–90 words): email, note, greeting/congratulations.' }
          ]},
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🏢 Centres in Portugal and abroad vary by session — check the list of centros de exame on the CAPLE website before registering',
          ...
          '📄 Results — in your CAPLE personal account after 6–8 weeks; the PDF certificate can be downloaded there too'
        ]}
      ]
    },
    {
