export default {
  ...
  steps: [
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'd1', title: 'Child of a Portuguese citizen', content: [
            { kind: 'paragraph', text: 'If, at the time of birth, one of the parents was already a Portuguese citizen, a child born abroad may obtain citizenship by origin through birth registration or a declaration at a Conservatória / IRN / consulate. If the parent became Portuguese only AFTER the child was born, a separate analysis applies: for minors there may be a citizenship-acquisition regime; for adults there is not always a direct route.' }
          ]},
          { id: 'd2', title: 'Grandchild of a Portuguese citizen', content: [
            { kind: 'paragraph', text: 'This is citizenship by origin, but NOT “automatic”: you must submit a declaration/application to IRN or a Conservatória and meet the conditions of art. 1.º Lei da Nacionalidade.\n\nIn practice, the key proof of connection to the Portuguese community is sufficient knowledge of the Portuguese language, usually level A2 (CIPLE or a recognised equivalent/exemption). “Cultural ties” alone are usually not enough. Criminal/security grounds for exclusion are also checked.' }
          ]},
          { id: 'd3', title: 'Great-grandchild and beyond — there is NO direct route', content: [
            { kind: 'paragraph', text: 'There is no direct “great-grandchild” category in Lei 37/81. The usual sequence is: first, the intermediate generation (parent or grandparent) obtains citizenship; then the applicant checks whether they can apply as the child or grandchild of a Portuguese citizen. If it is impossible to build the chain, the ordinary routes remain, primarily naturalisation after 5 years of legal residence (under the new law after publication of Decreto AR 48/XVII in the DRE — 7 years for CPLP/EU, 10 years for others).' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Birth certificate of the parent through whom the relationship is proven',
          'Birth certificate of the grandmother/grandfather (if the applicant is a grandchild)',
          'Proof of the ancestor’s Portuguese citizenship (assento de nascimento in a Conservatória, Cartão de Cidadão, passport or historical record)',
          'For GRANDCHILDREN: proof of sufficient knowledge of Portuguese — usually an A2 certificate (CIPLE or a recognised equivalent/exemption). For CHILDREN of Portuguese citizens this is generally NOT required',
          ...
          'For grandchildren: there must NOT be a sentence of imprisonment of 3 years or more (on the Portuguese scale) and no grounds related to a threat to security/terrorism',
          'In some acquisition regimes, the Ministério Público may object (oposição) in cases of voluntary military service for a foreign state or non-technical public functions for a foreign state — this is NOT an ordinary checklist item, but it matters in rare cases'
        ]},
        { kind: 'warning', text: 'The chain of certificates must be continuous. If the ancestor lost citizenship or records have been lost, the process is more complex.' }
      ]
    },
    {
      id: 'process',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'p1', title: '1. Gather the genealogy', content: [
            { kind: 'paragraph', text: 'Apostille/legalisation of all foreign certificates + translation into Portuguese, duly certified (notary in Portugal, consulate, lawyer/solicitador or another method accepted by IRN).\n\nPortuguese records are searched by place and period: Conservatória/IRN for civil registry, Arquivo Distrital for many old records, Torre do Tombo for certain collections. It is best to start with the exact concelho/freguesia and year.' }
          ]},
          { id: 'p2', title: '2. Check the ancestor’s record', content: [
            { kind: 'paragraph', text: 'On the IRN website or via a request to a Conservatória — make sure the record exists.' }
          ]},
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The Sephardic route evolved in three stages: (1) **Lei Orgânica n.º 1/2013** introduced it into the Lei da Nacionalidade (details — Decreto-Lei 30-A/2015); (2) **Decreto-Lei n.º 26/2022** (01.09.2022) tightened the Regulamento and required evidence of a connection with Portugal; (3) **Lei Orgânica n.º 1/2024 of 5 March 2024** (entered into force on 01.04.2024) materially changed the law itself: it introduced mandatory **legal residence in Portugal for ≥ 3 years (consecutive or interpolated)** + assessment by a special committee at the Ministry of Justice (researchers + representatives of Jewish communities with religious legal entity status in PT).\n\nAfter 1/2024, the “remote” Sephardic route is effectively closed.' },
        { kind: 'paragraph', text: '**03.05.2026 President Seguro promulgated Decreto AR 48/XVII** (renamed from 17/XVII after passing through the TC) — the law **completely abolishes** the Sephardic route, even in its current format with 3 years’ residence. It enters into force on the day after publication in the Diário da República; **published as **Lei Orgânica n.º 1/2026**, DR 18.05.2026, in force from 19.05.2026**. The text of the law contains a transitional provision — administrative processes being processed on the date of entry into force are subject to the previous version of Lei 37/81 (the PS proposal for broader transitional guarantees was rejected). In his speech on 03.05.2026, Seguro also publicly asked that already-submitted cases be considered under the old rules for the sake of legal certainty.\n\nUntil 19.05.2026, the Sephardic route technically operates under the post-LO 1/2024 regime (residence ≥ 3 years + committee).' },
        { kind: 'warning', text: 'If you plan to apply — do so URGENTLY, before Decreto 48/XVII is published in the DRE. Submission anchors the case in the old regime (the law’s transitional provision + the President’s request to IRN).\n\nAfter publication, the new law will completely remove this route for new applicants.' }
      ]
    }
  ],
  costs: [
  ...
  sources: [
    ...
    { title: 'Lei Orgânica n.º 1/2024 (05.03.2024) — material change to the Sephardic regime: residence of 3+ years + committee, in force from 01.04.2024', url: 'https://diariodarepublica.pt/dr/detalhe/lei-organica/1-2024-854130977', kind: 'law', language: 'pt', lastRetrieved: '2026-05-18' },
