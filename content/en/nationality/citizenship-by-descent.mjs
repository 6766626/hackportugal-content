export default {
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'For grandchildren: there must be NO conviction resulting in a prison sentence of 3 years or more (under the Portuguese scale) and no grounds connected with security threats/terrorism',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The Sephardic route evolved in three stages: (1) **Lei Orgânica n.º 1/2013** introduced it into the Lei da Nacionalidade (detail — Decreto-Lei 30-A/2015); (2) **Decreto-Lei n.º 26/2022** (01.09.2022) tightened the Regulamento and required evidence of a connection with Portugal; (3) **Lei Orgânica n.º 1/2024 of 5 March 2024** (entered into force on 01.04.2024) materially changed the law itself: it introduced mandatory **legal residence in Portugal for ≥ 3 years (consecutive or interpolated)** + assessment by a special committee at the Ministry of Justice (researchers + representatives of Jewish communities with religious legal entity status in PT). After 1/2024 the “remote” Sephardic route is effectively closed.' },
        { kind: 'paragraph', text: '**On 03.05.2026 President Seguro promulgated Decreto AR 48/XVII** (after passing through the TC, renumbered from 17/XVII) — the law **fully abolishes** the Sephardic route, even in the current format with 3 years’ residence. It enters into force on the day after publication in the Diário da República; **check the current publication status at diariodarepublica.pt**. The text of the law contains a transitional provision — administrative processes being processed on the date of entry into force are subject to the previous wording of Lei 37/81 (the PS proposal for broader transitional guarantees was rejected). In his speech on 03.05.2026, Seguro also publicly asked for cases already submitted to be examined under the old rules for the sake of legal certainty. Until 48/XVII enters into force, the Sephardic route technically operates under the post-LO 1/2024 regime (residence ≥ 3 years + committee).' },
        { kind: 'warning', text: 'If you plan to apply, do so URGENTLY, before Decreto 48/XVII is published in the DRE. Submission anchors the case in the old regime (the law’s transitional provision + the President’s request to IRN). After publication, the new law will fully remove this route for new applicants.' }
      ]
    }
  ],
  costs: [
  ...
  sources: [
    ...
    { title: 'Lei Orgânica n.º 1/2024 (05.03.2024) — material change to the Sephardic regime: 3+ years’ residence + committee, in force from 01.04.2024', url: 'https://diariodarepublica.pt/dr/detalhe/lei-organica/1-2024-854130977', kind: 'law', language: 'pt', lastRetrieved: '2026-05-18' },
