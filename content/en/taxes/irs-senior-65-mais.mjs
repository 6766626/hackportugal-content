export default {
  ...
  tldr: 'In IRS, being aged 65+ does not in itself exempt you from filing a tax return. With OE 2025 (Lei 45-A/2024), the base dedução específica for **both categories A and H** is linked to the formula **max(€4,104; 8.54 × IAS for that year)**. **For 2025 income (2026 return): €4,462.15** (8.54 × IAS 2025 €522.50) — for each pension recipient (Categoria H) or employee (Categoria A). You can claim lares: 25% of expenses with a limit of around €403. Pensão de alimentos: the recipient declares income, the payer deducts 20% under a court/notarial decision. The Modelo 3 return for 2025 is filed from 1 April to 30 June 2026.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'If you became a tax resident of Portugal, IRS covers your worldwide income: Portuguese pension, foreign pension, rent, interest, dividends, capital gains and some benefits. Being aged 65+ does not remove the obligation to file Modelo 3 if income exceeds exemption thresholds or if there is foreign income.' },
        ...
        { kind: 'warning', text: 'Do not confuse a residence permit with tax residence. For IRS, the tax residence rules matter: usually 183+ days in Portugal over 12 months or having housing that implies habitual residence.' }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'For the IRS 2026 return (for 2025 income) — the base is €4,462.15 per titular with Categoria H OR Categoria A income.',
          'The deduction applies not to the tax, but to the taxable base: first bruto pension/salary income is reduced, then the IRS scale is applied.',
          ...
          'If you receive both salary and pension, income may fall into different categories; deductions do not always simply add up mechanically.',
          'If mandatory Segurança Social/professional scheme contributions exceed the base dedução específica, the higher amount applies in Categoria A (under CIRS art. 25 rules).'
        ] },
        { kind: 'warning', text: 'Check the IRS simulation before submitting. For pensioners with a foreign pension, a common mistake is leaving Anexo J blank because “tax has already been withheld in the source country”. For a Portuguese resident, this risks an additional assessment and a fine. Also do not use old figures of €4,350 / €4,104 — after the 2025 reform the base is unified (€4,462.15 for 2025 income).' }
      ]
    },
    {
      id: 'lares',
      ...
      content: [
        { kind: 'paragraph', text: 'Expenses for lares, casas de repouso, apoio domiciliário and institutions for older people can give a deduction of 25% of the amount, with a limit of around €403 per year. This is a dedução à coleta: it reduces the IRS already calculated, not income.' },
        { kind: 'checklist', items: [
          ...
          'If the lar did not transmit the factura to e-Fatura, ask them to correct it before the invoice checking period closes.'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'In Portugal there is no universal rule of “turned 65 — you do not pay IRS”. Most reliefs are tied not to age itself, but to the type of income, income amount, household composition, disability, expenses and confirmed invoices.' },
        { kind: 'checklist', items: [
          ...
          'For a family supporting an elderly parent, there may be a dedução por ascendente, but this is a deduction for the children/relatives, not for the pensioner themself.',
          'Municipal IMI benefits for older and low-income households are not IRS and are checked separately with Câmara Municipal/Finanças.',
          'A pensioner with income from rent, investments or property sale may pay substantial IRS, even if the main pension is small.'
        ] },
        { kind: 'warning', text: 'Do not submit the return only because it is “automática”. IRS Automático is convenient, but it is poorly suited to foreign pensions, foreign taxes, lares, alimony and non-standard family situations.' }
      ]
    },
    {
      id: 'practical-check',
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'If the pension amount, source country or double taxation treaty is disputed — ask for advice from a contabilista certificado before 30 June.'
        ] },
        { kind: 'paragraph', text: 'After submission, AT usually assigns the status declaração certa, depois liquidação processada. The refund arrives to the IBAN stated in Finanças. If the IBAN is a foreign SEPA IBAN, it is allowed, but sometimes requires additional checks.' }
      ]
    }
  ],
  costs: [
    ...
    { label: 'Lares deduction', amountEURMax: 403, note: '25% of expenses, but no more than the annual limit; the actual benefit depends on the calculated IRS.' },
  ...
  sources: [
    ...
    {
      title: 'Código do IRS — Categoria H, specific deductions and deduções à coleta',
