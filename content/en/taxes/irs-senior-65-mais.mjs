export default {
  ...
  tldr: 'For IRS, being aged 65+ does not in itself exempt you from filing, but pensioners have important differences: income from pensões is treated as Categoria H, a dedução específica of €4,350 applies for each pension recipient, rather than the usual €4,104 for salary income. You can claim lares: 25% of expenses with a limit of around €403. Pensão de alimentos: the recipient declares the income, while the payer deducts 20% under a court or notarial decision. The Modelo 3 return for 2025 is filed from 1 April to 30 June 2026.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'If you have become a tax resident of Portugal, IRS covers your worldwide income: Portuguese pension, foreign pension, rent, interest, dividends, capital gains and some benefits. Being aged 65+ does not remove the obligation to file Modelo 3 if income exceeds the exemption thresholds or if there is foreign income.' },
        { kind: 'checklist', items: [
          ...
          'If the pension is taxable only in another country under a Convenção para Evitar Dupla Tributação, it is still usually shown in Anexo J with the method for eliminating double taxation.',
          ...
          'If there are recibos verdes, rental income, a sale of shares or property, the relevant IRS annexes are added to the pension rules.'
        ] },
        { kind: 'warning', text: 'Do not confuse a residence permit with tax residency. For IRS, tax residency rules matter: usually 183+ days in Portugal over 12 months or having accommodation that suggests permanent residence.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Pension income under Categoria H is reduced by the dedução específica. For IRS returns filed in 2026, use the reference figure of €4,350 for each titular with pension income. This is higher than the standard dedução específica of €4,104 for employment income under Categoria A.' },
        { kind: 'checklist', items: [
          'The deduction applies not to the tax itself, but to the taxable base: first the bruto pension income is reduced, then the IRS bands are applied.',
          ...
          'If you receive both salary and pension income, the income may fall into different categories; deductions do not always add up mechanically.'
        ] },
        { kind: 'warning', text: 'Check the IRS simulation before submitting. For pensioners with a foreign pension, a common mistake is to leave Anexo J empty because “tax has already been withheld in the source country”. For a Portuguese resident, this creates a risk of an additional assessment and a fine.' }
      ]
    },
    {
      id: 'lares',
      ...
      content: [
        { kind: 'paragraph', text: 'Expenses for lares, casas de repouso, apoio domiciliário and institutions for elderly people may give a deduction of 25% of the amount, with a limit of around €403 per year. This is a dedução à coleta: it reduces the IRS already calculated, not the income.' },
        { kind: 'checklist', items: [
          'The invoice must have your NIF or the NIF of the family member for whom the expense is claimed.',
          ...
          'Medical services inside a lar may be treated as saúde if invoiced by a separate medical entidade and they have the correct CAE/IVA.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'The recipient of pensão de alimentos reports the amounts in the return as pension/alimony income.',
          ...
          'If alimony is paid from abroad or to another country, check how this is reported in Anexo J and in the source country.'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'In Portugal, there is no universal rule that “you turn 65 and do not pay IRS”. Most reliefs depend not on age itself, but on the type of income, amount of income, household composition, disability, expenses and confirmed invoices.' },
        { kind: 'checklist', items: [
          'IRS Jovem does not apply to pensioners 65+: it is a regime for young taxpayers based on age and the start of working life.',
          ...
          'A pensioner with income from rent, investments or a property sale may pay substantial IRS, even if the main pension is small.'
        ] },
        { kind: 'warning', text: 'Do not submit the return just because it is “automática”. IRS Automático is convenient, but it is poorly suited to foreign pensions, overseas taxes, lares, alimony and non-standard family situations.' }
      ]
    },
    {
      id: 'practical-check',
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'If the pension amount, source country or double taxation treaty is disputed, ask a contabilista certificado for advice before 30 June.'
        ] },
        { kind: 'paragraph', text: 'After filing, AT usually assigns the status declaração certa, then liquidação processada. The refund is paid to the IBAN stated in Finanças. If the IBAN is a foreign SEPA account, it is permitted, but sometimes requires an additional check.' }
      ]
    }
  ],
  costs: [
    ...
    { label: 'Usual dedução específica Categoria A', amountEUR: 4104, note: 'Reference figure for comparison with employment income.' },
    { label: 'Lares deduction', amountEURMax: 403, note: '25% of expenses, but no more than the annual limit; the actual benefit depends on the IRS calculated.' },
  ...
  sources: [
    ...
    {
      title: 'Autoridade Tributária — filing the Modelo 3 IRS return',
