export default {
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'A pedido de reembolso is a refund of accumulated IVA credit. It arises when deductible IVA on purchases, imports, rent, accounting, equipment and other business expenses is greater than the IVA you charged to clients.' },
        { kind: 'checklist', items: [
          ...
          'There are no missed IVA returns, IES/DA or other mandatory reports that AT could use as grounds for a delay.'
        ] },
        { kind: 'warning', text: 'If you work under the isenção art. 53 CIVA regime, you generally do not charge IVA to clients and do not deduct IVA on expenses. This means the standard pedido de reembolso through field 95 is not suitable for you.' }
      ]
    },
    {
      id: 'field-95',
      ...
      content: [
        { kind: 'paragraph', text: 'In the declaração periódica de IVA, after the tax calculation, the system shows whether there is IVA a pagar or crédito. If you want the credit refunded in cash, the amount is entered in quadro 06, campo 95 — “Montante a reembolsar”. If you want to carry it forward to the next period, use campo 96 — “Excesso a reportar”.' },
        { kind: 'checklist', items: [
          'You can request the whole credit or only part of it, provided field 95 remains ≥€250.',
          'The balance that you do not ask to be refunded is carried forward to subsequent periods.',
          'The amount cannot be “invented”: it must arise from the return calculation.',
          'If the crédito is less than €250, the pedido de reembolso will not go through — the amount is carried forward.',
          'For companies with ongoing investments, a refund is often better than endlessly carrying the credit forward.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'Check that atividade aberta includes the actual CAE/CIRS codes for your activity.',
          ...
          'Make sure there are no missed declarações periódicas de IVA for previous periods.',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'login', title: '1. Log in to Portal das Finanças', content: [
            { kind: 'paragraph', text: 'Log in using NIF + password, Chave Móvel Digital or Cartão de Cidadão. For a company, representative access or a contabilista certificado is usually needed.' }
          ] },
          { id: 'declaration', title: '2. Open the declaração periódica de IVA', content: [
            { kind: 'paragraph', text: 'The path in Portal das Finanças changes, but the section is usually found via IVA → Declaração Periódica → Entregar declaração. Choose the period: monthly or quarterly.' }
          ] },
          { id: 'calculate', title: '3. Fill in IVA and calculate the crédito', content: [
            { kind: 'paragraph', text: 'Enter taxable operations, IVA liquidado, IVA dedutível, regularizações and other fields. After calculation, check that there is an excesso/crédito.' }
          ] },
          ...
          { id: 'follow-up', title: '5. Track the status', content: [
            { kind: 'paragraph', text: 'The refund status is checked in Portal das Finanças in the IVA / reembolsos area. If AT asks for documents, reply within the deadline through e-Balcão or the channel specified in the notification.' }
          ] }
        ] }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'The money is transferred to the IBAN registered with Finanças.',
          ...
          'If AT misses the legal deadline without cause, juros indemnizatórios may accrue, but in practice this requires separate monitoring.'
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Working under art. 53 CIVA but trying to reclaim IVA on expenses.',
          'Not updating the IBAN after changing bank.',
          'Missing a quarterly return and trying to obtain a refund in the next period.',
          'Not accounting for prorata if there are both operations with and without the right to deduct IVA.',
          'Thinking that an IVA refund is income. It is not income for IRS/IRC purposes, but a refund of previously paid indirect tax; however, the accounting treatment must be correct.'
        ] },
  ...
  sources: [
    {
      title: 'gov.pt: Reembolso de Imposto sobre Valor Acrescentado (IVA) in Portugal',
    ...
    {
      title: 'Portal das Finanças: IVA — obrigações declarativas and declaração periódica',
