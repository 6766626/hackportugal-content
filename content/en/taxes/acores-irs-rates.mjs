export default {
  ...
  id: 'acores-irs-rates',
  categoryId: 'taxes',
  title: 'IRS in the Açores: separate 2026 withholding tables for RA residents',
  tldr: 'If you are a tax resident of Região Autónoma dos Açores, your salary or pension in 2026 is withheld not under the Continente tables and not under Madeira, but under the separate tabelas de retenção na fonte dos Açores, approved by Despacho 1179/2026. This is advance IRS withholding, not the final tax: the final calculation is still done in the Modelo 3 return for 2026 in 2027. Check that your employer/pension fund is applying Açores specifically, especially if you work remotely for a company on the mainland.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Retenção na fonte is the monthly advance payment of IRS that an employer, pension fund or other payer withholds from income. It is not the final tax rate: the final amount is calculated after filing Modelo 3 in 2027, taking into account all income, deductions, household composition and residence.' },
        { kind: 'checklist', items: [
          'If you live and are a tax resident in the Açores — the Açores tables apply.',
          'If your employer is in Lisboa/Porto, but your tax residence and address in Finanças are in the Açores, withholding should be under the Açores tables.',
          'If you live on the mainland but your employer is registered in the Açores — the Açores tables do not apply by themselves.',
          'Madeira has its own tables; Madeira and Açores cannot be mixed.',
          'For recibos verdes, standard retenção depends on the type of income and CIRS rules, not on the employee salary table.'
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'In practice, this concerns everyone who receives a salary or pension and has a tax address in the Azores: São Miguel, Terceira, Faial, Pico, Santa Maria, São Jorge, Graciosa, Flores or Corvo.' },
        { kind: 'checklist', items: [
        ...
        { kind: 'warning', text: 'The main risk is that payroll applies Continente out of habit. The difference is only spotted on the recibo de vencimento or during the annual IRS process, when an unexpected additional payment or refund may appear.' }
      ]
    },
    {
      id: 'check-payroll',
      title: 'How to check that the correct amount is being withheld',
      content: [
        ...
        { kind: 'substeps', items: [
          { id: 'address', title: '1. Check your morada fiscal', content: [
            { kind: 'paragraph', text: 'In Portal das Finanças, open Dados Pessoais → Morada Fiscal. The address should be in the Açores. If the address is still on the mainland, payroll may formally apply the wrong table.' }
          ] },
          { id: 'payslip', title: '2. Open the recibo de vencimento', content: [
            { kind: 'checklist', items: [
              'Find the IRS or Retenção IRS line.',
              'Check the monthly base: salário base + regular allowances, if they are taxable.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'Lower withholding each month does not mean the tax has been “forgiven”.',
          ...
          'When changing region mid-year, the dates of actual and tax residence are important.',
          'Foreign income is declared separately; the employer withholding table does not see it.',
          'Having IFICI, old NHR or a preferential regime does not remove the obligation to check payroll.'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'In 2026, the salário mínimo nacional is €920 per month, IAS is €537.13. These figures are important for social and tax calculations, but they do not replace the withholding tables. For a salary, you need to look specifically at the Açores 2026 table by family type and number of dependentes.' },
        { kind: 'paragraph', text: 'If the salary is close to SMN, IRS withholding may be zero or low depending on family situation. But Segurança Social is usually withheld separately: standard 11% from the employee under a contrato de trabalho, unless a special regime applies.' },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Tell HR/payroll the month from which Açores should be applied.',
          'Check the next recibo de vencimento.',
          'If withholding used the old table for several months, ask for a correction in payroll.',
          'If in doubt, show an accountant all payslips for the year and the moving dates.'
        ] },
        { kind: 'paragraph', text: 'Withholding errors are usually corrected through later payroll months or through the final IRS liquidação. But it is better to correct them during the year, so you do not receive a large additional payment in spring-summer 2027.' }
      ]
    }
  ],
  sources: [
    ...
    {
      title: 'TOC Online: update to IRS tables for the Açores',
