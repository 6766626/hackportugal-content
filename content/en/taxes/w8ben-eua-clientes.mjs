  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'By default, the US may withhold 30% from certain payments to foreigners: dividends, royalties, certain platform payments. W-8BEN tells the withholding agent that you are not a US person and provides the basis for applying a treaty rate instead of 30%.' },
        { kind: 'paragraph', text: 'For a resident of Portugal, the Convention Between the United States of America and the Portuguese Republic for the Avoidance of Double Taxation applies. In practice, this is not a single rate, but a rate according to the type of income.' },
        ...
        { kind: 'warning', text: 'W-8BEN is only for individuals. If the payment recipient is a Portuguese Lda, US LLC, UK LTD or another company, W-8BEN-E or another form is usually required. US citizens, green card holders and persons with US tax residency do not use W-8BEN.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The form is rarely sent directly to the IRS. Usually you complete a tax interview inside the platform, and the platform keeps the W-8BEN as withholding agent.' },
        { kind: 'checklist', items: [
          ...
          'if the platform does not let you choose the Portugal treaty, check that the country of tax residence is listed as Portugal, not the country of your passport'
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Field names may differ in an online interview, but the logic is the same as in IRS Form W-8BEN.' },
        { kind: 'checklist', items: [
          ...
          'Line 4 / Mailing address: complete only if your mailing address is different',
          'Line 5 / U.S. TIN: usually left blank if you do not have an SSN/ITIN; some situations require an ITIN, but for most brokers and platforms a foreign TIN is sufficient',
          'Line 6a / Foreign tax identifying number: your Portuguese NIF',
          'Line 8 / Date of birth: date of birth in the platform’s format; on the paper IRS form it is usually MM-DD-YYYY',
        ...
        { kind: 'warning', text: 'The NIF in W-8BEN is not a “Portuguese equivalent of an SSN”, but a foreign TIN for a treaty claim. If you have only just moved and have not yet become a tax resident of Portugal, you cannot automatically claim Portugal treaty benefits.' }
      ]
    },
    {
      id: 'line-10-examples',
      ...
      content: [
        { kind: 'paragraph', text: 'Line 10 is not always needed. Brokers often apply Article 10 automatically after Portugal is selected. Amazon and some platforms may ask you to specify the article, rate and explanation.' },
        { kind: 'substeps', items: [
          {
            id: 'services',
            title: 'Services / freelance from Portugal — 0%',
            content: [
          ...
          },
          {
            ...
            content: [
              { kind: 'paragraph', text: 'On US shares, the broker withholds tax at source from dividends. For a tax resident of Portugal, the treaty rate is usually 15% under Article 10 instead of the standard 30%.' },
              { kind: 'checklist', items: [
                'Article: 10',
        ...
        { kind: 'warning', text: 'Do not copy someone else’s rate from the internet. The treaty rate depends on the type of income. For a resident of Portugal, Amazon KDP royalties are not the same as freelance services or dividends at a broker.' }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'renew the form when your country of tax residence changes',
          'renew it when your name, address or NIF changes',
          'renew it if you obtain a US green card, SSN/ITIN or become a US tax resident',
          'renew it if the income starts being paid to a company, rather than to you personally',
          'keep a PDF/screenshot of the tax interview and the submission date',
          'check the actual withholding in the annual tax statement: 1042-S, broker activity statement, Amazon tax report',
          'if 30% was withheld because the form had expired, the platform does not always make a refund; sometimes a US tax filing is needed, which is expensive and slow'
        ] }
      ]
    },
    {
      id: 'portugal-tax',
      title: 'What to declare afterwards in Portugal',
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'freelance services: often Categoria B / recibos verdes, if the activity is carried on as self-employed',
        ...
        { kind: 'warning', text: 'If you have NHR legacy, IFICI, empresa, US LLC, partnership income, stock options or large royalties, do not rely on the platform’s tax interview as tax advice. An error in W-8BEN may lead to under-withholding in the US or an incorrect declaration in Portugal.' }
      ]
    }
  ],
  costs: [
    { label: 'Submitting W-8BEN via a platform', amountEUR: 0, note: 'There is no IRS fee; the form is usually completed online with the withholding agent' },
    { label: 'Obtaining an ITIN, if genuinely needed', amountEUR: 0, note: 'The IRS does not charge a fee, but a Certified Acceptance Agent or document postage may cost extra' },
    { label: 'Consultation with a contabilista / tax adviser', amountEURMin: 80, amountEURMax: 250, note: 'Typical one-off review of the treaty, IRS/Portugal returns and income classification' }
  ],
  sources: [
    {
