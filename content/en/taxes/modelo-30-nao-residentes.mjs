export default {
  ...
  tldr: 'Modelo 30 is filed with Finanças when an empresa, ENI or atividade pays income to a non-resident: a foreign contractor, landlord, consultant, rights holder or creditor. The deadline is by the end of the 2nd month after payment: payment on 10.04.2026 → declaration by 30.06.2026. It is filed even when applying a Convenção para Evitar Dupla Tributação via Modelo 21-RFI. Late filing usually risks a coima from €150 to €3,750 under the RGIT.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'For an expat, this most often arises not in personal life, but when you have a sociedade, ENI or atividade aberta: you have paid a foreign developer, marketer, consultant, lawyer, landlord, interest, royalties, dividends or other income that, under Portuguese rules, is considered non-resident income.' },
        { kind: 'checklist', items: [
          ...
          'There is interest on a loan paid to a non-resident.',
          ...
          'The payment was not in cash, but by set-off/withholding/colocação à disposição — an event for Modelo 30 may still arise.'
        ] }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'An ordinary employee without atividade who simply buys a service for personal purposes from a foreign person generally does not become a regular Modelo 30 filer. But if you have a NIF with atividade aberta or an empresa, your accountant should check every foreign payment.' },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'Practical mistake: using the invoice date as the reference. For Modelo 30, the key point is not only the factura, but the moment of pagamento, vencimento or colocação à disposição. Agree with your accountant which date they are using in your situation.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Modelo 30 does not replace tax withholding. If, under Portuguese rules, IRS/IRC must be withheld from non-resident income, the payer withholds retenção na fonte, pays it to Finanças and separately files Modelo 30.' },
        { kind: 'paragraph', text: 'The rate depends on the type of income, the recipient’s status and the tax treaty. In typical cases, non-residents often encounter 25% on business/professional income, rents, royalties or corporate income, but dividends to individuals may be at 28%, and a treaty may reduce the rate or provide an exemption. Do not use one rate for all payments.' },
        { kind: 'checklist', items: [
          ...
          'Check whether the income is considered to be sourced in Portugal.',
          ...
          'Report in Modelo 30 not only the amount of income, but also the tax withheld or the basis for not withholding.'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'collect-data', title: '1. Gather the payment data', content: [
            { kind: 'checklist', items: [
              'NIF of the Portuguese payer.',
              'Month and year of the payment or colocação à disposição.',
              'Name/company name of the non-resident.',
              'Country of the recipient’s tax residence.',
          ...
          { id: 'submit-online', title: '2. File the declaration online', content: [
            { kind: 'paragraph', text: 'Log in to Portal das Finanças with NIF and senha or via Chave Móvel Digital. The section is usually found under Entregar > Declarações > Modelo 30 or through the Finanças site search. The declaration can be completed online or submitted as a file if your accounting software generates XML.' }
          ] },
          { id: 'save-proof', title: '3. Keep the evidence', content: [
            { kind: 'checklist', items: [
              ...
              'Rate calculation and reference to the treaty/article, if you applied relief.'
            ] }
          ] }
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Assuming that if the contractor is from the EU, Modelo 30 is not needed. EU status by itself does not remove the obligation.',
          'Paying the gross amount to a non-resident when retenção na fonte should have been withheld.',
          'Applying a treaty without Modelo 21-RFI or without proof of tax residence.',
          'Reporting by invoice date instead of payment/colocação à disposição date.',
        ...
        { kind: 'paragraph', text: 'For failure to file or late filing of a tax declaration, the RGIT usually provides for a coima from €150 to €3,750. If the error is linked to tax that was not withheld, the risk amount is higher: Finanças may demand the tax itself, juros compensatórios and separate penalties.' },
        { kind: 'warning', text: 'If you have found missed Modelo 30 declarations for past months, do not wait for an inspection. Ask your contabilista to file a falta/declaração de substituição and separately check retenção na fonte. Voluntary correction is usually cheaper than a notice from AT.' }
      ]
    }
  ],
  costs: [
    ...
    { label: 'Penalty for failure to file/late filing of the declaration', amountEURMin: 150, amountEURMax: 3750, note: 'Typical coima range under RGIT art. 116; the outcome depends on the facts and the taxpayer’s conduct.' }
  ],
  sources: [
    {
    ...
    {
      title: 'Autoridade Tributária — Convenções para evitar dupla tributação and RFI forms',
