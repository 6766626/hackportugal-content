export default {
  ...
  tldr: 'Number porting between Portuguese operators under DL 56/2010 is FREE, takes 1 working day, and is requested from the new operator (they deal with the old one). To obtain the **Código de Validação da Portabilidade (CVP)**: send an SMS with the text **“CVP”** to the short number **1696** from the old SIM (for mobile numbers). The standard command used by Portuguese operators is exactly “CVP”, not “PORT”. Porting does NOT cancel loyalty commitment with the old operator — if there is a penalty, it must be paid.',
  tags: ['number porting', 'MNP', 'operator switch', 'porting code'],
  ...
  steps: [
    {
      ...
      title: '🔄 How MNP works',
      content: [
        { kind: 'paragraph', text: 'MNP (Mobile Number Portability) is guaranteed by DL 56/2010 — every user has the right to port their number when changing operator without losing it. The service is free. You do NOT need to go to the old operator’s shop.' },
        { kind: 'checklist', items: [
          ...
          '⚠️ IMPORTANT: service with the old operator may leave an active loyalty commitment — with a penalty, if applicable'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'p1', title: '1. Get the porting code from the old operator', content: [
            { kind: 'checklist', items: [
          ...
          { id: 'p2', title: '2. Apply with the new operator', content: [
            { kind: 'checklist', items: [
              ...
              'Do not activate the new SIM until you receive confirmation of the port!'
            ]}
          ]},
          { id: 'p3', title: '3. Porting day', content: [
            { kind: 'checklist', items: [
              ...
              '🔁 If the port has not happened within 24 hours — call the new operator to escalate'
            ]}
          ]},
          { id: 'p4', title: '4. Close the old account', content: [
            { kind: 'checklist', items: [
              '📝 The old operator automatically closes the account after porting',
              '💸 The final bill arrives for the days before porting (pro rata)',
              '⚠️ If the old contract had a loyalty commitment — the penalty will appear on the final bill',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '🛑 Loyalty commitment with the old operator is NOT cancelled — if there are 6 months left on the contract × €20 — the penalty is about €60 (50%)',
          '🛑 If the old operator had a bundle (fibre + television + SIM) — a separate request is needed for each service',
          '🛑 Porting takes place within 1 working day — but an operator may “drag it out” for 2–3 days. By law, you can complain to ANACOM',
          '🛑 If you had postpaid service with the old operator — the final bill for “unclosed” days arrives 2–3 weeks later',
