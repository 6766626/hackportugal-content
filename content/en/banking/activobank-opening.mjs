export default {
  ...
  categoryId: 'banking',
  title: 'Opening a bank account in Portugal (non-resident and resident)',
  tldr: 'Portugal has around 9 large banks licensed by Banco de Portugal. Several offer fully online account opening for non-residents with a Portuguese NIF. Typical process: video identification, basic KYC, IBAN issued on the same day, card by post in 5-10 days. Basic maintenance is free at most banks with minimal activity.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'An account with a Portuguese bank with an IBAN starting with PT50 is needed for most everyday procedures: registering a long-term rental contract, direct debits (utilities, taxes, car fines), receiving a salary, arranging investments, receiving benefits from Segurança Social, applying for a residence permit (some types require proof of funds in a Portuguese account).' },
        { kind: 'warning', text: 'An IBAN from another EU country (IE, DE, LT, etc.) is technically equivalent to a Portuguese one under the SEPA regulation, but in practice a number of Portuguese counterparties refuse direct debits from a foreign IBAN. For full compatibility, you need a PT-IBAN.' }
      ]
    },
    {
      id: 'types-of-banks',
    ...
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'o2', title: 'In a branch', content: [
            { kind: 'paragraph', text: 'The classic route is to go to a branch with a passport, NIF, proof of address, and sometimes proof of income. Large banks often specifically require in-person identification for non-residents.' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Proof of address — rental contract, utility bill or bank statement not older than 3 months',
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'p2', title: '2. Upload documents', content: [
            { kind: 'paragraph', text: 'Scans / photos of the passport, NIF, proof of address. Quality: all corners visible, no glare.' }
          ]},
          { id: 'p3', title: '3. Video identification (KYC)', content: [
            { kind: 'paragraph', text: 'Video call of 5-15 minutes. The operator asks you to show your passport, turn it around, and asks control questions (under AML rules). They speak Portuguese or English, sometimes Spanish.' }
          ]},
          ...
          { id: 'p5', title: '5. Receive IBAN and card', content: [
            { kind: 'timeline', text: 'IBAN active on the day of approval (1-3 days). The debit card arrives by post in 5-10 working days.' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'SEPA transfers in euros within the SEPA area; free in many online packages, but not everywhere — it depends on the preçário',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Anuidade / manutenção — annual/monthly maintenance fee. At many online banks it is €0 with minimal activity',
          'Imposto do Selo — stamp duty. In Portugal it is NOT a fixed quarterly charge for the account itself; it is usually charged as **4%** on bank fees, **0.5%** on interest on loans/consumer credit, etc. If you have a free account with no other services — there may be no actual Imposto do Selo',
    ...
    },
    {
      ...
      content: [
        { kind: 'warning', text: 'Banks in Portugal are required to carry out AML/KYC checks under Banco de Portugal and EU regulations. Common reasons for refusing to open an account for a non-resident:' },
        { kind: 'checklist', items: [
          'Mismatch between the address on documents and in the form',
          'No proof of source of funds for a large initial deposit',
          'Political exposure (PEP) or sanctions filter — refusal or prolonged due diligence check',
          'Poor-quality video identification — they often ask you to repeat it',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Save the IBAN in notes for quick copying when making payments',
          ...
          'Enable Multibanco-Homebanking for access via ATM'
        ]}
      ]
    }
  ],
  documents: [
    ...
    { title: 'NIF' },
    { title: 'Proof of address — not older than 3 months' },
    { title: 'Proof of source of funds' }
  ],
  costs: [
    { label: 'Account opening', amountEUR: 0 },
    { label: 'Annual maintenance (often)', amountEUR: 0 },
    { label: 'Imposto do Selo on bank fees', amountEUR: 0, note: '4% on bank fees, 0.5% on % on loans — NOT a fixed quarterly charge' },
  ...
  sources: [
    ...
    { title: 'BdP Regulation 2/2018 (AML rules)', url: 'https://www.bportugal.pt/aviso-circular/aviso-ndeg-22018', kind: 'law', language: 'pt', lastRetrieved: '2026-04-22' }
  ],
