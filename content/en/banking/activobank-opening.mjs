export default {
  ...
  tldr: 'Portugal has ~9 major banks licensed by Banco de Portugal. Several offer fully online account opening for non-residents with a Portuguese NIF. Typical process: video identification, basic KYC, IBAN issued the same day, card by post within 5-10 days. Basic account maintenance is free at most banks with minimal activity.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'An account with a Portuguese bank, with an IBAN starting with PT50, is needed for most everyday procedures: registering a long-term rental contract, direct debits (utilities, taxes, traffic fines), receiving salary, setting up investments, receiving benefits from Segurança Social, applying for a residence permit (some types require proof of funds in a Portuguese account).' },
        { kind: 'warning', text: 'An IBAN from another EU country (IE, DE, LT, etc.) is technically equivalent to a Portuguese one under SEPA rules, but in practice some Portuguese counterparties refuse direct debits from a foreign IBAN. For full compatibility, you need a PT-IBAN.' }
      ]
    },
    {
      id: 'types-of-banks',
      ...
      content: [
        { kind: 'checklist', items: [
          'Large universal banks: Millennium BCP, Caixa Geral de Depósitos (state bank), Novobanco, Santander Totta, BPI',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'o1', title: 'Online (remotely)', content: [
            { kind: 'paragraph', text: 'Several banks allow fully online account opening for customers with a NIF.\n\nProcess: video identification with an operator in Portuguese or English, electronic signature via Chave Móvel Digital or via video confirmation. Suitable even if you are not yet in Portugal, but already have a NIF.' }
          ]},
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Portuguese phone number — not mandatory, but greatly simplifies 2FA and MB WAY'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'p1', title: '1. Fill in the form', content: [
            { kind: 'paragraph', text: 'On the bank’s website or in its app: full name, NIF, profession, source of income, purpose of the account, tax residence. For non-residents of Portugal, the form must state the country of current tax residence (CRS/DAC2 compliance).' }
          ]},
          { id: 'p2', title: '2. Upload documents', content: [
            { kind: 'paragraph', text: 'Scans / photos of passport, NIF and proof of address. Quality: all corners visible, no glare.' }
          ]},
          { id: 'p3', title: '3. Video identification (KYC)', content: [
            { kind: 'paragraph', text: 'A 5-15 minute video call. The operator asks you to show your passport, turn it over, and asks control questions (under AML rules). They speak Portuguese or English, sometimes Spanish.' }
          ]},
          ...
          { id: 'p5', title: '5. Receive IBAN and card', content: [
            { kind: 'timeline', text: 'The IBAN is active on the day of approval (1-3 days). The debit card arrives by post within 5-10 working days.' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Euro account + multicurrency options at some banks',
          ...
          'SEPA transfers in euros within the SEPA area; free in many online packages, but not everywhere — depends on the preçário',
          'Direct debits (utilities, taxes, traffic fines)',
          'Access to Multibanco (ATM network in Portugal) with cash withdrawal limits of €200-400/day'
        ]}
      ]
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Political exposure (PEP) or sanctions filter — refusal or prolonged due diligence',
        ...
        { kind: 'paragraph', text: 'If bank A refused, it does not mean all banks will refuse — requirements and AML thresholds differ. On average, 2-3 attempts are enough.' }
      ]
    },
    {
      id: 'after-account',
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Save your IBAN in notes for quick copying when making payments',
          'Set up direct debits (débitos diretos) for utilities and taxes',
          'Add your PT-IBAN in Portal das Finanças for IRS refunds',
          'Add your PT-IBAN in Segurança Social for salary/benefits',
