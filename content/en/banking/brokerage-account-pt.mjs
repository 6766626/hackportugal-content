export default {
  ...
  tldr: 'With a Portuguese NIF you can open an account with EU brokers: DEGIRO, IBKR, Trading 212, XTB. Check whether the intermediary is registered with the CMVM or operates under an EU passport, who holds the assets, and which compensation scheme applies: the Portuguese SII covers up to €25,000, but foreign brokers usually fall under the scheme of the licensing country. For US shares, complete W-8BEN: dividend withholding is usually 15% instead of 30%. A Portuguese tax resident declares foreign dividends, interest and trades in IRS, most often via Anexo J.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'NIF on its own does not create a “Portuguese brokerage account”. Most popular platforms open an account with a foreign EU legal entity and serve clients from Portugal under the prestação de serviços / livre prestação de serviços mechanism — EU passport. This is normal, but it is important to understand exactly who your broker is.' },
    ...
    {
      id: 'documents',
      title: '2. What you need to open an account',
      content: [
        { kind: 'paragraph', text: 'For an expat in Portugal, standard broker KYC takes from a few minutes to a few days. NIF is required as a tax identifier; if you are already a Portuguese tax resident, specify Portugal as your tax residence.' },
        { kind: 'checklist', items: [
          'NIF — the Finanças taxpayer number.',
          'Identity document: passport, cartão de residência / residence permit, Cartão de Cidadão for Portuguese citizens.',
          ...
          'For US securities — W-8BEN, if the broker gives access to US shares/ETFs.'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'W-8BEN is a form for US non-resident individuals. It is needed so the broker applies the US–Portugal tax treaty to dividends on American shares. Without the form, standard US withholding is often 30%; with a correct W-8BEN for a Portuguese resident it is usually 15% on dividends.' },
        { kind: 'checklist', items: [
          'Completed inside the broker interface; usually there is no need to send a paper form.',
          'Enter your legal name as in your document, country of citizenship, residential address and tax residence.',
          'Foreign TIN — your NIF, if you are a Portuguese tax resident.',
          'The form is usually valid until 31 December of the third calendar year after the year of signing, provided your details have not changed.',
          ...
          'For US ETFs, the PRIIPs/KID restriction often applies to EU retail clients: many American ETFs cannot be bought directly, but you can keep positions already purchased or buy UCITS ETFs.'
        ] },
        { kind: 'warning', text: 'The 15% withheld in the US on dividends is not always the “final tax” for Portugal. In IRS you declare the gross income and tax withheld abroad; Finanças calculates the foreign tax credit within the CIRS rules.' }
      ]
    },
    {
      id: 'tax-reporting',
      ...
      content: [
        { kind: 'paragraph', text: 'A Portuguese tax resident declares worldwide income. For DEGIRO, IBKR, Trading 212 and often XTB brokers, income is usually considered foreign-source if the securities, account or paying agent are outside Portugal. In practice, most expats complete Anexo J.' },
        { kind: 'checklist', items: [
          'Dividends and interest from abroad — usually Anexo J, the quadro for rendimentos de capitais, category E.',
          'Sale of shares, ETFs, bonds, options with a foreign source — usually Anexo J, category G gains/losses.',
          'Portuguese dividends/interest already processed by a Portuguese paying agent may go through Anexo E or may already have been withheld at source; check the declaração anual do banco.',
          ...
          'The standard autonomous rate on many dividends, interest and capital gains is 28%, but you can choose englobamento if it is advantageous under your IRS scale.',
          'If you choose englobamento for part of the income, it may apply more broadly within the category; do not click the option without a calculation.',
        ...
        { kind: 'warning', text: 'The taxable base for trades is calculated in euros. If the purchase/sale is in USD or GBP, conversion at the correct exchange rate is needed. Broker reports do not always match Finanças logic: check fees, FX, corporate actions and fractional shares manually.' }
      ]
    },
    {
      id: 'protection',
      ...
      content: [
        { kind: 'paragraph', text: 'Investments are not insured against market falls. Compensation schemes do not cover losses on shares/ETFs, but rather the intermediary’s failure to return money or instruments belonging to you under certain conditions.' },
        { kind: 'checklist', items: [
          ...
          'Client securities should normally be segregated from the broker’s assets, but in insolvency there may be delays, reconciliations and legal costs.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'For accumulating ETFs, taxation usually arises on sale, not on reinvestment within the fund; for distributing ETFs, dividends are declared annually.',
          ...
          'Before leaving Portugal, update your tax residence with the broker and with Finanças; CRS will continue exchanging data according to the country stated.'
        ] }
      ]
    }
  ],
  costs: [
    { label: 'Opening an account with DEGIRO / IBKR / Trading 212 / XTB', amountEUR: 0, note: 'Usually free; fees arise on trades, FX, exchange charges, inactivity or withdrawals — depending on the tariff and the country of the legal entity.' },
  ...
  sources: [
    { title: 'CMVM — financial intermediary registers and investor warnings', url: 'https://www.cmvm.pt', kind: 'official', language: 'pt', lastRetrieved: '2026-04-28' },
