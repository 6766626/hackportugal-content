export default {
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Apple Pay and Google Pay in Portugal are standard contactless Visa/Mastercard card payments via a phone or watch. If the terminal has the contactless symbol, you can usually pay with your phone.' },
        { kind: 'checklist', items: [
          'Supermarkets: Continente, Pingo Doce, Lidl, Aldi, Auchan, Mercadona',
          'Cafés, restaurants, pharmacies, petrol stations, hotels',
          'Taxis and TVDE services, if the driver has a terminal with contactless',
          'Online shops and apps, if Apple Pay or Google Pay is available at checkout',
          'Transport ticket machines and some turnstiles where bank cards are accepted',
          'Newer-type Multibanco terminals — if contactless is enabled by the specific acquirer'
        ] },
        { kind: 'warning', text: 'Do not confuse Apple Pay/Google Pay with Multibanco. In Portugal, many everyday payments — electricity, water, telecoms, taxes — are made via entidade + referência in Multibanco/MB WAY. Apple Pay and Google Pay do not replace this system.' }
      ]
    },
    {
      id: 'supported-banks',
      ...
      content: [
        { kind: 'paragraph', text: 'Support depends not only on the bank, but also on the card type: debit/credit, Visa/Mastercard, personal/business, and sometimes even the country of issue. The most reliable test is to open Wallet/Google Wallet or the bank app and try to add the card.' },
        { kind: 'checklist', items: [
          ...
          'Revolut — one of the simplest options: a virtual/physical card is added almost immediately after opening an account',
          'Wise, N26, Openbank and other EU fintech cards usually also work if the card was issued in a supported country',
          'Cartão de refeição, corporate and prepaid cards may not be addable, even if the bank is on the list'
        ] },
        { kind: 'warning', text: 'Apple and Google lists are updated without separate notice. If a bank is on the list, this does not guarantee support for every card; if a bank is not listed, the card can sometimes still be added through an international issuer.' }
      ]
    },
    {
      id: 'apple-pay-setup',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'iphone', title: '1. Add a card on iPhone', content: [
            { kind: 'checklist', items: [
              ...
              'Verify the card via SMS, call, email or the bank app',
              'Set the card as default if you want to pay with it first'
            ] }
          ] },
          { id: 'watch', title: '2. Add a card on Apple Watch', content: [
            { kind: 'paragraph', text: 'Open the Watch app on iPhone → Wallet & Apple Pay → Add Card. The card on the watch is tokenised separately: if it is on the iPhone, that does not always mean it is already on the Apple Watch.' }
          ] },
        ...
        { kind: 'warning', text: 'The Apple ID region usually does not need to be Portugal to pay with a Portuguese card, but the device must have Face ID/Touch ID or a passcode. Without screen lock, Wallet will not let you use the card properly.' }
      ]
    },
    {
      id: 'google-pay-setup',
      ...
      content: [
        { kind: 'paragraph', text: 'In 2026, for the user, Google Pay is the Google Wallet app. In-store payment works via NFC. On some phones with Chinese firmware or without Google Services, contactless payment may not work.' },
        { kind: 'checklist', items: [
          ...
          'Scan the card or enter the details manually',
          'Verify the card through the bank: SMS, push notification, app, call',
        ...
        { kind: 'warning', text: 'Root, an unlocked bootloader, old Android versions, disabled Google Play Services or corporate MDM restrictions can block payments. The bank may still say “the card is supported”, but Google Wallet will not allow payment.' }
      ]
    },
    {
      id: 'limits-and-pin',
      ...
      content: [
        { kind: 'paragraph', text: 'In Portugal, the standard limit for a normal contactless payment with a physical card without PIN is €50 per transaction. After several small transactions in a row, the terminal or bank may request a PIN because of SCA rules.' },
        { kind: 'checklist', items: [
          'A physical contactless card up to €50 usually works without PIN',
          'A physical card above €50 almost always requires PIN',
          'Apple Pay/Google Pay use Face ID, Touch ID, fingerprint, the phone PIN or password',
          'Because of biometrics, these payments are considered authenticated and often work above €50 without the card PIN',
          'Some terminals may still ask for a PIN — this is normal, especially on older POS terminals',
          'The bank may decline an unusual transaction and ask you to repeat the payment with the card and PIN',
          'For car hire, a hotel deposit and caução, a physical credit card is sometimes required rather than Wallet'
        ] },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Payment of referências Multibanco: bills, taxes, services',
  ...
  costs: [
    { label: 'Adding a card to Apple Pay / Google Pay', amountEUR: 0, note: 'Apple and Google do not charge users a fee for adding and paying by card.' },
