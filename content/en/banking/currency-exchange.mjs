export default {
  ...
  tldr: 'It is usually best to convert via Wise, Revolut or N26 (exchange rate ≈ mid-market + 0.4-0.5%). Portuguese banks charge a 1.5-3% spread (avoid). Exchange offices at airports/in city centres — up to a 5% spread. At ATMs in Portugal, always refuse DCC and choose to be charged in EUR — then the rate is set by the card-issuing bank/card network. For large amounts (>€10,000) — bank transfer via a broker (CurrencyFair, OFX). For Russians after sanctions, routes are limited; crypto channels require VASP/CASP compliance and must not be used to circumvent sanctions.',
  tags: ['currency', 'exchange', 'wise', 'revolut', 'rub', 'usd', 'exchange rate'],
  estimatedReadMinutes: 7,
  steps: [
    {
      id: 'best-options',
      title: '💱 Best ways to exchange',
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'b2', title: 'Revolut', content: [
            { kind: 'checklist', items: [
              ...
              '💳 For Revolut customers migrated to the Portuguese branch, a PT IBAN may be available; check in the app. Non-residents/older accounts may have an LT or another IBAN',
              ...
              '💰 Limits depend on the plan and country of registration; Standard has a monthly fair-use limit, while Premium/Metal is higher or has no weekday fair-use fee'
            ]}
          ]},
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'a2', title: 'Portuguese banks (for currency exchange)', content: [
            { kind: 'checklist', items: [
              ...
              '✅ For large amounts there are better options'
            ]}
          ]},
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'After the 2022 sanctions, currency flows between the Russian Federation and the EU are heavily restricted. SWIFT is closed for most Russian Federation banks, and rouble operations in the EU are done through complex routes.' },
        { kind: 'substeps', items: [
          { id: 'r1', title: 'Via a third country', content: [
            { kind: 'checklist', items: [
              ...
              '⏱️ 3-7 days + 0.5-2% FX loss',
              '⚠️ Russian Federation rules on currency transfers and exporting cash change often; separately check Central Bank of the Russian Federation/customs limits on the date of the transaction. Do not confuse bank transfers, transfers to your own foreign accounts and exporting cash'
            ]}
          ]},
          { id: 'r2', title: 'Via cryptocurrency', content: [
            { kind: 'checklist', items: [
              '💵 USDT (Tether) — the most liquid for conversion',
              '💱 P2P crypto for RUB is heavily restricted and depends on the exchange/jurisdiction; Binance has left the Russian Federation and is not a reliable RUB-P2P route. Any crypto-to-bank cash-out in the EU requires documentary source of funds and must not be used to circumvent sanctions',
              '⚠️ In Portugal, crypto operations may fall under IRS: gains when held for <365 days are usually taxed at 28% (if not aggregated); ≥365 days — qualifying assets may be exempt. Mining/staking/profit from professional activity — separate rules. Reporting depends on the type of income, not on total turnover',
              '⚠️ AML checks can be strict in EU banks when funds come from cryptocurrency',
          ...
          { id: 'r3', title: 'Direct transfer (a few banks)', content: [
            { kind: 'checklist', items: [
              ...
              '⚠️ Most large Russian Federation banks (Sber, VTB, Alfa) are blocked for SWIFT (Reg 833/2014 art. 5h)',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '⚖️ **AT declaration**: foreign bank accounts of a Portuguese resident are declared in the annual **Modelo 3 IRS, Anexo J, Quadro 11** (IBAN + country), and NOT in Modelo 38. Modelo 38 is separate reporting for Portuguese financial institutions on transfers by residents to countries outside the EU, not for individuals. There is no “€50,000 threshold” for resident individuals — Anexo J Quadro 11 is mandatory regardless of the balance',
          '📊 **Portuguese IRS**: exchange-rate gains on currency transactions are taxed as “mais-valias” (28%)',
          '⚠️ **Tax resident**: if you became resident in Portugal and sold assets abroad — IRS on the gain',
          '🌐 **CMVM regulator**: the broker must be licensed in the EU; check cmvm.pt',
          '💰 **Cash flow**: have a EUR reserve for 3-6 months of living costs, do not depend on currency movements'
        ]}
      ]
    },
    {
