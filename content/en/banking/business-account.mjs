export default {
  ...
  tldr: 'A business account is mandatory for Recibo Verde (sole trader) from €25,000/year turnover and always for Lda (LLC). Banks Millennium BCP, Santander Totta, Caixa Geral, BPI support sole traders. For Lda — the same plus ActivoBank Empresas (online). Required: NIF + Início de Atividade or Lda registration + share capital (capital social). Cost: €5–€15/month for maintenance + transfer fees. Important: do not confuse a sole-trader account (a personal account can be used) with the mandatory corporate account for Lda.',
  ...
  steps: [
        ...
        { kind: 'substeps', items: [
          { id: 'ind', title: 'Sole trader (Recibo Verde)', content: [
            { kind: 'checklist', items: [
              '🟢 Up to €25,000/year turnover: a personal account is sufficient, but for bookkeeping it is recommended to separate business transactions',
              ...
              '⚠️ A sole-trader account may be an ordinary personal account in your name. Separate bookkeeping is not required unless AT requests it'
            ]}
          ]},
          { id: 'lda', title: 'Sociedade por Quotas / Lda (LLC)', content: [
            { kind: 'checklist', items: [
              '✅ A corporate account is always mandatory — a separate account in the company’s name',
              '💰 Minimum share capital (capital social): €1 (but banks often require ≥ €1,000 to open)',
              ...
              '⚠️ Do not mix with personal funds — this is treated as a withdrawal (levantamento de fundos) and is subject to IRS'
            ]}
          ]}
        ]}
      ]
        ...
        { kind: 'substeps', items: [
          { id: 'b1', title: 'Traditional banks', content: [
            { kind: 'checklist', items: [
              ...
              '🏛️ **BPI Empresas** — a competitive option for mid-sized Lda',
          ...
          { id: 'b2', title: 'Online banks', content: [
            { kind: 'checklist', items: [
              '💻 **ActivoBank Empresas** — subsidiary of Millennium, focused on online service',
              '💻 **Caixadirecta Empresas** (CGD) — online channel of the state bank',
              '🌐 **Wise Business** — for international payments, but no Portuguese IBAN; not suitable for Lda',
              '🌐 **Revolut Business** — partially works, Lithuanian IBAN; transfers within Portugal may face issues',
              '⚠️ Lda requires a Portuguese IBAN — some fintech services are not suitable'
            ]}
          ]},
          { id: 'b3', title: 'Specialised', content: [
            { kind: 'checklist', items: [
              ...
              '🇪🇺 **EuroBic / Bankinter** — premium pricing for high-net-worth clients'
            ]}
          ]}
        ]}
      ]
    ...
    {
      id: 'documents',
      title: '📋 Documents required to open',
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'd2', title: 'For Lda (LLC)', content: [
            { kind: 'checklist', items: [
              '📄 **Pacto Social** — articles of association of the Lda',
              ...
              '📃 **Beneficial Owners (RCBE)** — mandatory declaration of ultimate beneficial owners',
              '🏢 Proof of registered address (Comprovativo de sede): office/virtual office address',
              '⚠️ For foreign founders — apostilled documents from their country'
            ]}
          ]}
        ]}
      ]
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'p1', title: 'For sole traders — simple', content: [
            { kind: 'checklist', items: [
              '📅 Book an appointment with the bank (online or by phone)',
              '🏛️ Attend with documents — meeting 30–45 minutes',
              '✍️ Sign the agreement',
              '💳 Receive debit card (delivered by post in 7–10 days)',
              '🔐 Activate online banking',
              '⏱️ Total timeline: 1–2 weeks'
            ]}
          ]},
          { id: 'p2', title: 'For Lda — longer', content: [
            { kind: 'checklist', items: [
              '🏛️ **Step 1**: Register the Lda via “Empresa na Hora” (60 minutes, €360) or Conservatória (5–10 days, €220)',
              '🆔 **Step 2**: Obtain the company NIF automatically after registration',
              '📃 **Step 3**: RCBE declaration (online at IRN, 5 days)',
              '🏦 **Step 4**: Book with the bank — meeting 1–2 hours',
              '💰 **Step 5**: Block the share capital (capital social)',
              '📩 **Step 6**: Registration with AT (company Início de Atividade)',
              '✅ **Step 7**: Activate online banking',
              '⏱️ Total timeline: 2–4 weeks'
            ]}
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🌐 **International transfer**: €25–€50 + 0.5–1% FX spread',
          '💱 **Currency conversion**: 1–3% spread (up to 5% at traditional banks!)',
          '🏧 **ATM withdrawal**: free at your bank, €0.50–€2 at others',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '🤝 Attend the meeting with your accountant — they will help you choose the right package',
          '💰 Negotiate fees — especially for businesses > €50,000/year',
          '📋 Ask for tariffs in writing before signing',
          '🔄 You can switch banks at any time, but international clients may lose built-up standing',
          '🌍 For businesses with foreign clients: Wise Business (additional currencies) + a local Portuguese account for Lda',
  ...
  costs: [
    ...
    { label: 'Opening a corporate Lda account', amountEURMin: 0, amountEURMax: 50 },
    { label: 'Monthly maintenance', amountEURMin: 5, amountEURMax: 25 },
    { label: 'Empresa na Hora (Lda registration)', amountEUR: 360 },
    { label: 'Conservatória: Lda registration (classic)', amountEUR: 220 },
