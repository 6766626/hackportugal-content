export default {
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'If the goal is only to buy BTC/ETH for the long term, choose an exchange with clear SEPA, 2FA and CSV export, not the maximum number of tokens.'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Almost all major exchanges in 2026 require full identification. NIF is not always required on the first screen, but it is worth adding it straight away: this reduces the risk of manual review when withdrawing to a Portuguese bank and helps with tax history.' },
        { kind: 'checklist', items: [
          'NIF — Portuguese tax number; enter the same one as in the bank and on Portal das Finanças.',
          ...
          'Address in Portugal: contrato de arrendamento, fatura de água/luz/internet, declaração da Junta de Freguesia or bank statement.',
          'Selfie / liveness-check — phone camera, no glasses or filters; the name in the document must match the account.',
    ...
    {
      id: 'funding',
      title: '3. Funding and withdrawal: card, SEPA, Portuguese bank',
      content: [
        { kind: 'paragraph', text: 'The cheapest and cleanest route is a SEPA transfer from your Portuguese IBAN to the exchange and back. A card is convenient for the first purchase, but more expensive and more often triggers limits. MB WAY is rarely supported directly; it usually works only as a way to top up a card/account at the bank, not the exchange.' },
        { kind: 'checklist', items: [
          'SEPA transfer: usually €0-1 from the bank side, crediting from a few minutes to 1 working day, but it depends on the exchange and instant SEPA.',
          'Debit card: convenient, but the fee is often 1–4% plus spread; the bank may decline a crypto merchant.',
          'Credit card: not recommended — higher risk of blocking, cash-advance fee and questions from the bank.',
          'Withdrawal to PT IBAN: withdraw only to an account in your own name; save the PDF/CSV confirmation of the transaction.',
          'Large amounts: prepare in advance comprovativo de rendimentos, payslips, IRS returns, an asset sale agreement or the crypto purchase history.',
          ...
          'When buying USDT/USDC, take into account issuer risk and that a “stablecoin” is not the same as a bank deposit.'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Since 2023, Portugal has introduced special rules for criptoativos in IRS. For a private investor, the key point is: gain from selling crypto held for less than 365 days is usually taxed as mais-valias at 28% or may be included in englobamento. If the asset was held for 365 days or more, gain on ordinary crypto assets is often exempt, but exceptions may apply for tokens classified as securities and for transactions in a professional regime.' },
        { kind: 'checklist', items: [
          ...
          'Income from mining, staking, liquidity provision, airdrops, referrals may fall under a different regime from a simple sale of BTC.',
          ...
          'Keep the purchase date and price, sale date and price, fees, txid, exchange CSV, bank statements.',
          'IRS for 2025 income is filed in 2026 via Portal das Finanças, usually from 1 April to 30 June.',
          'The NIF on the exchange must match the NIF in declaração de IRS.',
          'If you became a resident of Portugal in the middle of the year, separate transactions before and after the date of tax residence.'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The main mistake expats make is to buy crypto, change country, phone and bank, and then 2 years later have neither CSV, nor access to 2FA, nor proof of purchase. For Portugal, this is a problem not only for security, but also for taxes/bank.' },
        { kind: 'checklist', items: [
          ...
          'Keep KYC confirmations: not a screenshot of the document, but the verification date, exchange entity, email notifications.',
  ...
  costs: [
    { label: 'SEPA top-up', amountEURMin: 0, amountEURMax: 1, note: 'Typically from the bank side; the exchange may charge a separate fee or spread.' },
    ...
    { label: 'IRS tax on gain <365 days', amountEURMin: 0, amountEURMax: 28, note: 'Usually 28% of the gain, not of the entire sale amount; englobamento under the progressive IRS scale is possible.' },
    { label: 'Contabilista for a return with crypto', amountEURMin: 80, amountEURMax: 250, note: 'Indicative price for IRS with Anexo G/J and exchange exports; complex DeFi may cost more.' }
  ],
  sources: [
