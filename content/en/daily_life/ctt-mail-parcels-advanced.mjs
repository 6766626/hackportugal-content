export default {
  ...
  tldr: 'Forwarding when moving: **Reencaminhamento Postal** — 3 months (€17.55), 6 months (€28.90), 12 months (€51.30). **Reserva domiciliária** — holding mail at the post office for up to 2 months (€9.60). Parcels from non-EU countries: IVA 23% + customs duty from €150. Customs clearance — on ctt.pt via “Desalfandegamento Online” in 5 min, €5 fee per parcel + IVA on value+shipping. Lost parcel — CTT online assistant, compensation up to €50.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'When changing address in Portugal (internal move) or leaving for abroad — CTT will forward all incoming correspondence.' },
        { kind: 'substeps', items: [
          { id: 'f1', title: 'Reencaminhamento Postal (forwarding)', content: [
            { kind: 'checklist', items: [
              ...
              'Registered items (registada) → the notice goes to the new address, the parcel itself — to the original branch, it must be collected'
            ]}
          ]},
          ...
          { id: 'f3', title: 'Mudança de Morada — official', content: [
            { kind: 'paragraph', text: 'Do not confuse this with reencaminhamento. Changing address with Finanças, IRN, AIMA — via ePortugal “Mudança de morada” free of charge, but it changes official records, not postal delivery.' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Arrive in 2-7 days by standard delivery',
          'Tracking: on ctt.pt by number or via the CTT app',
          'If you were not at home: notice (“aviso”) in the letterbox, 14 days to collect at the branch',
        ...
        { kind: 'substeps', items: [
          { id: 'p1', title: '💰 Taxes', content: [
            { kind: 'checklist', items: [
              ...
              '**Customs duty**: on goods > **€150** (value + shipping). The rate depends on the product’s TARIC code — 0-17% for most, up to 50% for clothing in certain categories',
              '**Extra CTT costs**: €5 handling fee + €1-3 for an additional operation',
              'Example for a €100 parcel (no customs duty, up to €150): €23 IVA + ~€5 CTT fee = ~€28 additional costs on top of the item value',
          ...
          { id: 'p3', title: '⚠️ When problems may occur', content: [
            { kind: 'checklist', items: [
              ...
              'Counterfeit branded goods — confiscation + fine for the sender',
    ...
    {
      id: 'iossi',
      title: '🌐 IOSS — the easy route',
      content: [
        { kind: 'paragraph', text: 'IOSS (Import One-Stop Shop) — a system since 2021 allowing retailers from non-EU countries to charge IVA at the time of purchase. For the consumer = trouble-free receipt.' },
        { kind: 'checklist', items: [
          ...
          '❌ **Russian shops, Wildberries before sanctions, private sellers** — no IOSS, still customs clearance',
    ...
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'i1', title: 'Parcel lost', content: [
            { kind: 'checklist', items: [
              'Tracking shows "Delivered", but there is nothing → check with the concierge, neighbours',
              ...
              'International items via EMS — the sending country will pay you additionally'
            ]}
          ]},
          { id: 'i2', title: 'Parcel delayed in customs', content: [
            { kind: 'checklist', items: [
              ...
              'Sometimes you need to send the invoice to CTT manually (to e-mail desalfandegamento@ctt.pt)',
  ...
  costs: [
    ...
    { label: 'CTT handling fee', amountEUR: 5, note: 'per parcel' },
