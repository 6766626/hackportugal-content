export default {
  ...
  tldr: 'In Portugal there are 3 essential services: electricity, water, gas (if connected)\.\n\nElectricity and gas are a liberalised market: you can choose the supplier yourself, for example EDP, Galp, Iberdrola, Endesa and others. Water is always a municipal service (EPAL in Lisboa)\.\n\nSwitching supplier is free and happens without interruptions. Transferring contracts to a new address when moving takes 5–15 days, with no penalty, under Decreto-Lei 38/2017.',
  ...
  steps: [
        ...
        { kind: 'substeps', items: [
          ...
          { id: 's2', title: '2. Choose power capacity (potência)', content: [
            { kind: 'checklist', items: [
              ...
              '6.90 kVA — 3-bedroom flat with air conditioning and electric hob',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '📊 Meter readings — once every 2 months, yourself or by phone'
        ]},
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '📅 Switch is automatic — maximum 3 weeks',
          '💡 Electricity is not interrupted even for a minute',
          '💰 There is no switching fee',
          '🔒 The old contract is closed automatically, the new supplier takes over the process',
    ...
    {
      id: 'move',
      title: 'Moving home — transferring the contract',
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'm2', title: 'New supplier in the new home', content: [
            { kind: 'paragraph', text: 'If the previous resident left a contract, you close it with a request and set up your own immediately. No delays.' }
          ]},
          { id: 'm3', title: 'Disconnected after a long break', content: [
            { kind: 'paragraph', text: 'Reconnection is needed: €50–100 + technician on site. Timeframe — up to 15 days. If the meter is old, replacement is mandatory.' }
          ]}
        ]}
      ]
    },
  ...
  costs: [
    ...
    { label: 'Reconnection of a disconnected service', amountEURMin: 50, amountEURMax: 100 }
  ],
  sources: [
