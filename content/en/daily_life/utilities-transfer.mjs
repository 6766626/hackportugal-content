export default {
  ...
  tldr: 'In Portugal there are 3 essential utilities: electricity, water, gas (if connected). Electricity and gas are liberalised markets: you can choose the supplier yourself, for example EDP, Galp, Iberdrola, Endesa and others. Water is always a municipal service (EPAL in Lisboa). Switching supplier is free and happens without interruptions. Transferring contracts to a new address when moving takes 5–15 days, with no penalty, under Decreto-Lei 38/2017.',
  tags: ['electricity', 'gas', 'water', 'edp', 'galp', 'iberdrola'],
  estimatedReadMinutes: 6,
  steps: [
    {
      id: 'market',
      title: 'Regulated and liberalised markets',
      content: [
        { kind: 'paragraph', text: 'Electricity and gas in Portugal have been liberalised since 2015 — the supplier can be any company and prices are free. At the same time, since 2021 the regulated tariff has returned for vulnerable customers: elderly people and people on low incomes.' },
    ...
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 's2', title: '2. Choose power capacity (potência)', content: [
            { kind: 'checklist', items: [
              '3.45 kVA — small flat without high-power appliances',
              '4.60 kVA — standard 2-bedroom flat',
              '6.90 kVA — 3-bedroom flat with air conditioning and an electric hob',
          ...
          { id: 's3', title: '3. Tariff (tarifa)', content: [
            { kind: 'checklist', items: [
              ...
              'Bi-horária — daytime / night-time (from 22:00 to 08:00)',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '💻 Online via the supplier’s website or call centre',
          '📞 Payment: monthly direct debit or referência Multibanco',
          '📅 Connection: 2–10 working days',
          '📊 Meter readings — once every 2 months, submitted yourself or by phone'
        ]},
        { kind: 'warning', text: 'A new connection requires the building’s Certificado Energético (renewed every 10 years). In old buildings it is often not up to date — sort this out with the landlord / owner.' }
      ]
    },
    {
      id: 'change',
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '📝 You need: NIF, CPE / CUI (on the bill), IBAN',
          ...
          '📊 Final bill from the old supplier — after the last reading'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'm1', title: 'Keep the old supplier but change address', content: [
          ...
          { id: 'm2', title: 'New supplier in the new home', content: [
            { kind: 'paragraph', text: 'If the previous occupant left a contract in place, you close it by submitting a request and immediately set up your own. No delays.' }
          ]},
          { id: 'm3', title: 'Disconnected after a long gap', content: [
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '📋 Livro de Reclamações (complaints book) — paper version or at livroreclamacoes.pt',
          ...
          '🚫 Cutting off electricity without notice is prohibited; compensation is due',
          '📅 Delays in refunds / credit >30 days — supplier penalty'
        ]}
      ]
    }
  ],
