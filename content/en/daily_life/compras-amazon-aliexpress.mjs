export default {
  ...
  tldr: 'For Portugal, the most predictable option is Amazon.es: delivery from EU warehouses is usually 2–5 working days, with no customs clearance or duties. Amazon PT is convenient for its interface/local deals, but the catalogue is smaller. AliExpress is cheap, often with IVA included in the price via IOSS, but delivery from China can take 3–8 weeks. Since 01/07/2021, commercial parcels from outside the EU have been subject to IVA: in mainland Portugal the standard rate is 23%; above €150, a customs declaration, possible duty and CTT/courier fees are added.',
  tags: ['amazon', 'aliexpress', 'ctt', 'customs duties'],
 ReadMinutes: 6,
  steps: [
    {
      id: 'platforms',
      title: 'Where to shop without surprises',
      content: [
        { kind: 'paragraph', text: 'The main rule: if the item is shipped from a warehouse inside the EU and the seller treats the sale as an EU sale, there is no customs clearance in Portugal. You pay the price with IVA at the time of purchase, and the courier simply delivers the parcel.' },
        { kind: 'checklist', items: [
          ...
          'Amazon PT / the Portuguese Amazon storefront — more convenient for language and local selections, but the catalogue is smaller, and some items still go through Amazon.es or other EU sellers.',
          ...
          'AliExpress/eBay EU warehouses — Spain, France, Germany, Poland, Czechia — usually no customs clearance, if the item is genuinely dispatched from there.',
          ...
          'Madeira and Açores have their own tax features and logistics; delivery times and rates may differ from mainland Portugal.'
        ] }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'The €150 threshold for duty is calculated on the item’s intrinsic value: usually the price of the goods excluding delivery and insurance.',
          'The IVA base is wider: item value + delivery + insurance + duties + customs/postal fees, if they are included in the import base.',
          'Gifts from one private individual to another have a separate €45 limit, but marketplace purchases do not qualify for this.',
          'If the seller writes “gift” on a commercial order, this does not cancel IVA and may trigger a check.',
          'For alcohol, tobacco, perfume, batteries, medicines, food supplements, drones and radio devices, restrictions or additional documents may apply.'
        ] },
        { kind: 'warning', text: 'Do not rely on old advice saying “under €22 tax-free”. This rule was abolished in the EU on 01/07/2021. In 2026, CTT and couriers may still request IVA and a clearance fee if the platform did not transmit the IOSS data correctly.' }
      ]
    },
    {
      id: 'ctt-clearance',
      ...
      content: [
        { kind: 'paragraph', text: 'If a parcel from outside the EU arrives by regular post, it is almost always handled by CTT. status may change to “A aguardar procedimentos declarativos” or “Desalfandegamento”. You then need to go to the CTT portal, confirm the details and pay the charges.' },
        { kind: 'checklist', items: [
          ...
          'Pay the IVA, possible duty and CTT serviço de apresentação/desalfandegamento online.',
          'After payment, the parcel is usually released and moves to delivery; during peak periods the delay may be 3–10 working days.',
          'If you do not provide the documents in time, the parcel may be returned to the sender.'
        ] },
        { kind: 'warning', text: 'CTT does not “invent the tax”: it collects amounts under the import rules of the Autoridade Tributária e Aduaneira. But mistakes happen — especially when the shop collected IVA via IOSS and the IOSS number did not make it into the postal data. In that case, submit the invoice and dispute it through the CTT portal before paying, if the system allows it.' }
      ]
    },
    {
        ...
        { kind: 'substeps', items: [
          {
            ...
            content: [
              ...
              { kind: 'checklist', items: [
                ...
                'Amazon returns are usually easier than on AliExpress/eBay, especially if the seller is Amazon or an EU business seller.',
                'Do not confuse the item price and delivery cost: sometimes a cheap item with expensive delivery loses out to a local shop.'
              ] }
            ]
          },
          {
            ...
            title: 'AliExpress',
            content: [
              { kind: 'paragraph', text: 'AliExpress is good for small items: cases, cables, spare parts and hobby goods. Economy delivery from China is often free, but the real timeframe is 3–8 weeks. AliExpress Choice and EU-warehouse can be faster — sometimes 7–15 days.' },
              { kind: 'checklist', items: [
                ...
                'For electronics, check CE marking, EU plug and real reviews with photos.',
                'If you need the item by specific date, AliExpress is a poor option.'
              ] }
            ]
          },
          {
            ...
            content: [
              ...
              { kind: 'checklist', items: [
                ...
                'For private sellers, the invoice may be weak — CTT will still ask for proof of PayPal/card payment.',
                'For used equipment from outside the EU, IVA is often charged on the actual price paid + delivery.',
                'Calculate expensive purchases above €150 in advance: it is sometimes better to buy in the EU at a higher price, but without customs hassle.'
              ] }
            ]
          }
        ] }
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'If the item is above €150: add 23% IVA, possible duty by product category and a brokerage fee.',
          ...
          'If the difference compared with an EU shop is less than €15–€25, it is usually better to buy in the EU: faster, easier returns, less risk.'
        ] },
        { kind: 'warning', text: 'Do not ask the seller to understate the value. If CTT/Alfândega requests a card or PayPal statement, the tax will be recalculated based on the real payment; if there is suspicion, delays, penalty consequences or return of the parcel may occur.' }
      ]
    }
  ],
  costs: [
    ...
    { label: 'Standard Amazon.es delivery to Portugal mainland', amountEURMin: 0, amountEURMax: 8, note: 'Depends on Prime, order value, seller and item; typical timeframe is 2–5 working days.' },
    { label: 'AliExpress economy delivery from China', amountEURMin: 0, amountEURMax: 5, note: 'Often free or cheap; typical timeframe is 3–8 weeks, faster with Choice/EU-warehouse.' },
