export default {
  ...
  tldr: 'Universidade Sénior is the Portuguese U3A format: daytime courses for older people, without exams or diplomas. There are 200+ such schools across the country, many of them part of the RUTIS network and run by Câmaras Municipais, Juntas de Freguesia, IPSS or associations. Typical cost in 2026: inscrição €10-30 and mensalidade €30-50 for many classes: línguas, cultura, informática, dança, artes, saúde. Registration is usually through the Câmara/Junta or directly at the school secretaria.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Universidade Sénior is not a university in the academic sense, but a local educational and social project for older people. The format is similar to U3A: classes for social contact, activity and learning, without entrance exams, grades or an official degree.' },
        ...
        { kind: 'checklist', items: [
          ...
          'pensioner status is often NOT mandatory: age and available places matter more',
          ...
          'for foreigners, this is a good way to practise Portuguese and enter the local community'
        ] }
      ]
    },
    {
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Start with RUTIS and your Câmara Municipal website. If there is no separate Universidade Sénior in the municipio, a similar programme may be called Academia Sénior, Universidade da Terceira Idade, Espaço Sénior, Programa Envelhecimento Ativo or Atividades Sénior.' },
        { kind: 'checklist', items: [
          'open rutis.pt and check the Rede de Universidades Seniores list/contacts',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Registration is usually offline: at the Universidade Sénior secretaria, balcão da Câmara Municipal, Junta de Freguesia or IPSS office. There may be an online form, but not everywhere. Intake usually opens in June-September for the new academic year; free places may appear in January.' },
        { kind: 'checklist', items: [
          ...
          'foto tipo passe — sometimes requested for a cartão de aluno',
          'list of chosen disciplines or horário pretendido',
        ...
        { kind: 'warning', text: 'Not all schools accept people from a neighbouring município at the same price. Municipal projects may give priority to residentes da freguesia/concelho and ask for comprovativo de morada.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The typical model is a small annual registration fee plus a mensalidade. In 2026, for ordinary municipal/association-run schools, a realistic range is €30-50 per month for access to several or “unlimited” classes according to the timetable. In some Câmaras, the price is lower or symbolic if the programme is funded by the municipality.' },
        { kind: 'checklist', items: [
          'inscrição is usually paid once a year',
          'mensalidade may not be charged in August if there are no classes',
          'materials for pintura, cerâmica, fotografia and excursões are often paid separately',
          'classes may be cancelled if there are not enough students or no teacher',
          'the voluntary format means less bureaucracy, but also less “service” than in a private school',
  ...
  costs: [
    ...
    { label: 'Mensalidade', amountEURMin: 30, amountEURMax: 50, note: 'Typical monthly range in 2026 for several disciplines or “unlimited” access according to the school timetable.' },
