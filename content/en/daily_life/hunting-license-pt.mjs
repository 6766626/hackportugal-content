export default {
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'In Portugal, “being able to shoot” is not enough. Hunting is regulated by ICNF and hunting areas, while firearms are regulated by PSP. These are two different systems: a Carta de Caçador does not give you the right to own a shotgun, and a firearms licence does not give you the right to hunt.' },
        { kind: 'checklist', items: [
          'Carta de Caçador — hunter certificate, usually required for residents after the ICNF exam',
          'Licença de caça — annual/seasonal hunting licence; without it, a Carta de Caçador on its own does not give you the right to go hunting',
          'Seguro de responsabilidade civil — compulsory hunter civil liability insurance for third parties',
          'The right to hunt in a specific area: zona de caça associativa, turística, municipal or national territory with a valid calendário venatório',
          ...
          'For bringing firearms from abroad: separate PSP/customs rules; a European Firearms Pass on its own does not replace a hunting authorisation',
          'Compliance with bag limits, species, season dates and firearm transport rules'
        ] },
        { kind: 'warning', text: 'You cannot legalise hunting “retroactively”. If GNR/ICNF checks you without a valid licença de caça, insurance or right to use the area, this is an administrative offence; firearm-related breaches may lead to criminal liability and seizure of the firearm.' }
      ]
    },
    {
      id: 'resident-carta',
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Prepare the topics: game species, closed seasons, hunting areas, safety, firearms, dogs, liability',
          ...
          'Arrange the annual licença de caça and insurance separately — without them you cannot go hunting',
          'If you plan to hunt with a firearm, start the PSP process for LUPA in parallel'
        ] },
        { kind: 'warning', text: 'A Carta de Caçador is not a “firearms licence”. Even with a Carta de Caçador, you cannot buy or keep a hunting shotgun without the PSP procedure under Lei 5/2006.' }
      ]
    },
    {
      id: 'non-resident',
      ...
      content: [
        { kind: 'paragraph', text: 'For foreigners who do not live permanently in Portugal, there is a simplified regime: licença especial de caça para não residentes. You usually need to prove that you already have the right to hunt in your country of residence/nationality, and arrange Portuguese liability insurance.' },
        { kind: 'checklist', items: [
          'Valid passport or ID',
          'Document proving your right to hunt in your country: hunting licence / hunter card / hunter permit',
          'Translation or explanation of the document if it is not in PT/EN/ES/FR; in practice, the hunt organiser often helps',
          ...
          'Confirmation of hunting in a specific area: invitation, contract with a zona de caça turística/associativa or organiser',
          'If bringing a firearm from the EU: European Firearms Pass + invitation/basis for the trip + compliance with PSP rules',
          'If bringing a firearm from a third country: check the temporary PSP authorisation and customs regime in advance; do not bring a firearm “just in case”'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Compulsory insurance is one of the documents most often checked on site. It must cover the hunter’s civil liability to third parties in Portugal. The policy is usually taken out for the season; hunting clubs and organisers often sell a “licença + seguro” package.' },
        { kind: 'checklist', items: [
          'Check that the policy expressly states hunting/atividade cinegética, not just sport or travel',
          'Take a paper or offline copy of the policy with you: in rural areas the internet is often unstable',
          'Before travelling, check the ICNF calendário venatório for the current season: species, dates, limits and permitted methods',
          'Clarify the type of area: municipal, associativa, turística or outra; access rules differ',
          'Do not rely on “locals said it is allowed”: you need the area documents or accompaniment by a responsible organiser',
          ...
          'After hunting, keep documents on the bag/authorisation if the area requires reporting'
        ] },
        { kind: 'warning', text: 'The calendário venatório changes by season. Hunting dates for rabbit, wild boar, partridge, pigeon and other species cannot be carried over from last year’s PDF or Facebook advice.' }
      ]
    },
    {
      id: 'firearms-psp',
      title: 'Firearms: separate PSP licence',
      content: [
        { kind: 'paragraph', text: 'Firearms are controlled by Polícia de Segurança Pública (PSP). For hunting this usually means classes C/D under Lei 5/2006, but the specific category depends on the type of firearm. The process includes suitability checks, training, firearm registration and storage requirements.' },
        { kind: 'checklist', items: [
          'Apply for a Licença de Uso e Porte de Arma (LUPA) with PSP/SIGAE or through an available PSP channel',
          ...
          'Prove the need for the firearm: hunting, sport shooting or another lawful purpose',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The safest route is first to decide whether you are a resident hunter or a guest on a single trip. For one organised hunt, it is almost always cheaper and faster to use the non-resident licença especial and a local organiser. For living in Portugal and hunting regularly — Carta de Caçador + annual licença + PSP, if you need your own firearm.' },
        { kind: 'checklist', items: [
          'If you live in Portugal: start with the ICNF Carta de Caçador, then licença de caça and insurance',
          ...
          'Always keep a set of documents in the car and on you: ID, Carta/licença, seguro, firearm documents, area authorisation',
          'Do not mix hunting and alcohol: in an incident this aggravates liability and the insurance dispute',
  ...
  costs: [
    ...
    { label: 'Annual licença de caça', amountEURMin: 30, amountEURMax: 80, note: 'Guide amount for a regional/national licence; the sum changes according to licence type and season.' },
    ...
    { label: 'Organised hunting package for a non-resident', amountEURMin: 100, amountEURMax: 500, note: 'Excluding flights and accommodation; depends on the area, type of hunt, accompaniment and included documents.' },
    { label: 'PSP firearms procedure', amountEURMin: 50, amountEURMax: 250, note: 'State fees, training, medical/psychological checks and documents; does not include the cost of the firearm, safe and ammunition.' }
  ],
  sources: [
