  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'A horta comunitária is a municipal or neighbourhood allotment where residents are given a small talhão: a plot for vegetables, herbs and sometimes flowers. Usually this is not land rental in the classic sense, but a temporary right of use under the rules of the Câmara Municipal or Junta de Freguesia.' },
        { kind: 'paragraph', text: 'The format is especially popular in Lisboa, Cascais, Porto, Loures, Almada, Oeiras, Sintra and other municípios. The aim is not commercial farming, but self-sufficiency, ecology, neighbourly contact and the use of vacant urban land.' },
        { kind: 'checklist', items: [
          'People grow vegetables, herbs, berries and aromatic plants',
          'The plot is usually small: enough for a family, but not for selling produce',
          ...
          'The plot must be worked regularly: abandoned talhões are taken back',
          'There are shared cleaning, composting and training days',
    ...
    {
      id: 'where-to-apply',
      title: 'Where to find a programme in your município',
      content: [
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'other-municipios', title: 'Porto, Loures, Almada and others', content: [
            { kind: 'paragraph', text: 'In Porto, neighbourhood hortas can be found within reabilitação urbana and bairros programmes; Loures and Almada have municipal hortas urbanas/comunitárias. Names and application forms differ, but the logic is the same: resident of the município, documents, queue, rules of use.' }
          ] }
        ] }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Comprovativo de morada: tenancy agreement, luz/água/internet bill, atestado de residência from the Junta de Freguesia',
        ...
        { kind: 'warning', text: 'If you moved recently and the address on your NIF is still old, first update your morada in Finanças. Many municípios check the address against the tax profile specifically, not only against the tenancy agreement.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The process is not fast. In popular areas of Lisboa, Cascais and Porto, free talhões appear after withdrawals, moves or expansion of the network. A realistic waiting time in 2026 is 6–12 months; in central freguesias and by the sea it may be longer.' },
        { kind: 'checklist', items: [
          ...
          'Choose a preferred horta if the form allows it',
          'Save the application number or confirmation email',
          'Check the status every 2–3 months, but do not submit duplicates without reason',
          'When you are invited, sign the termo de responsabilidade/regulamento',
          'Pay the first fee if one is provided for',
          'Receive your talhão number and access instructions'
        ] },
        { kind: 'warning', text: 'Do not buy tools and seedlings in advance. A place in the queue does not guarantee a specific date, and the municipality may offer a plot in another horta or ask you to confirm that you still live in the concelho.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'A horta comunitária is not a country house. The land is shared, the water is shared, and neighbours are nearby. A good reputation matters: if you do not follow the rules, the plot may be passed to the next person in the queue.' },
        { kind: 'checklist', items: [
          'Do not use chemical herbicides and insecticides',
          'Do not occupy other people’s beds, paths or shared areas',
          'Do not sell the produce as a commercial product if the rules prohibit it',
          'Water sparingly: in summer, Portugal can have water restrictions',
          'Do not leave plastic, rubbish, old pots or building materials',
          'Respect the horários de funcionamento if the horta is locked',
          'Take part in dias comunitários: cleaning, compost, path repairs',
          'Tell the coordinator about pests, a broken tap or a conflict',
          'If you are leaving for the summer, arrange watering or give official notice',
          'If you can no longer care for the plot, give it up in writing'
        ] },
        { kind: 'paragraph', text: 'For expats, a horta is a good way to become part of the bairro: neighbours will tell you what actually grows in your zone, when to plant couve, tomate, coentros, alface and how to deal with caracóis without chemicals.' }
      ]
    },
    {
      id: 'alternatives',
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Ask at the associação de moradores in your bairro',
          'Look for “horta pedagógica” — sometimes volunteers are needed without an individual plot',
          'Check neighbourhood Facebook groups: private shared gardens sometimes appear',
          'If you have a varanda, start with vasos: ervas aromáticas, tomate cherry, morangos',
          'Check the condomínio rules with your landlord for pots on the balcony',
          'For children, look for hortas escolares or oficinas ambientais at the Câmara',
          'In the suburbs, it is sometimes cheaper to agree with a neighbour on a small terreno, but put it in writing'
        ] },
        { kind: 'warning', text: 'Do not occupy an empty plot without permission. In Portugal, a lot of land looks “ownerless”, but it has an owner: Câmara, Estado, a private owner or condomínio. Planting without permission can end in a complaint and removal.' }
      ]
    }
  ],
  costs: [
