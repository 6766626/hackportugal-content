export default {
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'When using it, you may be asked for a passport, residence permit or Cartão de Cidadão to check age and name'
        ] }
      ]
    },
    {
      id: 'eligibility',
      title: 'Who can get it in Portugal',
      content: [
        { kind: 'paragraph', text: 'For a foreigner, the key conditions are simple: live in Portugal and be under 30. Portuguese citizenship is not required. It suits students, people working on D1/D3, digital nomads on D8, family members, EU citizens with CRUE and other residents.' },
        { kind: 'checklist', items: [
          'Passport or another document with date of birth',
        ...
        { kind: 'warning', text: 'If you have already turned 30, a new card is usually not issued. If you bought the card at age 29, check the validity period in your personal account: the partner checks the card validity and the age conditions of their own offer.' }
      ]
    },
    {
      id: 'how-to-apply',
      title: 'How to apply online in 10–15 minutes',
      content: [
        { kind: 'substeps', items: [
          { id: 'create-account', title: '1. Create an account', content: [
            { kind: 'paragraph', text: 'Go to cartaojovem.pt and choose the Cartão Jovem Europeu application. Enter your email, name as in your document, date of birth and contact details. Check the spelling of your name: it may be matched against your passport or residence permit.' }
          ] },
          { id: 'fill-details', title: '2. Fill in the details', content: [
            { kind: 'checklist', items: [
              'First name and surname in Latin characters',
              'Date of birth',
              'Address in Portugal',
              'NIF, if the field is requested or a recibo/fatura is needed',
              'Document type and number, if the form asks for identification',
    ...
    {
      id: 'best-discounts',
      title: 'Where it most often pays for itself',
      content: [
        { kind: 'paragraph', text: 'The partner list changes, so before buying a ticket, check the conditions on cartaojovem.pt and with the partner itself. In 2026 the main mass-use case is transport and culture.' },
        { kind: 'checklist', items: [
          'CP: a 25% discount on journeys is often listed, but the fare, train and purchase channel may have restrictions',
          'Museums and monuments: entry discounts, especially at state and municipal sites',
          'Cinemas, concerts, festivals: promotional fares for Cartão Jovem holders',
          'Pousadas de Juventude and hostels: accommodation discounts and membership offers',
          'Restaurants and cafés: local discounts, especially in university towns',
          'Sport and fitness: gyms, activities, equipment rental',
          'Education: courses, language schools, bookshops',
          'European EYCA partners: useful for trips to Spain, France, Italy and other countries'
        ] },
        { kind: 'warning', text: 'The discount is not automatically guaranteed. The partner may have exclusions: it cannot be combined with other promotions, a promo code is needed before payment, or the discount applies only at the ticket office or only on certain dates.' }
      ]
    },
    {
      id: 'practical-tips',
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Check the validity period: the card is annual, and automatic renewal should not be considered guaranteed',
  ...
  sources: [
    { title: 'Official Cartão Jovem website — application, price and partners', url: 'https://cartaojovem.pt', kind: 'official', language: 'pt', lastRetrieved: '2026-04-28' },
