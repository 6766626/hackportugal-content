export default {
  ...
  title: 'Campervan and autocaravana: where you can stay overnight in Portugal',
  tldr: 'In 2026, the rules for autocaravana are no longer as strict as immediately after Lei 92/2019: outside protected zones, pernoita is allowed for up to 48 hours in one município, provided the place is not prohibited by signs or municipal rules. In Rede Natura 2000, áreas protegidas and coastal POOC/POC areas, overnight stays and aparcamento outside specifically authorised places are prohibited. Fines: €60–300 for breaching the general limit, €120–600 in protected/coastal zones.',
  tags: ['autocaravana', 'campervan', 'pernoita', 'fines'],
  ...
  steps: [
    ...
    },
    {
      ...
      title: 'How to find a legal place to stay overnight',
      content: [
        { kind: 'paragraph', text: 'The safe algorithm: first look for an official ASA or parque de campismo, then check municipal signs on site. Apps are useful, but they are not a source of law.' },
        { kind: 'checklist', items: [
        ...
        { kind: 'paragraph', text: 'FCMP and local caravanismo clubs usually publish useful explanations and lists of places, but the final decision is always determined by the law, municipal signs and the inspector on site.' }
      ]
    },
    {
