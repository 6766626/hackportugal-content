export default {
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Park & Ride here is more often called parques dissuasores or simply parques junto à estação. The idea is simple: avoid driving into the centre, leave the car near the metro, CP, Fertagus or a bus terminal, and continue by public transport.' },
        ...
        { kind: 'checklist', items: [
          ...
          'Keep the parking ticket until exit; payment is usually at a machine before getting into the car',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'In Greater Lisbon there is no single map of all free P+R sites. The practical approach is to choose parking by your entry direction: north via Odivelas/Loures, west via Oeiras/Cascais, south via Almada/Pragal, east via Oriente/Moscavide.' },
        { kind: 'checklist', items: [
          'Senhor Roubado / Odivelas — convenient for entering from the north and changing to the Metro Linha Amarela; check the actual parking status on site',
          ...
          'Cais do Sodré — convenient for Linha Verde, CP Cascais and ferries, but it is central; use it only if you specifically need this hub, not savings',
          'Pragal — a good option from the south: Fertagus to Entrecampos/Sete Rios/Roma-Areeiro, with access roads from Almada and the A2 nearby; car parks are often paid, but cheaper than the centre',
        ...
        { kind: 'warning', text: 'Do not leave the car “like everyone else” on the roadside near stations. In Lisbon and the suburbs, Polícia Municipal, EMEL and municipal tow trucks operate regularly. A fine + reboque can easily turn free parking into the most expensive trip of the week.' }
      ]
    },
    {
      id: 'porto',
      title: 'Porto: Metro do Porto and suburban car parks',
      content: [
        { kind: 'paragraph', text: 'In Porto, the P+R logic is usually better: Metro do Porto directly connects the suburbs, the airport, Matosinhos, Maia, Gondomar and the centre. The most convenient scenario is to leave the car not in Baixa, but at a station outside the historic centre and continue with Andante.' },
        { kind: 'checklist', items: [
          'Rio Tinto — a practical eastern option for entering from Gondomar/Valongo and changing to Metro/train',
          ...
          'Estádio do Dragão — convenient near the VCI and Metro, but on FC Porto match days and event days parking arrangements change',
          ...
          'Aeroporto / Verdes / Botica — options for those coming from Maia/Vila do Conde/Póvoa and wanting to continue to the centre by Metro'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Free spaces exist, but there are fewer of them than old forums suggest. At popular hubs, the free zone is often full by 08:00–09:00, while nearby paid parques operate with hourly or daily tariffs.' },
        { kind: 'checklist', items: [
          'Free: open municipal car parks near some stations and stadiums, if there is no event or restriction',
          'Cheap: peripheral car parks with a daily tariff of about €1–4',
          'Mid-range: interchange stations and shopping areas — often €4–10 per day',
          'Expensive: Cais do Sodré, Baixa, Trindade, Parque das Nações, airport — treat as standard urban parking',
          'Plus transport: a single Metro/CP ticket or a monthly Navegante/Andante pass',
          'For a daily commute, count not only parking, but also fuel, portagens, IUC and time spent entering the centre'
        ] },
    ...
    {
      id: 'routine',
      title: 'Practical daily algorithm',
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'backup', title: '2. Keep a backup option', content: [
            { kind: 'paragraph', text: 'For every journey, have a “plan B” 1–2 stations further on. If Senhor Roubado, Senhora da Hora or Pragal are full, do not spend 20 minutes circling — drive to the next station.' }
          ] },
          { id: 'payment', title: '3. Check payment before leaving', content: [
            { kind: 'paragraph', text: 'Look at how to pay: Multibanco, card, MB WAY, machine, operator app. Some car parks require payment before exit, not at the barrier.' }
          ] },
          { id: 'security', title: '4. Leave the car “empty”', content: [
            { kind: 'paragraph', text: 'Put bags, sat nav, cables, documents, glasses and children’s items in the boot before entering the car park. Do not do this obviously once you are already on site.' }
          ] }
        ] }
      ]
    }
  ...
  costs: [
    ...
    { label: 'Peripheral P+R / parque dissuasor', amountEURMin: 1, amountEURMax: 4, note: 'Typical order of daily cost; check the specific car park' },
