export default {
  ...
  tldr: 'In Portugal, some offences are not administrative but criminal (Código Penal + Código da Estrada). These are: driving with BAC ≥1.2 g/l, refusing an alcohol test, driving after disqualification, manslaughter / serious injury by negligence, leaving the scene of an accident. Penalties: driving ban from 2 months to 3 years, fines up to €15,000, imprisonment up to 5 years. **Sistema carta por pontos**: for a crime rodoviário — **−6 points**; for a contra-ordenação muito grave (incl. BAC 0.8–1.2) — **−5 points**; grave — usually −3. At 0 points — **cassação do título**: you cannot obtain a new licence for 2 years, then you must retake it from scratch. A conviction remains on the certidão do registo criminal.',
  tags: ['traffic rules', 'crime', 'driving', 'fines'],
  estimatedReadMinutes: 6,
  steps: [
    {
      id: 'alcohol',
      title: 'Alcohol behind the wheel — the main trap',
      content: [
        { kind: 'paragraph', text: 'Portugal has one of Europe’s strict BAC enforcement systems.' },
        { kind: 'checklist', items: [
          ...
          '🍸 **BAC ≥ 1.2 g/l** — **criminal offence** (art. 292 Código Penal): up to 1 year imprisonment or a fine of up to 120 daily rates, ALWAYS a ban of 2+ months, criminal record for 5–10 years',
          '🚫 **Refusal to take the test** — treated as BAC ≥ 1.2 g/l + charge of "desobediência qualificada" (up to 2 years imprisonment)',
          '⚠️ For new drivers (<3 years’ licence): limit 0.2 g/l — even a pint of beer can be an offence',
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'p2', title: 'Minus 2 points', content: [
            { kind: 'checklist', items: [
              ...
              'Driving where not permitted (one-way street, pedestrian zone)'
            ]}
          ]},
          ...
          { id: 'p4', title: 'Minus 4 points', content: [
            { kind: 'checklist', items: [
              'Alcohol 0.8–1.2 g/l',
              'Driving without a valid IPO (roadworthiness test)',
          ...
          { id: 'p5', title: 'Minus 5 points — criminal offence', content: [
            { kind: 'checklist', items: [
              ...
              'Leaving the scene of an accident with casualties',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Hidden ANSR radars: no warning, may be in GNR vehicles',
          'Mobile radars — often on the roadside in small villages on national roads',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '🚦 IMT Portal Digital (imt-ip.pt) — log in with CMD / CC → "Consultar carta" → shows points + history',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The points system applies to **all** drivers on Portuguese territory, even with foreign licences. If you reach 0 points — loss of the right to drive in Portugal (your home licence is invalid in Portugal); when you return home — the licence works as usual.' },
        { kind: 'checklist', items: [
          ...
          'When changing your licence to a Portuguese one (after exchange) — points are transferred',
          'Fine notices arrive at the vehicle registration address',
          'For a rented car with a UK licence: the company receives the fine and invoices you + €30–50 for an administrative fee'
        ]}
      ]
    }
  ],
