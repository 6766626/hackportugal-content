export default {
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'A6: direction Évora / Espanha via Caia',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The tariff is calculated not “by car make”, but by the class for portagens. A class error is a common reason for unexpectedly high bills for vans, campervans and large SUVs.' },
        { kind: 'checklist', items: [
          ...
          'Classe 2: 2 axles and height at the front axle ≥1.10 m; vans, some people carriers and commercial versions often fall into this class',
          'Classe 3: 3 axles and height at the front axle ≥1.10 m',
          'Classe 4: 4 or more axles and height at the front axle ≥1.10 m',
          'A trailer may change the class if it changes the number of axles in the section’s tariff logic',
          ...
          'If you are driving a hire car, the class is already set by the rental operator and linked to the Via Verde device, if one is installed'
        ] },
        { kind: 'warning', text: 'Do not rely only on “passenger car/not passenger car” in the documents. For portagem, the physical height at the front axle of 1.10 m and the number of axles matter. With a campervan or carrinha, the tariff is often higher than the driver expects.' }
      ]
    },
    {
      id: 'how-to-pay',
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'Entry: choose a normal lane, take a ticket; do not enter a “Via Verde” lane without a device',
          ...
          'Via Verde: green lane, drive through without stopping; debit from the linked account/card',
          'In a hire car: check with the rent-a-car whether Via Verde is activated and what the daily fee is',
          'If the ticket is lost, the operator may charge the maximum tariff for the section',
          'If you accidentally drove through Via Verde without a device, record the date, road number, praça and contact the operator/Via Verde — do not wait for a penalty letter',
        ...
        { kind: 'warning', text: 'The Via Verde lane is not a “fast lane for everyone”. The camera reads the transponder/registration number. Without an active device, the trip becomes an unpaid portagem with administrative costs.' }
      ]
    },
    {
      id: 'tariffs-2026',
      title: '2026 tariff guide figures',
      content: [
        { kind: 'paragraph', text: 'The exact tariff depends on the entry point, exit point, operator, class and annual indexation. For a trip, it is better to calculate not “by kilometres” but via the official Brisa or Via Verde simulador de portagens: enter origem, destino and classe.' },
        { kind: 'checklist', items: [
          'A5 Lisboa–Cascais, classe 1: usually around €1.95–2.15 for a short section, depending on the entry/exit point',
          'A1 Lisboa–Porto, classe 1: guide figure around €24–26 for the full route on the tolled A1',
          'A2 Lisboa–Algarve, classe 1: guide figure around €23–25 to the Albufeira/Faro area via the A2',
          'A6 Lisboa/Marateca–Caia, classe 1: guide figure around €17–20 on the main tolled corridor towards Espanha',
    ...
    },
    {
      ...
      title: 'When Via Verde is useful',
      content: [
        { kind: 'paragraph', text: 'Via Verde is convenient if you live in Portugal and drive on autoestradas more than a couple of times per month. The device is linked to the vehicle registration number and payment method. Debits are visible in the personal account and app.' },
        { kind: 'checklist', items: [
          'Makes sense: regular Lisboa–Cascais, Porto–Lisboa, Algarve trips, working outside the city',
          ...
          'Not essential: if you use toll roads 1–2 times per year, manual payment is usually enough',
          'For a hire car, do not buy your own transponder: use the rent-a-car option or pay manually if the road allows it',
        ...
        { kind: 'warning', text: 'Via Verde does not remove the road tariff itself. It is a payment method. You pay the same portagem according to the vehicle class plus any subscription fee/commission for the selected plan.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'In the sat nav, compare the “avoid tolls” route: sometimes saving €20 costs an extra 60–90 minutes',
          'On the A1/A2, do not enter without fuel: there are service stations, but autoestrada prices are often higher than in towns',
          'Keep a bank card and some cash: a machine or card may not work at a particular praça',
          'Do not throw away the ticket until the end of the journey and payment',
          'If you are driving with a roof box, this usually does not change the class, because what matters is the height at the front axle, but a commercial van is a different matter',
          'For Túnel do Marão, check the weather in advance: the alternative on the old mountain road may be slower and more dangerous in winter',
          'For accounting/recibos verdes, keep Via Verde faturas or the recibo da portagem if the trip is for work'
        ] },
        { kind: 'paragraph', text: 'If you need the most predictable budget, plan: fuel + portagens + parking. For a Lisboa ↔ Porto trip in classe 1, tolls alone for the return journey may be around €50, excluding fuel.' }
      ]
    }
  ],
  costs: [
  ...
  sources: [
    { title: 'Brisa — portagens, autoestrada network and simulator', url: 'https://www.brisa.pt', kind: 'company', language: 'pt', lastRetrieved: '2026-04-28' },
