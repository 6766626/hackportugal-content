export default {
  ...
  steps: [
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'l3', title: 'Price', content: [
            { kind: 'checklist', items: [
              ...
              '2nd household car: €36/year',
              'Each additional one: €72/year',
              'Dístico de visitante (visitor): €24/year + time restrictions',
              'Pensioners 65+ — 50% discount'
            ]}
          ]},
          { id: 'l4', title: 'Zones', content: [
            { kind: 'paragraph', text: 'The dístico is valid ONLY in your freguesia. For neighbouring ones, you must pay hourly. Electric vehicles and hybrids have a separate tariff, plus free parking in some zones (see below).' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The municipality of Cascais issues resident parking through Cascais Próxima. Residents of the municipality receive the viver Cascais card (municipal ID), which gives access to discounted parking.' },
        { kind: 'checklist', items: [
          ...
          'Works in central Cascais and Estoril — in other areas of the municipality (Alcabideche, São Domingos de Rana), parking is free'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Atestado de Residência from the Junta de Freguesia + vehicle registration to your NIF',
          'Apply at Divisão de Trânsito, Rua Dr. Francisco Santana Ramos',
          'Cartão de Residente for parking — €20/year',
          'Works in central Setúbal; Azeitão, Palmela and further out — free parking'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Distinguishing mark: electric vehicles receive a separate symbol on the registration certificate + a green number plate frame'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Parking without a dístico or payment: €30-50 (if paid quickly)',
          ...
          'Appeal a fine — via EMEL.pt or Câmara, deadline 30 days'
        ]}
      ]
    }
  ],
