export default {
  ...
  steps: [
    {
      id: 'types',
      title: 'Fine classification',
      content: [
        { kind: 'substeps', items: [
          { id: 't1', title: 'Leve (minor)', content: [
            { kind: 'checklist', items: [
              '€60–300 for an individual, €300–1500 for a legal entity',
              'Example: not wearing a seat belt, crossing a level crossing, failing to give way to a pedestrian',
              'No points deducted'
            ]}
          ]},
      ...
      content: [
        ...
        { kind: 'substeps', items: [
          ...
          { id: 's3', title: '40–60 / 60–80 km/h — Muito Grave', content: [
            { kind: 'paragraph', text: '€300–1500, usually −4 points, driving ban for 2–24 months' }
          ]},
          { id: 's4', title: '> 60 / > 80 km/h — Muito Grave', content: [
            { kind: 'paragraph', text: '€500–2500, usually −4 points, driving ban for 2–24 months' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '💊 Drugs: muito grave, usually €500–2500, −5 points, ban of 2 months–2 years; criminal liability is possible if inability to drive safely is proven',
          '🚨 Refusal/evasion of a check or leaving the scene of an accident may lead to serious administrative/criminal consequences; there is no automatic “0 points immediately” as a general rule'
        ]}
      ]
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'If you do not appeal and do not pay, the fine becomes an enforceable document. Recovery may be made from your salary, IBAN or seized property.' }
      ]
    }
  ],
  costs: [
    ...
    { label: 'Pagamento voluntário (minimum coima amount)', amountEUR: 0, note: 'when paying voluntarily within the set deadline, the minimum amount stated in the notice is paid' }
  ],
  sources: [
    { title: 'Código da Estrada (Portugal Highway Code)', url: 'https://dre.pt/dre/legislacao-consolidada/decreto-lei/1994-55253174', kind: 'law', language: 'pt', lastRetrieved: '2026-04-22' },
