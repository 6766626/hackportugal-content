export default {
  ...
  steps: [
    {
      id: "what-it-is",
      title: "What Avença Residente gives you",
      content: [
        {
          kind: "paragraph",
          text: "This is an EMEL resident permit for on-street parking in the area where you live in Lisboa. It does not give you free parking across the whole city: it is valid only in the zone/neighbourhood linked to your address, and only in EMEL spaces where resident parking is allowed."
        },
        {
          kind: "checklist",
          items: [
    ...
    {
      id: "documents",
      title: "Documents for the EMEL counter",
      content: [
        {
          kind: "paragraph",
      ...
      content: [
        {
          ...
          items: [
            ...
            {
              id: "update-nif",
              title: "2. Update the morada fiscal",
              content: [
                {
                  kind: "paragraph",
            ...
            {
              id: "confirm-active",
              title: "4. Check that the permit is active",
              content: [
                {
                  kind: "paragraph",
    ...
    {
      id: "prices-and-use",
      title: "Prices and how to use it in 2026",
      content: [
        {
          kind: "paragraph",
        ...
        {
          kind: "warning",
          text: "In historic neighbourhoods and congested areas of Lisbon, having an Avença Residente does not mean that a space will be easy to find in the evening. It is a legal right to park in the zone under the resident regime, not a guarantee that a free space will be available."
        }
      ]
    }
  ],
  ...
  sources: [
    ...
    {
      title: "EMEL — where to park and parking zones in Lisboa",
    ...
    {
      title: "Câmara Municipal de Lisboa — parking and mobility",
