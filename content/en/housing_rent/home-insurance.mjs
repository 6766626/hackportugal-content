export default {
  ...
  tldr: 'By law (art. 1429 Código Civil), for flats in a condomínio (horizontal property), insurance against **fire risk** is mandatory — both for individual flats and for common areas. Multirriscos habitação is broader (fire + water + theft + civil liability), but as a contractual obligation the bank requires it for a mortgage — this is not law, but a loan condition. For tenants, insurance is not mandatory, but is recommended (seguro de recheio, €50-150/year). Best insurers 2026: Fidelidade, Generali Tranquilidade (Generali brand), Allianz, Zurich, Liberty. Annual cost €150-500 for a 70-100 m² flat depends on cover and excess.',
  ...
  steps: [
        ...
        { kind: 'substeps', items: [
          { id: 't1', title: 'Seguro Multirriscos Habitação (main)', content: [
            { kind: 'checklist', items: [
              ...
              '⚠️ **Family civil liability** — NOT always included in multirriscos. It may be a separate subscription; check this',
              'Electronics, furniture (recheio) — a separate section; some policies insure only the property/building without recheio — check',
              'Costs for temporary accommodation — usually limited additional cover, not universal',
          ...
          { id: 't2', title: 'Seguro de Recheio (for tenants only)', content: [
            { kind: 'checklist', items: [
              ...
              'Recommended if your equipment is worth more than €3,000 in total'
            ]}
          ]},
          { id: 't3', title: 'Seguro contra incêndio (mandatory by law)', content: [
            { kind: 'checklist', items: [
              ...
              'Paid by the owner of each flat; common areas — through the condomínio fee',
              'Does NOT cover the internal contents of the flat (recheio) — for this you need separate multirriscos with recheio'
            ]}
          ]},
          { id: 't4', title: 'Specialised add-ons', content: [
            { kind: 'checklist', items: [
              ...
              '**Household appliance repair** — repair of large appliances after the warranty (+€20-40/year)',
              '**Cyber-theft protection** — protection against cyber-theft and identity theft (+€5-15/year)',
              '**Pet insurance** — veterinary care for pets (can sometimes be added to home insurance)'
            ]}
          ]}
        ]}
      ]
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'c3', title: 'What to check', content: [
            { kind: 'checklist', items: [
              ...
              '  - Commercial use (if you rent out as AL)',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 's1', title: 'Immediately (48 h)', content: [
            { kind: 'checklist', items: [
              'Call the insurer’s 24-hour line (all have one)',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '📝 **Inventory with photos**: photograph all significant items (appliances, jewellery, works of art) with serial numbers. For reporting damage — the gold standard',
          '💾 **Digital backup**: save the inventory in the cloud (not on the device)',
          '🔒 **Panic button / alarm**: 10-15% discount from the insurer',
          '🎂 **Renewal date**: review the policy annually — your belongings have changed (bought new appliances, moved home)',
          '💍 **Expensive jewellery / watches / collection**: separate declaração, independent valuation required',
          '🌊 **Natural disasters**: earthquake cover in PT is cheap (low-activity zone), but if your region is risky (Algarve, Azores) — add it',
          '🏠 **Alojamento Local (AL)**: if you rent out — you need separate commercial insurance (many standard policies exclude this)',
