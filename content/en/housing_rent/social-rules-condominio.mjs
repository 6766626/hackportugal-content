export default {
  ...
  steps: [
        ...
        { kind: 'substeps', items: [
          { id: 'n1', title: 'Quiet hours', content: [
            { kind: 'checklist', items: [
              ...
              '🎵 Music in the flat from 8:00-20:00 — within reason. In the evening — quieter. At night — it must not be audible through the wall'
            ]}
          ]},
          { id: 'n2', title: 'What counts as a breach', content: [
            { kind: 'checklist', items: [
              ...
              'Construction / renovation works during prohibited hours (usually 9:00-19:00 Mon-Fri, 10:00-18:00 Sat, prohibited on Sundays and public holidays)',
    ...
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'c1', title: 'Step 1: Talk to the neighbour (recommended)', content: [
            { kind: 'checklist', items: [
          ...
          { id: 'c3', title: 'Step 3: GNR / PSP — call the police', content: [
            { kind: 'checklist', items: [
              ...
              'Local PSP / GNR number — find it on Google with "posto territorial + neighbourhood name"',
              'The police will come, ask for the noise to be reduced — this usually resolves it on the spot',
              '📋 Get the incident/reference number — for later steps'
            ]}
          ]},
          { id: 'c4', title: 'Step 4: Câmara Municipal', content: [
            { kind: 'checklist', items: [
              'For an **ongoing** breach',
              ...
              'If the limit is exceeded — the fine is issued to the offender (€200-€2,500 for an individual, up to €25,000 for a company)',
              'Process: 1-3 months'
            ]}
          ]},
          { id: 'c5', title: 'Step 5: Tribunal (court)', content: [
            { kind: 'checklist', items: [
              ...
              'Rarely used for noise — more often for construction works / serious cases'
            ]}
          ]}
        ]}
      ]
        ...
        { kind: 'substeps', items: [
          { id: 'cd1', title: 'Structure', content: [
            { kind: 'checklist', items: [
              ...
              '**Regulamento interno** — building rules (pets, balconies, noise, renovation works)',
          ...
          { id: 'cd2', title: 'Assembleia', content: [
            { kind: 'checklist', items: [
              ...
              '**Extraordinária**: at the request of 1/4 of the owners or the administrator',
              'Voting: by flat size (permilagens). 1 flat ≠ 1 vote',
              'Decisions are made by a majority of permilagens; some (major repairs) require 2/3',
          ...
          { id: 'cd3', title: 'Monthly fees', content: [
            { kind: 'checklist', items: [
              ...
              'Covers: cleaning, lighting for common areas, lift maintenance, building insurance, administration, Fundo Reserva',
          ...
          { id: 'cd4', title: 'Breaches of the regulamento', content: [
            { kind: 'checklist', items: [
              ...
              'Balcony: you cannot hang laundry outside (in some condomínios), install air conditioning (without approval)',
              'Pets: if the regulamento prohibits them — not allowed; if it permits them — rules apply (lead in common areas)',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '**Works by neighbours**: the owner must give 8 days’ notice of scheduled works',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '**Renovation works below you have been going on for more than 3 months** → check permits with the municipality; often illegal',
          ...
          '**Aggressive neighbour**: PSP 112 in the event of a physical threat; Provedor de Justiça for a recurring conflict'
        ]}
      ]
    }
  ],
