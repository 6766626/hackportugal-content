export default {
  ...
  tldr: 'Portugal is a country of quiet everyday protocol, but neighbours vary. Noise rules: Regulamento Geral do Ruído (DL 9/2007) — período nocturno **23:00-07:00**, diurno 07:00-20:00, entardecer 20:00-23:00 (standard definitions; municipalities may add local rules). Where to complain: GNR/PSP (one-off breach) → Câmara Municipal (persistent breach) → court. Noise fines: €200-2,500 for an individual. In a condomínio, the general meeting adopts internal rules, and the assembleia is held at least once a year. Fundo Comum de Reserva is mandatory.',
  ...
  steps: [
        ...
        { kind: 'substeps', items: [
          { id: 'n1', title: 'Quiet hours', content: [
            { kind: 'checklist', items: [
              ...
              '🎵 Music in a flat from 8:00-20:00 — within reason. In the evening — quieter. At night — it must not be audible through the wall'
            ]}
          ]},
          { id: 'n2', title: 'What counts as a breach', content: [
            { kind: 'checklist', items: [
              ...
              'Construction / renovation work during prohibited hours (usually 9:00-19:00 Mon-Fri, 10:00-18:00 Sat, prohibited on Sun and public holidays)',
              'Shouting, arguments, a baby crying (children are a reasonable exception in court)',
              'A dog barking on a balcony (the owner is responsible)',
              'Shower water noise after 23:00 (less common, but complaints do happen in old buildings)',
        ...
        { kind: 'substeps', items: [
          { id: 'c1', title: 'Step 1: Dialogue with the neighbour (recommended)', content: [
            { kind: 'checklist', items: [
              ...
              'Write a note for the letterbox or speak in person',
              'Explain that the problem is not personal, but about shared wellbeing',
              'Give 1-2 weeks for a response',
          ...
          { id: 'c2', title: 'Step 2: Condominium administrator', content: [
            { kind: 'checklist', items: [
              ...
              'Outcome: written warning → fine from the common budget',
              'If the administrator ignores it — next step'
            ]}
          ]},
          { id: 'c3', title: 'Step 3: GNR / PSP — calling the police', content: [
            { kind: 'checklist', items: [
              ...
              'Local PSP / GNR number — find it on Google using "posto territorial + area name"',
              'The police will come and ask for the noise to be reduced — this usually solves it on the spot',
              '📋 Get the case/reference number — for later steps'
            ]}
          ]},
          { id: 'c4', title: 'Step 4: Câmara Municipal', content: [
            { kind: 'checklist', items: [
              'For a **persistent** breach',
              'Submission: online on the municipality website or in person at the public desk',
        ...
        { kind: 'substeps', items: [
          { id: 'cd1', title: 'Structure', content: [
            { kind: 'checklist', items: [
              ...
              '**Regulamento interno** — building rules (pets, balconies, noise, renovations)',
          ...
          { id: 'cd2', title: 'Assembleia', content: [
            { kind: 'checklist', items: [
              ...
              'Decisions are passed by a majority of permilagens; some (major repairs) require 2/3',
          ...
          { id: 'cd3', title: 'Monthly contributions', content: [
            { kind: 'checklist', items: [
              ...
              'Factors: building size, presence of a lift, pool, security, garden',
              'Covers: cleaning, lighting in common areas, lift maintenance, building insurance, administration, Fundo Reserva',
              'The owner must pay; the tenant only if stated in the contract (more often the owner pays)',
              'Debt: **administrative** debt → court for recovery; there is no legal charge over the flat'
            ]}
          ]},
          { id: 'cd4', title: 'Breaches of regulamento', content: [
            { kind: 'checklist', items: [
              '60 days to challenge an assembleia decision',
              'Fine conditions in the regulamento: from €50-500 per breach',
              'Major changes to the flat (demolishing walls): approval from the assembleia',
              'Balcony: you may not hang laundry outside (in some condominiums), or install air conditioning (without approval)',
              'Pets: if the regulamento prohibits them — you cannot; if it allows them — there are rules (lead in common areas)',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '**Peaceful enjoyment**: Lei 6/2006 (NRAU) — the owner guarantees peaceful use',
          'If neighbours disturb you and the owner does not help → you may demand a rent reduction or exit the contract without a penalty',
          '**Repairs by neighbours**: the owner must give 8 days’ notice of planned works',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '**Neighbours smoke on the balcony, smoke enters your flat** → not a direct breach (smoking on a private balcony is allowed); but if the condomínio has prohibited it — fine',
          ...
          '**Aggressive neighbour**: PSP 112 if there is a physical threat; Provedor de Justiça for a recurring conflict'
        ]}
      ]
    }
  ],
  ...
  sources: [
    ...
    { title: 'Lei 6/2006 — NRAU (urban rental)', url: 'https://diariodarepublica.pt/dr/legislacao-consolidada/lei/2006-34454575', kind: 'law', language: 'pt', lastRetrieved: '2026-04-22' }
  ],
