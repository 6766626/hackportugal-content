export default {
  ...
  tldr: 'A process allowing you to bring your spouse, children or parents after obtaining your own residence permit. The application is submitted via AIMA (portal-rf.aima.gov.pt). Important: from 2024 (Lei 9/2024 + Lei 61/2025 of 23.10.2025), at least 2 years of legal residence in Portugal are required BEFORE applying. AIMA’s decision deadline is up to 9 months (previously 90 days). Exceptions: Golden Visa holders, D3 (EU Blue Card), and several other qualified statuses.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Spouse (official marriage or união de facto — cohabitation for ≥ 2 years, requiring registration with the Junta de Freguesia)',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Suitable housing (rental contract for ≥ 12 months or owned property, floor area ≥ 30 m² for 1 person + 15 m² for each additional person)',
          'Stable income — minimum 100% of the SMN (€920 in 2026) for the applicant + 50% for the spouse (€460) + 30% per child (€276 per child)',
          'Health insurance for all family members until they obtain SNS',
          'No debts to Finanças or Segurança Social'
        ]},
        { kind: 'warning', text: 'Lei 9/2024 (entered into force in 2024, confirmed by Lei 61/2025): at least 2 years of legal residence BEFORE applying for Reagrupamento Familiar. Previously, you could apply immediately after obtaining a residence permit. This is the key change for new residents.' }
      ]
    },
    {
      id: 'process',
        ...
        { kind: 'substeps', items: [
          { id: 'r1', title: '1. Gather family documents', content: [
            { kind: 'checklist', items: [
              ...
              'Criminal record certificates for the wife/husband and adult family members',
              'Passports of all family members'
            ]}
          ]},
          { id: 'r2', title: '2. Submit the application to AIMA', content: [
            { kind: 'paragraph', text: 'Via the dedicated portal portal-rf.aima.gov.pt (launched in 2024) or at an in-person appointment. Select the “Reagrupamento Familiar” type.' }
          ]},
          ...
          { id: 'r4', title: '4. The family obtains a visa at the consulate', content: [
            { kind: 'paragraph', text: 'Based on AIMA approval. The fee is about €90 per person.' }
          ]},
          { id: 'r5', title: '5. Entry and residence permit processing at AIMA', content: [
            { kind: 'timeline', text: 'Within 4 months from the visa issue date. Biometrics at AIMA. Card — within 30–90 days.' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Portugal recognises civil partnerships. After 2 years of cohabitation, you can register a união de facto with the Junta de Freguesia and use this as a basis for reunification.' }
      ]
    },
    {
      id: 'common-issues',
      title: 'Common issues',
      content: [
        { kind: 'warning', text: 'Insufficient housing floor area is a common reason for refusal. Check before applying.' },
  ...
  costs: [
    ...
    { label: 'AIMA — residence permit (art. 75, each person)', amountEUR: 307.20, note: 'from 01.03.2026' },
    { label: 'Visa at the consulate (each person)', amountEUR: 90 },
  ...
  sources: [
    ...
    { title: 'Lei 61/2025 — 9-month AIMA decision deadline', url: 'https://diariodarepublica.pt/dr/detalhe/lei/61-2025', kind: 'law', language: 'pt', lastRetrieved: '2026-04-22' }
  ],
