export default {
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'n2', title: 'What is needed from the parents', content: [
            { kind: 'checklist', items: [
              ...
              '📛 Decision on the child’s names — discuss in advance with the maternity hospital (there is a list of permitted names)',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          '📅 Free of charge if you meet the 20-day deadline; afterwards — possible fine and additional procedure',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '⚖️ If the parents are not married: the father personally acknowledges paternity at registration in the Conservatória by presenting a document. A DNA test is NOT required by default, only in the event of a dispute (through court)',
          '👶 PNV vaccinations are free in SNS',
          '🩺 Child insurance — employers include a family plan (Generali, Médis)',
  ...
  sources: [
    ...
    { title: 'ePortugal — Nascer Cidadão', url: 'https://www.gov.pt/cidadaos/-/informacoes/nascer-cidadao-', kind: 'official', language: 'pt', lastRetrieved: '2026-04-28' },
