  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'CSI does not replace a residence permit, D7/D8 visa, IRS tax return or health insurance.'
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The main conditions are age, residence, low resources and the absence of significant financial assets. Segurança Social looks not only at the Portuguese pension, but also at payments from abroad. For Russians, Ukrainians, British people, Americans and other non-EU residents, this usually means: you need to prove lawful residence and disclose foreign pensions and accounts.' },
        { kind: 'checklist', items: [
          ...
          'If you are entitled to an old-age, sobrevivência or other applicable pension, Segurança Social may require you to request it first.'
        ] },
        { kind: 'warning', text: 'A mistake that often leads to refusals for expats: “I have a small Portuguese pension”. That is not enough. Segurança Social takes worldwide income into account: a foreign pension, rental income from a flat abroad, deposit interest, dividends, investments and part of property resources.' }
      ]
    },
    {
      id: 'how-much',
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Income from renting property in Portugal or abroad is taken into account.',
          'Interest, dividends and investment income are taken into account.',
          'Property and financial assets may affect the resources assessment.',
    ...
    {
      id: 'health-benefits',
      title: 'CSI extras: medicines, teeth, glasses',
      content: [
        { kind: 'paragraph', text: 'CSI is valuable not only because of the monthly payment. Recipients are entitled to benefícios adicionais de saúde — additional health benefits. In practice, this reduces an older person’s spending on prescription medicines, dentistry and certain medical devices.' },
        { kind: 'checklist', items: [
          'Medicines: CSI recipients have 100% coverage of part of the cost of prescription medicines prescribed within the SNS system and falling under the relevant comparticipação rules.',
          ...
          'Prescriptions must be issued by a doctor and processed through the normal SNS/pharmacy system.',
    ...
    },
    {
      ...
      title: 'How to apply',
      content: [
        { kind: 'paragraph', text: 'You can apply online via Segurança Social Direta / gov.pt or in person at a balcão da Segurança Social. For elderly applicants, it is often easier to go in person or through a representative with a procuração, because documents, foreign income and bank details need to be checked.' },
        { kind: 'checklist', items: [
          'Applicant’s NISS.',
          'Applicant’s NIF.',
          'Documento de identificação: Cartão de Cidadão, residence permit / autorização de residência, passport with proof of status.',
          'Proof of residence in Portugal for 6 consecutive years: residence permit, certificados, atestado de residência, Câmara Municipal/Junta de Freguesia documents, tax and social records.',
          'IBAN of a Portuguese or SEPA account for payments.',
          'Documents on the Portuguese pension, if any.',
          'Certificates of foreign pensions and social benefits.',
          'Documents on rental income, bank interest, investments.',
          'Details of the spouse/partner and their income, if applicable.',
          'Contacts: address, telephone, email, so that Segurança Social can request missing documents.'
        ] },
        { kind: 'paragraph', text: 'After submission, Segurança Social checks the income and entitlement to the payment. If approved, the payment is awarded taking into account the application date under Segurança Social rules. If income, family situation, address or bank assets change, this must be reported, otherwise overpayments may have to be repaid.' }
      ]
    },
    {
      id: 'expat-pitfalls',
      ...
      content: [
        { kind: 'checklist', items: [
          'Applying immediately after moving on a D7: there will usually be a refusal because there are not 6 years of residence.',
          ...
          'Assuming that children are obliged to support the applicant and therefore CSI is impossible: after the reforms, children’s income is generally no longer the previous automatic barrier.',
          ...
          'Not updating the address with Finanças and Segurança Social: letters requesting documents may be missed.',
          'Ignoring IRS: even with low income, foreign pensions and tax residence need to be analysed separately.'
        ] },
        { kind: 'warning', text: 'If you are helping an elderly relative, do not transfer large sums to their account before applying “for convenience”. Bank balances and assets may affect entitlement to CSI.' }
      ]
    }
  ],
  costs: [
