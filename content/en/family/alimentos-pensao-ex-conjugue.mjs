export default {
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Pensão de alimentos means regular support payments. In family cases, there are two different regimes: child maintenance and maintenance for a former spouse. They are not added together automatically and are assessed under different Código Civil rules.' },
        { kind: 'checklist', items: [
          'For a child: food, housing, clothing, school, transport, health, medicines, extracurricular activities, a share of rent and utility bills',
          'For a child: usually paid until age 18; after 18 — if the child is studying or in professional training, usually until age 25 if this is reasonable',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'In child cases, the court sets parental responsibilities: who the child lives with, contact arrangements, who makes important decisions and how much the other parent pays. This is called regulação das responsabilidades parentais.' },
        { kind: 'paragraph', text: 'The amount depends on the child’s needs and the means of both parents. In practice, for one child and ordinary income levels, courts often fall within the range of 10–30% of the payer’s net income, but this is not a guaranteed bracket: with a low salary the amount may be lower, and with a private school and high income it may be higher.' },
        { kind: 'checklist', items: [
        ...
        { kind: 'warning', text: 'Do not stop paying by yourself because of a conflict with the other parent or because the child has started living with you for more days. First formalise the change by agreement or through the court, otherwise a debt will arise.' }
      ]
    },
    {
      id: 'ex-spouse',
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Qualifications, work, and the possibility of entering the labour market',
        ...
        { kind: 'paragraph', text: 'Maintenance for a former spouse may be temporary. It can be reduced, ended or increased through the court if circumstances change. For expats, the important point is: if one spouse has left Portugal, this does not cancel the obligation, but it makes notifications and enforcement more difficult.' },
        ...
        { kind: 'substeps', items: [
          { id: 'agreement', title: '1. If the parents/spouses have reached an agreement', content: [
            ...
            { kind: 'checklist', items: [
              ...
              'How unforeseen expenses are split: 50/50, in proportion to income or otherwise',
              'Indexation and review date',
              'What happens if the child or parent moves'
            ] }
          ] },
          { id: 'court', title: '2. If agreement is impossible', content: [
            { kind: 'paragraph', text: 'A pedido is submitted to the Tribunal de Família e Menores for the child’s or defendant’s place of residence. For urgent child-related issues, the court may order provisional measures before the final decision.' },
            { kind: 'paragraph', text: 'A lawyer is not always compulsory at the first step, but in cases of conflict, a foreign element, non-payment or a dispute about income, it is better to proceed with an advogado. If income is low, submit a pedido de proteção jurídica to Segurança Social.' }
          ] },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'For children there is the Fundo de Garantia de Alimentos Devidos a Menores — FGADM. This is a state mechanism through Segurança Social that pays instead of the debtor when maintenance has been ordered by a court, but the parent does not pay and enforcement does not produce results.' },
        { kind: 'checklist', items: [
          ...
          'Usually, incumprimento das responsabilidades parentais is first recorded',
          ...
          'The FGADM amount is not automatically equal to the debt; it is set by the court within the law and the fund’s budget',
          'In typical cases with an absent parent, a payment of around €124/month per child is seen, but this is not a universal tariff',
          'The state can then recover these amounts from the debtor',
          'FGADM does not cover maintenance for a former spouse'
        ] },
        { kind: 'warning', text: 'If the debtor pays in cash, require a receipt or a transfer to IBAN. Without a payment trail, it is later difficult to prove whether the debt was or was not paid.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Maintenance can have IRS consequences. In Portugal, the tax regime depends on who pays, who receives, whom the amount is intended for and whether there is a court decision or homologated agreement. The rules may differ for an ex-cônjuge and children, so before filing your IRS return check Portal das Finanças or a contabilista.' },
        { kind: 'checklist', items: [
          ...
          'If income has fallen, submit a pedido de alteração immediately; the debt for previous months usually does not disappear by itself',
          ...
          'If you have a low income, request apoio judiciário/proteção jurídica before filing a claim'
        ] },
  ...
  costs: [
    { label: 'FGADM for a child', amountEUR: 124, note: 'Typical indicative payment in cases with an absent parent; the exact amount is set by the court, it is not an automatic tariff.' },
    { label: 'Advogado for a family case', amountEURMin: 600, amountEURMax: 2500, note: 'Private lawyer for an agreement, change to maintenance or enforcement; complex international cases cost more.' },
