export default {
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Pensão de alimentos means regular payments for support. In family cases, these are two different regimes: child maintenance and maintenance for a former spouse. They are not added together automatically and are assessed under different Código Civil rules.' },
        { kind: 'checklist', items: [
          'For a child: food, housing, clothing, school, transport, health, medicines, extracurricular activities, a share of rent and utility costs',
          'For a child: usually paid until age 18; after 18 — if the child is studying or undergoing vocational training, usually until age 25, if reasonable',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'The amount depends on the child’s needs and the means of both parents. In practice, with one child and ordinary incomes, courts often end up in the range of 10–30% of the payer’s net income, but this is not a guaranteed bracket: with a low salary the amount may be lower, while with private school and high incomes it may be higher.' },
        { kind: 'checklist', items: [
          'Gather recibos de vencimento or declaração de IRS for both parents',
          'Prepare a list of the child’s expenses: Creche/school, food, clothing, transport, medicines, insurance, clubs and activities',
          'Attach evidence: faturas, recibos, contrato de arrendamento, bills for electricity/water/gas, medical prescriptions',
          ...
          'Request annual indexation, for example by inflation/IAS, if the parties agree or the court considers it reasonable',
          'Set the payment date, IBAN, payment reference and consequences of late payment',
          'If the parent receives the salário mínimo nacional of €920 in 2026, the court can still order maintenance, but will take the payer’s minimum expenses into account'
        ] },
        { kind: 'warning', text: 'Do not stop paying on your own because of a conflict with the other parent or because the child has started living with you for more days. First formalise the change by agreement or through court, otherwise a debt will arise.' }
      ]
    },
    {
      id: 'ex-spouse',
      ...
      content: [
        { kind: 'paragraph', text: 'After divorce, Portuguese law starts from the principle that each former spouse must support themselves. Therefore pensão de alimentos ao ex-cônjuge is not automatic compensation for the marriage, but an exceptional measure when one spouse is genuinely in need and the other can pay.' },
        { kind: 'checklist', items: [
          'The court looks at the length of the marriage and life together',
          'The age and health of each spouse',
          'Qualifications, employment, ability to enter the labour market',
          'Income, assets, rent, loans and essential expenses',
          'Who cares for the children and how this affects work',
          'The standard of living during the marriage, but with no guarantee of maintaining it after divorce',
        ...
        { kind: 'paragraph', text: 'Maintenance for a former spouse may be temporary. It can be reduced, ended or increased through the court if circumstances change. For expats, it is important to know that if one spouse has left Portugal, this does not cancel the obligation, but it does make notifications and enforcement more complicated.' },
        { kind: 'warning', text: 'In Portugal there is no general state fund that pays maintenance for a former spouse instead of the debtor. FGADM applies to children, not to an ex-cônjuge. Names such as FNGCAS are often used incorrectly; check exactly which fund or benefit is being offered to you.' }
      ]
    },
    {
      id: 'how-to-formalize',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'agreement', title: '1. If the parents/spouses have reached an agreement', content: [
            { kind: 'paragraph', text: 'The agreement must be made enforceable: in a divorce by mutual consent through the Conservatória, it is filed together with the acordo de responsabilidades parentais. If there are minor children, the Ministério Público checks whether the child’s interests are protected.' },
            { kind: 'checklist', items: [
              ...
              'Recipient’s IBAN',
              'Who pays for school, health, activities, holidays',
              'How unforeseen expenses are split: 50/50, proportionally to income or otherwise',
          ...
          { id: 'court', title: '2. If agreement is not possible', content: [
            ...
            { kind: 'paragraph', text: 'A lawyer is not always compulsory at the first step, but in cases involving conflict, a foreign element, non-payment or a dispute about income, it is better to proceed with an advogado. If your income is low, submit a pedido de proteção jurídica to Segurança Social.' }
          ] },
          { id: 'foreigners', title: '3. If you are an expat', content: [
            { kind: 'paragraph', text: 'The court needs documents in a language it can understand. Foreign judgments, marriage/birth certificates and income certificates may require an apostila, tradução certificada and sometimes revisão de sentença estrangeira.' },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'For children, there is the Fundo de Garantia de Alimentos Devidos a Menores — FGADM. This is a state mechanism through Segurança Social that pays instead of the debtor when maintenance has been ordered by a court, but the parent does not pay and enforcement produces no result.' },
        { kind: 'checklist', items: [
          ...
          'The need benchmark is linked to IAS; in 2026 IAS = €537.13',
          'The FGADM amount is not automatically equal to the debt amount; it is set by the court within the limits of the law and the fund’s budget',
        ...
        { kind: 'warning', text: 'If the debtor pays in cash, ask for a receipt or a transfer to IBAN. Without a payment trail, it is later difficult to prove whether the debt was or was not repaid.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Maintenance can have IRS consequences. In Portugal, the tax treatment depends on who pays, who receives, who the amount is intended for and whether there is a court decision or homologated agreement. The rules may differ for an ex-cônjuge and for children, so before filing the IRS return check Portal das Finanças or a contabilista.' },
        { kind: 'checklist', items: [
          ...
          'If your income has fallen, immediately submit a pedido de alteração; debt for past months usually does not disappear by itself',
          'If the child’s expenses have increased, gather faturas before applying for an increase',
          ...
          'If you have low income, request apoio judiciário/proteção jurídica before bringing the claim'
        ] },
  ...
  costs: [
    ...
    { label: 'IAS 2026', amountEUR: 537.13, note: 'Used as a social benchmark, including when assessing need for certain benefits and funds.' }
  ],
  sources: [
    {
