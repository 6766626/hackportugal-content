export default {
  ...
  tldr: 'Municipal markets are a living tradition: fresh fish, meat, vegetables, spices. The main ones in Lisbon: Mercado da Ribeira (Time Out), Mercado de Campo de Ourique, Arroios, 31 de Janeiro. In Porto — the legendary Mercado do Bolhão. They operate 7:00-14:00 (main hours), some until the evening as food halls.',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'l1', title: 'Mercado da Ribeira / Time Out Market', content: [
            { kind: 'paragraph', text: 'Cais do Sodré. In the morning — a traditional market: fish, meat. From midday until late — Time Out Market with 30+ food stalls from top Portuguese chefs. Very touristy, but the quality is high.' },
          ]},
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'p4', title: 'Feira de Vandoma', content: [
            { kind: 'paragraph', text: 'By Bolhão metro, on Sunday mornings. Flea market.' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Mercado de Abrantes — medieval town, on Saturdays',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Ask for NIF for the IRS deduction on receipts',
  ...
  sources: [
    { title: 'Câmara Municipal de Lisboa — Markets', url: 'https://www.lisboa.pt/cidade/comercio/mercados-e-feiras', kind: 'official', language: 'pt', lastRetrieved: '2026-04-22' },
