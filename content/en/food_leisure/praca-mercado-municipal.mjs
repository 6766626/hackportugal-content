export default {
  ...
  tldr: 'Mercado Municipal is not a tourist backdrop, but a normal way to buy fish, vegetables, fruit, cheese, bread and flowers. In 2026 the main spots are: Mercado da Ribeira / Time Out Lisboa, Mercado 31 de Janeiro and Forno do Tijolo in Lisbon, Mercado do Bolhão in Porto, Mercado Municipal D. Pedro V in Coimbra. Fresh-produce stalls usually work in the morning: 07:00–14:00, with Bolhão open longer. Prices are often lower than the supermercado for seasonal vegetables and fish, but higher for “gourmet” and prepared food.',
  tags: ['mercado', 'markets', 'lisbon', 'porto', 'coimbra'],
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Mercado Municipal is a municipal market with licensed sellers. Inside there are usually areas for: peixe, carne, fruta e legumes, charcutaria, queijo, pão, flores, cafés. In large cities, some markets have turned into a hybrid: in the morning — fresh produce, in the afternoon and evening — a food hall, restaurants and tourist footfall.' },
        { kind: 'checklist', items: [
          'The best time for fresh fish and seafood is 07:30–10:30, especially Tuesday–Saturday.',
          'On Mondays the fish selection is often weaker: there are fewer deliveries after Sunday.',
          ...
          'Bags may be charged for; bring your own bag and small containers.',
          'Fish prices are usually shown per 1 kg; the seller can clean the peixe for free or for a symbolic fee.',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'ribeira', title: 'Mercado da Ribeira / Time Out Market Lisboa', content: [
            { kind: 'paragraph', text: 'Address: Avenida 24 de Julho, Cais do Sodré. This is two markets in one building: the classic Mercado da Ribeira with fresh produce and the tourist-oriented Time Out Market with restaurants. For home shopping, come in the morning, not in the evening.' },
            { kind: 'checklist', items: [
              'Fresh market: as a guide, Monday–Saturday, morning until early afternoon; check the timetable on cm-lisboa.pt before public holidays.',
              ...
              'Not the best choice for a cheap everyday basket: the location is touristy, and prepared food prices are higher than in ordinary tascas.',
              'Convenient after taking the ferry, the Cascais line train or the metro to Cais do Sodré.'
            ] }
          ] },
          { id: '31-janeiro', title: 'Mercado 31 de Janeiro', content: [
            { kind: 'paragraph', text: 'Address: Rua Engenheiro Vieira da Silva, near Saldanha / Picoas. This is one of the most practical markets for living in central Lisbon: fewer tourists, more regular shoppers.' },
            { kind: 'checklist', items: [
              'Typical hours for fresh bancas: Monday–Saturday, around 07:00–14:00.',
              'Its strengths are fish and seafood, vegetables, fruit and meat.',
              'Good for residents of Avenidas Novas, Arroios, Saldanha and Alameda.',
              'Prices for seasonal vegetables are often better than at the nearby Continente/Pingo Doce.',
              'After 12:30 the fish selection may shrink noticeably.'
            ] }
          ] },
          { id: 'forno-tijolo', title: 'Mercado Forno do Tijolo', content: [
            { kind: 'paragraph', text: 'Address: Rua Maria da Fonte, Anjos / Intendente area. The market is useful for those who live in Arroios, Graça, Penha de França and Anjos. There are many small cafés and Asian/African shops around it.' },
            { kind: 'checklist', items: [
              'Guide for fresh stalls: Monday–Saturday, morning and early afternoon.',
        ...
        { kind: 'substeps', items: [
          { id: 'bolhao', title: 'Mercado do Bolhão, Porto', content: [
            ...
            { kind: 'checklist', items: [
              ...
              'For photos and coffee, you can come during the day; for groceries, come in the morning.',
          ...
          { id: 'coimbra', title: 'Mercado Municipal D. Pedro V, Coimbra', content: [
            { kind: 'paragraph', text: 'Coimbra’s main market is Mercado Municipal D. Pedro V, near Avenida Sá da Bandeira and the historic centre. It is a calmer and more “homely” format than Ribeira or Bolhão.' },
            { kind: 'checklist', items: [
              'Opening-hours guide: Monday–Saturday, roughly 07:00–19:00; individual fresh bancas close earlier.',
          ...
          { id: 'olhao', title: 'Mercado Municipal de Olhão', content: [
            ...
            { kind: 'checklist', items: [
              'Guide: Monday–Saturday, morning until 13:00–14:00; Sunday usually closed.',
              'Its strength is fresh fish, shellfish, octopus and local produce.',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The main rule: mercado does not always win. It is often cheaper and better for seasonal vegetables, herbs, fruit and fish from “today’s catch”. Supermercado wins on promotions, stable pricing, packaged products, milk, yoghurts, household chemicals and products with longa validade.' },
        { kind: 'checklist', items: [
          ...
          'Farmed dourada / robalo: the price is more stable in a supermercado; at the market it may be more expensive if the fish is wild.',
          'Bacalhau, queijo, enchidos: compare per kg; attractive stalls in tourist markets do not mean a low price.',
          'Prepared food in Time Out / Bolhão food areas is a restaurant budget: often €10–18 per dish, not a “cheap market”.',
          'Coffee at the market is usually €0.80–1.20 for a bica, but in tourist areas it may be higher.',
          'Towards the end of the day there may be discounts on fruit and vegetables, but do not count on a wide choice.'
        ] },
        { kind: 'warning', text: 'Compare not a “bag for €3”, but the price per kg and the quality. At markets you may sometimes be offered a caixa inteira — a crate of fruit for less, but it spoils quickly. For a household of 1–2 people, this is not always a saving.' }
      ]
    },
    {
      id: 'seasonality',
    ...
    {
      id: 'practical-tips',
      title: 'Practical tips for expats: how not to overpay',
      content: [
        { kind: 'checklist', items: [
          'The first time, walk through the whole market without buying anything and note the prices per kg at 3–4 bancas.',
          'Buy from sellers where local pensioners and families queue, not only tourists.',
          'Ask for a small amount: “Meio quilo”, “Só duas peças”, “Para duas pessoas”.',
          'If you do not know the fish, say how you plan to cook it: “para grelhar”, “para forno”, “para sopa”.',
          'Check the receipt or the spoken total before paying, especially when buying several items.',
          'Do not touch fruit with your hands without permission: often the seller chooses and bags it themselves.',
          'For fish, take a separate bag and go straight home; in summer, do not walk around with it for 2 hours.',
          'Before public holidays and in August, check the hours: feriados, férias and municipal events change the schedule.',
          'For a regular basket, combine: market in the morning + supermercado for milk, grains, frozen food and household goods.'
        ] },
        { kind: 'warning', text: 'Official market hours and the hours of a specific banca are different things. A municipal market may be open until 19:00 or 20:00, but the fish seller has already closed at 13:00. For fresh produce, plan for the morning.' }
      ]
    }
  ],
  costs: [
    { label: 'Vegetables and herbs for 2–3 days', amountEURMin: 6, amountEURMax: 15, note: 'Seasonal market basket; imports and berries are more expensive.' },
    ...
    { label: 'Lunch in a Time Out / Bolhão food hall', amountEURMin: 12, amountEURMax: 25, note: 'Dish + drink; this is a restaurant format, not grocery shopping.' },
