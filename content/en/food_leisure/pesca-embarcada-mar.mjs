export default {
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          '1 day (embarcada): ~€5 (for comparison: from the shore — ~€2; apeada option)',
          '1 month (embarcada): ~€12',
          '1 year (embarcada): ~€50',
          'Licences come in only three durations: daily, monthly and annual (there is no “3-day” or “3-year” option)',
          'There is also a general (geral) licence covering all modalities: ~€20 a month, ~€70 a year'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'No more than 3 rods (lines) and 9 hooks per person at the same time',
  ...
  costs: [
    { label: 'Pesca Lúdica Embarcada licence — 1 day', amountEUR: 5 },
    { label: 'Licence — 1 month', amountEUR: 12 },
    { label: 'Licence — 1 year', amountEUR: 50 },
