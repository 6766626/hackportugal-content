export default {
  ...
  costs: [
    { label: 'Treats for neighbours’ children', amountEURMin: 5, amountEURMax: 20, note: 'A bag of sweets, broas or fruit for an apartment block/small group; depends on the bairro.' },
  ...
  sources: [
    ...
    {
      title: 'Diário da República: list of public holidays, including 1 November',
