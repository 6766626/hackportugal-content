export default {
  ...
  tldr: 'Any boat longer than 2.5 m or with an engine more powerful than 4.5 kW requires registration with the Capitania do Porto (under DGAM/AMN — AMN: the national maritime authority). The navigation class — Local/Costeira/Largo — determines where you may sail and what equipment is required. Registration cost: ~€50-200 depending on class and size. In parallel you need: insurance (~€150-400 per year), an operating permit (~€50), and for fishing — a separate pesca lúdica (recreational fishing) licence from a boat. Import from the EU: IVA (Portuguese VAT) is paid only for a new boat; used (6+ months and/or 100+ engine hours) — no IVA. From non-EU countries — duty + IVA + ISV equivalent. An imported boat is re-registered in Portugal and receives a new number.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '✅ Any motor boat with an engine more powerful than 4.5 kW (~6 hp)',
          '✅ Sailing boats of any size if they go beyond the bathing area',
          '✅ Kayaks and SUPs with any motor',
          '✅ Jet skis — all of them',
          '❌ Small plastic kayaks and SUP boards without a motor — registration is not needed',
          '❌ Inflatable mattresses and rings — not considered watercraft'
        ] },
        { kind: 'paragraph', text: 'If the boat is in Portugal for more than 6 months — registration is mandatory regardless of flag state. This also applies to yachts that are “temporary guests”.' }
      ]
    },
    {
      id: 'classes',
      ...
      content: [
        { kind: 'paragraph', text: 'The class determines how far from the coast and in what conditions you are allowed to sail. This is the most important decision when registering.' },
        { kind: 'checklist', items: [
          'Local: up to 5 miles from shore in sheltered waters. Minimal equipment. Suitable for daytime coastal fishing.',
          ...
          'Largo: no distance limits. Requirements are close to IMO standards.',
          'Interior: rivers and reservoirs. Separate category.'
        ] },
        { kind: 'paragraph', text: 'The higher the class, the more expensive registration, insurance and maintenance become. For beach/coastal fishing, 90% of people choose Local.' }
      ]
    },
    {
      id: 'how-to-register',
        ...
        { kind: 'substeps', items: [
          {
            ...
            content: [
              { kind: 'checklist', items: [
                ...
                'IBAN for refunding overpayments',
          ...
          },
          {
            ...
            content: [
              { kind: 'checklist', items: [
                ...
                'Photographs of the boat from different angles and of the serial number (HIN — Hull Identification Number)',
          ...
          },
          {
            ...
            content: [
              { kind: 'paragraph', text: 'Format: P-XX-NNNN, where P — Portugal, XX — port of registration (LX — Lisboa, CS — Cascais, SE — Setúbal, FA — Faro, etc.), NNNN — number. The number must be applied to both sides of the hull with indelible paint or on a plate in a visible place.' }
            ]
          }
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'If you move to Portugal with your boat — it must be re-registered.' },
        { kind: 'checklist', items: [
          'From the EU, new boat (< 6 months or < 100 engine hours): you need to pay IVA (Portuguese VAT) 23% in Portugal',
          'From the EU, used (> 6 months and > 100 hours): no IVA is needed, but registration is mandatory',
          ...
          'DAU (customs declaration) is processed at port customs',
          'After customs — standard registration at the Capitania'
        ] },
        { kind: 'paragraph', text: 'If you had a boat in another EU country, when moving to Portugal on a residence permit you can use the regime de transferência de residência (IVA exemption), if the boat has been owned for more than 6 months and you are moving permanently. Submit via the tax authority (Finanças) within 12 months after registering in Portugal.' }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Pump or bucket for bailing water',
          'Spare engine or oars (if the main engine is more powerful than 4.5 kW)',
          'First-aid kit',
          'Waterproof torch'
        ] },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Comprehensive (corpo + civil): 0.5-1.5% of the boat value per year',
          'Russian/Ukrainian documents are accepted by normal Portuguese insurers (Tranquilidade, Fidelidade, Allianz, Lusitania); the key point is that the boat must be registered in PT',
          'Cover: damage to third parties, hull, engine, equipment, reboque (towing), assistência',
          'Excess (franquia): usually 5-10% of the boat value or a fixed amount'
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Once a year, an operating licence for the boat is needed (similar to an MOT for a car):' },
        { kind: 'checklist', items: [
          'Local: ~€50 per year',
          'Costeira: ~€80 per year',
          'Largo: ~€150 per year',
          'Technical inspection: every 4 years for most classes, ~€50-100 per visit',
          'An annual fee (taxa de embarcação) is also charged — ~€30-100 depending on size'
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Exceeding the navigation class (Local boat in a Largo area): €250-1,500',
  ...
  costs: [
    ...
    { label: 'Comprehensive insurance (corpo)', amountEURMin: 300, amountEURMax: 1500, note: '0.5-1.5% of the value' },
    { label: 'IVA when importing a new boat', amountEURMin: 0, amountEURMax: 50000, note: '23% of the value — example: €50,000 boat = €11,500 IVA' }
  ],
  sources: [
