export default {
  ...
  tldr: 'Any apiary in Portugal (even a single hive in your garden) must be registered with DGAV (Direção-Geral de Alimentação e Veterinária — the public authority for food safety and veterinary matters). Registration is free: submit at the Junta de Freguesia (local parish council) or via ePortugal (the government services portal). After registration you receive a beekeeper number and the obligation to keep a sanitary logbook (caderno sanitário). Minimum distances: 200 m in urban areas, 50 m in rural areas (can be closer with a high fence). Honey for personal consumption — no HACCP. For sales you need a registered extraction room (sala de extração) and an ASAE (Autoridade de Segurança Alimentar e Económica — food safety enforcement) inspection. FNAP (the national federation of beekeepers) is the main union. Beginner courses: €150-€300. One hive yields 15-30 kg of honey per year; a starter kit (hive + swarm + protective gear) €250-€500.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Portugal is one of the EU leaders in honey production (~10,000 tonnes per year). The climate is mild, and there are many wild nectar sources: eucalipto (eucalyptus), rosemary, lavender, lemon balm, mato (wild scrub), citrus, chestnut, sobreiro (cork oak). The season is long: from February to October.' },
        { kind: 'checklist', items: [
          'Mel de Eucalipto — the most recognisable Portuguese honey, dark, with a bold flavour',
          'Mel de Rosmaninho — aromatic, a classic of Alentejo',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Since 2014, registration has been mandatory for all bee keepers in Portugal. Decreto-Lei 203/2005 and subsequent amendments. No registration — a fine of €100-€500 and the risk of losing bees during a DGAV inspection.' },
        { kind: 'substeps', items: [
          {
            id: 's1',
            ...
            content: [
              { kind: 'checklist', items: [
                ...
                'Address where the hives will be placed (your plot or the owner’s written permission)',
                'Number and type of hives: Lusitano and Langstroth boxes are common',
                'If there are multiple sites (apiaries) — list each one separately'
              ] }
            ]
          },
          {
            ...
            content: [
              { kind: 'checklist', items: [
                'Via ePortugal (government services portal): eportugal.gov.pt → Cidadão → Apicultura',
                ...
                'Upon approval you are issued a beekeeper number (format AA-NN-NNNN)'
              ] }
            ]
          },
          {
            ...
            content: [
              { kind: 'paragraph', text: 'Each hive must display your beekeeper number and the hive number. Use indelible paint on both sides, with character height at least 5 cm. This is critical for DGAV inspections.' }
            ]
          }
        ] }
      ]
    ...
    {
      id: 'distance-rules',
      title: 'Minimum distances — where you may place hives',
      content: [
        { kind: 'paragraph', text: 'This is the most common cause of disputes with neighbours. Decreto-Lei 203/2005 and Portaria 9/2021 set out the minimum distances:' },
        { kind: 'checklist', items: [
          '200 m from any buildings where people are present (dwellings, schools, hospitals) in urban areas',
          '50 m in rural areas',
          '25 m if there is a solid barrier at least 2 m high (hedge or wooden partition)',
          'You can place them adjacent if there is a line-of-sight barrier — a high wall or fence',
          ...
          'At least 50 m between neighbouring apiary sites to reduce swarming competition'
        ] },
        { kind: 'warning', text: 'If neighbours complain and the distances are not respected, the municipality (Câmara Municipal — municipal council) can require you to move the hives. This often happens after the first stinging incidents involving neighbours’ children. Check your municipality’s rules — they may be stricter.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The minimum for one hive:' },
        { kind: 'checklist', items: [
          ...
          'Hive stands: €10-€20',
          'Tools: uncapping fork, knife, honey extractor — basic manual from €100 (can be shared via a local association)'
        ] },
        ...
        { kind: 'paragraph', text: 'FNAP (the national federation of beekeepers) offers discounts to members, runs courses and publishes supplier catalogues.' }
      ]
    },
    {
      id: 'health-checks',
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Sanitary logbook (caderno sanitário): you must record all treatments — DGAV checks it'
        ] },
        { kind: 'paragraph', text: 'DGAV recommends consulting a veterinarian at least once a year. A vet’s visit usually costs €30-€80.' }
      ]
    },
    {
      id: 'selling-honey',
      ...
      content: [
        { kind: 'paragraph', text: 'If you want to sell honey, the requirements are greater:' },
        { kind: 'checklist', items: [
          'Beekeeper registration already in place',
          ...
          'Laboratory analyses of batches of honey (moisture, HMF, diastase) at least once per season: €30-€80 per analysis',
          'Labelling per EU requirements: name, beekeeper’s NIF, batch number, country of origin, net weight, best-before date',
          'Selling at markets — permit from the municipality (Câmara Municipal)',
          'Online sales — IVA is mandatory if turnover > €14,500 per year (changes possible from 2025)',
          'IGP (Indicação Geográfica Protegida — protected geographical indication): Mel da Serra de Aire, Mel do Alentejo, Mel de Trás-os-Montes — premium segment, requires additional registration'
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Groups in Telegram/WhatsApp: regional chats for beginners',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'Transhumance subsidy (transumância): about €2-€5 per hive',
          'Support for rebuilding colonies after losses due to Vespa velutina',
          'Investment in extraction equipment: co-funding up to 50%',
          'Training courses with funding: reimbursement up to 70%',
          'Pollination contracts: farmers pay the beekeeper to place hives during flowering (€5-€50 per hive per season)',
  ...
  sources: [
    ...
    { title: 'IFAP — support for beekeeping', url: 'https://www.ifap.pt', kind: 'official', language: 'pt', lastRetrieved: '2026-05-03' }
  ],
