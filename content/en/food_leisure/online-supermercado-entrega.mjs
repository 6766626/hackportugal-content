export default {
  ...
  tldr: 'In 2026, grocery delivery in Portugal works reasonably well in Lisboa, Porto and the suburbs, but coverage depends heavily on the postcode. Continente Online usually charges around €3–7 per slot, Auchan and Pingo Doce show the price after you enter the address, and El Corte Inglés Supermercado/Express is convenient in central Lisboa and can deliver part of the range in about 1 hour. For urgent purchases, use Glovo Mercado and Bolt Market, but prices and mark-ups are higher.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'There is no single “national” grocery delivery service in Portugal. The same brand may deliver in Lisboa, Porto, Cascais, Oeiras, Matosinhos or Gaia, but not in a neighbouring concelho. The check always starts with the código postal.' },
        { kind: 'checklist', items: [
          ...
          'Compare the final total, not just product prices: delivery, service fee, bags, promotions and substitutions affect the bill.',
          'If you live in a prédio without a lift, specify the floor and intercom code in advance.',
    ...
    },
    {
      ...
      title: '2. Main chains: which one to choose',
      content: [
        { kind: 'substeps', items: [
          { id: 'continente', title: 'Continente Online', content: [
            { kind: 'paragraph', text: 'The most universal option for a large shop. Good selection, frequent promoções, Continente card, delivery in many areas of Lisboa/Porto and other cities. A typical delivery charge in 2026 is around €3–7 depending on the slot, address and campaigns.' },
            { kind: 'checklist', items: [
              'Suitable for a weekly shop.',
              'Convenient for buying water, household chemicals, children’s products and Continente products.',
              'You can allow or block substituições — replacements for out-of-stock items.',
              'Prices and promos are best checked on the day of the order: offers change frequently.',
              'Clube/Cartão Continente may provide coupons, saldo em cartão and Galp fuel discounts through separate campaigns.'
            ] }
          ] },
          ...
          { id: 'el-corte-ingles', title: 'El Corte Inglés Supermercado / Express', content: [
            { kind: 'paragraph', text: 'A premium option, especially in Lisboa. In central Lisboa, the Express service can be convenient for fast delivery in about 1 hour if the address is within the coverage area. Prices are often higher, but there is a good selection of delicatessen items, imported goods, meat, fish, wine and ready meals.' }
          ] },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'For urgent delivery, choose items without complicated substitutions: milk, bread, eggs, snacks, household chemicals.',
          'For fresh fish, meat and vegetables, a large supermercado with proper picking and slots is better.',
          'In the rain, on Friday evenings and on holidays, delivery times and prices can rise sharply.'
        ] },
        { kind: 'warning', text: 'Do not compare the price of a product on Glovo/Bolt directly with the shelf price in a shop: the platform may have separate prices, fees and promo codes. A final €30 basket can easily become €35–40.' }
      ]
    },
    {
      id: 'ordering-tips',
      ...
      content: [
        { kind: 'checklist', items: [
          'Create an account in advance, and add a NIF only if you need an invoice-fatura for IRS or a company.',
          ...
          'Mark whether you need sacos. Bags are usually paid for, even if the amount is small.',
        ...
        { kind: 'paragraph', text: 'Payment usually works by Visa/Mastercard, MB WAY, and sometimes PayPal or Multibanco. International cards can be declined because of 3-D Secure; a Portuguese card or MB WAY is often more reliable.' }
      ]
    },
    {
      id: 'fresh-products',
      ...
      content: [
        { kind: 'paragraph', text: 'The main problem with online supermarkets is not delivery, but the selection of fresh products. The picker chooses vegetables, fruit, meat and fish for you. In good chains this works reasonably well, but quality depends on the shop, the shift and the order time.' },
        { kind: 'checklist', items: [
          'Vegetables and fruit where exact ripeness matters are better bought offline at a mercado municipal or in a frutaria.',
          'For meat and fish, specify a weight range and preferences if the comment field is available.',
          ...
          'For a large water order, check whether couriers carry it up to the flat or leave it at the entrance — rules depend on the service.'
        ] },
        { kind: 'warning', text: 'In Portugal, couriers and pickers are not obliged to call about every out-of-stock item. If substitutions are critical because of allergies, baby food or diet, it is better to block substituições.' }
      ]
    },
    {
      id: 'best-strategy',
      ...
      content: [
        { kind: 'paragraph', text: 'The optimal setup in 2026: one large order once a week via Continente/Auchan/Pingo Doce, premium or imported items via El Corte Inglés, and urgent small items via Glovo or Bolt Market. After 2–3 orders it will become clear which chain best covers your exact address.' },
        { kind: 'checklist', items: [
          'For a family: Continente Online or Auchan with a large slot and delivery at €3–7 / according to the address tariff.',
          'For central Lisboa: El Corte Inglés Express for fast, high-quality purchases.',
          'For a studio flat or one person: Glovo/Bolt for urgent items, offline supermercado for basics.',
          'To save money: compare promoções and buy heavy items online, fresh items near home.',
          'For new areas after moving: test 2–3 services in the first two weeks, and do not place a huge first order.'
        ] }
      ]
    }
  ],
