export default {
  ...
  tldr: 'Portugal is a world capital of surfing. Nazaré holds records for the biggest waves (30+ m).\n\nEriceira is Europe’s only World Surf Reserve. Peniche, Sagres, Aljezur are legendary spots. Schools from €30-60/lesson + €15-25 rental, a full weekend camp around €150-350. Peak season: September-April for big waves, May-August for beginners. Every level — from beginner to world-class.',
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'sc3', title: 'What is included', content: [
            { kind: 'checklist', items: [
              ...
              'Instructor',
              'Photo shoot (sometimes an extra €10-20)',
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'b3', title: 'Rental (for tourists)', content: [
            { kind: 'checklist', items: [
              ...
              'Popular beaches often have rentals, but wild/remote spots may not; book in advance and check seasonality'
            ]}
          ]}
        ]}
      ]
  ...
  sources: [
    { title: 'FPS — Portuguese Surf Federation', url: 'https://www.fpsurf.pt/', kind: 'official', language: 'pt', lastRetrieved: '2026-04-22' },
