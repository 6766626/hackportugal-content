export default {
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'Do not confuse “buying a sweet in Sintra” with “buying a Sintra sweet”. In Lisbon and supermarkets you can find similar versions, but a travesseiro from a display case in Sintra centro is a different experience: freshness is what matters.' }
      ]
    },
    {
      id: 'route',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Staff in central Sintra usually speak English, but a few phrases in Portuguese speed up the order and help you avoid looking lost in the queue.' },
        { kind: 'checklist', items: [
          '“Um travesseiro, por favor” — one travesseiro, please.',
          '“Duas queijadas de Sintra” — two queijadas de Sintra.',
  ...
  sources: [
    {
      title: 'Câmara Municipal de Sintra — tourism and local gastronomy',
