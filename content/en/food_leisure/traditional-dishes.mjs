export default {
  ...
  tldr: 'The staples are bacalhau (cod, “1001 recipes”), sardinhas assadas (sardines in Lisbon in summer), cozido à portuguesa (mixed meats), francesinha (Porto’s flagship dish), arroz de marisco (seafood rice), leitão da Bairrada (suckling pig).\n\nFor dessert — pastel de nata everywhere, ovos moles in Aveiro.',
  tags: ['food', 'cuisine', 'bacalhau', 'pastel de nata'],
  estimatedReadMinutes: 6,
  steps: [
    {
      id: 'must-try',
      title: 'TOP 10: what you absolutely must try',
      content: [
        { kind: 'checklist', items: [
          ...
          '🥟 Pastéis de Bacalhau — fried croquettes made from cod and potato (snack)'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🥚 Ovos Moles de Aveiro — egg yolk + sugar, in a wafer casing (IGP/PGI Aveiro)',
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'd2', title: 'Wine', content: [
            { kind: 'checklist', items: [
              ...
              'Bairrada espumante — sparkling wine, usually white or rosé'
            ]}
          ]},
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Bread, olives, butter and pâtés may be placed on the table as a couvert, but they are charged for if you eat them; prices must be shown on the menu. If you do not want them, say “não, obrigado” straight away and ask for them to be removed',
          'Main lunch is 13:00-15:00, dinner 20:00-22:00',
          'Coffee is after dessert, never with food',
          'Tips are not compulsory: in cafés people usually round up, and in a restaurant you can leave a small amount or around 5–10% for good service',
          'Menu do dia/prato do dia is usually the cheapest lunch: roughly €9–15 depending on the city and neighbourhood',
          'On the bill, “IVA incluído” means that IVA is already included in the price. A separate “taxa de serviço” is only possible if stated in advance',
  ...
  sources: [
    ...
    { title: 'DGADR — DOP/IGP: protected designations and traditional products', url: 'https://www.dgadr.gov.pt/', kind: 'official', language: 'pt', lastRetrieved: '2026-05-17' }
  ],
