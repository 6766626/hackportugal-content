export default {
  ...
  tldr: 'The tax address (domicílio fiscal) is a mandatory field in Finanças. Under art. 19.º LGT (Lei Geral Tributária), a new address must be reported within 60 days. The change is free. If you have a Cartão de Cidadão, the address is changed through the CC/ePortugal procedure, with confirmation using a code from a letter; if you only have a NIF, use Portal das Finanças → Alterar Domicílio Fiscal. IMPORTANT: changing your address in Finanças does NOT automatically update AIMA, SNS, Segurança Social, your bank, or your driving licence — notify each authority separately. For IMI, what mainly matters is the habitação própria e permanente status; the IMI rate itself depends on the município where the property is located.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '💻 If you have a Cartão de Cidadão: change your morada through ePortugal/Cartão de Cidadão; confirmation is by a code sent in a postal letter. After confirmation, the address is sent to AT',
          ...
          '✅ For AT-only changes, it is usually applied immediately or after validation; for CC — after confirmation with the code from the letter',
          '📬 Download the comprovativo/certidão in Portal das Finanças and save the PDF',
          '🆓 Free'
        ]},
        { kind: 'warning', text: 'Changing your address in Finanças does NOT automatically update your address in AIMA, SNS, Segurança Social, your bank, or your driving licence. Notify each authority separately. For CC, the procedure may partially update a number of authorities through AMA, but not AIMA and many services.' }
      ]
    },
    {
      id: 'in-person',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'A foreign domicílio fiscal usually means registration with AT as a non-resident, but tax residence is determined under the rules of art. 16.º CIRS (183+ days or accommodation indicating habitual residence). For non-residents, Portugal-source income is taxed at special rates: employment/self-employment income is often 25% (art. 72), dividends/interest are usually subject to 28% withholding, blacklist jurisdictions — 35%; real estate has its own rules. Double taxation agreements may change the rates.' },
        { kind: 'warning', text: 'If your tax address is outside the EU/EEA, check whether you are required to appoint a representante fiscal. In some cases, this requirement is removed by opting in to electronic notifications, but for IVA/professional activity a representative may remain mandatory.' }
      ]
    },
    {
      id: 'when-change',
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🇵🇹 Moving to Portugal and actually meeting the tax residence criteria (183+ days or accommodation indicating habitual residence); obtaining a residence permit in itself does not equal tax residence',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The certificate confirms your current tax address. It may be needed by a bank, landlord, accountant, or public authority; requirements depend on the specific procedure.' },
        { kind: 'checklist', items: [
          'Portal das Finanças → “Certidões” → “Certidão de Domicílio Fiscal”',
          'Instantly, PDF with QR code',
          'Free',
          'Authenticity check — through Portal das Finanças → Validar certidão/documento, using the code or QR code on the PDF'
        ]}
      ]
    }
  ],
  sources: [
    ...
    { title: 'IRS Code — art. 16.º, 71.º, 72.º (residence, rates)', url: 'https://diariodarepublica.pt/dr/legislacao-consolidada/decreto-lei/1988-34544875', kind: 'law', language: 'pt', lastRetrieved: '2026-05-17' },
