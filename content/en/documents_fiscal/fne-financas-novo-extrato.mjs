export default {
  ...
  title: 'Obtaining Finanças certificates: IRS, IUC, IMI, dividends and no-debt status',
  tldr: 'In Portal das Finanças you can obtain AT tax certificates free of charge or for a small fee: declaração de não-dívida, certidão de IRS, IUC, IMI, comprovativo de morada fiscal and income certificates, including dividends. Path: Portal das Finanças → Cidadãos → Serviços → Certidões. Most PDFs are issued immediately and cost €0; some certidões can cost up to €10. Validity depends on the type: não-dívida is usually 3 months, and many recipients accept other certificates only if they are no older than 6 months.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Certidão de IRS — a certificate relating to filed IRS declarations, liquidação or income for a specific year.',
          'Comprovativo de entrega da declaração IRS — confirmation that the IRS Modelo 3 declaration was submitted.',
          'Demonstração de liquidação IRS — the IRS tax assessment: income, deductions, withholdings, amount payable or refund.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'If you have a residence permit and a Portuguese phone number, it is more convenient to activate Chave Móvel Digital.',
          'Make sure your morada fiscal is up to date: many certificates are tied to your tax address.',
          'Disable your browser’s automatic translator if the portal buttons start behaving incorrectly.',
          'Download PDFs immediately: some pages do not restore the result after you log out of the session.'
        ] },
        { kind: 'warning', text: 'Having a NIF does not in itself mean tax residency. Comprovativo de morada fiscal shows the address registered with AT, but a bank or foreign tax authority sometimes requires a separate certidão de residência fiscal.' }
      ]
    },
    {
      id: 'path-certidoes',
      ...
      content: [
        { kind: 'paragraph', text: 'The standard path in 2026 is: Portal das Finanças → Cidadãos → Serviços → Certidões. Menu item names on the portal sometimes change, so it is faster to use the search bar with terms such as “certidão”, “não dívida”, “domicílio fiscal”, “IRS”, “IUC”, “IMI”.' },
        { kind: 'substeps', items: [
          {
            id: 'non-debt',
            title: 'No-debt certificate',
            content: [
              { kind: 'paragraph', text: 'Look for “Situação Tributária Regularizada” or “Certidão de dívida e não dívida”. Select emissão, confirm the request and download the PDF.' },
          ...
          },
          {
            ...
            content: [
              { kind: 'paragraph', text: 'For IRS, use the IRS → Consultar Declaração, Obter Comprovativo, Liquidação or Certidões sections. For dividend income, look for certificates relating to rendimentos or download the declaração IRS Modelo 3 + Anexo E and demonstração de liquidação for the required year.' }
            ]
          },
          {
            id: 'imi-iuc',
            title: 'IMI and IUC',
            content: [
              { kind: 'paragraph', text: 'For property, look for “Património”, “Prédios”, “Caderneta Predial” or “Certidão de teor matricial”. For cars, use “Veículos”, “IUC” and tax comprovativos/certidões.' }
            ]
          }
        ] }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'For a bank when opening an account: comprovativo de morada fiscal, declaração de IRS or certidão de residência fiscal, if the bank checks tax residency.',
          ...
          'For a car: comprovativo IUC, vehicle details and absence of IUC debts.',
          'For foreign tax authorities: a certidão de residência fiscal is often needed, sometimes stating the year and the applicable convenção para evitar dupla tributação.',
          'For dividends: use Anexo E IRS, declaração de rendimentos and broker documents; Finanças does not automatically see all foreign payments.'
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Most electronic certificates in Portal das Finanças are issued immediately as PDFs and are free of charge. If the system shows emolumentos or a taxa, you can pay via referência Multibanco/MB WAY, after which the document becomes available.' },
        { kind: 'checklist', items: [
          'Typical cost: €0 for most comprovativos and certidões downloaded online.',
          'Some certidões or certified versions may cost up to €10.',
          'Validity is not universal: check the “validade” field in the PDF.',
          'Não-dívida is usually valid for 3 months.',
          'For IRS, IMI, IUC and morada fiscal, many organisations require a document no older than 3–6 months, even if the PDF has no explicit expiry date.',
          'A PDF from Portal das Finanças usually contains a código de validação; the recipient can verify its authenticity online.',
        ...
        { kind: 'warning', text: 'Do not send a full IRS to third parties unless necessary: it contains NIF, address, income, withholdings, marital status and bank details for the refund. For renting or school, the first page or a certidão específica is sometimes enough.' }
      ]
    },
    {
      id: 'common-problems',
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'No IRS for last year — you may not have been a tax resident or the declaration may not have been filed.',
          ...
          'IUC remains attached to a sold car — check whether the buyer re-registered the veículo with IRN/IMT; the tax is paid by the owner on the date of aniversário da matrícula.',
        ...
        { kind: 'paragraph', text: 'If the online section does not work, you can open a pedido e-balcão in Portal das Finanças: describe the document, tax year, NIF and purpose. For urgent cases, booking an appointment at a Serviço de Finanças can help, but AT expects most certificates to be obtained online.' }
      ]
    }
  ],
  costs: [
    { label: 'Comprovativo de morada fiscal', amountEUR: 0, note: 'Usually downloaded free of charge in Portal das Finanças.' },
    { label: 'Declaração de não-dívida / situação tributária regularizada', amountEUR: 0, note: 'Electronic issue is usually free of charge; validity is usually 3 months.' },
    { label: 'IRS comprovativo / liquidação', amountEUR: 0, note: 'Available online for submitted declarations and years with data in AT.' },
    { label: 'Specific AT certidões', amountEURMin: 0, amountEURMax: 10, note: 'The cost depends on the type of certificate and method of issue; the portal will show the amount before confirmation.' }
  ],
  sources: [
