export default {
  ...
  title: 'Obtaining certificates from Finanças: IRS, IUC, IMI, dividends and no outstanding debts',
  tldr: 'In Portal das Finanças you can obtain AT tax certificates free of charge or for a small fee: declaração de não-dívida, certidão de IRS, IUC, IMI, comprovativo de morada fiscal and income certificates, including dividends. Path: Portal das Finanças → Cidadãos → Serviços → Certidões. Most PDFs are issued immediately and cost €0, while some certidões may cost up to €10. Validity depends on the type: não-dívida is usually 3 months, and many recipients accept other certificates only if they are no more than 6 months old.',
  tags: ['finanças', 'certificates', 'irs', 'imi', 'iuc'],
  estimatedReadMinutes: 5,
  steps: [
    {
      id: 'what-you-can-get',
      title: 'Which certificates are available from Finanças',
      content: [
        { kind: 'paragraph', text: 'Portal das Finanças is the main source of official tax certificates from the Autoridade Tributária e Aduaneira (AT). PDFs with a verification code are usually accepted by banks, Câmara Municipal, AIMA, employers, universities, insurers and landlords.' },
        { kind: 'checklist', items: [
          ...
          'Certidão de IRS — a certificate relating to submitted IRS returns, liquidação or income for a specific year.',
          ...
          'Certidão de domicílio fiscal / comprovativo de morada fiscal — official tax address in Portugal.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Make sure your morada fiscal is up to date: many certificates are linked to your tax address.',
          'Turn off the browser auto-translator if the portal buttons start working incorrectly.',
          'Download PDFs immediately: some pages do not restore the result after you log out of the session.'
        ] },
        { kind: 'warning', text: 'Having a NIF does not by itself mean tax residence. Comprovativo de morada fiscal shows the address held by AT, but a bank or foreign tax authority may sometimes require a separate certidão de residência fiscal.' }
      ]
    },
    {
      id: 'path-certidoes',
      ...
      content: [
        { kind: 'paragraph', text: 'The standard path in 2026 is: Portal das Finanças → Cidadãos → Serviços → Certidões. On the portal, item names sometimes change, so it is quicker to use the search bar with the words “certidão”, “não dívida”, “domicílio fiscal”, “IRS”, “IUC”, “IMI”.' },
        { kind: 'substeps', items: [
          {
            id: 'non-debt',
            title: 'Certificate of no outstanding debts',
            content: [
          ...
          },
          {
            ...
            title: 'IMI and IUC',
            content: [
              { kind: 'paragraph', text: 'For property, look for “Património”, “Prédios”, “Caderneta Predial” or “Certidão de teor matricial”. For cars, use “Veículos”, “IUC” and tax-related comprovativos/certidões.' }
            ]
          }
        ] }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'For a bank when opening an account: comprovativo de morada fiscal, declaração de IRS or certidão de residência fiscal, if the bank is checking tax residence.',
          ...
          'For foreign tax authorities: certidão de residência fiscal is often required, sometimes stating the year and the applicable convenção para evitar dupla tributação.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'For IRS, IMI, IUC and morada fiscal, many organisations require a document issued within the last 3–6 months, even if the PDF has no explicit expiry date.',
          ...
          'If the data is wrong, first correct the source record: morada fiscal, IRS declaration, registo do imóvel or veículo; the new certidão will pull in the updated data.'
        ] },
        { kind: 'warning', text: 'Do not send your full IRS to third parties unless necessary: it contains NIF, address, income, withholdings, marital status and bank details for the refund. For renting or school, the first page or a certidão específica is sometimes enough.' }
      ]
    },
    {
      id: 'common-problems',
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Não-dívida is not issued — check pagamentos em falta, coimas, IMI, IUC, IVA, IRS or instalment payment dívida em prestações.',
          ...
          'IUC is still attached to a sold car — check whether the buyer re-registered the veículo with IRN/IMT; the tax is paid by the owner on the date of aniversário da matrícula.',
          'The recipient does not accept the PDF — send it together with the código de validação or ask them to state the exact name of the required certidão.'
        ] },
        { kind: 'paragraph', text: 'If the online section does not work, you can open a pedido e-balcão in Portal das Finanças: describe the document, tax year, NIF and purpose. For urgent cases, an appointment at Serviço de Finanças can help, but AT expects you to obtain most certificates online.' }
      ]
    }
  ],
  costs: [
    { label: 'Comprovativo de morada fiscal', amountEUR: 0, note: 'Usually downloaded free of charge in Portal das Finanças.' },
    { label: 'Declaração de não-dívida / situação tributária regularizada', amountEUR: 0, note: 'Electronic issuance is usually free; validity is usually 3 months.' },
    { label: 'IRS comprovativo / liquidação', amountEUR: 0, note: 'Available online for submitted returns and years with data in AT.' },
    { label: 'Specific AT certidões', amountEURMin: 0, amountEURMax: 10, note: 'The cost depends on the type of certificate and method of issuance; the portal will show the amount before confirmation.' }
  ],
  sources: [
    ...
    { title: 'Portal das Finanças — Cidadãos / Serviços / Certidões section', url: 'https://www.portaldasfinancas.gov.pt/at/html/index.html', kind: 'official', language: 'pt', lastRetrieved: '2026-04-28' },
