export default {
  ...
  timelineDaysMax: 1,
  sources: [
    { title: 'ePortugal — Obtain a NIF', url: 'https://eportugal.gov.pt/servicos/pedir-o-numero-de-identificacao-fiscal-nif-para-pessoa-singular', kind: 'official', language: 'pt', lastRetrieved: '2026-05-17' },
