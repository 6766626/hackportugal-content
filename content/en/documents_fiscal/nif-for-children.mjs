export default {
  ...
  tldr: 'A child’s NIF is often requested: for school, SNS (Número de Utente) registration, insurance, private medical services, Abono de Família. If the child obtains Portuguese citizenship and the first Cartão de Cidadão/Nascer Cidadão is issued, NIF/NISS/Número de Utente are usually assigned as part of that procedure. For a foreign child (even if born in PT), the NIF is arranged separately at Finanças. Free of charge.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Enrolment in a state or private school, nursery school or crèche',
          'Registration with SNS (Número de Utente) — through the Centro de Saúde',
          'Abono de Família — in addition to the NIF, the child’s NISS/link in Segurança Social is usually needed, as well as meeting residency and income conditions',
        ...
        { kind: 'paragraph', text: 'For school and SNS, the absence of a NIF should not block basic access, but a NIF is often needed for administrative records, benefits, insurance and tax/financial actions.' }
      ]
    },
    {
      id: 'path-pt-born',
      ...
      content: [
        { kind: 'paragraph', text: 'Hospitals have the Balcão do Nado Vivo (“newborn counter”) — a single procedure for registering a newborn.' },
        { kind: 'checklist', items: [
    ...
    {
      id: 'path-foreign',
      title: 'If the child came from abroad',
      content: [
        { kind: 'substeps', items: [
          { id: 'f1', title: 'Option A — in person at Finanças', content: [
            { kind: 'checklist', items: [
              'Book an appointment on Portal das Finanças or attend on a walk-in basis',
          ...
          { id: 'f2', title: 'Option B — remotely through a representative', content: [
            { kind: 'paragraph', text: 'If the parents are third-country nationals and are not yet in Portugal, the same mechanism applies as for an adult NIF through a tax representative. After moving, the morada fiscal must be changed to an address in Portugal/EU/EEA — then the representante fiscal can usually be removed; the residence permit itself, without changing the morada fiscal in Finanças, does not do this.\n\nCost — €70–150 through a lawyer or company.' }
          ]},
          { id: 'f3', title: 'Option C — if the tax address is in Portugal/EU/EEA', content: [
            { kind: 'paragraph', text: 'If the child’s/parent’s tax address is in Portugal/EU/EEA, a fiscal representative is usually not needed. If the address is in a third country (including CPLP), the rules on representante fiscal/electronic notifications must be checked separately; CPLP citizenship in itself does not grant EU treatment.' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'The parent/legal representative acts on behalf of the child; if necessary, you can request a Portal das Finanças password for the child’s NIF. For taxes, the correct linking of the child in the agregado familiar is important',
          'Activate Portal das Finanças for the child — if the parent needs to view taxes on the child’s behalf; usually this is not required before age 18',
          'Provide the NIF to the school or nursery school at enrolment',
          'For SNS (Número de Utente), the next step is to contact the Centro de Saúde for the place of residence',
          'For Abono de Família — submit through the parent’s Segurança Social Direta for the child'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'warning', text: 'If the country issuing the certificate is not a party to the Hague Apostille Convention, consular legalisation is needed. Check the country’s status in the HCCH Apostille status table — Canada (since 11.01.2024) and China (since November 2023, mainland) already use apostilles. For Ukraine — online apostille through Diia. For EU documents, a multilingual standard form under Reg. (EU) 2016/1191 may be available without translation.' },
  ...
  documents: [
    { title: 'Birth certificate', note: 'apostille/legalisation, if applicable, + certified translation into Portuguese; for EU documents — check the multilingual standard form (Reg. EU 2016/1191)' },
  ...
  costs: [
    ...
    { label: 'Apostille + translation of the certificate', amountEURMin: 100, amountEURMax: 300 },
    { label: 'Tax representative (if remote)', amountEURMin: 70, amountEURMax: 150 }
  ],
  timelineDaysMin: 1,
  timelineDaysMax: 15,
  sources: [
