export default {
        ...
        { kind: 'substeps', items: [
          ...
          { id: 's2', title: 'UPAC > 30 kW', content: [
            { kind: 'checklist', items: [
              ...
              'For large houses / commercial premises',
              'Cost: €10,000-€30,000+',
  ...
  sources: [
    ...
    { title: 'Decreto-Lei 15/2022 — National Electricity System / self-consumption', url: 'https://diariodarepublica.pt/dr/detalhe/decreto-lei/15-2022', kind: 'law', language: 'pt', lastRetrieved: '2026-05-17' },
