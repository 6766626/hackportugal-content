export default {
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'In the apartment’s technical description, check for the words solar térmico or sistema solar para AQS.',
          'Confirm the volume of the depósito acumulador: for T1/T2 it is often 150–200 l, for T3/T4 — 200–300 l and more.',
          'Check whether the apartment has an individual system or a shared condomínio system.',
          'Clarify the type of apoio: electric, gas, bomba de calor; this affects winter bills.',
    ...
    {
      id: 'existing-homes',
      title: 'If the home is already built: there is no obligation, but it can make sense',
      content: [
        { kind: 'paragraph', text: 'For existing housing, installing solar térmico is usually not mandatory. Exceptions may arise during major renovation, replacement of AQS systems, or due to project/licensing requirements at the Câmara Municipal. For an ordinary apartment bought on the resale market, nobody will force you to urgently install a collector.' },
        { kind: 'paragraph', text: 'The economics depend on hot-water consumption. A family of 3–4 people with an electric water heater usually sees the most noticeable effect: in summer, apoio is barely needed; in winter, the system reduces the load but does not fully replace backup.' },
        { kind: 'warning', text: 'In an apartment building, you cannot simply install a collector on the roof without the consent of the condomínio. The roof is usually a common part of the building; you need an acta da assembleia de condóminos, a technical project and sometimes a comunicação/licença at the Câmara Municipal.' }
      ]
    },
    {
      id: 'incentives',
      ...
      content: [
        { kind: 'paragraph', text: 'For existing homes, subsidies are not automatic but come through specific Fundo Ambiental avisos: for example, building energy-efficiency improvement programmes may include solar térmico, bombas de calor, insulation and windows. Conditions change by aviso: support percentage, maximum amount, region, invoice date, mandatory equipment certificates.' },
        { kind: 'checklist', items: [
          'Check only the official Fundo Ambiental website and avisos abertos.',
          'Do not buy equipment “for a subsidy” until you have read the date range for eligible expenses.',
          'Keep the fatura with the homeowner’s NIF.',
          'Pay by bank method so that there is a comprovativo de pagamento.',
          ...
          'If the home is rented, obtain the owner’s written consent in advance.',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '“Painéis solares incluídos” without specifying: photovoltaic or solar térmico.',
          'No Certificado Energético SCE before escritura.',
          ...
          'The system is shared, but maintenance is not included in the orçamento condomínio.',
  ...
  costs: [
    { label: 'Solar térmico for an apartment/small house', amountEURMin: 1800, amountEURMax: 3500, note: 'Benchmark for a kit with a 150–300 l tank and installation; the price depends on the roof, pipes, access and apoio.' },
    ...
    { label: 'Certificado Energético SCE for housing', amountEURMin: 150, amountEURMax: 350, note: 'Market benchmark for an apartment/house; depends on area and the perito qualificado.' }
  ],
  sources: [
    {
    ...
    {
      title: 'DGEG — solar térmico energy and energy efficiency',
