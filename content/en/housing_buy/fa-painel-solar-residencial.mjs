export default {
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'The property is in Portugal: a flat or house used as habitação.',
          'The applicant has a NIF and access to Portal do Fundo Ambiental; for expats, NIF + email/password is suitable, and sometimes CMD makes login easier.',
          'The applicant is the owner, co-owner, usufrutuário or another titular, if the Aviso expressly allows this.',
          'There are no debts to Autoridade Tributária and Segurança Social; certidões de não dívida are usually required.',
          'Expenses are confirmed by fatura and recibo in the applicant’s name with a Portuguese NIF.',
          'The equipment is new, installed in an eligible dwelling and complies with the Aviso technical requirements.',
          ...
          'The IBAN belongs to the applicant; compensation arrives by bank transfer after verification.',
          'The application is submitted on time and before the call budget is exhausted.'
        ] },
        { kind: 'warning', text: 'A tenant without the owner’s consent is almost always in a weak position: panels change the technical configuration of the property and require autorização do proprietário/condomínio. For a flat, also check the condomínio rules and roof access.' }
      ]
    },
    {
      id: 'amounts-and-2026-timing',
      title: 'How much is paid and when to expect the 2026 wave',
      content: [
        { kind: 'paragraph', text: 'Fundo Ambiental works through an Aviso: the call document sets the budget, dates, compensation percentages, the cap by equipment type and the list of documents. In 2026, rely not on an installer’s advertising banner, but on the PDF Aviso on fundoambiental.pt.' },
        { kind: 'paragraph', text: 'A practical benchmark for a home solar system: compensation may be partial — for example, up to 85% of eligible cost in previous energy-efficiency programmes, but with a typology cap. For solar térmico or PV with storage, the cap could be higher, around €2,500; for simple PV without a battery, the ceiling could be lower. In a new wave, the figures may differ.' },
        { kind: 'checklist', items: [
          ...
          'Check whether an already installed system can be submitted, or only expenses after publication of the Aviso.',
          'Check whether there is an increased cap for areas outside Lisboa/Porto or for vulnerable households.',
        ...
        { kind: 'substeps', items: [
          { id: 'check-property', title: '1. Check the property and restrictions', content: [
            { kind: 'checklist', items: [
              ...
              'For solar térmico: space for the tank, water pipe runs and roof load.',
          ...
          { id: 'choose-installer', title: '2. Choose an installer without traps', content: [
            { kind: 'checklist', items: [
              ...
              'Check whether the price includes UPAC registration with DGEG, if it is needed.',
              'Do not pay 100% before checking the documents for Fundo Ambiental.'
            ] }
          ] },
          { id: 'paper-trail', title: '3. Collect the right documents straight away', content: [
            { kind: 'checklist', items: [
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'PV for self-consumption in Portugal is regulated under the UPAC regime. Small systems usually go through simplified registration, but thresholds and obligations depend on installed capacity. The installer must explain whether comunicação prévia, registration with DGEG or certificado de exploração is required.' },
        { kind: 'paragraph', text: 'If the system exports surplus to the grid, this is not the same as a Fundo Ambiental subsidy. Selling excedentes requires a contract with a comercializador/agregador and may have tax consequences. For an ordinary household, the key saving is reducing the EDP/Galp/Iberdrola bill and grid consumption during daylight hours.' },
        { kind: 'warning', text: 'Do not install panels “sem legalização”. When selling the house, in an insurance claim or during a condomínio inspection, the absence of DGEG/instalador documents can become a problem.' }
      ]
    },
    {
      id: 'application',
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Specify the property: morada, artigo matricial, housing type.',
          ...
          'Submit the candidatura and save the submission comprovativo.',
          'Respond to pedidos de esclarecimento quickly: missing the deadline leads to indeferimento.',
          'After aprovação, wait for pagamento; timeframes may range from weeks to many months.'
        ] },
        { kind: 'warning', text: 'If the application is rejected, you can usually submit a reclamação/contestação within the deadline stated in the notification. But a missing mandatory document, an incorrect fatura date or an installer outside the Aviso conditions often cannot be fixed after the fact.' }
      ]
    }
  ],
  costs: [
    { label: 'Fundo Ambiental subsidy benchmark per dwelling', amountEURMax: 2500, note: 'Not a guaranteed 2026 cap; depends on the specific Aviso and equipment typology.' },
    { label: 'Home PV system without battery, 2–4 kW', amountEURMin: 2500, amountEURMax: 6000, note: 'Indicative market price with installation; depends heavily on the roof, inverter and brand.' },
    { label: 'PV with battery', amountEURMin: 6000, amountEURMax: 12000, note: 'A battery increases self-consumption, but does not always pay for itself without an accurate calculation of the consumption profile.' },
