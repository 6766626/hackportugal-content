export default {
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The property classification in Finanças is called natureza do prédio. It appears in the caderneta predial and affects IMI, VPT valuation, IMT on purchase and permitted actions with the land.' },
        { kind: 'checklist', items: [
          'Prédio urbano — flat, house, commercial premises, warehouse, industrial property, as well as terreno para construção.',
          'Prédio rústico — land for agricultural or forestry use, where income is expected from the land rather than from a building.',
          ...
          'VPT — valor patrimonial tributário, the taxable value in Finanças; IMI is calculated from it.',
          'Caderneta predial — the property record in Finanças: natureza, VPT, área, proprietário, artigo matricial.',
          'Certidão permanente do registo predial — registration at the Conservatória: owner, mortgage, easements, seizures.',
          ...
          'Marketing terms such as “quinta”, “monte”, “ruína” or “terreno com viabilidade” prove nothing without the PDM/PDI and written information from the Câmara Municipal.'
        ] },
        { kind: 'warning', text: 'If an advert says “rústico com ruína”, this does not mean that you can restore the house for housing. The ruin may have no legal licença de utilização, may be outside the urban perimeter or may be in RAN/REN/an ICNF zone.' }
      ]
    },
    {
      id: 'taxes',
      ...
      content: [
        { kind: 'paragraph', text: 'The main recurring difference is IMI. For urbano, the rate is set by the Câmara Municipal within 0.3–0.45% of the VPT per year. For rústico, the rate is fixed — 0.8% of the VPT. The payment notice usually arrives through Portal das Finanças in May; for amounts above €100, 2–3 payments may be possible according to the Finanças calendar.' },
        { kind: 'checklist', items: [
          'IMI urbano: 0.3–0.45% of the VPT; check the specific rate for the concelho on Portal das Finanças.',
          'IMI rústico: 0.8% of the VPT.',
          'IMT when buying urbano housing for permanent residence — progressive scale; for second homes/investments the scale is different.',
          ...
          'Imposto do Selo when buying property — 0.8% of the price/VPT, whichever is higher.',
          'AIMI applies to high-value urban real estate: usually to the total VPT of urbano habitacional and terrenos para construção above €600,000 per person; rústico is usually not included in the AIMI base.',
          'IRS/IRC on sale: capital gains are calculated not by the word urbano/rústico, but by the purchase price, sale price, expenses, resident status and time periods.',
          ...
          'A tractor, trailer or agricultural machinery may have its own registration/transport rules, but this is separate from IMI on the plot.'
        ] },
        { kind: 'warning', text: 'Low IMI on rústico does not offset the risk if you are buying land “for a house” and the Câmara Municipal does not confirm the right to build. The loss may be legal rather than tax-related: the property will remain agricultural land without housing.' }
      ]
    },
    {
      id: 'construction',
      ...
      content: [
        { kind: 'paragraph', text: 'The decision is not made by Finanças, but by spatial planning: PDM or PDI, planta de ordenamento, planta de condicionantes, RAN, REN, ICNF, Rede Natura 2000, fire restrictions and Câmara Municipal rules. The rústico tax classification is only one signal, not the full answer.' },
        { kind: 'checklist', items: [
          ...
          'If the plot is forest land or in a high fire-risk area, check ICNF and municipal regras de gestão de combustível.',
          'Construction requires a projeto submitted by an architect/engineer and a licence or comunicação prévia at the Câmara Municipal.',
          '“Viabilidade de construção” is best obtained in writing: pedido de informação prévia (PIP) or official informação urbanística.',
          'Restoring a ruína may be simpler than new construction only if there is proven legality of the existing building and a permitted uso.',
          'A borehole, septic tank, access, electricity and water supply require separate checks; the existence of a neighbour’s connection does not give you an automatic right.',
        ...
        { kind: 'warning', text: 'Buying rústico with an agent’s verbal promise that “you will change it to urbano later” is a red flag. Changing the classification depends on the PDM/PDI, Câmara Municipal procedures and sometimes regional/national restrictions. It is not done by a simple declaration to Finanças.' }
      ]
    },
    {
      id: 'due-diligence',
      ...
      content: [
        { kind: 'paragraph', text: 'For an expat buyer, the safe logic is this: first check ownership and restrictions, then taxes, then sign the CPCV. This is especially important with rural property, where boundaries, access and buildings are often described less clearly than in the city.' },
        { kind: 'checklist', items: [
          ...
          'Check acesso: a public road or only an easement through neighbours; a verbal agreement is not the same as a registered right.',
          'Ask for the licença de utilização for the existing house or confirmation that old properties are exempt from it.',
          'Check whether the property is an AUGI, illegal development or part of an unformalised inheritance.',
          'Request dívida de condomínio if it is urbano in a building or condomínio fechado.',
          'Check IMI arrears: the seller’s debts should not pass to you, but they can complicate the transaction.',
          ...
          'Do not transfer a large sinal without review by a lawyer or solicitador, especially if you are buying remotely.'
        ] }
      ]
    },
    {
      id: 'agricultor-familiar',
      title: '5. Agricultor familiar: useful, but not a “magic benefit”',
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Family income, amount of labour and farm structure matter; the criteria are checked under the rules in force.',
          'The status may be useful for subsidies, local markets, short supply chains and rural development programmes.',
          'For housing construction, the deciding factors are still the PDM/PDI, Câmara Municipal, RAN/REN and other restrictions.',
          'If the aim is to live on the land, check in advance whether habitação do agricultor or apoio agrícola is permitted specifically in this zone.',
          'An agricultural building, armazém agrícola or apoio agrícola is not the same as a residential house: changing the use without a licence is not allowed.'
        ] },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'If the project is admissible, the architect submits the projeto de arquitetura and specialities; the Câmara issues a licence or accepts comunicação prévia.',
          'After completion of the works, autorização de utilização is issued, where applicable.',
          ...
          'A mass change of zoning from rústico to urbano is possible through a change to the PDM/PDI, but this is a political-administrative process, not an individual “buyer application”.',
  ...
  costs: [
    ...
    { label: 'IMT when buying prédio rústico', amountEURMin: 0, amountEURMax: 0, note: 'Usually 5% of the transaction price or VPT, whichever is higher.' },
