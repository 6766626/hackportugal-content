export default {
  ...
  sources: [
    ...
    { title: 'ePortugal: Energy certificate for buildings', url: 'https://www.gov.pt/servicos/pedir-o-certificado-energetico-de-edificios', kind: 'official', language: 'pt', lastRetrieved: '2026-04-28' }
  ],
