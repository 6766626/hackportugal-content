export default {
  ...
  tldr: 'When buying property in Portugal, the buyer pays IMT and Imposto do Selo before the escritura. The tax base is the higher of the transaction price and the VPT from the caderneta predial. For habitação própria e permanente in Continente in 2026, a progressive IMT table applies: 0% up to €106,346, then 2–8%, with separate rates of 6% and 7.5% for expensive properties (escalões updated by OE 2026 +2%). Imposto do Selo on the purchase is 0.8%. For jovens até 35 years old buying their first permanent home, there is an exemption up to €330,539 and partial relief up to €661,078.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'IMT — Imposto Municipal sobre as Transmissões Onerosas de Imóveis, a tax on property transfers. Imposto do Selo is stamp duty. Both are usually paid before signing the escritura or documento particular autenticado; otherwise the notary/solicitador will not complete the transaction.' },
        { kind: 'checklist', items: [
          'IMT is paid by the buyer, not the seller.',
          'Imposto do Selo on the purchase is 0.8% of the tax base.',
          'The tax base is the higher of two values: the contract price or the VPT from the caderneta predial.',
          ...
          'Payment is made by guia/DUC, usually via Multibanco, online banking or on Portal das Finanças.',
        ...
        { kind: 'warning', text: 'Do not calculate the tax only from the price in the CPCV. If the VPT is higher than the transaction price, Finanças will charge IMT and Selo on the VPT. This often comes up in cheap intra-family sales or older properties that have been revalued.' }
      ]
    },
    {
      id: 'imt-rates-mainland',
      title: 'IMT rates for residential property in Continente',
      content: [
        { kind: 'paragraph', text: 'For urban residential property, rates depend on the purpose: habitação própria e permanente — the buyer’s main home; habitação secundária or arrendamento — a second home, investment or rental. In Madeira and Açores, regional tables apply.' },
        { kind: 'paragraph', text: 'For habitação própria e permanente in Continente, the 2026 table (OE 2026, escalões increased by 2%) uses these thresholds: up to €106,346 — 0%; €106,346–€145,471 — 2% minus parcela a abater of €2,126.92; €145,471–€198,347 — 5% minus €6,491.03; €198,347–€330,539 — 7% minus €10,457.98; €330,539–€661,078 — 8% minus €13,763.38; €661,078–€1,150,853 — flat rate of 6%; above €1,150,853 — flat rate of 7.5%.' },
        { kind: 'checklist', items: [
          ...
          'A buyer connected with a jurisdiction on the paraísos fiscais list may fall under the 10% IMT rate.',
          'If you buy a share, the tax is calculated under the transaction rules and the value of the share transferred, but the notary will still check the VPT.'
        ] }
      ]
    },
    {
      id: 'jovem-exemption',
      title: 'Relief for young buyers aged up to 35',
      content: [
        { kind: 'paragraph', text: 'Since 2024, a regime has applied for jovens até 35 anos on the first purchase of habitação própria e permanente (DL 44/2024). In 2026, the practical full-relief threshold is linked to the 4th IMT escalão: up to €330,539. The relief applies to IMT and Imposto do Selo on the purchase.' },
        { kind: 'checklist', items: [
          ...
          'From €330,539 to €661,078: the relief is partial; tax is paid only on the part above the protected amount under the Finanças mechanism.',
          ...
          'After purchase, the property must be used as the main home; a change of purpose may lead to loss of the relief and additional tax to pay.'
        ] },
        { kind: 'paragraph', text: 'Example: a flat for a main home costing €350,000. Under the 2026 table, the ordinary IMT is €14,236.62 and Selo is €2,800. For a buyer aged up to 35 on a first purchase (DL 44/2024), the relief covers the part up to €330,539, and the amount payable is the proportional share only above €330,539.' },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'In practice, the calculation is done by the notary, advogado, solicitador, Casa Pronta or bank. But responsibility for correctness and payment lies with the buyer. Without a comprovativo de pagamento, the transaction will not go ahead.' },
        { kind: 'substeps', items: [
          ...
          { id: 'issue-guides', title: '2. Issue the guias de pagamento', content: [
            { kind: 'paragraph', text: 'The IMT and Imposto do Selo guias can be issued through Portal das Finanças or through the professional handling the transaction. The guia will contain a referência para pagamento and a deadline.' }
          ] },
          { id: 'pay-before-deed', title: '3. Pay before signing', content: [
            { kind: 'checklist', items: [
              ...
              'Check that the buyer’s NIF is shown correctly.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'If the price is below the VPT, recalculate all examples from the VPT.',
          ...
          'Do not spend your entire deposit on the CPCV: the taxes must be available in cash by the escritura date.'
        ] },
        { kind: 'warning', text: 'The bank finances the purchase price, but usually does not finance IMT, Imposto do Selo or notary costs. The buyer must have this money separately.' }
      ]
    }
  ],
  costs: [
