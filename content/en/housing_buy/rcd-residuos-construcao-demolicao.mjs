export default {
  ...
  tldr: 'RCD (resíduos de construção e demolição) means tiles, concrete, brick, plasterboard and sanitaryware left after renovation works. In Portugal you cannot put it in normal contentores or leave it by the bins: you need an Ecocentro for small DIY volumes or a licensed transportadora + aterro/operador RCD and e-GAR/Guia de Acompanhamento de Resíduos. Small volumes at a municipal Ecocentro are often free, but limits vary; commercial removal in 2026 is usually €80–200/m³ plus possible landfill fees.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'RCD means resíduos de construção e demolição: waste from construction, renovation, demolition and small obras. In everyday home situations, this is usually bags of tiles, cement, plaster, brick, concrete, plasterboard, leftover pipes, doors, windows and sanitaryware.' },
        { kind: 'checklist', items: [
          ...
          'Asbestos/amianto — a separate hazardous category; a normal RCD carrier is not suitable.',
          'Household rubbish, cardboard from purchases, food waste — not RCD, and should go into the normal recycling/indiferenciados streams.'
        ] },
        { kind: 'warning', text: 'You must not leave construction bags next to ordinary contentores. Even if “everyone does it”, this is considered deposição ilegal de resíduos and can end in a fine from the Câmara Municipal or municipal police.' }
      ]
    },
    {
      id: 'small-diy',
      ...
      content: [
        { kind: 'paragraph', text: 'If you have replaced a couple of rows of tiles yourself, removed a toilet or dismantled a cupboard, the cheapest route is usually the municipal Ecocentro. For residents of the município, acceptance of small volumes is often free, but the rules and limits are set by the Câmara Municipal or the intermunicipal waste company.' },
        { kind: 'checklist', items: [
        ...
        { kind: 'paragraph', text: 'In Lisbon, the Câmara Municipal directs residents to ecocentros and municipal recolha channels for separate streams. The practical point: do not try to make an arrangement with the building cleaner or leave bags out at night — for RCD, that is not a legal solution.' }
      ]
    },
    {
      id: 'large-renovation',
      ...
      content: [
        { kind: 'paragraph', text: 'If there is more waste than fits in a car boot, or an empreiteiro is working, arrange removal through a licensed transportadora de resíduos. It must take the RCD to an authorised operador/aterro RCD: for example, regional systems and operators such as Valnor, Tratolixo or other facilities listed in APA/SILOGR licences.' },
        { kind: 'checklist', items: [
          ...
          'Confirm the LER/EWC waste code: for ordinary entulho, construction codes from group 17 are often used, but the operator must classify it themselves.',
        ...
        { kind: 'warning', text: 'If the carrier offers “cheaper without documents”, the risk remains with the waste producer. If there is illegal dumping, they may look for the person whose renovation generated the waste using bags, address labels, condomínio cameras or neighbours’ complaints.' }
      ]
    },
    {
      id: 'egar-gar',
      ...
      content: [
        { kind: 'paragraph', text: 'Guia de Acompanhamento de Resíduos is now usually issued in practice as an e-GAR in the SILIAMB/APA system. This is an electronic consignment note linking the waste producer, carrier and receiving operator. For a private individual, it is usually prepared by the transportadora or contractor, but you should ask for a copy/number.' },
        { kind: 'checklist', items: [
          ...
          'The date of transport and the vehicle/carrier registration must be included.',
        ...
        { kind: 'paragraph', text: 'For one or two bags that you personally take to an Ecocentro, an e-GAR is usually not required from a resident as a household user. But for commercial RCD removal, the document should be part of the service.' }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'A contentor on the street may require autorização da Câmara Municipal and payment for occupation of public space.',
          'The aterro/operador may charge by the tonne; check whether the gate fee is included in the price.',
          'Carrying up/down without a lift, narrow stairs, historic centre, restricted-access area — a separate surcharge.',
        ...
        { kind: 'warning', text: 'Do not pay the full removal cost in cash without a recibo/fatura and without an e-GAR, unless the volume is “small Ecocentro”. Cheap illegal removal can become an expensive fine and a problem when selling the flat or in a dispute with the condomínio.' }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'Tell the administração do condomínio the dates of the works and removal.',
          'Check whether the lift can be used for RCD bags and whether the cabin needs protection.',
          'Do not store bags in shared corridors, on stairs or by the entrance: this is a fire and hygiene risk.',
          'If a contentor is needed on the street, check the licença/ocupação de via pública with the Câmara Municipal.',
          'Agree horários de ruído: construction noise in residential buildings is usually limited to working days and daytime hours under municipal rules.',
  ...
  costs: [
    ...
    { label: 'Commercial RCD removal by a licensed transportadora', amountEURMin: 80, amountEURMax: 200, note: 'Guide price per m³ in 2026 for ordinary entulho; depends on the city, weight, floor, loading and access.' },
