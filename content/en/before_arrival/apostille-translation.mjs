export default {
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Criminal record certificate — valid for 3-6 months, often a “recent” one is required',
          'Diploma + supplement + academic transcript — for recognition',
          'School certificate — for children',
          'Medical certificates — rarely, but possible',
          'Powers of attorney'
        ]},
        { kind: 'warning', text: 'You do NOT need to apostille your passport or residence permit — they are recognised internationally in their own right.' }
      ]
    },
    {
      id: 'russia-process',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'r1', title: '1. Civil registry office — certificates', content: [
            { kind: 'paragraph', text: 'Obtain a duplicate certificate from the civil registry office → apostille at the regional civil registry office administration or the Ministry of Justice. 3-30 days, RUB 2,500-4,000.' }
          ]},
          { id: 'r2', title: '2. Criminal record certificate', content: [
            { kind: 'paragraph', text: 'Ministry of Internal Affairs → apostille via the Ministry of Justice. 2-4 weeks. It can be done remotely via Gosuslugi + consulate, but the consular process is slower.' }
          ]},
          ...
          { id: 'r4', title: '4. Consulate of Portugal in Moscow', content: [
            { kind: 'paragraph', text: 'Alternative — legalisation at the consulate (only if an apostille is unavailable).' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Civil registry office — certificates (apostilled at the Ministry of Justice of the Republic of Belarus). Ministry of Internal Affairs — criminal record certificate (apostille at the Ministry of Justice). Diploma — Ministry of Education of the Republic of Belarus.' },
        { kind: 'paragraph', text: 'The timeframe is usually 2-4 weeks. Expedited services are available when applying in person in Minsk.' }
      ]
    },
    {
      id: 'ukraine-process',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Portugal does not have the institution of a “sworn translator” in the same way as some countries. Instead:' },
        { kind: 'substeps', items: [
          ...
          { id: 't2', title: 'Option B — translation with a notary', content: [
            { kind: 'paragraph', text: 'The notary adds a certification statement to the translation.' }
          ]},
          { id: 't3', title: 'Option C — Consulate of Portugal in the country of origin', content: [
  ...
  costs: [
    { label: 'Russian Federation apostille (certificate)', amountEURMin: 25, amountEURMax: 45, note: 'RUB 2,500-4,000' },
    { label: 'Russian Federation apostille (criminal record certificate)', amountEURMin: 20, amountEURMax: 40 },
    { label: 'Sworn translation (1 document)', amountEURMin: 30, amountEURMax: 80 },
    { label: 'Certification at the Conservatória do Registo Civil/with a notary', amountEURMin: 25, amountEURMax: 60 }
  ],
  sources: [
