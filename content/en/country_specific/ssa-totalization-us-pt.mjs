export default {
  ...
  tldr: 'You can receive a US Social Security pension while living in Portugal: payments are handled through the SSA/Federal Benefits Unit at the US Embassy in Lisbon, usually to an account in PT. If you do not have 40 US credits, the US–Portugal totalization agreement allows contribution periods in Segurança Social to be counted; for a US payment you need at least 6 US credits. A totalization claim is filed with SSA-2490-BK. Medicare barely works abroad.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The United States and Portugal have a social security agreement: it helps avoid double contributions and allows insurance periods to be combined for pensions, disability and survivors benefits.' },
        { kind: 'paragraph', text: 'In the US, standard entitlement to retirement benefits requires 40 credits. In 2026, 1 credit is earned for $1,810 of earnings, up to a maximum of 4 credits per year. If you do not have 40 credits, the SSA can count Portuguese contribution periods, but only if you have at least 6 US credits.' },
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Workers temporarily posted from the US to Portugal or from Portugal to the US, to avoid paying contributions into both systems.'
        ] },
        { kind: 'paragraph', text: 'If you already have 40 US credits, Portuguese periods usually will not increase your US pension. But they may be important for the Portuguese pension: in Portugal, the standard minimum contributory period for an old-age pension is 15 years of contributions, and the normal pension age in 2026 is 66 years and 7 months.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Residents of Portugal usually work not with a local SSA office in the US, but with the Federal Benefits Unit (FBU) at the US Embassy in Lisbon. The FBU receives applications, checks documents and forwards the case to the SSA.' },
        { kind: 'substeps', items: [
          { id: 'prepare-records', title: '1. Gather your work record documents', content: [
            { kind: 'checklist', items: [
          ...
          { id: 'contact-fbu', title: '2. Contact FBU Lisbon', content: [
            { kind: 'paragraph', text: 'Write to the FBU via the U.S. Embassy Lisbon / Federal Benefits page. Do not send originals without FBU instructions. The FBU usually schedules a phone/video contact or asks you to upload/send copies.' }
          ] },
          { id: 'file-forms', title: '3. Complete the SSA forms', content: [
            { kind: 'paragraph', text: 'For a standard retirement claim, SSA retirement benefits forms are used; if Portuguese credits are needed, SSA-2490-BK — Application for Benefits Under a U.S. International Social Security Agreement — is added.' },
            { kind: 'warning', text: 'SSA-2490-BK is important specifically for totalization. If you simply file a standard application and do not list Portuguese periods, the SSA may not request data from Portugal Segurança Social.' }
          ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The SSA can pay benefits to residents of Portugal. Money can be received by international direct deposit into a Portuguese bank account or into a US account. When transferring to PT, take account of bank fees and exchange rates if the account is not in dollars.' },
        { kind: 'checklist', items: [
          'Tell the SSA/FBU if your address in Portugal changes.',
          'Report marriage, divorce, the death of a spouse, starting/ending work and any change of citizenship if it affects benefits.',
          'Check your post: the SSA sends out the Foreign Enforcement Questionnaire, usually forms SSA-7162 or SSA-7161.',
          'If the questionnaire is not returned on time, payments may be suspended until proof of life and address is confirmed.',
          'Medicare barely covers medical services outside the US; for Portugal you need SNS, private insurance or both.',
          'Part B premiums may continue to be deducted from Social Security even if you live in Portugal; cancellation and re-enrolment can involve penalties.'
        ] },
        { kind: 'warning', text: 'Do not ignore SSA letters because of Portuguese post. A practical approach is to keep your address up to date, keep scans of all mailings and regularly check communication with the FBU.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'The agreement also regulates which system social security contributions are paid into. The general logic is that a worker pays into the system of the country where they work, but for a temporary posting the system of the sending country may continue to apply.' },
        { kind: 'checklist', items: [
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Social Security benefits and a Portuguese pension are not only an SSA issue. Americans still have US tax filing; Portuguese tax residents have IRS obligations. The tax treatment depends on residence, the type of payment, the double taxation treaty and your income structure.' },
        { kind: 'checklist', items: [
          'Download your Social Security Statement before applying: check the earnings record and the estimated benefit.',
          'Compare claim age scenarios: 62, full retirement age and 70; an early claim reduces the payment for life.',
          'If you have a Portuguese pension, request a simulação in Segurança Social Direta.',
          'Check how payments will be reported in IRS Modelo 3 and US Form 1040.',
          'Keep all SSA notices, SSA-2490-BK, coverage certificates and confirmations from Segurança Social.',
          'Do not plan healthcare in Portugal through Medicare: register with SNS and consider private insurance.'
        ] },
        { kind: 'paragraph', text: 'From 2025, WEP/GPO for Social Security have been repealed in the US, so a foreign public pension should no longer reduce the benefit under those rules. However, the SSA may still request information about a foreign pension to process the case correctly.' }
      ]
    }
  ],
  costs: [
