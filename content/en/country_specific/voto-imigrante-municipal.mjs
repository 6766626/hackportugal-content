export default {
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Citizens of Cabo Verde: usually fall under the CPLP regime with reciprocity for eleições autárquicas after lawful residence for more than 2 years.',
          'Citizens of other countries with reciprocity: Argentina, Chile, Colombia, Iceland, Norway, New Zealand, Peru, United Kingdom, Uruguay, Venezuela — the right depends on the length of lawful residence and the current MAI/CNE declaration.',
          'Age: 18+ on election day.',
          'You must be registered as a voter in your freguesia of residence.',
        ...
        { kind: 'warning', text: 'Check your country against the current CNE/MAI list before the elections. The list of countries with reciprocity can be updated by state declarations; do not rely on old tables from blogs.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'For EU citizens, the key condition is residence in Portugal and registration as an eleitor. A minimum residence period for the municipal vote is usually not applied in the same way as for third-country nationals.' },
        ...
        { kind: 'paragraph', text: 'For “other treaty / reciprocity countries”, you need to check the current CNE and MAI wording. Public guidance notes often mix up the active right to vote and the passive right to stand as a candidate: the periods for candidacy are higher. If someone tells you “4 years”, clarify whether this refers to voting or to the possibility of being elected.' },
        { kind: 'checklist', items: [
          'EU: residência + registration in the recenseamento eleitoral.',
          'CPLP with reciprocity: usually legal residence for more than 2 years to vote.',
          'Brazil: check the Estatuto de Igualdade separately if you want rights broader than municipal rights.',
          ...
          'Having a NIF, NISS or SNS does not by itself create a voting right.'
        ] }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Take proof of address: atestado de residência, contrato de arrendamento, utilities bill or Câmara/Junta document, if requested.',
          'State your country of citizenship and the basis for your voting right: EU, CPLP/reciprocity or treaty reciprocity.',
        ...
        { kind: 'warning', text: 'Registration and changes in the recenseamento eleitoral are usually closed 60 days before elections. If local elections have been scheduled, do not wait until the final week: you may not be included in the cadernos eleitorais for the current vote.' }
      ]
    },
    {
      id: 'election-day',
      title: 'On voting day',
      content: [
        { kind: 'paragraph', text: 'In local elections, you vote at the assembleia de voto of your freguesia. The polling station and eleitor number are checked at eleitor.mai.gov.pt or through MAI SMS services, if they are active for the specific elections.' },
        { kind: 'checklist', items: [
          'Take a valid ID document: Cartão de Cidadão, passport, EU national ID or residence permit.',
          'Check your morada and freguesia in the eleitor lists in advance.',
          ...
          'If you have recently moved, the polling station may still be in your old freguesia until the change has been updated.'
        ] }
      ]
    },
    {
      id: 'common-mistakes',
      title: 'Common mistakes made by migrants',
      content: [
        { kind: 'checklist', items: [
          'Thinking that a residence permit automatically gives you the right to vote. It does not: you need a country with a suitable regime and registration.',
          'Confusing municipal elections with national elections. Foreign nationals’ voting rights are almost always limited to local elections.',
          ...
          'Assuming that all CPLP citizens automatically have the same rights. Reciprocity and lawful residence are required.',
          'Confusing the right to vote with the right to stand as a candidate: the rules for candidacy are stricter.',
          'Relying on lists of countries from before Brexit or before new MAI/CNE declarations.'
        ] },
        { kind: 'paragraph', text: 'If you are not sure, write to or visit the Junta de Freguesia for your address and ask them to check “inscrição no recenseamento eleitoral para cidadão estrangeiro”. This is a free administrative procedure.' }
      ]
    }
  ],
  costs: [
    { label: 'Registration in the recenseamento eleitoral', amountEUR: 0, note: 'Free; there may only be costs for obtaining proof of address if the Junta de Freguesia requires an atestado.' },
  ...
  sources: [
    ...
    {
      title: 'Portal do Eleitor MAI — checking recenseamento eleitoral and polling place',
    ...
    {
      title: 'Lei Orgânica n.º 1/2001 — Election of the office-holders of local authority bodies',
