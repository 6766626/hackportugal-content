export default {
  ...
  tldr: 'Belarusians in Portugal: there is no Portuguese consulate in Minsk. The nearest are Warsaw or Moscow. D visas are processed through these consulates. Apostille: Ministry of Justice of Belarus. Portuguese banks accept Belarusians without particular restrictions. Sanctions only affect politically exposed persons.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Warsaw: Embaixada de Portugal em Varsóvia, ul. Atenska 37, 03-978 Warszawa (Saska Kępa district). Tel. +48 22 511 10 10. Book online via varsovia.embaixadaportugal.mne.gov.pt. Queue 1–3 months',
          'Vilnius is usually faster because there is less demand',
          'All type D visas are available to Belarusians: D2, D3, D4, D7, D8',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'a1', title: '1. Civil registry office — certificates', content: [
            { kind: 'paragraph', text: 'Obtain a duplicate certificate (birth, marriage, etc.) → apostille it at the Ministry of Justice of Belarus. Timeframe 7-30 days, cost ~30 BYN per apostille.' }
          ]},
          { id: 'a2', title: '2. Ministry of Internal Affairs — criminal record certificate', content: [
            { kind: 'paragraph', text: 'Apply via mvd.gov.by or at an office. Timeframe 14 days. Apostille — Ministry of Justice. Valid for 3-6 months in Portugal.' }
          ]},
        ...
        { kind: 'paragraph', text: 'Translation in Portugal — by a sworn translator or certify it at a Conservatória (irn.justica.gov.pt).' }
      ]
    },
    {
      id: 'banking',
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Open an account in Portugal: ActivoBank, Millennium — they accept Belarusians',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Chats for Belarusian expats (Telegram)',
          ...
          'For up-to-date news on current consular options, check via the Ministry of Foreign Affairs of Belarus'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Open an account in Portugal during the first week — it is difficult without one',
          'For children: Portuguese school + the PLNM programme for those whose native language is not Portuguese',
          'Do not use Wise/Revolut accounts as “proof of funds” for D7 — the consulate prefers a bank with a classic licence (EU, Belarus, another country with banking supervision), not a neobank'
        ]}
      ]
    }
  ],
  sources: [
    { title: 'Embassy of Portugal in Warsaw', url: 'https://varsovia.embaixadaportugal.mne.gov.pt/', kind: 'official', language: 'pt', lastRetrieved: '2026-04-22' },
