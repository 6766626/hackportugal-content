export default {
  ...
  steps: [
    ...
    {
      id: 'asylum',
      title: '🏛️ Asylum for LGBT refugees',
      content: [
        { kind: 'checklist', items: [
          'Portugal is one of the leaders in granting asylum on the basis of sexual orientation / identity',
          'Lei 27/2008 recognises persecution of LGBT people as a valid ground for refugee status',
    ...
    {
      id: 'trans-medical',
      title: '⚕️ Medical transition in Portugal',
      content: [
        { kind: 'substeps', items: [
  ...
  sources: [
    ...
    { title: 'Lei 9/2010 — Same-sex marriage', url: 'https://diariodarepublica.pt/dr/detalhe/lei/9-2010-616040', kind: 'law', language: 'pt', lastRetrieved: '2026-04-22' },
    { title: 'Lei 38/2018 — Gender identity', url: 'https://diariodarepublica.pt/dr/detalhe/lei/38-2018-115933863', kind: 'law', language: 'pt', lastRetrieved: '2026-04-22' },
