export default {
  ...
  sources: [
    ...
    { title: 'Portal das Finanças — раздел Cidadãos / Serviços / Certidões', url: 'https://www.portaldasfinancas.gov.pt/at/html/index.html', kind: 'official', language: 'pt', lastRetrieved: '2026-04-28' },
