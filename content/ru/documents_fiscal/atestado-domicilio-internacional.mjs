  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Для США справка сама по себе не отменяет обязанности по налогообложению на основании гражданства и FATCA. Для UK, РФ и других стран она тоже не заменяет местные правила утраты налогового резидентства. Это португальское подтверждение, которое иностранная сторона оценивает по своим законам.' }
      ]
    },
    {
      id: 'before-request',
      ...
      content: [
        ...
        { kind: 'warning', text: 'Налоговое резидентство по CIRS art. 16 обычно возникает, если вы провели в Португалии более 183 дней в любые 12 месяцев, начинающиеся или заканчивающиеся в соответствующем году, либо имели здесь жильё в условиях, предполагающих намерение сделать его постоянным местом проживания (residência habitual). Наличие NIF само по себе не делает вас налоговым резидентом.' }
      ]
    },
    {
      id: 'request-online',
