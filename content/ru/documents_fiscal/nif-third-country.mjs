  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Если ваш налоговый адрес вне ЕС/ЕЭЗ и появляется налоговая связь с Португалией (доход/недвижимость/авто/деятельность) — по общему правилу нужно назначить fiscal representative с налоговым домицилем в Португалии. Альтернатива для многих физических лиц — подписка на электронные уведомления (notificações/citações) в Portal das Finanças / Caixa Postal Eletrónica; для IVA/профессиональной деятельности и отдельных случаев представитель остаётся обязательным'
        ]},
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'Если вы фактически стали налоговым резидентом Португалии (183+ дня или постоянное место проживания), отдельно смените налоговый адрес на португальский. Пока в AT указан иностранный адрес/статус нерезидента, португальский работодатель удерживает IRS как с нерезидента — для employment income обычно ставка 25% (Código do IRS art. 71; удержание у источника — по правилам retenção na fonte).' }
      ]
    }
  ],
  documents: [
