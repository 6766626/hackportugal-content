export default {
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Если ваш налоговый адрес вне ЕС/ЕЭЗ и есть налоговая связь с Португалией (доход/недвижимость/авто/деятельность) — фискальный представитель с налоговым домицилем в Португалии. Для простого получения NIF без налоговых обязательств AT с 2022 допускает отсутствие представителя, но отдельные отделения могут запрашивать его на практике'
        ]},
        { kind: 'paragraph', text: 'Как попасть: сайт Finanças → "Agendamentos" → очный приём → выбрать услугу "Atribuição de Número de Contribuinte". Без записи — живая очередь с раннего утра в крупных отделениях Lisboa/Porto.' },
      ...
      content: [
        ...
        { kind: 'substeps', items: [
          { id: 's1', title: '1. Выбрать представителя', content: [
            { kind: 'paragraph', text: 'Варианты: португальский адвокат с налоговым домицилем в Португалии (список Ordem dos Advogados — portal.oa.pt) либо сертифицированная фирма. Представитель — физическое или юридическое лицо с налоговым домицилем в Португалии. Для деятельности с IVA могут применяться дополнительные требования.' }
          ]},
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'Если вы фактически стали налоговым резидентом Португалии (183+ дня или постоянное место проживания), отдельно смените налоговый адрес на португальский. Пока в AT указан иностранный адрес/статус нерезидента, португальский работодатель удерживает IRS как с нерезидента — для дохода от трудовой деятельности обычно фиксированная ставка 25% (Código do IRS art. 71).' }
      ]
    }
  ],
  documents: [
  ...
  timelineDaysMax: 15,
  sources: [
    { title: 'Autoridade Tributária — Ofício Circulado n.º 90054/2022 (representante fiscal)', url: 'https://info.portaldasfinancas.gov.pt/pt/informacao_fiscal/legislacao/instrucoes_administrativas/Pages/oficio-circulado-90054-2022.aspx', kind: 'official', language: 'pt', lastRetrieved: '2026-04-22' },
