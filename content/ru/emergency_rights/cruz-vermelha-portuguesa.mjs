export default {
  ...
  steps: [
    ...
    {
      id: 'ambulance',
      title: 'Ambulância: когда везёт Красный Крест, а когда звонить 112',
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'сохраните factura/recibo: иногда расходы можно заявить страховке или учесть в IRS как медицинский расход (despesa de saúde), если это соответствует правилам Finanças'
        ] },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'практика: проверьте, есть ли отработка СЛР (CPR) на манекене и тренажёр DAE',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'дети и молодёжь: школьная поддержка, каникулярные программы, молодёжные проекты — зависит от delegação',
        ...
        { kind: 'warning', text: 'CVP не заменяет Segurança Social, SNS, AIMA или Câmara Municipal. Для пособий, ВНЖ, SNS utente и жилья нужны официальные процедуры; Красный Крест помогает с поддержкой и encaminhamento, но не “выдаёт статус”.' }
      ]
    },
    {
      id: 'volunteer',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'для курса первой помощи: отдел formação местной CVP',
