export default {
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Ориентир (потолок) выплаты — 1,1 IAS: 590,84 € в 2026',
          'Порог нуждаемости для principal обычно считается относительно 1,3 IAS: 698,27 €',
          'Сумма subsídio = разница между ориентиром 590,84 € и расчётным доходом домохозяйства, поэтому она индивидуальна',
          ...
          'С 2026 года сам subsídio cuidador informal не учитывается как доход при назначении других социальных выплат',
          'При изменении доходов, адреса, состава семьи, госпитализации или помещении в учреждение нужно уведомлять Segurança Social'
        ] },
        { kind: 'warning', text: 'Не планируйте бюджет семьи так, будто выплата будет ровно 590,84 €. Это лишь верхний ориентир; на практике сумма зависит от расчёта Segurança Social и может быть нулевой при признанном статусе.' }
      ]
    },
    {
      id: 'how-to-apply',
  ...
  costs: [
    ...
    { label: 'Ориентир максимальной месячной поддержки principal в 2026', amountEURMax: 590.84, note: '1,1 IAS 2026; фактическая сумма равна разнице с расчётным доходом и зависит от Segurança Social.' },
