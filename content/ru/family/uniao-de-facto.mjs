  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'Для Reagrupamento Familiar — собирайте сильные доказательства cohabitation/отношений и проверяйте текущий список AIMA. Для гражданства по união с гражданином PT — планируйте reconhecimento judicial; одной регистрации в Conservatória недостаточно.\n\n⚠️ Reforma Lei da Nacionalidade: Decreto AR 48/XVII промульгирован Президентом Сегуру 03.05.2026 — на дату 17.05.2026 ещё ожидает публикации в DRE; перед подачей сверяйтесь с актуальной редакцией закона.' }
      ]
    }
  ],
  costs: [
