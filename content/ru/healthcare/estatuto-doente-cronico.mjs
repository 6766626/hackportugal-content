  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Estatuto de Doente Crónico — не отдельный пластиковый документ и не универсальная льгота. На практике это медицинское подтверждение хронического заболевания в системе SNS: диагноз, длительное лечение, активные рецепты и, если применимо, право на специальную comparticipação лекарств или isenção de taxas moderadoras.' },
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Специальную comparticipação лекарств: стандартные уровни в Португалии — 90%, 69%, 37% или 15%, но по отдельным протоколам может быть 100%.',
          ...
          'Для онкологических заболеваний: многие препараты выдаются через hospitalar pharmacy SNS без оплаты пациентом, если лечение назначено hospital público.',
          ...
          'Более простой доступ к follow-up: consultas de vigilância, анализы, renouvellement de receita, вакцинация по показаниям.'
        ] },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Если препарата нет, аптека может заказать или предложить эквивалент; для некоторых hospitalar medicines нужно идти в farmácia hospitalar.',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Asma/DPOC: важно показать старые inhaladores и результаты spirometria, если есть; разные ингаляторы имеют разную comparticipação.',
          ...
          'Хроническая боль/ревматология: часть препаратов требует specialist и hospitalar prescription; médico de família может вести базовые лекарства, но не всё.',
