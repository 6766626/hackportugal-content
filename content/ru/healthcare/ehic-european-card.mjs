export default {
  ...
  tldr: 'Cartão Europeu de Seguro de Doença (CESD), он же EHIC — даёт доступ к medically necessary helping state-provided помощи во всех странах ЕС, ЕЭЗ, Швейцарии и Великобритании на тех же условиях, что у местных застрахованных. Бесплатно. В Португалии обычно действует **3 года**; затем нужно запросить продление/новую карту. CESD выдаёт компетентная страна страхования: для людей с португальским покрытием Segurança Social — через SS Direta. Временный сертификат можно запросить, если карта не успела прийти. CESD/EHIC действует только при временном пребывании за границей, а не при переезде или поездке специально за лечением.',
