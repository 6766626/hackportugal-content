  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'S1 нужен британским пенсионерам и некоторым получателям британских пособий, которые живут в Португалии и хотят пользоваться SNS на тех же условиях, что и резиденты Португалии. Расходы по государственному лечению оплачивает Великобритания, но само лечение вы получаете через португальскую систему.' },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Форму выдаёт NHS Business Services Authority, отдел Overseas Healthcare Services. Запрашивать S1 нужно в Великобритании, а не в португальском SNS. Обычно это делают после принятого решения о переезде или уже после прибытия, когда понятен адрес в Португалии.' },
        { kind: 'checklist', items: [
          ...
          'Сообщите данные супруга/партнёра и dependants, если хотите, чтобы проверили их право на покрытие.',
