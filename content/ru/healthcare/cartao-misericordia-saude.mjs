export default {
  ...
  tldr: 'Misericórdias — сеть местных благотворительных учреждений IPSS, не замена SNS, а параллельный недорогой доступ к врачам, стоматологии и социальной поддержке.\n\nВ Лиссабоне это Santa Casa da Misericórdia de Lisboa; в других городах — отдельные Santas Casas. Приём обычно стоит около 10–15 €, стоматология и анализы — по прайсу учреждения. ВНЖ и número de utente часто не обязательны, но почти всегда попросят паспорт/ВНЖ, NIF, адрес и подтверждение дохода.',
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Цены не регулируются единым государственным тарифом.\n\nВ 2026 году типичный социальный приём у врача в благотворительной клинике может стоить около 10–15 €, но в Лиссабоне, Порту и для частично субсидируемых услуг цена может отличаться. Специалисты, стоматология, анализы и физиотерапия почти всегда оплачиваются отдельно.' },
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'bring', title: '3. Принесите все документы и лекарства', content: [
            { kind: 'paragraph', text: 'Возьмите паспорт/ВНЖ, NIF, адрес, список лекарств и предыдущие диагнозы. Если нужна льготная цена, принесите подтверждение дохода сразу — это экономит второй визит.' }
          ] },
