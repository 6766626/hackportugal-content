  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'Пособие по безработице, зарплата и другие доходы учитываются при расчёте RSI и могут уменьшить или исключить выплату. Движимое имущество семьи не должно превышать установленный лимит (обычно 60× IAS). Несоблюдение правил/сокрытие доходов = потеря права и санкции.' }
      ]
    },
    {
      id: 'unemployment',
