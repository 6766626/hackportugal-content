export default {
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'RSI — доплата до референтной суммы домохозяйства для семей с очень низким доходом. Как считается: 100% базовой суммы для заявителя, 70% для каждого следующего взрослого, 50% для каждого несовершеннолетнего; выплата = эта референтная сумма минус учитываемые доходы семьи.' },
        { kind: 'checklist', items: [
          '📊 Базовая сумма: около €247,56/мес для заявителя в 2026 (≈ 46,09% IAS €537,13); +70% этой суммы (≈ €173,29) за каждого дополнительного взрослого; +50% (≈ €123,78) за каждого несовершеннолетнего',
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'u2', title: 'Размер и срок', content: [
            { kind: 'checklist', items: [
              ...
              'Subsídio social de desemprego доступен при низком доходе домохозяйства; размер обычно 80% IAS (≈ €429,70 в 2026) для одинокого или 100% IAS (€537,13) для лица с семьёй; срок зависит от возраста и стажа, а также от того, назначается ли он первичным (inicial) или последующим (subsequente) после subsídio de desemprego'
            ]}
          ]},
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '  - Домохозяйства с годовым доходом ≤ €6 272 (+€3 136 за каждого члена без дохода, до 10 человек). Актуальный порог — на dgeg.gov.pt',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '👶 Subsídio parental inicial: проценты зависят от выбранной длительности и распределения отпуска между родителями: 120 дней — 100%, 150 дней — 80% (или 100% при разделении по правилам SS), 180 дней — 90% при разделённом отпуске. Проверять таблицу Segurança Social',
          ...
          '👵 Complemento Solidário para Idosos (CSI): доплата для пожилых с годовыми ресурсами ниже референтного порога CSI; учитываются доходы заявителя, супруга/партнёра и в ряде случаев детей. Порог брать из актуального Guia Prático CSI',
  ...
  costs: [
    { label: 'RSI базовая сумма для заявителя', amountEUR: 247.56, note: '€/мес 2026 (≈ 46,09% × IAS €537,13)' },
