export default {
  ...
  tldr: 'ERPI — официальное название домов престарелых в Португалии: Estruturas Residenciais para Pessoas Idosas. В 2026 году места делятся на социальные через Segurança Social/IPSS и полностью частные. Социальное место обычно обходится примерно в 600–1 500 €/мес и зависит от доходов семьи; IPSS без полного субсидирования — 800–2 500 €/мес; частные ERPI — 1 500–4 500 €/мес. Очереди длинные: 12–36 месяцев в Лиссабоне, Порту и прибрежных районах. Проверяйте лицензию через Carta Social.',
