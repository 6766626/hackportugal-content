export default {
  ...
  tldr: 'В Португалии termalismo — не просто spa, а медицинские процедуры на термальной воде. Если семейный врач SNS назначит tratamentos termais и вы выберете лицензированные termas-aderentes, SNS компенсирует 35% стоимости процедур, но максимум 95 € на человека в год. Типичный 14-дневный курс стоит 220–500 € без проживания; после компенсации — примерно 145–405 €. Популярные направления: Caldas da Rainha, Monfortinho, São Pedro do Sul, Vidago.',
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'На апрель 2026 базовое правило остаётся таким: SNS компенсирует 35% стоимости назначенных tratamentos termais, но не больше 95 € на utente за календарный год. Если курс стоит 200 €, возврат будет 70 €. Если курс стоит 350 €, 35% = 122,50 €, но получите максимум 95 €.' },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Реалистичный бюджет на одного взрослого в 2026: медицинская часть 220–500 € за 12–14 дней, если брать не luxury wellness, а лечебный курс. После максимальной comparticipação SNS 95 € фактическая медицинская часть часто выходит 145–405 €.' },
        { kind: 'checklist', items: [
          ...
          'Максимальная компенсация SNS: 95 € в год',
  ...
  costs: [
    { label: 'Компенсация SNS за tratamentos termais', amountEURMax: 95, note: '35% стоимости процедур, но максимум 95 € на utente в календарный год' },
    ...
    { label: 'Фактическая стоимость после максимального возврата SNS', amountEURMin: 145, amountEURMax: 405, note: 'Если курс подходит под comparticipação и достигнут лимит 95 €' }
  ],
  sources: [
    { title: 'DGS: termalismo и лицензирование estabelecimentos termais', url: 'https://www.dgs.pt', kind: 'official', language: 'pt', lastRetrieved: '2026-04-28' },
    { title: 'Termas de Portugal: каталог терм, показания и контакты', url: 'https://www.termasdeportugal.pt', kind: 'company', language: 'pt', lastRetrieved: '2026-04-28' },
