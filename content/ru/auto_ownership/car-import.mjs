        ...
        { kind: 'substeps', items: [
          { id: 'o1', title: 'A. Льгота ISV — isenção por transferência de residência', content: [
            { kind: 'checklist', items: [
              'Вы переносите нормальное место жительства в Португалию (получили ВНЖ/CRUE, оформили налоговое резидентство)',
          ...
          { id: 'o2', title: 'B. Обычный ввоз — с ISV', content: [
            { kind: 'paragraph', text: 'Если условия льготы не выполнены — ISV (Imposto sobre Veículos).\n\nСчитается по объёму двигателя + CO2 + возрасту. Для нового авто может составить 5000-30000 €. Для 100% электрических ISV обычно 0 €, но остаются регистрационные расходы. Для гибридов и plug-in гибридов действуют специальные ставки и условия. При импорте из-за пределов ЕС отдельно проверяются пошлина и IVA.' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Подтверждение нормального проживания за границей: для ISV-льготы — ≥ 6 мес; для таможенной льготы при импорте не из ЕС — ≥ 12 мес. Документы: CRUE/ВНЖ в прежней стране, налоговое резидентство, счета за коммунальные услуги, договор аренды',
