export default {
  ...
  tldr: 'Fundo Ambiental ежегодно выдаёт ваучеры на mobilidade elétrica: в последнем опубликованном Aviso 06/2025 (открыт 29.12.2025, на 2025–2026 годы) бюджет был 17,6 млн €, для физлиц — 4 000 € на новый 100% электрический легковой M1 до 38 500 € с НДС (до 55 000 € для машин более чем на 5 мест) и сдачей старого авто с ДВС старше 10 лет на утилизацию; PHEV не проходили. На 31.05.2026 отдельный Aviso 2026 ещё нужно проверять на fundoambiental.pt: правила, лимиты и даты действуют только после публикации нового Aviso.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Важно: правила меняются каждый год. На 31.05.2026 на сайте Fundo Ambiental нужно проверять именно новый Aviso 2026. Последний опубликованный ориентир — Aviso 06/2025 (Mobilidade Verde Passageiros, открыт 29.12.2025 на 2025–2026 годы): общий бюджет 17,6 млн €, лимиты по категориям и принцип “пока есть бюджет”.' },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Максимальная цена легкового авто по Aviso 06/2025: 38 500 € с IVA и всеми обязательными расходами в счёте (до 55 000 € для машин более чем на 5 мест).',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Для легкового BEV по модели 2025 требовалась утилизация старого авто с ДВС старше 10 лет; новый Aviso может сохранить или изменить это условие.'
        ] },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'Цена 38 500 € в Aviso 06/2025 считалась с IVA. Дилерские “кампании” иногда показывают цену без обязательных расходов, ISV/IUC/доставки/документации. Для фонда важна сумма в fatura.' }
      ]
    },
    {
      id: 'how-to-apply',
  ...
  costs: [
    { label: 'Легковой 100% электрический M1 для физлица', amountEUR: 4000, note: 'Ориентир Aviso 06/2025; цена авто до 38 500 € с IVA (до 55 000 € для машин более чем на 5 мест); в 2026 подтвердить по новому Aviso.' },
