  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Важно: правила меняются каждый год. На 28.04.2026 на сайте Fundo Ambiental нужно проверять именно новый Aviso 2026. Последний полный опубликованный ориентир — Avisos Mobilidade Elétrica 2025: общий бюджет 13,5 млн €, лимиты по категориям и принцип “пока есть бюджет”.' },
