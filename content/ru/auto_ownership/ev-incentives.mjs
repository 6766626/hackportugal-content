        ...
        { kind: 'substeps', items: [
          { id: 's1', title: 'Ориентиры (проверяйте Aviso текущего года)', content: [
            ...
            { kind: 'checklist', items: [
              ...
              'Электроскутер: ~€500',
              'Потолок цены для субсидии M1 в недавних Avisos был около €38 500 с IVA и расходами (для версий более чем на 5 мест лимит выше). €62 500 без IVA — это отдельный налоговый порог для компаний, а не критерий субсидии'
            ]}
          ]},
          { id: 's2', title: 'Как подать', content: [
            { kind: 'paragraph', text: 'fundoambiental.pt → Candidaturas → Mobilidade Elétrica. Заявка подаётся только онлайн с Chave Móvel Digital или Cartão de Cidadão. Дата открытия окна каждый год разная (в 2026 году — между маем и июнем; в прошлые годы — в январе), точные сроки публикуются на fundoambiental.pt. Нужны: счёт-фактура на автомобиль (можно предварительный счёт-фактура), копия ВНЖ/Cartão de Cidadão, NIF, IBAN для зачисления.' }
          ]},
          { id: 's3', title: 'Срок выплаты', content: [
            { kind: 'timeline', text: '30–90 дней после одобрения. Деньги приходят на IBAN как возврат.' }
          ]}
        ]},
        { kind: 'warning', text: 'Бюджет программы за 2024–2025 заканчивался за 2–3 месяца. Следите за датой открытия Aviso на fundoambiental.pt и подавайте заявку в первые дни — деньги распределяются по очереди до исчерпания бюджета.' }
      ]
    },
    {
      id: 'taxes',
        ...
        { kind: 'substeps', items: [
          { id: 't1', title: 'ISV (растаможка/ввоз)', content: [
            { kind: 'checklist', items: [
              ...
              'PHEV (подключаемый гибрид): сниженный ISV (скидка 75%) при запасе хода на электричестве ≥50 км и выбросах CO₂ ≤80 г/км по норме Euro 6e-bis (порог поднят с 50 до 80 г/км в OE 2026). Старые PHEV без Euro 6e-bis: ≤50 г/км',
          ...
          { id: 't2', title: 'IUC (ежегодный налог)', content: [
            { kind: 'checklist', items: [
              'BEV: как правило, освобождены от IUC — у чистых EV нет компоненты по объёму двигателя (CC). Проверяйте конкретный автомобиль в Portal das Finanças/AT',
