export default {
        ...
        { kind: 'substeps', items: [
          { id: 'c1', title: 'Millennium BCP', content: [
            { kind: 'checklist', items: [
              ...
              'Приложение обычно PT/EN; на русскую версию не рассчитывайте',
              'Сеть ~400 отделений',
          ...
          { id: 'c3', title: 'Santander Totta', content: [
            { kind: 'checklist', items: [
              ...
              'Счёт: 7 €/мес',
              'Приложение обычно PT/EN/ES; на русскую версию не рассчитывайте',
        ...
        { kind: 'substeps', items: [
          { id: 'n1', title: 'Revolut', content: [
            { kind: 'checklist', items: [
              ...
              'Бесплатные SEPA-переводы + обмен в 20 валютах (в пределах лимитов тарифа; в выходные обычно дополнительная наценка)',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          '💸 Переводы по телефону мгновенно; типовой лимит MB WAY — до 2000 € за перевод и около 5000 €/мес, конкретный банк может установить более низкие лимиты',
  ...
  costs: [
    ...
    { label: 'Revolut Standard (IBAN PT бесплатно)', amountEUR: 0, note: 'с 2025 новым клиентам в PT выдают IBAN PT; существующих переводят постепенно' },
