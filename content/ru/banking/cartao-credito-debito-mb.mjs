  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Crédito: просрочка портит банковскую историю и может попасть в Central de Responsabilidades de Crédito Banco de Portugal.'
        ] },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Pagamentos ao Estado — налоги, IMI, IUC, штрафы и другие платежи Estado, если выдана referência.',
          ...
          'Некоторые банкоматы дают услуги depóstio/cheques, но это зависит от банка и конкретного ATM.'
        ] },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'Pré-pago не всегда подходит для депозитов в отелях, аренды авто и некоторых подписок. Система видит её как предоплаченную карту и может отказать.' }
      ]
    },
    {
      id: 'security',
