    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '📊 Кредитная история: в первые 6–12 месяцев проживания в Португалии истории нет, поэтому лимит будет небольшим — € 300–500',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🌍 Для поездок за границу выгодно платить кредиткой: у таких карт часто есть страховка и chargeback — возврат денег при мошенничестве',
