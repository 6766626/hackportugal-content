  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'MTIC: montante total imputado ao consumidor — сколько всего заплатите банку за весь срок.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Banco de Portugal применяет макропруденциальные рекомендации: банки должны оценивать DSTI — долю всех кредитных платежей в чистом доходе. С 01.08.2026 (Recomendação Macroprudencial 1/2026) рекомендованный потолок DSTI — 45% чистого дохода (ранее ориентир был 50%): если все prestações после нового кредита приближаются к этому уровню, одобрение усложняется или сумму уменьшают.' },
        { kind: 'checklist', items: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'При variável ставке комиссия за досрочное погашение потребительского кредита обычно не взимается.',
