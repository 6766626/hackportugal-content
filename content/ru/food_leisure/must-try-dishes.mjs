export default {
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🥬 Caldo verde — суп из листовой капусты (kale) и картофеля с chouriço. Национальное зимнее блюдо',
          '🐄 Tripas à moda do Porto — рубец с фасолью. Жителей Порту за это блюдо называют «tripeiros»',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Треска — самая важная рыба для португальцев, хотя сама Португалия её почти не ловит: bacalhau в основном импортируется из Северной Атлантики, особенно из Норвегии и Исландии. Пословица: «365 способов приготовить bacalhau, по одному на каждый день года». Вот топ-6:' },
        { kind: 'checklist', items: [
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🧀 Casa de pasto — обед с menu do dia, часто около € 10–15 (в небольших городах иногда дешевле, в туристических районах дороже)',
