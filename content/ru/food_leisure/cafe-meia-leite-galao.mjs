export default {
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'В обычном bairro café или pastelaria базовый кофе остаётся дешёвым по европейским меркам. Разброс зависит от города, района, того, садитесь ли вы за стол, и от того, насколько место туристическое.' },
        { kind: 'checklist', items: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Воду к эспрессо приносят не всегда; попросите “um copo de água”.',
          'Сахар часто подают в пакетике на блюдце; чтобы пить без сахара, специально говорить не нужно.',
