export default {
  ...
  tldr: 'В Португалии хороший хлеб проще искать не в супермаркете, а в padaria/pastelaria: обычная булка стоит 0,20–0,45 €, большой pão alentejano, broa или regueifa — обычно 1–3 € за штуку. Padaria Portuguesa — удобная сеть с 50+ точками в Lisboa и Porto, Mago do Pão — вариант для тех, кто готов ехать специально за качеством, Confeitaria Nacional работает с 1829 года и сильна в классической выпечке. Для pastel de nata отдельно держите в списке Manteigaria.',
  ...
  steps: [
        ...
        { kind: 'substeps', items: [
          ...
          },
          {
            ...
            content: [
              ...
              { kind: 'warning', text: 'У небольших пекарен график, отпуск и ассортимент могут меняться быстрее, чем обновляются сайт или Google Maps. Перед специальной поездкой проверьте свежие отзывы и часы работы.' }
            ]
          },
          {
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Хлеб остаётся одной из недорогих повседневных покупок. Разброс зависит от района, размера и «ремесленности»: туристический центр Lisboa дороже, районная padaria дешевле, а ремесленный хлеб на закваске дороже обычного pão.' },
        { kind: 'checklist', items: [
        ...
        { kind: 'warning', text: 'Если видите pão за 5–8 €, проверьте вес и формат: это может быть ремесленный хлеб на закваске, органическая мука или большая буханка. Для обычного ежедневного хлеба 1–3 € за штуку — нормальный ориентир.' }
      ]
    },
    {
      id: 'ordering-tips',
