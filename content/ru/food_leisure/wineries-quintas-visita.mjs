  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Поездка по португальской wine country — это не только «попробовать вино». Обычно quinta даёт экскурсию по виноградникам или погребам, объясняет DOC/IGP, показывает lagares или barrel room и завершает дегустацией. Почти везде нужна предварительная бронь: приехать без записи можно, но свободного слота может не оказаться.' },
        { kind: 'checklist', items: [
          ...
          'Если не пьёте алкоголь, заранее спросите про non-drinker rate: одни quintas всё равно берут полную цену за тур, другие делают скидку.'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Douro Valley — объект ЮНЕСКО и самый фотогеничный винный регион Португалии. Основные базы для ночёвки: Peso da Régua, Pinhão, Lamego, Vila Real. Ради вида на реку и террасы чаще выбирают район Pinhão.' },
        { kind: 'checklist', items: [
        ...
        { kind: 'paragraph', text: 'Практичный маршрут без спешки: ночь в Pinhão, утром Quinta do Seixo, обед у реки, после обеда Quinta do Crasto или другая quinta с видом. Если едете из Porto на один день, выбирайте 1–2 визита, а не «всё Douro за день».' }
      ]
    },
    {
      id: 'south',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'Португальский лимит алкоголя за рулём: общий порог — 0,5 g/l, для начинающих водителей (стаж до 3 лет) и профессионалов — 0,2 g/l. После дегустации безопаснее иметь непьющего водителя, брать тур с трансфером или ночевать рядом.' }
      ]
    },
    {
      id: 'budget',
      ...
      content: [
        { kind: 'paragraph', text: 'Цены сильно зависят от бренда, уровня вин и наличия еды. В 2026 году разумный ориентир для качественного визита — 30–100 € на человека без транспорта. Всё, что включает обед, rare bottles или private guide, легко выходит за 100 €.' },
        { kind: 'checklist', items: [
