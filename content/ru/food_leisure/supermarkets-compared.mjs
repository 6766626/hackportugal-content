export default {
  ...
  steps: [
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'c1', title: 'Continente (Sonae)', content: [
            { kind: 'paragraph', text: 'Крупнейшая сеть. Hyper (гипермаркеты), Modelo (средние), Bom Dia (маленькие). Карта Continente — обязательно! Ориентирована на еженедельные акции и кэшбэк до 50%.' }
          ]},
          { id: 'c2', title: 'Pingo Doce (Jerónimo Martins)', content: [
            { kind: 'paragraph', text: 'Второй по обороту. Известен пятничными акциями «-50%» на одну категорию. Свежая рыба и мясо на высшем уровне. Карта Pingo Doce с персонализированными купонами.' }
          ]},
          { id: 'c3', title: 'Lidl', content: [
            { kind: 'paragraph', text: 'Немецкий дискаунтер. Дешёвые базовые продукты, хорошие собственные марки (Deluxe = премиум). Четверг — акции «Parkside»/«Esmara» на непродовольственные товары. Свежая выпечка.' }
          ]},
          { id: 'c4', title: 'Minipreço (Auchan, бывшая DIA)', content: [
            { kind: 'paragraph', text: 'Дискаунтер с большим количеством мелких магазинов. В 2024–2025 Auchan Retail Portugal приобрёл DIA Portugal; часть точек интегрируется/ребрендируется в Auchan. Программа Clube Minipreço может меняться в течение переходного периода — проверяйте на месте.' }
          ]},
          { id: 'c5', title: 'Auchan', content: [
            { kind: 'paragraph', text: 'Французский гипермаркет. Большой выбор, включая иностранные товары. Карта Auchan.' }
          ]},
    ...
    {
      id: 'cards',
      title: 'Карты лояльности — как использовать',
      content: [
    ...
    {
      id: 'cultural-shops',
      title: 'Специализированные магазины',
      content: [
        { kind: 'checklist', items: [
          'Talho — мясная лавка (часто лучше супермаркета)',
          'Peixaria — рыбная лавка',
          'Padaria — пекарня (свежий хлеб и выпечка)',
          'Pastelaria — кафе + кондитерская',
          'Mercado Municipal — рынок (Лиссабон: Campo de Ourique, Arroios, 31 de Janeiro; Porto: Bolhão)',
          'Ásia Supermercado — азиатские магазины для соевого соуса, рисовой бумаги и т. д.',
          '«Русские» магазины: Magnit (Лиссабон), «Матрёшка» и др. — продукты из СНГ'
        ]}
      ]
    }
  ],
