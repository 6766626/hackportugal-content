        ...
        { kind: 'substeps', items: [
          ...
          { id: 's2', title: 'Ericeira — World Surf Reserve', content: [
            { kind: 'checklist', items: [
              ...
              'примерно 45–60 минут на машине из Лиссабона, дольше в часы пик'
            ]}
          ]},
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'b3', title: 'Прокат (для туристов)', content: [
            { kind: 'checklist', items: [
              ...
              'На популярных пляжах часто есть прокат, но на диких/удалённых спотах его может не быть; бронируйте заранее и проверяйте сезонность'
            ]}
          ]}
        ]}
      ]
