export default {
  ...
  tldr: 'Если у тебя на участке растёт виноград, ты можешь делать вино для собственного потребления без любых лицензий.\n\nЛимит — 100 л в год на семью без декларации (закон IVDP)\.\n\nСвыше 100 л — обязательная декларация в IVV (Instituto da Vinha e do Vinho), даже без продажи. Продажа — серьёзный регулируемый бизнес: обязательно атестат качества, IGP/DOC сертификации, IVA, registo en IVV. Для квинт с виноградом стоит выяснить, входит ли участок в DOC регион — это влияет на разрешённые сорта и стиль. Смешивать с гражданскими винами и продавать как DOC без сертификации = большой штраф.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Португалия — пятая страна по производству вина в мире. Закон относится к домашнему производству относительно мягко, но есть чёткие правила:' },
        { kind: 'checklist', items: [
          'До 100 л/год для семьи: НИКАКИХ деклараций. Делай и пей, дари соседям',
          '100-1000 л/год: декларация в IVV (Instituto da Vinha e do Vinho) обязательна, даже без продажи. Декларация бесплатна, но обязательна',
          '1000+ л/год: уже коммерческое производство. Регистрация виноградника, atestado, регулярные пробы',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Чтобы делать DOC вино — нужна сертификация в Comissão Vitivinícola Regional (CVR) соответствующего региона. Минимум: registo вiноградника в IVV + анализы вина + дегустация комиссии.' }
      ]
    },
    {
      id: 'making',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Если у тебя 5-10 виноградных лоз на даче — давай сразу 50-70 л масла за сезон (это уже семейный запас)',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Производство свыше 100 л без декларации IVV: 100-1000 €',
