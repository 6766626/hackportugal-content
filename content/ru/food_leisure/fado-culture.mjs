export default {
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'В Alfama (Largo do Chafariz de Dentro 1). Муниципальный музей Лиссабона, управляется EGEAC; стандартный билет около € 5, проверяйте актуальную цену на официальном сайте. Коллекция инструментов, фотографии, аудио- и видеоархив, временные выставки. Рекомендуется ДО похода на живой концерт — помогает понять контекст.' },
