export default {
  ...
  steps: [
    {
      id: 'big-three',
      title: 'Os Três Grandes — «Большая тройка»',
      content: [
        { kind: 'substeps', items: [
    ...
    {
      id: 'match-day',
      title: 'День матча — чего ожидать',
      content: [
        { kind: 'checklist', items: [
          '🚇 Метро забито за 1,5–2 часа до матча. Приезжайте заранее',
          '🍻 Бары у стадиона — хаотично, но весело',
          '🥪 Bifana / cachorro (хот-дог) / сардины — традиционная еда',
          '📣 Гимны клубов — все поют',
    ...
    {
      id: 'national-team',
      title: 'Сборная Португалии',
      content: [
        { kind: 'paragraph', text: 'Seleção das Quinas (красно-зелёные квины в гербе). Форма — красно-зелёная. Стадионы: Estádio Nacional do Jamor (классический финал Taça), Estádio da Luz, Estádio do Dragão.' },
        { kind: 'checklist', items: [
    ...
    },
    {
      ...
      title: 'Туры по стадионам',
      content: [
        { kind: 'checklist', items: [
          '🏟️ Estádio da Luz (Benfica) — тур за € 20 с раздевалкой и музеем',
          '🏟️ Estádio do Dragão (Porto) — тур за € 15 с клубным музеем',
          '🏟️ Estádio José Alvalade (Sporting) — тур за € 12–15',
          '🏟️ Museu Cosme Damião (Benfica) — один из лучших футбольных музеев Европы',
          '⏰ Туры длятся 1,5–2 часа, на EN/PT/ES, с аудиогидом',
          '🎫 Покупка на сайтах клубов или у стадиона'
        ]}
      ]
    },
    {
  ...
  sources: [
    { title: 'FPF — Федерация футбола Португалии', url: 'https://www.fpf.pt/', kind: 'official', language: 'pt', lastRetrieved: '2026-04-22' },
