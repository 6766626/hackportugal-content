export default {
  ...
  tldr: 'В Португалии у работника по contrato de trabalho обычно 14 зарплат в год: 12 месячных, Subsídio de Férias и Subsídio de Natal. Natal платят до 15 декабря, Férias — до начала отпуска, если нет другого письменного соглашения. В год найма/увольнения суммы считаются пропорционально отработанному времени. Обе субсидии облагаются IRS и Segurança Social, но для IRS удержание считается отдельно. У recibos verdes автоматической 13-й/14-й зарплаты нет.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Subsídio de Natal — рождественская субсидия, фактически 13-я зарплата. Subsídio de Férias — отпускная субсидия, фактически 14-я зарплата. Для наёмных работников это не бонус “по доброй воле”, а обязанность работодателя по Código do Trabalho.' },
        ...
        { kind: 'checklist', items: [
          ...
          'Subsídio de Férias: минимум равен оплате периода отпуска и отпускной субсидии по правилам art. 264 Código do Trabalho.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'Уходите в отпуск 1 августа — отпускная субсидия обычно должна прийти до 1 августа.',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Для полного календарного года каждая субсидия обычно равна одной месячной зарплате брутто. Если вы работали не весь год, сумма считается пропорционально отработанному времени. Практическая формула для Natal: месячная базовая зарплата × месяцы работы в году / 12.' },
        { kind: 'substeps', items: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          '1/12 от 2 000 € = 166,67 € брутто в месяц за одну субсидию.',
