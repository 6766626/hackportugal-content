  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Медицинская и психологическая пригодность, обычно по Grupo 2',
        ...
        { kind: 'substeps', items: [
          { id: 'requirements', title: '1. Проверить личные требования', content: [
            { kind: 'checklist', items: [
              ...
              'Медицинская справка и avaliação psicológica, если школа/IMT требует для Grupo 2',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Inspeção periódica válida; для TVDE платформы обычно требуют актуальный лист inspeção',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Комиссия платформы и комиссия оператора уменьшают оборот до налогооблагаемого дохода',
