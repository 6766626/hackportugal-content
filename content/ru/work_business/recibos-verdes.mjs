        ...
        { kind: 'substeps', items: [
          ...
          { id: 'o4', title: '4. IVA (НДС)', content: [
            { kind: 'checklist', items: [
              ...
              'Если за год оборот превысил € 15 000, но не более € 18 750, alteração подаётся в первые 15 рабочих дней января, и переход в regime normal происходит с 1 января. Если оборот превысил € 18 750 в течение года, переход в regime normal — немедленный: счёт, которым превышен лимит, уже выставляется с IVA. После перехода появляются periodic VAT returns и платежи IVA. Стандартная ставка 23% (или 13%/6% для отдельных услуг). Для B2B-клиентов за границей часто применяется reverse charge / regras de localização'
            ]}
          ]},
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'i3', title: '3. Указать сумму и категорию', content: [
            { kind: 'paragraph', text: 'Услуги включаются в счёт. Если вы не в isenção art. 53, при выпуске документа нужно выбрать применимую ставку IVA или основание não liquidação/isenção. Для иностранных клиентов и reverse charge не полагайтесь на «автоматически»: проверьте regras de localização и статус клиента.' }
          ]},
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Pagamentos por conta de IRS могут быть назначены AT на основании предыдущей декларации/ликвидации IRS; это не автоматический налог для всех TI. Если назначены, обычно платятся 3 раза в год — в июле, сентябре и декабре'
        ]},
        { kind: 'paragraph', text: 'Для участников режима IFICI (новый режим, заменил NHR с 2024): фиксированная ставка 20% на квалифицированную деятельность из утверждённых перечней при выполнении условий режима.' }
      ]
    },
    {
      id: 'tips',
