        ...
        { kind: 'substeps', items: [
          ...
          { id: 'o4', title: '4. IVA (НДС)', content: [
            { kind: 'checklist', items: [
              ...
              'Если лимит превышен — alteração de atividade в сроки CIVA art. 58 (обычно в январе следующего года с начислением IVA с февраля). Стандартная ставка 23% (или 13%/6% для отдельных услуг). Для B2B клиентов за границей часто применяется reverse charge / regras de localização'
            ]}
          ]},
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Квартальные авансовые платежи IRS со второго года деятельности'
        ]},
