export default {
  ...
  tldr: 'В Португалии invoices/recibos должны оформляться через AT-certified software, Portal das Finanças или ручные типографские бланки — выбор зависит от оборота, учёта и способа работы. QR-код обязателен на fiscal documents с 2022 года, ATCUD — с 01.01.2023. Серии документов нужно заранее сообщать в AT, иначе программа не получит validation code. Для бизнеса важно не только выдать счёт клиенту, но и передать его в e-Fatura обычно до 5-го числа следующего месяца.',
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Могут использоваться ручные типографские бланки от authorised print shops, но это неудобно и не подходит большинству digital-бизнесов',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'Перед использованием новой серии документов её нужно сообщить в AT',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Не ждите периода IRS/IRC: e-Fatura — ежемесячная операционная обязанность'
        ] },
