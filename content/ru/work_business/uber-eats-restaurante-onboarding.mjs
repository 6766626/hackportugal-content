export default {
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'IVA на комиссию платформы: комиссия 30% + IVA 23% превращается в 36,9% cash impact, если IVA не учтён в марже',
        ...
        { kind: 'paragraph', text: 'Считайте delivery-меню отдельно. Блюдо за 10 € в зале при комиссии 30% + IVA на комиссию оставляет примерно 6,31 € до food cost, упаковки, персонала и IVA с продажи. Часто delivery-цены делают на 10–20% выше, но проверьте, не запрещает ли договор price parity.' }
      ]
    },
    {
  ...
  costs: [
    { label: 'Комиссия платформы за delivery orders', amountEURMin: 25, amountEURMax: 30, note: 'Ориентир как процент от заказа, не фиксированная госпошлина; коммерческие условия зависят от города, оборота, логистики и переговоров. Обычно к комиссии добавляется IVA 23%.' },
