export default {
  ...
  tldr: 'В Португалии part-time не означает “без прав”: salário, férias, subsídio de Natal/férias и Segurança Social считаются пропорционально, но отпуск обычно остаётся 22 рабочих дня. Contrato a termo certo в 2026 допустим только при временной потребности работодателя по art. 140 Código do Trabalho; после Lei 13/2023 нельзя прикрывать им “первую работу” или долгую безработицу. Общий лимит fixed-term — до 2 лет, не универсальные 18 мес. RTI — редкий режим “вызывают когда нужно”: минимум 5 мес работы/год и компенсация за простой обычно 20%.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Если письменной формы нет или режим part-time описан плохо, спор обычно трактуется не в пользу работодателя.',
          'Salário считается пропорционально: при 20 ч/нед вместо 40 ч/нед — минимум 50% от применимого full-time salário.',
          'SMN 2026 — 920 € в месяц для full-time; для 50% занятости ориентир — не ниже 460 € gross, если нет более выгодного CCT.',
