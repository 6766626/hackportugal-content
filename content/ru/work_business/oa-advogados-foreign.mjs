  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'Можно: консультировать по праву своей страны, если это честно указано в договоре и профиле',
          'Можно: работать in-house в компании, в compliance, privacy, contracts, AML, relocation/legal operations',
          'Можно: переводить и готовить проекты документов под проверку advogado',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'EU route не распространяется на гражданство само по себе. Важно не то, что у вас паспорт EU, а то, что вы уже профессионально квалифицированы как адвокат в одной из юрисдикций EU/EEA.' }
      ]
    },
    {
      id: 'practical-plan',
