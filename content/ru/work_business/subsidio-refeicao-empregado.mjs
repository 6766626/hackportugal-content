export default {
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Для IRS и Segurança Social важен не сам факт выплаты, а способ выплаты и дневной лимит. На апрель 2026 применяются такие практические лимиты: cash — до 6 € в день; cartão/vale refeição — до 10,20 € в день.' },
        { kind: 'checklist', items: [
          'Cash 6 € в день: 0 € IRS и 0 € Segurança Social.',
          'Cash 7 € в день: 6 € освобождены, 1 € считается зарплатой.',
          'Cartão refeição 10,20 € в день: 0 € IRS и 0 € Segurança Social.',
          'Cartão refeição 11 € в день: 10,20 € освобождены, 0,80 € считается зарплатой.',
        ...
        { kind: 'warning', text: 'Старый лимит cash 5,20 € уже не является актуальным ориентиром для 2026. Для текущей практики используйте 6 € cash и 10,20 € cartão/vale.' }
      ]
    },
    {
      id: 'cash-vs-card',
      ...
      content: [
        { kind: 'paragraph', text: 'Если работодатель готов платить больше 6 € в день, карта почти всегда выгоднее: безналоговый потолок выше — 10,20 € вместо 6 €. При 22 рабочих днях это до 224,40 € в месяц без IRS и Segurança Social через cartão refeição против 132 € cash.' },
        { kind: 'checklist', items: [
          'Cash удобнее: деньги приходят на обычный банковский счёт.',
          'Cash свыше 6 € быстро теряет выгоду из-за IRS и Segurança Social.',
          'Cartão refeição выгоднее при суммах 6,01–10,20 € в день.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Дневная ставка: например 6 €, 7,63 €, 9,60 € или 10,20 €.',
          ...
          'Tributável: только превышение над 6 € cash или 10,20 € cartão должно облагаться.',
  ...
  costs: [
    { label: 'Безналоговый cash-лимит', amountEUR: 6, note: 'В день, если выплата идёт деньгами вместе с зарплатой.' },
    { label: 'Безналоговый лимит cartão/vale refeição', amountEUR: 10.20, note: 'В день, если используется meal card или voucher с ограниченным назначением.' },
    { label: 'Пример за 22 рабочих дня cash', amountEUR: 132, note: '22 × 6 € без IRS и Segurança Social.' },
    { label: 'Пример за 22 рабочих дня cartão', amountEUR: 224.40, note: '22 × 10,20 € без IRS и Segurança Social.' }
  ],
  sources: [
    {
