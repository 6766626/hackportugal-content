  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Частые карты: Edenred, Pluxee (бывш. Sodexo), Coverflex, Euroticket.',
          'Сумма должна быть видна в payslip/recibo de vencimento отдельной строкой.',
          'Для part-time есть правило Código do Trabalho: если subsídio de refeição предусмотрен CCT или обычно платится в компании, работник на неполной ставке тоже имеет на него право; и только если рабочий день меньше 5 часов, сумма считается пропорционально недельным часам по сравнению с full-time.'
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Для IRS и Segurança Social важен не сам факт выплаты, а способ выплаты и дневной лимит. В 2026 применяются такие практические лимиты: cash — до 6,15 € в день; cartão/vale refeição — до 10,46 € в день.' },
        { kind: 'checklist', items: [
          ...
          'На превышение удерживается IRS по вашей ставке retenção na fonte (withholding).',
        ...
        { kind: 'warning', text: 'Прошлогодний лимит cash 6,00 € уже не актуален для 2026. Для текущей практики используйте 6,15 € cash и 10,46 € cartão/vale.' }
      ]
    },
    {
      id: 'cash-vs-card',
      ...
      content: [
        { kind: 'paragraph', text: 'Если работодатель готов платить больше 6,15 € в день, карта почти всегда выгоднее: безналоговый потолок выше — 10,46 € вместо 6,15 €. При 22 рабочих днях это до 230,12 € в месяц без IRS и Segurança Social на cartão refeição — против 135,30 € при выплате cash.' },
        { kind: 'checklist', items: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Если вы на teletrabalho/remote, сам факт работы из дома обычно не повод убрать subsídio de refeição, когда он уже положен по contrato, CCT, практике компании или платится сопоставимым работникам в офисе. Но если права на subsídio de refeição в компании нет вообще, удалёнка сама по себе его не создаёт.',
