    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Recibos de vencimento, extratos bancários, comprovativos de transferência, сообщения о задержке оплаты.',
          ...
          'Расчёт долга: месяц, сумма bruto/líquido, что не оплачено — salário, subsídios, férias, horas extra, compensação.'
        ] },
      ...
      content: [
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'write-facts', title: '3. Опишите факты по схеме “кто-что-когда-где”', content: [
            { kind: 'paragraph', text: 'Пример: “Работаю в Restaurante X, Rua Y, Lisboa, с 03.02.2026. Договор не выдали. Зарплата 920 € bruto была обещана устно, за март 2026 не выплачено ничего. Работал 6 дней в неделю по 10 часов, recibos de vencimento нет.\n\nДокументы и переписка приложены”.' }
          ] },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Оспаривание despedimento: для большинства индивидуальных увольнений (disciplinar, extinção do posto de trabalho, inadaptação) срок короткий — 60 дней с получения письменного решения по Código do Trabalho art. 387. Для despedimento coletivo действует отдельный срок 6 месяцев со дня прекращения договора по art. 388. Revogação и caducidade оспариваются по иным правилам — срочно покажите документы юристу.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Минимальная месячная зарплата SMN в континентальной Португалии в 2026 — 920 € bruto (до удержаний) за полный рабочий день; на руки после взноса в Segurança Social обычно меньше (около 818 € líquido). Платить ниже этой ставки за полный рабочий день нельзя, кроме специальных законных режимов.',
