  ...
  steps: [
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Титр антител к бешенству (для стран с высоким риском бешенства — анализ крови берут минимум через 30 дней после вакцинации, затем ожидание 3 месяца до въезда)',
        ...
        { kind: 'warning', text: 'Для Египта, Турции и некоторых стран Африки действуют дополнительные требования. Для России в 2026 году титрование обязательно.' }
      ]
    },
    {
      id: 'eu-countries',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Багажник машины — разрешено, нужна переноска или ремень безопасности',
