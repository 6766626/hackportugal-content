export default {
  ...
  tldr: 'Сертификат уровня A2 нужен только для натурализации по проживанию (по действующему Lei 37/81 — 5 лет; изменения, одобренные парламентом 01.04.2026, до 7 лет для CPLP/EU и 10 лет для остальных, на 28.04.2026 НЕ промульгированы и НЕ в силе). Для брака, união de facto, Reagrupamento Familiar — НЕ нужен. ВАЖНО: для натурализации IRN принимает только официальный сертификат уровня A2+ (CIPLE / PLA / Centros Qualifica / DEPLE / DAPLE) — простая справка о посещении 150 часов курса БЕЗ оценки уровня НЕ принимается. Самые дешёвые пути: PLA (0 €), IEFP (0 € + стипендия, но с обязательствами как безработного), государственные школы для взрослых ~20 €/семестр. Экзамен CIPLE — 85 € (2026), ежемесячные сессии.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          '✅ **Натурализация по проживанию** (art. 6 Lei 37/81 + art. 25 Decreto-Lei 237-A/2006): сейчас — после 5 лет. Изменения до 7 лет для CPLP/EU и 10 лет для остальных одобрены парламентом 01.04.2026, но на 28.04.2026 ещё НЕ промульгированы — действуют старые правила',
