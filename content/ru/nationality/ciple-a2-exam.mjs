  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'IRN при подаче на натурализацию по проживанию (art. 6) принимает только ОФИЦИАЛЬНЫЙ сертификат, в котором указан конкретный уровень A2 или выше. Справка о посещении курса (frequência) без оценки уровня — НЕ подходит. Для внуков/правнуков (art. 1(1)(d/e)) набор приемлемых доказательств шире — уточняйте в IRN, если CIPLE недоступен.' }
      ]
    },
    {
