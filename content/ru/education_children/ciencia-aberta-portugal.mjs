export default {
  ...
  tldr: 'В Португалии много бесплатных научных событий для семей и взрослых: дни открытых лабораторий, мероприятия Ciência Viva, Pavilhão do Conhecimento в Лиссабоне, центры Ciência Viva по стране и Noite Europeia dos Investigadores. В 2026 году главная ночь исследователей приходится на пятницу 25 сентября. Вход часто бесплатный, но почти всегда нужна онлайн-регистрация: места на лаборатории, телескопы и детские мастер-классы разбирают за часы.',
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Регистрируйте каждого участника, включая ребёнка, если форма просит individual registration',
          ...
          'Если не идёте — отмените регистрацию; это нормальная практика и помогает другим семьям'
        ] },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Хорошая стратегия для новой семьи в Португалии: начать с Pavilhão do Conhecimento или ближайшего Centro Ciência Viva, затем раз в месяц проверять “agenda” университета в вашем городе. Это дешёвый способ встроиться в местную среду без идеального португальского.' }
      ]
    },
    {
      id: 'calendar-2026',
