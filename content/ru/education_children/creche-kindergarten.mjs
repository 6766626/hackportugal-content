  ...
  steps: [
    {
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 't1', title: 'Creche Feliz (бесплатные ясли для подходящих мест) — с 2022', content: [
            { kind: 'paragraph', text: 'Бесплатное место в покрытых учреждениях — преимущественно социальная/солидарная сеть IPSS; частные коммерческие creches могут участвовать только при соблюдении правил программы (обычно когда нет подходящего места в социальной сети)\.\n\nИзначально (2022/23) действовало ограничение по 1–2 эшелонам abono — на 2026 это уже не основное правило. Стандартная mensalidade — €0; дополнительные услуги (например, расширенные часы) могут оплачиваться отдельно.' }
          ]},
          ...
          { id: 't3', title: 'Частные ясли (Creche Privada)', content: [
            { kind: 'paragraph', text: 'Коммерческие учреждения. € 400–1200/мес в Лиссабоне и Порту. Есть международные варианты с обучением на английском, французском или немецком языке.' }
          ]},
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'c4', title: '4. Ждать ответа', content: [
            { kind: 'timeline', text: '1–6 мес. В Лиссабоне и Порту очередь в Creche огромная — подавайте заявку до рождения или в первые 1–2 месяца.' }
          ]}
        ]}
      ]
    },
