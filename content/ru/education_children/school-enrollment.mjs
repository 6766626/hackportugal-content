export default {
  ...
  tldr: 'Обучение в Португалии обязательно с 6 до 18 лет. Государственные школы бесплатные, зачисление — по району проживания через Portal das Matrículas. Возможны частные школы (€ 3 000–15 000 в год) и международные (€ 10 000–25 000 в год). Окно matrícula/renovação для пре-эскоаляр и 1.º ano на 2026/2027 — 22 апреля – 1 июня 2026 (Despacho 4472-A/2026); иностранцы могут подавать документы в течение года.',
