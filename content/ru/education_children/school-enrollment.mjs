export default {
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 't1', title: 'Государственные школы', content: [
            { kind: 'paragraph', text: 'Бесплатные для всех резидентов. Качество варьируется по региону, рейтинги доступны публично. Язык обучения — португальский. Для детей, чей родной язык не португальский, есть программа PLNM — португальский как неродной.' }
          ]},
          ...
          { id: 't4', title: 'Домашнее обучение (ensino doméstico/individual)', content: [
            { kind: 'paragraph', text: 'Разрешено, но ребёнок всё равно должен быть зачислен в школу: оформляется запрос с responsável educativo и индивидуальным планом, а оценивание идёт по правилам школы и законодательства. Перед выбором проверьте требования Portaria n.º 69/2019 и актуальные инструкции DGEstE/DGE.' }
          ]}
        ]}
      ]
    },
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'e3', title: '3. Подать заявление на зачисление', content: [
            { kind: 'paragraph', text: 'Окно основной сессии для 2026–2027 учебного года: 22 апреля – 1 июня 2026 (Portal das Matrículas, дошкольное образование + 1-й класс 1º Ciclo), согласно Despacho n.º 4472-A/2026. Для 2º Ciclo, 3º Ciclo и Secundário — свои сроки, проверяйте ежегодное распоряжение (despacho). Для перевода или переезда — в любое время, но желательно до конца июля.' }
          ]},
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Вычет IRS за образование — 30% приемлемых расходов, обычно до € 800 на agregado familiar (не на ребёнка); лимит может увеличиваться в отдельных случаях (например, при оплате аренды для estudante deslocado)'
        ]}
      ]
    }
  ],
  sources: [
    ...
    { title: 'ePortugal — Inscrever criança em escola', url: 'https://www.gov.pt/cidadaos/-/informacoes/matricular-ou-renovar-a-matricula-no-ensino-obrigatorio', kind: 'official', language: 'pt', lastRetrieved: '2026-04-22' }
  ],
