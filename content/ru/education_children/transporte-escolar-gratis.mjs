export default {
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Базовое правило для 2026 года: бесплатный школьный транспорт предоставляется учащимся обязательного образования, если расстояние от места проживания до школы превышает 3 км — а если в школе есть столовая (refeitório), порог часто составляет 4 км. Município может детализировать, как измеряет расстояние: по дороге, по кратчайшему пешеходному маршруту или через GIS-карту.' },
        { kind: 'checklist', items: [
          ...
          'Дом находится более чем в 3 км от школы (4 км, если в школе есть столовая)',
          ...
          'Для детей с особыми образовательными потребностями (necessidades educativas especiais) может быть отдельный режим, включая адаптированный транспорт'
        ] },
