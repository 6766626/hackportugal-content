  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'IVA на фиксированную часть зависит от мощности и региона. Для континентальной Португалии в 2026 ориентир такой: при baixa tensão normal сниженные/промежуточные ставки применяются к части potência до установленных лимитов, а более высокая часть облагается 23%. На практике смотрите строку IVA в счёте: поставщик обязан разбить base tributável по ставкам 6%, 13% и 23%.' }
      ]
    },
    {
      id: 'consumo',
