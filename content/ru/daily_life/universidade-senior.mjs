export default {
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Типичная модель — небольшой ежегодный регистрационный взнос плюс mensalidade.\n\nВ 2026 году для обычных муниципальных/ассоциативных школ реалистичный диапазон — 30–50 € в месяц за доступ к нескольким или “безлимитным” занятиям по расписанию. В некоторых Câmaras цена ниже или символическая, если программа финансируется муниципалитетом.' },
        { kind: 'checklist', items: [
