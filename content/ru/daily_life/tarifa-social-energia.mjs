  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'На практике первая автоматическая активация может занять несколько циклов выставления счетов. Если вы только переоформили договор или получили пособие, проверьте следующий и последующий счёт. 🆕 С 28.08.2026 (Decreto-Lei 130/2026) социальный тариф автоматически сохраняется при смене поставщика — не нужно заново его «выбивать» после перехода.' }
      ]
    },
    {
      id: 'manual-request',
