export default {
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Главная задача — понять, это реальный profissional с историей или случайный посредник. В Португалии много хороших маленьких бригад, но рынок фрагментирован: один и тот же человек может называться “empresa de remodelações”, не имея команды и страховки.' },
        { kind: 'checklist', items: [
