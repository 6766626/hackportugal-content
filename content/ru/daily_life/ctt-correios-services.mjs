        ...
        { kind: 'substeps', items: [
          ...
          { id: 's2', title: 'CTT Expresso', content: [
            { kind: 'checklist', items: [
              ...
              '⚖️ Срок хранения зависит от продукта (для постовых обычно ~10-15 дней, для lockers/pickup points может быть короче); проверяйте aviso'
            ]}
          ]},
          ...
          { id: 's4', title: 'Pagamentos и Espaço Cidadão', content: [
            { kind: 'checklist', items: [
              ...
              '🏛️ Espaço Cidadão (госуслуги) в части отделений CTT — набор услуг зависит от локации; типично: изменение адреса, заявления, справки. Cartão de Cidadão services ограничены, NIF для иностранцев обычно НЕ оформляется в CTT/Espaço Cidadão',
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'p2', title: 'Через CTT Locky / cacifos (автомат)', content: [
            { kind: 'checklist', items: [
              ...
              '✅ Доступно 24/7',
              '💰 Цены/условия зависят от продукта; для некоторых форматов онлайн дешевле, чем counter — проверяйте перед отправкой'
            ]}
          ]}
        ]}
      ]
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'r3', title: 'Amazon / международные отправления', content: [
            { kind: 'checklist', items: [
              ...
              '⚠️ Import IVA применяется к non-EU посылкам и ниже €150 (порог €150 относится в основном к таможенным пошлинам). Растаможка обычно через CTT customs portal/customs broker',
              '💸 IVA: 23% mainland, 16% Madeira, 16% Açores (региональные ставки); + сбор CTT за обработку, зависит от типа отправления и IOSS/prepaid VAT status'
            ]}
          ]}
        ]}
      ]
