export default {
  ...
  tldr: 'Граждане ЕС/ЕЭЗ/Швейцарии не нуждаются в визе. Если планируете жить в Португалии БОЛЕЕ 3 месяцев — нужно зарегистрироваться в течение 30 дней после истечения первых 3 месяцев пребывания и получить Certificado de Registo de Cidadão da União Europeia (CRUE). Оформляется в Câmara Municipal по месту жительства. ~€ 15 (для детей младше 6 лет — €7,50), выдаётся обычно в день визита; ожидание записи зависит от муниципалитета.',
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'По действующему праву натурализация после 5 лет легального проживания при выполнении остальных условий, включая знание португальского A2. **03.05.2026 Президент Сегуру промульгировал Decreto AR 48/XVII** — после публикации в DRE срок для граждан ЕС/ЕЭЗ/Швейцарии вырастет до 7 лет (приравнены к CPLP).' }
      ]
    }
  ],
  costs: [
