    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'После завершения обучения можно запросить ВНЖ для поиска работы или предпринимательства (Lei 23/2007 art. 122): для выпускников магистратуры/докторантуры (2-й/3-й цикл) — период до 1 года (al. p); для выпускников бакалавриата (1-й цикл) основание иное (al. o). Это НЕ job seeker visa для въезда из-за рубежа'
        ]}
      ]
    },
    {
