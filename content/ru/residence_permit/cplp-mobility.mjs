export default {
  ...
  changeSummary: 'Decreto-Lei 37-A/2024 прекратил приём новых Manifestação de Interesse с июня 2024; Lei 61/2025 (в силе с 23.10.2025) изменил/ужесточил последующий режим, включая CPLP-процедуры — для граждан CPLP, кроме бразильцев, теперь виза до въезда обязательна. Новый закон о гражданстве опубликован как Lei Orgânica 1/2026 (18.05.2026) и в силе с 19.05.2026: стаж до натурализации для всех граждан CPLP увеличен с 5 до 7 лет. По переходному правилу к заявлениям, поданным до вступления закона в силу, применяется прежняя редакция (5 лет).',
  variants: [
    {
      id: 'brazil',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Натурализация после 7 лет законного проживания: Lei Orgânica 1/2026 в силе с 19.05.2026 увеличила срок для граждан CPLP с 5 до 7 лет. По переходному правилу к заявлениям, поданным до вступления закона в силу, применяется прежний 5-летний режим',
