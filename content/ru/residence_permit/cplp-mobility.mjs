export default {
  ...
  changeSummary: 'Lei 61/2025 (в силе с 23.10.2025) отменил Manifestação de Interesse и ужесточил правила для граждан CPLP, кроме бразильцев: теперь виза до въезда обязательна. Новый закон о гражданстве (Decreto AR 48/XVII, промульгирован Президентом Сегуру 03.05.2026; вступит в силу после публикации в DRE) увеличит стаж до гражданства с 5 до 7 лет для всех граждан CPLP.',
  variants: [
    {
      id: 'brazil',
