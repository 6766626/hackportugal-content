export default {
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'В 2026 стандартные сроки подачи declaração periódica de IVA: месячный режим — до 20-го числа второго месяца после периода; квартальный режим — до 20-го числа второго месяца после квартала.\n\nНапример, IVA за январь 2026 подаётся до 20 марта 2026, а 1-й квартал 2026 — до 20 мая 2026.' },
