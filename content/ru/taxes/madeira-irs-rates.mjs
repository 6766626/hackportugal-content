export default {
  ...
  tldr: 'К налоговым резидентам Madeira применяется отдельная таблица IRS, а не таблица mainland Portugal. В 2026 году у Мадейры пониженные ставки: для нижнего диапазона MCS указывает 8,75% против материковой справочной 12,50%; при этом актуальная общенациональная первая ставка IRS на 2026 год — 11,97%, поэтому финальный расчёт проверяйте в симуляторе AT. Для капитального дохода стандартная специальная ставка на Madeira — 19,6% вместо 28%. Ключевое условие — fiscal domicile на Madeira.',
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Снижение заметнее всего по обычному облагаемому доходу: зарплата, пенсия, self-employment/recibos verdes, часть rental income при выборе englobamento. В 2026 году первая общенациональная ставка IRS для материка после обновлений — 11,97%, но Madeira применяет собственную пониженную региональную таблицу; коммерческие обзоры MCS отдельно указывают нижнюю ставку Madeira 8,75%.' },
        { kind: 'checklist', items: [
