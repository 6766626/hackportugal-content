export default {
  ...
  tldr: 'К налоговым резидентам Madeira применяется отдельная таблица IRS, а не таблица mainland Portugal. В 2026 году у Мадейры пониженные ставки: для нижнего диапазона MCS указывает 8,75% против материковой первой ставки IRS на 2026 год 11,97%, поэтому финальный расчёт проверяйте в симуляторе AT. Для капитального дохода стандартная специальная ставка на Madeira — 19,6% вместо 28%. Ключевое условие — fiscal domicile на Madeira.',
