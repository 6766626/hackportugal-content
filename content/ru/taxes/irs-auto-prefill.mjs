export default {
  ...
  tldr: 'IRS Automático — черновик декларации Modelo 3, который Finanças заранее заполняет по зарплате, пенсиям и e-Fatura. В кампании IRS 2026 по доходам за 2025 год декларацию можно подать с 1 апреля по 30 июня 2026 года. Если вы подходите под режим и ничего не делаете, декларация НЕ считается поданной 1 апреля: предварительная декларация становится окончательной только после окончания срока. Подходит не всем экспатам: recibos verdes, аренда, зарубежные доходы, crypto/акции обычно требуют обычную Modelo 3.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'Распространённая ошибка: IRS Automático не «подаётся 1 апреля». 1 апреля он лишь становится доступен. Если налогоплательщик не подтверждает декларацию и не подаёт другую до 30 июня, предварительная декларация обычно считается поданной автоматически после окончания срока — согласно art. 58-A CIRS.' }
      ]
    },
    {
      id: 'who-can-use',
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Если вы в браке или в união de facto, Portal das Finanças обычно показывает два варианта: отдельная и совместная подача. Не выбирайте автоматически первый вариант — сравните симуляции.' }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Данные e-Fatura неполные: крупные медицинские, образовательные, арендные или ипотечные расходы не подтянулись',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'У меня не было зарубежной зарплаты, пенсии, дивидендов, процентов, купонов или прироста капитала',
