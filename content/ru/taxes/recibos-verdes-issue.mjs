  ...
  steps: [
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '✅ NISS нужен для Segurança Social; для выписки recibo достаточно открытой деятельности (abertura de atividade), NIF и доступа к Portal das Finanças',
