export default {
  ...
  categoryId: 'taxes',
  title: 'Modelo 30 — ежемесячная декларация о выплатах нерезидентам',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'У экспата такая обязанность чаще всего возникает не в личной жизни, а когда у вас есть sociedade, ENI или atividade aberta: вы оплатили иностранного разработчика, маркетолога, консультанта, юриста, арендодателя, проценты, royalties, дивиденды или иные доходы, которые по португальским правилам считаются доходом нерезидента.' },
        { kind: 'checklist', items: [
          ...
          'Выплата была не деньгами, а зачётом/удержанием/colocação à disposição — обязанность по Modelo 30 всё равно может возникнуть.'
        ] }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Обычный наёмный работник без atividade, который просто покупает услугу у иностранца для личных нужд, как правило, не становится регулярным заявителем Modelo 30. Но если у вас есть NIF с atividade aberta или empresa, бухгалтер должен проверять каждую выплату иностранцу.' },
    ...
    {
      id: 'deadline',
      title: 'Сроки: ежемесячно, но со сдвигом на 2 месяца',
      content: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Отразите в Modelo 30 не только сумму дохода, но и удержанный налог или основание для неудержания.'
        ] },
