export default {
  ...
  tldr: 'IRS Municipal — это не отдельная льгота и не заявление: município может вернуть жителю до 5% части IRS через расчёт Finanças. В декларации IRS за 2025 год, подаваемой в 2026, возврат применяется автоматически, если ваш NIF-адрес на 31.12.2025 был в município с devolução. Примеры 2026: Lisboa — 2,5%, Porto — 3%, Cascais — 5%. Проверяйте адрес в Finanças до конца года: неверный domicílio fiscal = деньги уйдут не тому município или льготы не будет.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Это не значит, что вам вернут 5% от зарплаты или от всего удержанного налога. Расчёт идёт внутри liquidação IRS по формуле AT, от вашей collecta líquida после применимых вычетов.' },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'На практике разница может быть небольшой для людей с низкой collecta IRS и заметнее для семей с высоким облагаемым доходом. Возврат появляется в итоговой liquidação IRS, отдельно подавать заявление не нужно.' }
      ]
    },
    {
      id: 'address-rule',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Жили часть года в Lisboa, потом переехали в Cascais: обычно считается endereço fiscal на конец года',
