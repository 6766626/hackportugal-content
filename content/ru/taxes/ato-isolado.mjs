  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Ato Isolado — это разовая операция: вы один раз оказали услугу или продали товар и хотите выставить официальный документ через Portal das Finanças без регистрации постоянной atividade в статусе trabalhador independente.' },
        { kind: 'paragraph', text: 'Доход попадает в IRS как categoria B. Это не “налоговая лазейка”, а режим для случайных, непредвиденных или нерегулярных операций. Если вы регулярно занимаетесь дизайном, консультациями, уроками, разработкой, переводами или оказываете услуги одному и тому же клиенту — это уже abertura de atividade и recibos verdes.' },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'По IRS доход декларируется в годовой декларации IRS за год получения дохода. Для резидента он суммируется с прочими доходами и облагается по прогрессивным ставкам IRS; в 2026 году ставка первой ступени IRS — 11,97%. Итог зависит от всех доходов, вычетов и статуса резидентства.' },
        { kind: 'checklist', items: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Сохраните договор, письмо с заказом, подтверждение оплаты и переписку',
