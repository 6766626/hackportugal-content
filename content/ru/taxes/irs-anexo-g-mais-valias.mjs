export default {
  ...
  tldr: 'Anexo G подаётся вместе с Modelo 3 IRS, если в году были taxable mais-valias **из португальских источников**: продажа недвижимости в Португалии, акций/ETF/долей через ПОРТУГАЛЬСКОГО брокера, crypto <365 дней. ⚠️ **Mais-valias из ИНОСТРАННЫХ источников** (продажа недвижимости за рубежом, акций/ETF/фондов через зарубежного брокера и т.д.) для налогового резидента Португалии декларируются в **Anexo J** (а не Anexo G) — с расчётом устранения двойного налогообложения. Для налоговых резидентов Португалии прирост по недвижимости обычно включается в IRS только на 50% и облагается по прогрессивной ставке; акции/ETF/фонды чаще облагаются автономно 28%, но можно выбрать englobamento. Продажа primeira habitação может быть освобождена при реинвестировании в новую HPP за 24 мес до или 36 мес после продажи.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Anexo G — приложение к Modelo 3 IRS для прироста капитала из **португальских источников**, который не освобождён автоматически. В апреле–июне 2026 вы подаёте IRS за доходы 2025 года; сделки 2026 года попадут в декларацию 2027. **Mais-valias из иностранных источников** идут в Anexo J.' },
        { kind: 'checklist', items: [
          ...
          '⚠️ **Anexo J** (не G): иностранный capital gain любого типа (дивиденды и проценты — в Anexo J тоже, но в других разделах).',
