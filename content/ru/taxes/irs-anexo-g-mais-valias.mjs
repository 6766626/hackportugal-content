export default {
  ...
  tldr: 'Anexo G подаётся вместе с Modelo 3 IRS, если в году были taxable mais-valias из португальских источников: продажа недвижимости в Португалии, акций/ETF/долей через ПОРТУГАЛЬСКОГО брокера, crypto <365 дней.\n\n⚠️ Mais-valias из ИНОСТРАННЫХ источников (продажа недвижимости за рубежом, акций/ETF/фондов через зарубежного брокера и т.д.) для налогового резидента Португалии декларируются в Anexo J (а не Anexo G) — с расчётом устранения двойного налогообложения. Для налоговых резидентов Португалии прирост по недвижимости обычно включается в IRS только на 50% и облагается по прогрессивной ставке; акции/ETF/фонды чаще облагаются автономно 28%, но можно выбрать englobamento. Продажа primeira habitação может быть освобождена при реинвестировании в новую HPP за 24 мес до или 36 мес после продажи.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Anexo G — приложение к Modelo 3 IRS для прироста капитала из португальских источников, который не освобождён автоматически. В апреле–июне 2026 вы подаёте IRS за доходы 2025 года; сделки 2026 года попадут в декларацию 2027 года. Mais-valias из иностранных источников идут в Anexo J.' },
        { kind: 'checklist', items: [
          'Anexo G: продажа недвижимости в Португалии (или доли в ней).',
          'Anexo G: продажа португальских акций/ETF/облигаций/паёв/долей/options через ПОРТУГАЛЬСКОГО брокера.',
          'Anexo G: продажа crypto-assets резидентом, если срок владения < 365 дней или актив не подпадает под освобождение.',
          'Anexo G: компенсация за уступку прав, опцион, cessão onerosa и похожие операции по Código do IRS art. 10.',
          '⚠️ Anexo J (не G): продажа НЕДВИЖИМОСТИ ЗА ГРАНИЦЕЙ резидентом Португалии.',
          '⚠️ Anexo J (не G): продажа акций/ETF/фондов через ЗАРУБЕЖНОГО брокера (Interactive Brokers, Schwab, Tinkoff, Trade Republic за пределами PT и т.д.).',
          '⚠️ Anexo J (не G): иностранный capital gain любого типа (дивиденды и проценты — тоже в Anexo J, но в других разделах).',
          'Вы нерезидент, но продали португальскую недвижимость или португальские активы: тоже Anexo G в португальском IRS.'
        ] },
        { kind: 'warning', text: 'Anexo G/J не заменяет CRS/DAC7-обмен. Finanças часто видит зарубежные брокерские счета, банковские поступления и продажи через нотариусов. «Брокер за границей» не означает «не декларировать». Зарубежные источники — это Anexo J с указанием страны источника и налога, удержанного за рубежом, для устранения двойного налогообложения.' }
      ]
    },
    {
      id: 'real-estate',
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'В расходы обычно входят IMT, Imposto do Selo при покупке, услуги нотариуса, registo predial, агентская комиссия при продаже, certificado energético, подтверждённые obras de valorização за последние 12 лет.',
