export default {
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Семьи, где один супруг работает на материковую компанию, но домохозяйство зарегистрировано в Açores.',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Таблица retenção решает только, сколько удержать сейчас. Финальный IRS за 2026 год считается в 2027 году в декларации Modelo 3. Там учитываются прогрессивные ставки, dependentes, despesas gerais familiares, saúde, educação, rendas, PPR и другие вычеты.' },
        { kind: 'checklist', items: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Ошибки удержания обычно исправляются через последующие payroll-месяцы или через финальную liquidação IRS. Но лучше исправить в течение года, чтобы не получить крупную доплату весной или летом 2027.' }
      ]
    }
  ],
  sources: [
