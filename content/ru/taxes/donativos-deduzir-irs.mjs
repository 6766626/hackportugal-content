export default {
  ...
  tldr: 'Пожертвования в Португалии могут уменьшить IRS, если у получателя есть право принимать donativos fiscalmente relevantes, а платёж оформлен с вашим NIF. Базовое правило для физлиц: 25% суммы donativo вычитается из coleta IRS; для большинства IPSS, религиозных, культурных и научных организаций действует лимит до 15% coleta. В декларации IRS 2025, подаваемой с 01.04 по 30.06.2026, это проверяется в Anexo H, Quadro 6, поле 6B. Consignação de IRS 0,5% — это не расход и не то же самое.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Для физлица-резидента налоговый эффект обычно такой: 25% суммы пожертвования вычитается из coleta IRS — налога, рассчитанного до персональных вычетов. Это не автоматический возврат 25% на карту, а уменьшение итогового IRS к уплате или увеличение возврата, если была retenção na fonte.' },
        { kind: 'checklist', items: [
          ...
          'Пожертвование не было оплатой услуги, билета или членского взноса со встречной выгодой',
    ...
    {
      id: 'deduction-rules',
      title: 'Сколько можно вычесть: 25% и лимит coleta',
      content: [
        { kind: 'paragraph', text: 'Стандартное правило для физических лиц по Estatuto dos Benefícios Fiscais: 25% суммы donativos вычитается из coleta IRS. Для большинства пожертвований частным IPSS, религиозным, культурным, научным и социальным entidades действует потолок: вычет не может превышать 15% вашей coleta.' },
        { kind: 'paragraph', text: 'Пример: coleta IRS = 3 000 €. Вы пожертвовали 1 000 € в IPSS с правом на benefício fiscal. Расчёт: 1 000 € × 25% = 250 €. Лимит 15% coleta = 450 €. Значит, можно использовать весь вычет 250 €.' },
        { kind: 'paragraph', text: 'Если при той же coleta 3 000 € вы пожертвовали 3 000 €, расчётный вычет = 750 €, но лимит 15% coleta = 450 €. В IRS зачтут максимум 450 €.' },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Для donativo в натуральной форме — оценка стоимости и документ передачи'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Декларация IRS за 2025 год подаётся на Portal das Finanças с 01.04.2026 по 30.06.2026. Donativos проверяются в Modelo 3 → Anexo H → Quadro 6, поле 6B. Если сумма уже предзаполнена, проверьте NIF получателя, код льготы и сумму.' },
        { kind: 'substeps', items: [
          ...
          { id: 'validate', title: '3. Сверить суммы', content: [
            { kind: 'checklist', items: [
              ...
              'Вычет не превышает применимый лимит coleta',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Consignação de IRS — это отдельный механизм: вы выбираете entidade, которой государство перечислит 0,5% вашего начисленного IRS. Это не увеличивает ваш налог и не уменьшает ваш возврат. Это просто направление части уже рассчитанного IRS выбранной организации.' },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Пожертвование сделано иностранной благотворительной организации без португальского фискального статуса — автоматического вычета в IRS обычно нет',
          ...
          'Заявили сумму не в том налоговом году, в котором была оплата',
          'Путают coleta с зарплатным удержанием: лимит 15% считается от coleta, а не от вашей валовой зарплаты',
