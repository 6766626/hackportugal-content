  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Для расходов 2025 года ключевая дата — 2 марта 2026: до неё нужно подтвердить висящие фактуры, назначить категорию и исправить ошибки. По закону крайний срок — последний день февраля, но в 2026 году 28 февраля приходится на субботу, поэтому он сдвигается на ближайший рабочий день. Декларация IRS за 2025 год подаётся с 1 апреля по 30 июня 2026.' },
    ...
    {
      id: 'validate',
      title: 'Валидация до 2 марта: что нажимать',
      content: [
        { kind: 'substeps', items: [
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Продавцы обычно передают фактуры до 5-го числа следующего месяца, но задержки бывают. Если к концу февраля чека всё ещё нет, можно зарегистрировать его вручную через “Registar Faturas”, но сохраняйте оригинал: Finanças может запросить подтверждение.' },
        { kind: 'checklist', items: [
          ...
          'После закрытия валидации исправления сложнее: часть данных можно оспорить позже в период reclamação, но лучше не рассчитывать на это.'
        ] },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'С 16 по 31 марта обычно можно reclamar despesas gerais familiares и exigência de fatura, если суммы неверны.',
