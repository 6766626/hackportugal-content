  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'В США обычное право на retirement benefits требует 40 credits. В 2026 году 1 credit начисляется за 1 890 $ заработка, максимум 4 credits за год (7 560 $). Если 40 credits нет, SSA может зачесть португальские периоды взносов, но только если у вас есть минимум 6 US credits.' },
        { kind: 'warning', text: 'Totalization не делает «двойную пенсию». США платят только пропорциональную часть по вашему американскому earnings record. Португалия отдельно считает свою пенсию по правилам Segurança Social.' }
      ]
    },
    {
      id: 'who-should-use',
