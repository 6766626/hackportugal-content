    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'По новому закону (Decreto AR 48/XVII, после прохождения через TC переименован с 17/XVII; промульгирован Президентом Сегуру **03.05.2026**, вступит в силу после публикации в DRE) — 7 лет для CPLP+EU / 10 лет для остальных. Сегуру публично попросил рассматривать уже поданные дела по старым правилам',
