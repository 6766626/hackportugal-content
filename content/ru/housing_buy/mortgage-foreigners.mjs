export default {
  ...
  tldr: 'Иностранцы-резиденты могут получить ипотеку до 80–90% стоимости жилья в португальских банках. Нерезиденты — до 60–70%. Euribor 6 мес. в I квартале 2026 — ~2,0–2,3% (с пика 4% в конце 2023 снизился). Типичные португальские спреды — 0,6–1,5%. Итого реальная ставка — 2,7–3,8%. Срок — до 40 лет или до достижения 75–80 лет. Процесс занимает 30–90 дней с момента подачи досье.',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'r1', title: 'Плавающая ставка (Euribor + спред)', content: [
            { kind: 'paragraph', text: 'Euribor 6 мес. в I квартале 2026 ≈ 2,0–2,3% (после пика ~4% в 2023). Спред — 0,6–1,5%. Итого — 2,7–3,8%. Пересчитывается каждые 6 мес.' }
          ]},
