export default {
  ...
  tldr: 'Иностранцы-резиденты могут получить ипотеку: macroprudential LTV для owner-occupied/permanent жилья — до 90% от меньшей из цены покупки и оценки; для secondary residence — до 80%; non-resident borrowers — обычно ниже. Euribor 6 мес. в начале мая 2026 ≈ 2.45–2.56% (с пика ~4% в 2023 снизился). Типичные португальские спреды 0.6–1.5%. Реальная ставка ~3.0–4.0%.\n\nМакропруденциальный лимит срока (Banco de Portugal с 2022): для borrowers до 30 лет — до 40 лет; для 30-35 лет — до 37 лет; для >35 лет — до 35 лет. Процесс 30–90 дней.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Replace with: "Golden Visa: новые ARI через покупку недвижимости больше не доступны; для существующих ARI-заявителей/держателей банк всё равно индивидуально проверяет источник средств, санкционные риски и доход."'
        ]},
