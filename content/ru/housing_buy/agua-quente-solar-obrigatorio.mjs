  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Уточнить: "В старом RCCTE/DL 80/2006 это было практическое правило для новых зданий при благоприятной экспозиции, с возможностью обоснованных исключений или альтернативных ВИЭ-решений. Число 70% лучше подавать как исторический/проектный ориентир, а не как действующий универсальный минимум 2026 года."' },
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Написать: "Photovoltaic сам по себе не является системой AQS: он производит электричество. Но в действующем SCE-проекте PV вместе с bomba de calor/другим оборудованием может быть альтернативой solar térmico, если расчёт энергетических показателей проходит."',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Написать: "Запросите projeto de especialidades, memória descritiva/caderno de encargos, telas finais или документы condomínio, Certificado Energético SCE, manual da instalação и гарантии. Ficha técnica da habitação имеет смысл просить только если объект старый и такая ficha была выдана до отмены режима." Если покупаете off-plan, внесите характеристики AQS в contrato-promessa.' }
      ]
    }
  ],
  costs: [
