export default {
  ...
  tldr: 'При покупке недвижимости в Португалии покупатель платит IMT и Imposto do Selo до escritura. База — большее из цены сделки и VPT из caderneta predial. Для жилья под própria e permanente в Continente в 2026 действует прогрессивная IMT-таблица: 0% до 104 261 €, затем 2–8%, отдельные ставки 6% и 7,5% для дорогих объектов. Imposto do Selo на покупку — 0,8%. Для jovens até 35 лет при первой покупке постоянного жилья есть освобождение до 324 058 € и частичная льгота до 648 022 €.',
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Для habitação própria e permanente в Continente в актуальной таблице Finanças используются такие пороги: до 104 261 € — 0%; 104 261–142 618 € — 2% минус parcela a abater 2 085,22 €; 142 618–194 458 € — 5% минус 6 363,76 €; 194 458–324 058 € — 7% минус 10 252,92 €; 324 058–648 022 € — 8% минус 13 493,50 €; 648 022–1 128 287 € — единая ставка 6%; выше 1 128 287 € — единая ставка 7,5%.' },
        { kind: 'checklist', items: [
          'Основное жильё до 104 261 € в Continente: IMT = 0 €, но Selo 0,8% остаётся, если нет отдельной льготы.',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'С 2024 действует режим для jovens até 35 anos при первой покупке habitação própria e permanente. В 2026 практический порог полной льготы привязан к 4-му escalão IMT: до 324 058 €. Льгота касается IMT и Imposto do Selo на покупку.' },
        { kind: 'checklist', items: [
          ...
          'До 324 058 €: IMT = 0 € и Selo на покупку = 0 €.',
          'От 324 058 € до 648 022 €: льгота частичная; налог платится только сверх защищённой части по механике Finanças.',
          'Выше 648 022 €: льгота не применяется.',
        ...
        { kind: 'paragraph', text: 'Пример: квартира для основного жилья за 350 000 €. Обычный IMT — 14 506,50 €, Selo — 2 800 €. Для покупателя до 35 лет при первой покупке ориентировочно остаётся к оплате IMT около 2 075,36 € и Selo около 207,54 €, потому что льгота покрывает часть до 324 058 €.' },
  ...
  costs: [
    { label: 'Imposto do Selo на покупку', amountEURMin: 0, amountEURMax: 0, note: 'Ставка 0,8% от цены или VPT, что выше; сумма зависит от объекта. При льготе jovem может быть 0 € до 324 058 €.' },
    { label: 'IMT для основного жилья в Continente', amountEURMin: 0, amountEURMax: 0, note: 'Прогрессивно: 0% до 104 261 €, затем 2–8%; для дорогих объектов единые ставки 6% или 7,5%.' },
