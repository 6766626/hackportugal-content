export default {
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Для habitação própria e permanente в Continente в таблице на 2026 (OE 2026, escalões подняты на 2%) используются такие пороги: до 106 346 € — 0%; 106 346–145 470 € — 2% минус parcela a abater 2 126,92 €; 145 470–198 347 € — 5% минус 6 491,03 €; 198 347–330 539 € — 7% минус 10 457,98 €; 330 539–660 982 € — 8% минус 13 763,38 €; 660 982–1 150 853 € — единая ставка 6%; выше 1 150 853 € — единая ставка 7,5%.' },
        { kind: 'checklist', items: [
          'Основное жильё до 106 346 € в Continente: IMT = 0 €, но Selo 0,8% остаётся, если нет отдельной льготы.',
          'Основное жильё 250 000 €: IMT = 250 000 × 7% − 10 457,98 € = 7 042,02 €.',
          'Основное жильё 350 000 €: IMT = 350 000 × 8% − 13 763,38 € = 14 236,62 €.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'От 330 539 € до 660 982 €: льгота частичная; налог платится только сверх защищённой части по механике Finanças.',
          'Выше 660 982 €: льгота не применяется.',
  ...
  costs: [
    ...
    { label: 'IMT для основного жилья в Continente', amountEURMin: 0, amountEURMax: 0, note: 'Прогрессивно по таблице 2026 (OE 2026 +2%): 0% до 106 346 €, затем 2–8%; для дорогих объектов единые ставки 6% (от 660 982 €) или 7,5% (от 1 150 853 €).' },
