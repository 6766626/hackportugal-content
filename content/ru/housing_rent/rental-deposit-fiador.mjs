  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Собственник может попросить IRS, recibos de vencimento, contrato de trabalho, NIF, паспорт/ВНЖ, банковские выписки',
          'Для удалёнщиков и recém-chegados помогают: contrato sem termo, carta da empresa, налоговая декларация, выписка о накоплениях',
