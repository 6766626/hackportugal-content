  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Пример: аренда 1 200 € / месяц. Законная денежная схема на старте может быть: 1 200 € за первый месяц + до 2 400 € renda adiantada + до 2 400 € caução. На практике часто считают проще: «2 rendas + 2 cauções» = 4 800 €, где нужно чётко подписать, какая часть является депозитом, а какая — предоплатой.' },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'За 30–60 дней до выезда проверьте срок уведомления в contrato и Código Civil',
