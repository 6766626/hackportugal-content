    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Написать: "caução: в жилищной аренде законный предел — до суммы, эквивалентной 2 rendas; конкретная сумма должна быть в aviso/contrato".',
          'Добавить: "Для habitação закон ограничивает rendas antecipadas максимум 2 месяцами; если в aviso/contrato требуют больше, нужно проверять правовое основание до подписания".',
          'Заменить на: "обновление renda: для обычных договоров коэффициент atualização de rendas на 2026 год — 1,0224, то есть 2,24%, если договор не содержит иной законной схемы и нет исключения".',
