    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'caução: в жилищной аренде законный предел — до суммы, эквивалентной 2 rendas; конкретная сумма должна быть в aviso/contrato',
          'rendas antecipadas: для habitação закон ограничивает предоплату максимум 2 месяцами; если в aviso/contrato требуют больше, проверяйте правовое основание до подписания',
          'обновление renda: для обычных договоров коэффициент atualização de rendas на 2026 год — 1,0224, то есть 2,24%, если договор не содержит иной законной схемы и нет исключения',
