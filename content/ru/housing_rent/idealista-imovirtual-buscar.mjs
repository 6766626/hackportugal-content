    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Caução — депозит/обеспечение обязательств; по закону для arrendamento habitacional она ограничена суммой до 2 месячных аренд. Если просят больше — это повод торговаться и проверять законность условия.',
          'Rendas adiantadas — аренда вперёд; по закону antecipação de renda не может превышать 2 месяца. На практике могут просить 1–2 месяца, но требование большего аванса — красный флаг и повод для юридической проверки.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Индексация ренты в 2026 году ориентируется на коэффициент 1,0224, то есть 2,24%, если договор допускает ежегодное обновление по закону и владелец уведомил арендатора в установленном порядке.',
