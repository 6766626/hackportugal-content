  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Для собственника квартиры в режиме propriedade horizontal закон требует страхование от пожара для каждой fração autónoma и общих частей.\n\nНа практике это покрывается либо индивидуальным полисом владельца, либо коллективным полисом condomínio. Ответственность за наличие покрытия лежит на собственниках.' },
