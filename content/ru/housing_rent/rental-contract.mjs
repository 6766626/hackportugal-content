      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'p6', title: '6. Регистрация в Finanças', content: [
            { kind: 'paragraph', text: 'В течение 30 дней владелец обязан зарегистрировать договор на Portal das Finanças (налоговый портал). Он получает comprovativo (подтверждение), копию даёт вам. Без регистрации и recibos de renda вы, как правило, не сможете корректно заявить rent deduction в IRS. Для Junta/AIMA зарегистрированный договор сильно повышает надёжность доказательства адреса, но конкретный набор документов зависит от Junta и типа процедуры AIMA.' },
