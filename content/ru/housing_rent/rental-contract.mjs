        ...
        { kind: 'substeps', items: [
          { id: 'r1', title: 'Права арендатора', content: [
            { kind: 'checklist', items: [
              ...
              'Вычет в IRS: 15% расходов на renda de habitação permanente в пределах лимита текущего года — сверяйте действующий лимит по art. 78.º-E CIRS на portaldasfinancas.gov.pt. С доходов 2026 года лимит повышен до 900 €, с 2027 — до 1 000 € (Decreto-Lei 97/2026)'
            ]}
          ]},
