  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'SNS 24 (**808 24 24 24**) — государственная медицинская линия, работает 24/7. Медсестринский триаж по клиническим алгоритмам (это не разговор с врачом). Сама услуга бесплатна, но номер 808 тарифицируется по тарифу абонента: мобильные и иностранные SIM-карты могут оплачиваться поминутно:' },
