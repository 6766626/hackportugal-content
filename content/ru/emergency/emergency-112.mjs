  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          '1. Местоположение — улица, номер дома, город, freguesia (районное управление)',
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'l3', title: 'ВНЖ (título de residência)', content: [
            { kind: 'paragraph', text: 'Заявление в PSP (полицейский протокол) → запись в AIMA на замену → пошлина € 82 → ожидание 30-60 дней.' }
          ]},
