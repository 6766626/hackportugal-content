      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'p1', title: 'Foz do Douro', content: [
            { kind: 'paragraph', text: 'У устья Дору, премиальный район. Пляжи, рестораны, семьи. Далеко от центра — обычно нужны автобус, такси или машина; вдоль реки ходит исторический трамвай 1, но это не метро и не основной транспорт для ежедневных поездок. T1 — 1200-2000 €, виллы — 2500+ €.' }
          ]},
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'b3', title: 'Areosa / Ramalde', content: [
            { kind: 'paragraph', text: 'Северные районы, подходят для семей. У Ramalde есть своя станция метро (синяя линия A и др.); в Areosa чаще удобнее автобус или ближайшие станции — зависит от адреса. T1 — 700-1100 €.' }
          ]}
        ]}
      ]
    },
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'o1', title: 'Vila Nova de Gaia', content: [
            { kind: 'paragraph', text: 'Южный берег Дору, знаменитые погреба портвейна. Жёлтая линия метро (D) идёт в Gaia через Ponte Luís I. Те же виды, на 20-30% дешевле. T1 — 700-1200 €.' }
          ]},
          ...
          { id: 'o4', title: 'Gondomar / Valongo', content: [
            { kind: 'paragraph', text: 'Восток. Дёшево, но до центра добираться на машине или автобусе. T1 — 500-800 €.' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🌆 Порту компактнее Лиссабона: исторический центр легко обойти пешком, но Foz, Matosinhos, Maia, Gaia и восточные пригороды требуют транспорта',
          ...
          '🚆 Alfa Pendular до Лиссабона примерно за 3 ч (самые быстрые рейсы — чуть меньше)'
        ]}
      ]
    }
  ],
