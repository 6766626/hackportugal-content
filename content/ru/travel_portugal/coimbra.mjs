export default {
  ...
  sources: [
    ...
    { title: 'Turismo de Coimbra — муниципальный туризм', url: 'https://www.visitportugal.com/pt-pt/destinos/centro-de-portugal/coimbra', kind: 'official', language: 'pt', lastRetrieved: '2026-04-22' },
