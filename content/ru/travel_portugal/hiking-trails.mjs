    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🔥 Пожары: июль-сентябрь — высокий риск; красный уровень = запрет на все открытые тропы. Проверить на ipma.pt',
          '🥵 Жара: летом старт до 8 утра, финиш до 13:00. Разница между утром и полуднем — 10°C',
