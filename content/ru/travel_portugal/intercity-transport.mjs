export default {
  ...
  steps: [
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'cp2', title: 'Цены (2026)', content: [
            { kind: 'checklist', items: [
              ...
              'Порту–Брага: 5–8 €',
              'Скидки: 50% детям 4-13 лет, 25-50% студентам, 50% пенсионерам 65+',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '✈️ Между Лиссабоном/Порту и материковыми городами летают только редко (Фару 1 раз в день)',
          ...
          '🏝️ Мадейра: Лиссабон–Фуншал 1:40 мин, 50–150 €',
