  ...
  steps: [
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'a2', title: 'Ryanair', content: [
            { kind: 'paragraph', text: 'Дешёвые билеты от € 20 на рейсы Лиссабон — Фуншал, Порту — Фару. Но есть надбавки за багаж и выбор места. Важно читать условия мелким шрифтом.' }
          ]},
          ...
          { id: 'a4', title: 'Порту → Лиссабон', content: [
            { kind: 'paragraph', text: 'TAP летает 8–10 раз в день, 50 мин. Но поезд или автобус чаще экономнее с учётом дороги до аэропорта. Рекомендуется поезд.' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Покупать через тариф «tarifa residente» на SATA или TAP с указанием ВНЖ Мадейры/Азор.' }
      ]
    },
    {
      id: 'ferries',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Аэропорт → город: Лиссабон, Alameda, метро € 1,70, 20 мин; Порту, Aeroporto, метро (фиолетовая линия), € 2,25, 30 мин',
