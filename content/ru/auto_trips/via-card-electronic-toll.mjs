        ...
        { kind: 'substeps', items: [
          ...
          { id: 'p2', title: 'Если авто с иностранным номером', content: [
            { kind: 'checklist', items: [
              ...
              'Номер из ЕС: действует Директива 2011/82/EU — информация передаётся, штраф приходит',
              'Не из ЕС (РФ, UA, BY, CH, USA): письмо от Infraestruturas de Portugal приходит по адресу регистрации',
