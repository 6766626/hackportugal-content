export default {
  ...
  title: 'Licença de maternidade e direitos parentais',
  tldr: 'Licença de maternidade/paternidade (licença parental) em Portugal em 2026: licença parental inicial — 120 dias (100%), 150 dias ou 150/180 dias partilhada quando dividida com o pai (Lei 13/2023; 90% na partilhada de 180 dias).\n\nApós as 6 semanas obrigatórias da mãe, o tempo restante pode ser partilhado pelos pais. Pai: 28 dias obrigatórios (7 — imediatamente após o nascimento, 21 — nos 42 dias seguintes) + até 7 dias adicionais em simultâneo com a mãe. O posto de trabalho fica protegido durante a licença. Amamentação/aleitação: normalmente 2 horas por dia (2 períodos × 1 hora), após 1 ano em caso de amamentação — é necessário atestado médico. Direito a horário flexível / trabalho a tempo parcial — até aos 12 anos da criança (Código do Trabalho art. 55/56). Para crianças com necessidades especiais — regras alargadas.',
  tags: ['maternidade', 'licença de maternidade', 'licença parental', 'mãe', 'pai', 'segurança social'],
  ...
  steps: [
        ...
        { kind: 'substeps', items: [
          { id: 'mother', title: 'Mãe — parte obrigatória e parte adicional', content: [
            { kind: 'checklist', items: [
              '🏥 **Parte obrigatória**: 6 semanas (42 dias) imediatamente após o parto — só a mãe a pode gozar',
          ...
          { id: 'father', title: 'Pai — direitos e obrigações', content: [
            { kind: 'checklist', items: [
              '🛌 **28 dias obrigatórios**: 7 consecutivos imediatamente após o nascimento + 21 nos 42 dias após o nascimento (seguidos ou interpolados)',
              '➕ **+7 dias adicionais** após os 28 obrigatórios, desde que coincidam com a licença parental inicial da mãe',
              '🤝 **Parte partilhada** (por acordo com a mãe): período exclusivo mínimo obrigatório do pai — obrigatório na partilhada de 150/180 dias',
              '⚖️ Os direitos estão protegidos — o despedimento por causa da licença é ilegal (Lei 7/2009 art. 36)',
              '🏥 Se a mãe não puder gozar a licença ou tiver falecido — o pai recebe a parte da licença que caberia à mãe'
            ]}
          ]},
          { id: 'who-pays', title: 'Quem paga', content: [
            { kind: 'checklist', items: [
              ...
              '📑 O pedido do subsídio é apresentado pelo próprio trabalhador através da Segurança Social Direta; a entidade empregadora contabiliza separadamente a ausência e comunica os dados salariais'
            ]}
          ]}
        ]}
      ]
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'a1', title: 'Antes do parto', content: [
            { kind: 'checklist', items: [
              '📩 Se a mãe iniciar a licença antes do parto — informar a entidade empregadora com atestado médico, em regra com 10 dias de antecedência (em casos urgentes — o mais cedo possível)',
              ...
              '🤝 Se a licença for partilhada (partilhada): apresentar uma declaração conjunta com o pai'
            ]}
          ]},
          { id: 'a2', title: 'Após o parto', content: [
            { kind: 'checklist', items: [
              ...
              '⏰ O pedido de subsídio na Segurança Social deve ser apresentado no prazo de 6 meses a contar do primeiro dia de licença/do evento; em caso de apresentação tardia, o subsídio pode ser reduzido',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          '🕐 **2 horas de redução do dia de trabalho** em caso de amamentação (1 hora de manhã + 1 hora à tarde OU 2 horas num único bloco)',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          '⏰ **Horário flexível**: as mesmas horas, mas com possibilidade de ajustar o início/fim do dia',
          '✅ Se pretender recusar, a entidade empregadora é obrigada a cumprir um procedimento especial e a enviar o processo à **CITE** para parecer prévio (este é o organismo-chave precisamente para estas recusas)',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '👵 **Avós**: direitos especiais em casos concretos — por exemplo, até 30 dias consecutivos após o nascimento do neto, se o progenitor da criança tiver menos de 16 anos e o neto viver com o avô/avó; não existe um direito universal a «14 dias se os pais não puderem» (ver Código do Trabalho art. 50)',
          ...
          '🛂 **Estrangeiros que trabalham em Portugal**: os mesmos direitos laborais; o subsídio da SS depende do registo, das contribuições e do cumprimento do prazo de garantia. Se as contribuições forem insuficientes, podem existir prestações sociais mediante verificação de rendimentos'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '💰 Os 180 dias partilhada são muitas vezes vantajosos por causa dos 60 dias adicionais pagos a 90%, mas compare o rendimento familiar total e a possibilidade real de o pai gozar a sua parte',
          '📅 Antes/depois do nascimento, escolha o regime de licença parental inicial: 120, 150 ou partilhada 150/180 dias; para os 180 dias partilhada, combine antecipadamente com as entidades empregadoras os períodos da mãe e do pai',
          '🩺 Cálculo do subsídio: remuneração de referência = remuneração de 6 dos 8 meses anteriores / 180. Se entrar em licença pouco depois de um aumento, o novo salário pode não entrar totalmente na base de cálculo',
          '🛡️ A licença parental não interrompe o tempo de residência legal, se a autorização de residência continuar válida/prorrogada. Para a nacionalidade, verifique a redação atual da Lei da Nacionalidade: **Decreto AR 48/XVII promulgado pelo Presidente Seguro em 03.05.2026** e aumentará o prazo para 7/10 anos após publicação no DRE — em 17.05.2026 a regra em vigor é de 5 anos (Lei 37/81)',
          ...
          '👶 No SNS, o acompanhamento da gravidez, o parto, a vacinação e os cuidados pediátricos são geralmente gratuitos/isentos de taxas moderadoras; para estrangeiros — tratar antecipadamente do número de utente',
          '📑 Guarde todos os atestados e pedidos — podem ser necessários numa licença parental seguinte ou numa inspeção fiscal'
        ]}
      ]
    }
  ],
