export default {
  ...
  tldr: 'Criança nascida em Portugal: o nascimento deve ser registado no Registo Civil **no prazo de 20 dias** (Código do Registo Civil art. 96). Nos termos da Lei 37/81 art. 1 n.1 al. f), a criança adquire a nacionalidade portuguesa de origem se pelo menos um dos pais residir legalmente em Portugal (qualquer título) OU residir em Portugal há pelo menos 1 ano independentemente do título — e não estiver ao serviço de um Estado estrangeiro. Registo: gratuito através do ePortugal ou na maternidade («Nascer Cidadão»). À criança são emitidos Cartão de Cidadão, NIF, NISS, utente SNS — tudo de uma vez.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Nos termos da Lei 37/81 art. 1 n.1 al. f), uma criança nascida em Portugal torna-se cidadã portuguesa de origem se pelo menos UM dos pais cumprir uma das condições e não estiver ao serviço de um Estado estrangeiro:' },
        { kind: 'checklist', items: [
          ...
          '⚠️ Apenas uma visita turística curta sem presença prolongada — normalmente não; mas se houver 1+ ano de residência efetiva — há fundamento',
          '🌐 Portugal admite nacionalidade múltipla — a criança também pode adquirir uma segunda nacionalidade através dos pais',
          '⚖️ **03.05.2026 o Presidente Seguro promulgou o Decreto AR 48/XVII** (após passagem pelo TC, renumerado a partir de 17/XVII). Em 13.05.2026, a lei foi publicada em 18.05.2026 como **Lei Orgânica n.º 1/2026** (10 dias). Após a publicação em Diário da República, para apresentar pedido de nacionalidade da criança por jus soli, os pais devem ter ≥5 anos de autorização de residência válida. O texto da lei contém uma disposição transitória: aos processos em tramitação aplica-se a redação anterior da Lei 37/81 (1 ano). Até 19.05.2026 aplicam-se as regras antigas a todos'
        ]}
      ]
    },
    {
        ...
        { kind: 'substeps', items: [
          { id: 'n1', title: 'O que está incluído', content: [
            { kind: 'checklist', items: [
              ...
              '✅ Tudo numa só visita, gratuitamente'
            ]}
          ]},
          { id: 'n2', title: 'O que é necessário dos pais', content: [
            { kind: 'checklist', items: [
              ...
              '📛 Decisão sobre os nomes da criança — convém falar previamente com a maternidade (existe uma lista de nomes permitidos)',
              '💸 Morada/contacto dos pais para posterior pagamento do SNS',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Se o registo não tiver sido feito na maternidade (parto domiciliário, clínica privada sem o serviço), é necessário declarar o nascimento numa Conservatória do Registo Civil **no prazo de 20 dias** (art. 96 Código do Registo Civil).\n\nDepois desse prazo, o registo continua a ser possível, mas com procedimento adicional e eventual coima.' },
        { kind: 'checklist', items: [
          '🏛️ Qualquer Conservatória — escolha pela morada ou conveniência',
          '🌐 Alternativa: ePortugal online através da Chave Móvel Digital, com carregamento dos documentos',
          '📅 Gratuito, se for feito dentro do prazo de 20 dias; depois — pode haver coima e procedimento adicional',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          '🚫 Nos termos do art. 103 Código do Registo Civil, o nome é normalmente limitado a no máximo 2 nomes próprios e 4 apelidos',
          ...
          '⚠️ Se o nome não constar da base do IRN — os pais apresentam um «pedido de admissibilidade» (1–2 semanas, gratuito)',
          '👨‍👩‍👧 **Apelidos**: a criança pode receber apelidos de qualquer um dos pais e antepassados; a ordem é flexível, não tem de ser necessariamente «mãe+pai»',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🔢 **NIF** — necessário se abrir um depósito para a criança ou arrendar habitação para a família com criança',
          ...
          '🩺 **Médico de família** — marcar consulta de pediatria',
          '💉 **Plano de vacinação (PNV)**: primeira vacina aos 2 meses, consulta de controlo — 7 dias',
          '👶 **Abono de família**: calculado por escalão (rendimento familiar / número de crianças com direito + 1) e idade da criança. Calcule o valor exato na Segurança Social Direta ou através do ISS; as tabelas exatas estão em seg-social.pt',
          '🌐 **Registo na embaixada do país dos pais**: para dupla nacionalidade — pedido através do consulado'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🛏️ Na maternidade, pedir um quarto individual «quarto particular» — por vezes o seguro privado cobre',
          ...
          '⚖️ Se os pais não forem casados: o pai reconhece pessoalmente a paternidade no registo na Conservatória, apresentando documento. O teste de ADN NÃO é exigido por defeito, apenas em caso de contestação (por via judicial)',
          '👶 As vacinas do PNV são gratuitas no SNS',
          '🩺 Seguro da criança — alguns empregadores incluem plano familiar (Generali, Médis)',
          '🎓 Inscrição em Creche/Jardim de Infância: apresentar o pedido logo após o nascimento (lista de espera de 6–12 meses)'
        ]}
      ]
    }
  ],
  costs: [
    ...
    { label: 'Atraso no registo >20 dias', amountEURMin: 50, amountEURMax: 200, note: 'eventual coima + procedimento adicional' },
