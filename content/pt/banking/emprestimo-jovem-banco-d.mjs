export default {
  ...
  tldr: 'Em 2026, “Empréstimo Jovem” significa, na maioria dos casos, Linha Jovem Habitação: crédito à habitação para a primeira casa permanente de pessoas entre os 18 e os 35 anos, com garantia do Estado até 15% do preço, para que o banco possa financiar até 100% da compra. O limite do imóvel é 450 000 €, é necessária residência fiscal em Portugal e não pode existir outra habitação em nome do comprador. A taxa não é subsidiada: o banco calcula um crédito à habitação normal; em 2026, a referência ronda 3,3–4,0% TAN/TAEG. Para negócios existem linhas separadas IFD/BPF/IAPMEI, mas isto não é “dinheiro para todos até aos 35”.',
  tags: ['crédito habitação', 'jovem', 'garantia', 'banco'],
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Linha Jovem Habitação é uma garantia do Estado sobre uma parte do crédito à habitação para compra de primeira habitação própria e permanente. O objectivo é colmatar a diferença entre o limite bancário habitual de 80–90% LTV e a compra sem uma entrada inicial elevada.' },
        { kind: 'paragraph', text: 'O Estado pode garantir até 15% do valor da transacção. Isto permite ao banco conceder crédito até 100% do preço de compra, mas a decisão continua a ser do banco: este verifica o rendimento, contrato de trabalho, IRS, taxa de endividamento, avaliação do imóvel e risco do cliente.' },
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Inexistência de dívidas em atraso perante a Autoridade Tributária e a Segurança Social',
        ...
        { kind: 'paragraph', text: 'A nacionalidade, por si só, não é o critério principal. Para um expat, o mais importante é a permanência legal, a residência fiscal, o rendimento comprovável e a disponibilidade do banco para financiar um não residente/novo residente.\n\nNa prática, os bancos exigem frequentemente autorização de residência, contrato de trabalho sem termo ou recibos verdes/rendimento estrangeiro estáveis e documentados.' }
      ]
    },
    {
      id: 'numbers',
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Em 2026, as propostas de crédito à habitação no mercado para clientes jovens situam-se normalmente, de forma aproximada, no intervalo de 3,3–4,0% TAN/TAEG, consoante Euribor/taxa fixa, spread, seguro de vida, domiciliação de ordenado e cross-selling. A taxa concreta só consta da FINE do banco.' },
        { kind: 'checklist', items: [
          ...
          'Mas o comprador continua a pagar avaliação, escritura, registos, seguro e comissões bancárias',
        ...
        { kind: 'substeps', items: [
          { id: 'prepare-docs', title: '1. Reúna o conjunto de documentos', content: [
            { kind: 'checklist', items: [
              ...
              'Caderneta predial e certidão permanente do imóvel, se o imóvel já tiver sido escolhido'
            ] }
          ] },
          { id: 'ask-banks', title: '2. Compare os bancos aderentes à linha', content: [
            { kind: 'paragraph', text: 'Verifique não só a CGD e o Millennium bcp: a lista de bancos abrangidos pela garantia do Estado pode ser actualizada. Peça a FINE para cenários com taxa fixa, variável e mista.' }
          ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Para empreendedores, “jovem” é uma questão separada. Através do IFD/Banco Português de Fomento, IAPMEI, sociedades de garantia mútua e bancos existem linhas de crédito para PME, startups, inovação, empreendedorismo e mutual guarantee. Não são um crédito ao consumo automático para todos até aos 35 anos.' },
        { kind: 'checklist', items: [
          'É necessário um plano de negócios e atividade aberta / empresa',
          'O banco verifica a viabilidade económica do projecto',
          'Frequentemente são exigidos capitais próprios ou garantia do empreendedor',
          ...
          'O IAPMEI é útil para estatuto de PME, programas de financiamento e aconselhamento',
          'IFD/BPF publicam linhas abertas e intermediários financeiros'
        ] },
        { kind: 'warning', text: 'Não confunda a Linha Jovem Habitação com créditos para jovens empreendedores. Têm regulamentos, bancos, objectivos de despesa e critérios de selecção diferentes.' }
      ]
    },
    {
      id: 'expat-tips',
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Verifique se não tem dívidas à AT/Segurança Social',
          'Se o rendimento vier do estrangeiro — prepare declarações fiscais, payslips, contrato de trabalho e traduções',
          'Peça o Mapa de responsabilidades de crédito, mesmo que não tenha créditos em PT',
          ...
          'Verifique separadamente os benefícios de IMT/IS para jovens: é uma medida fiscal, não faz parte do crédito'
        ] },
        { kind: 'paragraph', text: 'Uma boa estratégia é obter duas pré-aprovações em bancos diferentes e só depois fazer uma proposta ao vendedor. Para um estrangeiro com histórico curto em Portugal, isto muitas vezes decide o desfecho da transacção.' }
      ]
    }
  ],
  costs: [
    { label: 'Avaliação do imóvel pelo banco', amountEURMin: 200, amountEURMax: 350, note: 'Normalmente paga pelo comprador; o montante depende do banco e do imóvel' },
    { label: 'Abertura/gestão do processo de crédito à habitação', amountEURMin: 250, amountEURMax: 600, note: 'As comissões variam; consulte a FINE e o preçário do banco' },
    ...
    { label: 'Garantia do Estado Linha Jovem Habitação', amountEUR: 0, note: 'Normalmente não há comissão separada para o comprador pela garantia, mas a taxa do crédito continua a ser de mercado' }
  ],
  sources: [
