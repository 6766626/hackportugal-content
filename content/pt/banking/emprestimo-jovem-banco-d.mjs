export default {
  ...
  tldr: 'Em 2026, “Empréstimo Jovem” significa, na maioria dos casos, Linha Jovem Habitação: crédito à habitação para a primeira casa permanente para pessoas dos 18 aos 35 anos, com garantia do Estado até 15% do preço, para que o banco possa financiar até 100% da compra. O limite do imóvel é 450 000 €, é necessária residência fiscal em Portugal e não ter outra habitação. A taxa não é subsidiada: o banco calcula um crédito à habitação normal; em 2026, a referência ronda 3,3–4,0% TAN/TAEG. Para negócios existem linhas separadas IFD/BPF/IAPMEI, mas isto não é “dinheiro para todos até aos 35”.',
  tags: ['crédito à habitação', 'jovem', 'garantia', 'banco'],
  estimatedReadMinutes: 6,
  steps: [
    {
      id: 'what-it-is',
      title: 'O que é dado exactamente: garantia, não uma oferta',
      content: [
        { kind: 'paragraph', text: 'Linha Jovem Habitação é uma garantia do Estado sobre uma parte do crédito à habitação para a compra da primeira habitação própria e permanente. O objectivo é colmatar a diferença entre o limite bancário habitual de 80–90% LTV e a compra sem uma entrada inicial elevada.' },
        { kind: 'paragraph', text: 'O Estado pode garantir até 15% do valor da operação. Isto permite ao banco conceder crédito até 100% do preço de compra, mas a decisão continua a ser do banco: este verifica rendimento, contrato de trabalho, IRS, taxa de esforço, avaliação do imóvel e risco do cliente.' },
        { kind: 'warning', text: 'Isto não é uma taxa subsidiada nem uma subvenção. Se deixar de pagar, o banco cobra-lhe a dívida; a garantia do Estado protege o banco, não liberta o comprador do crédito.' }
      ]
    },
    {
      id: 'eligibility',
      ...
      content: [
        { kind: 'checklist', items: [
          'Idade entre 18 e 35 anos, inclusive, à data de celebração do contrato de crédito',
          'Residência fiscal em Portugal: NIF com morada fiscal em PT e, regra geral, IRS/rendimentos comprovados',
          'Compra da primeira habitação própria e permanente — habitação para residência própria permanente',
          'O comprador não possui outro imóvel habitacional',
        ...
        { kind: 'paragraph', text: 'A nacionalidade, por si só, não é o critério principal. Para um expat, são mais importantes a permanência legal, a residência fiscal, o rendimento comprovável e a disponibilidade do banco para financiar um não residente/novo residente. Na prática, os bancos exigem com mais frequência autorização de residência, contrato de trabalho sem termo ou recibos verdes estáveis/rendimento estrangeiro com documentação.' }
      ]
    },
    {
      id: 'numbers',
      ...
      content: [
        { kind: 'paragraph', text: 'O limite essencial do programa é um imóvel até 450 000 €. A garantia do Estado cobre até 15% do preço, mas não paga IMT, Imposto do Selo, escritura, avaliação, seguros nem comissões bancárias.' },
        { kind: 'paragraph', text: 'Em 2026, as ofertas de crédito à habitação de mercado para clientes jovens situam-se normalmente, de forma aproximada, no intervalo 3,3–4,0% TAN/TAEG, consoante Euribor/taxa fixa, spread, seguro de vida, domiciliação de ordenado e cross-selling. A taxa concreta consta apenas da FINE do banco.' },
        { kind: 'checklist', items: [
          'Exemplo: apartamento de 300 000 €',
          'Um crédito à habitação normal a 90% exigiria cerca de 30 000 € de entrada',
          'Com garantia do Estado, o banco pode teoricamente financiar até 300 000 €',
          'Mas o comprador continua a pagar avaliação, escritura, registos, seguros e comissões bancárias',
          'Se tiver mais de 35 anos ou se esta não for a primeira habitação — a linha não se aplica',
          'Se a avaliação do banco for inferior ao preço de compra, o banco pode reduzir o montante do crédito'
        ] },
        { kind: 'warning', text: 'Não assine CPCV com sinal de 10–20% enquanto o banco não confirmar por escrito a pré-aprovação e a possibilidade de utilizar a garantia do Estado. Perder o sinal é um risco comum quando o banco recusa o crédito.' }
      ]
    },
    {
      id: 'how-to-apply',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'prepare-docs', title: '1. Reúna o pacote de documentos', content: [
            { kind: 'checklist', items: [
              ...
              '3–6 últimos recibos de vencimento ou recibos verdes',
          ...
          { id: 'ask-banks', title: '2. Compare os bancos aderentes à linha', content: [
            { kind: 'paragraph', text: 'Verifique não apenas a CGD e o Millennium bcp: a lista de bancos com garantia do Estado pode ser actualizada. Peça a FINE para cenários com taxa fixa, variável e mista.' }
          ] },
          ...
          { id: 'valuation', title: '4. Aguarde a avaliação e o ok final', content: [
            { kind: 'paragraph', text: 'O banco solicita a avaliação do imóvel. Se a avaliação for inferior ao preço, o montante do crédito pode ser calculado com base na avaliação, e não no preço indicado no CPCV.' }
          ] }
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Para empreendedores, “jovem” é uma história diferente. Através da IFD/Banco Português de Fomento, IAPMEI, sociedades de garantia e bancos, existem linhas de crédito para PME, startups, inovação, empreendedorismo e garantia mútua. Não são crédito ao consumo automático para todos até aos 35 anos.' },
        { kind: 'checklist', items: [
          ...
          'A IFD/BPF publica linhas abertas e intermediários financeiros'
        ] },
        { kind: 'warning', text: 'Não confunda a Linha Jovem Habitação para crédito à habitação com créditos para jovens empreendedores. Têm regulamentos, bancos, finalidades de despesa e critérios de selecção diferentes.' }
      ]
    },
    {
      id: 'expat-tips',
      ...
      content: [
        { kind: 'checklist', items: [
          'Actualize primeiro a morada fiscal nas Finanças: sem residência fiscal, o programa normalmente não funcionará',
          ...
          'Não assuma 100% financing como cenário garantido: o banco pode pedir 5–10% de fundos próprios',
          'Verifique separadamente os benefícios de IMT/IS para jovens: é uma medida fiscal, não parte do crédito'
        ] },
        { kind: 'paragraph', text: 'Uma boa estratégia é obter duas pré-aprovações em bancos diferentes e só depois fazer uma oferta ao vendedor. Para um estrangeiro com histórico curto em Portugal, isto determina muitas vezes o desfecho da operação.' }
      ]
    }
  ],
  costs: [
    ...
    { label: 'Garantia do Estado Linha Jovem Habitação', amountEUR: 0, note: 'Para o comprador, normalmente não há comissão separada pela garantia, mas a taxa do crédito continua a ser de mercado' }
  ],
  sources: [
