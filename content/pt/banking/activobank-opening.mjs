export default {
  ...
  categoryId: 'banking',
  title: 'Abertura de conta bancária em Portugal (não residente e residente)',
  tldr: 'Em Portugal existem cerca de 9 grandes bancos com licença do Banco de Portugal. Alguns permitem a abertura de conta totalmente online para não residentes com NIF português. Processo típico: videoidentificação, KYC básico, IBAN emitido no próprio dia, cartão por correio em 5-10 dias. A manutenção básica é gratuita na maioria dos bancos com atividade mínima.',
  tags: ['banco', 'conta', 'não residente', 'IBAN', 'MB WAY'],
  estimatedReadMinutes: 6,
  steps: [
    {
      id: 'why-pt-account',
      title: 'Para que serve uma conta portuguesa',
      content: [
        { kind: 'paragraph', text: 'Uma conta num banco português com IBAN começado por PT50 é necessária para a maioria dos procedimentos do dia a dia: registo de arrendamento de longa duração, débitos diretos (serviços públicos, impostos, coimas de trânsito), recebimento de salário, contratação de investimentos, pagamentos de prestações pela Segurança Social, pedido de autorização de residência (alguns tipos exigem prova de meios numa conta portuguesa).' },
        { kind: 'warning', text: 'Um IBAN de outro país da UE (IE, DE, LT, etc.) é tecnicamente equivalente a um português ao abrigo do regulamento SEPA, mas, na prática, vários operadores portugueses recusam débitos diretos com IBAN estrangeiro. Para compatibilidade total, é necessário um PT-IBAN.' }
      ]
    },
    {
      id: 'types-of-banks',
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Contas nos CTT (correios): CTT Bank — operador postal público com serviços bancários básicos'
        ]},
        { kind: 'paragraph', text: 'Bancos licenciados pelo Banco de Portugal ou por reguladores bancários da UE — depósitos até 100 000 € estão protegidos pelo DGS nacional (Fundo de Garantia de Depósitos para bancos licenciados em Portugal, DGS equivalentes para outros bancos da UE).\n\nIMPORTANTE: Wise, Revolut e empresas de pagamento/EMI semelhantes NÃO têm estatuto de banco e, geralmente, não estão cobertas por DGS; os fundos são protegidos por regime de safeguarding (conta separada num banco parceiro). É um nível de proteção diferente — especialmente importante para saldos elevados.' }
      ]
    },
    {
      id: 'online-vs-branch',
      title: 'Online ou agência',
      content: [
        { kind: 'substeps', items: [
          { id: 'o1', title: 'Online (à distância)', content: [
            { kind: 'paragraph', text: 'Alguns bancos permitem a abertura de conta totalmente online para clientes com NIF. Processo: videoidentificação com operador em português ou inglês, assinatura eletrónica através da Chave Móvel Digital ou por confirmação em vídeo. Adequa-se mesmo se ainda não estiver em Portugal, desde que já tenha NIF.' }
          ]},
          { id: 'o2', title: 'Na agência', content: [
            { kind: 'paragraph', text: 'O método clássico é deslocar-se a uma agência com passaporte, NIF, comprovativo de morada e, por vezes, comprovativo de rendimentos. Os grandes bancos exigem frequentemente identificação presencial para não residentes.' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Comprovativo de morada — contrato de arrendamento, fatura de serviços públicos ou extrato bancário com menos de 3 meses',
          'Comprovativo de rendimentos / origem dos fundos — recibo de vencimento, extrato de conta, declaração da entidade patronal',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'p1', title: '1. Preencher o formulário', content: [
            { kind: 'paragraph', text: 'No site ou na aplicação do banco: nome completo, NIF, profissão, origem dos rendimentos, finalidade da conta, residência fiscal. Para não residentes em Portugal, é necessário indicar no formulário o país da residência fiscal atual (conformidade CRS/DAC2).' }
          ]},
          ...
          { id: 'p4', title: '4. Assinar o contrato', content: [
            { kind: 'paragraph', text: 'Assinatura eletrónica: através da Chave Móvel Digital ou por código de confirmação enviado por e-mail + SMS.' }
          ]},
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Débitos diretos (serviços públicos, impostos, coimas de trânsito)',
          'Acesso a Multibanco (rede de caixas automáticas em Portugal) com limites de levantamento de 200-400 €/dia'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Anuidade / manutenção — comissão anual/mensal de manutenção. Em muitos bancos online é 0 € com atividade mínima',
          'Imposto do Selo — imposto de selo. Em Portugal NÃO é uma taxa trimestral fixa pela conta em si; normalmente é cobrado como **4%** sobre comissões bancárias, **0,5%** sobre juros de créditos/crédito ao consumo, etc. Se tiver uma conta gratuita sem outros serviços — pode não haver Imposto do Selo efetivo',
          'Comissão por levantamento em Multibanco de outro banco — normalmente 0 € em Portugal, mas existem limites',
          'Comissão por inatividade — alguns bancos cobram 3-10 €/mês se a conta não for utilizada durante mais de 6 meses',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Falta de comprovativo da origem dos fundos perante um depósito inicial elevado',
          'Exposição política (PEP) ou filtro de sanções — recusa ou análise de due diligence prolongada',
          'Videoidentificação de má qualidade — é frequente pedirem para repetir',
          'Recusa em declarar a residência fiscal (CRS) — recusa automática',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Ativar o MB WAY na aplicação (ferramenta de pagamento mais importante em Portugal)',
          'Guardar o IBAN nas notas para copiar rapidamente nos pagamentos',
          'Configurar débitos diretos (débitos diretos) para serviços públicos e impostos',
          'Indicar o PT-IBAN no Portal das Finanças para reembolso do IRS',
          'Indicar o PT-IBAN na Segurança Social para salário/prestações',
          'Ativar Multibanco-Homebanking para acesso através de caixa automática'
        ]}
      ]
    }
  ],
