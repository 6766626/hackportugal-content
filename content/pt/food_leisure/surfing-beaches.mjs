export default {
  ...
  steps: [
    {
      id: 'spots',
      title: '🏄 Spots lendários por região',
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 's5', title: 'Porto / costa norte', content: [
            { kind: 'checklist', items: [
    ...
    {
      id: 'schools',
      title: '🏫 Escolas de surf',
      content: [
        { kind: 'substeps', items: [
          { id: 'sc1', title: 'Preços 2026', content: [
            { kind: 'checklist', items: [
              '**Aula individual (1:1)**: 60-100 €/2 horas',
              '**Aula de grupo**: 35-50 €/2 horas',
              '**Dia completo** (grupo): 60-90 € + snacks',
              '**Camp de fim de semana (2 dias)**: 150-250 €',
              '**Surf camp de uma semana**: 350-800 € (aulas + alojamento + comida)',
              '**Aluguer de prancha + fato**: 20-30 €/dia, 60-100 €/semana'
            ]}
          ]},
          { id: 'sc2', title: 'Principais escolas', content: [
            { kind: 'checklist', items: [
              '**Ericeira Surf Camp** — um dos maiores da Europa',
              '**Peniche Surf Camp** — hostel + escola',
              '**Baleal Surf School** — ambiente familiar',
    ...
    {
      id: 'gear-buy',
      title: '🛒 Equipamento — comprar ou alugar',
      content: [
        { kind: 'substeps', items: [
          { id: 'b1', title: 'Comprar prancha', content: [
            { kind: 'checklist', items: [
              '**Soft-top nova para principiantes** (7-9 ft): 200-350 €',
              '**Prancha rígida para principiantes** (longboard 9 ft): 400-700 €',
              '**Shortboard para nível intermédio** (6-7 ft): 500-900 €',
              'Lojas: **Natural, Surf World Hossegor, Wavesailing**',
              'Mercado em segunda mão: **olx.pt, Facebook Marketplace** — metade do preço'
            ]}
          ]},
          ...
          { id: 'b3', title: 'Aluguer (para turistas)', content: [
            { kind: 'checklist', items: [
              'Prancha: 15-25 €/dia, 70-100 €/semana',
              'Fato: 10-15 €/dia',
              'Conjunto (prancha + fato): 25-35 €/dia',
              'Nas praias populares há frequentemente aluguer, mas em spots selvagens/remotos pode não haver; reserve com antecedência e verifique a sazonalidade'
            ]}
          ]}
        ]}
      ]
    ...
    {
      id: 'community',
      title: '👥 Comunidade e competições',
      content: [
        { kind: 'checklist', items: [
  ...
  costs: [
    { label: 'Aula de grupo (2 h)', amountEURMin: 35, amountEURMax: 50 },
    { label: 'Aula individual', amountEURMin: 60, amountEURMax: 100 },
    { label: 'Surf camp (semana)', amountEURMin: 350, amountEURMax: 800 },
    { label: 'Aluguer de prancha + fato (dia)', amountEURMin: 25, amountEURMax: 35 },
    { label: 'Comprar prancha nova para principiante', amountEURMin: 200, amountEURMax: 700 },
    { label: 'Fato 4/3', amountEURMin: 200, amountEURMax: 350 }
  ],
  sources: [
