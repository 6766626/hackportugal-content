export default {
  ...
  title: 'Apicultura para iniciantes — registo na DGAV (Direção-Geral de Alimentação e Veterinária)',
  tldr: 'Qualquer apiário em Portugal (mesmo uma só colmeia no jardim) deve estar registado na DGAV (Direção-Geral de Alimentação e Veterinária — serviço público de segurança alimentar e veterinária). O registo é gratuito: submete-se na Junta de Freguesia (órgão local da freguesia) ou através do ePortugal (portal de serviços públicos). Após o registo, recebe um número de apicultor e fica obrigado a manter um caderno sanitário. Distâncias mínimas: 200 m em zona urbana, 50 m em zona rural (pode ser mais perto se houver uma vedação alta). Mel para consumo próprio — sem HACCP. Para vendas, é necessária uma sala de extração registada e inspeção da ASAE (Autoridade de Segurança Alimentar e Económica — fiscalização da segurança alimentar). A FNAP (federação nacional dos apicultores) é a principal associação. Cursos para iniciantes: 150-300 €. Uma colmeia produz 15-30 kg de mel por ano; kit inicial (colmeia + enxame + proteção) 250-500 €.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Portugal é um dos líderes da UE na produção de mel (~10 000 toneladas por ano). O clima é ameno e há muitas plantas melíferas silvestres: eucalipto, alecrim, alfazema, erva-cidreira, mato (arbustivo silvestre), citrinos, castanheiro, sobreiro. A época é longa: de fevereiro a outubro.' },
        { kind: 'checklist', items: [
          ...
          'Mel multifloral — mistura de base',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Desde 2014, o registo é obrigatório para todos os detentores de abelhas em Portugal. Decreto-Lei 203/2005 e alterações posteriores. Sem registo — coima de 100-500 € e risco de perda das abelhas numa inspeção da DGAV.' },
        { kind: 'substeps', items: [
          {
            id: 's1',
            ...
            content: [
              { kind: 'checklist', items: [
                'NIF (número fiscal) e Cartão de Cidadão ou passaporte + atestado de residência',
                'Morada onde as colmeias serão colocadas (terreno próprio ou autorização escrita do proprietário)',
                'Número e tipo de colmeias: são comuns os modelos Lusitano e Langstroth',
          ...
          },
          {
            ...
            content: [
              { kind: 'checklist', items: [
                ...
                'Após a aprovação, é emitido um número de apicultor (formato AA-NN-NNNN)'
              ] }
            ]
          },
          {
            ...
            content: [
              { kind: 'paragraph', text: 'Em cada colmeia deve estar marcado o seu número de apicultor e o número da colmeia. Tinta indelével em dois lados, altura dos caracteres — mínimo 5 cm. Isto é crítico para inspeções da DGAV.' }
            ]
          }
        ] }
      ]
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Fato de apicultor: 50-150 €',
          'Luvas de apicultor: 10-30 €',
          'Fumigador: 30-60 €',
          'Formão/ferramentas para quadros: 10-20 €',
          'Alça para mel: 30-50 €',
          'Quadros e cera laminada: 20-40 € por colmeia',
          'Suportes para a colmeia: 10-20 €',
          'Ferramentas: separador, faca, extrator de mel — modelo manual básico a partir de 100 € (pode ser partilhado através de uma associação local)'
        ] },
        ...
        { kind: 'paragraph', text: 'A FNAP (federação nacional dos apicultores) dá descontos aos membros, organiza cursos e publica catálogos de fornecedores.' }
      ]
    },
    {
      id: 'health-checks',
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'Varroa destructor (ácaro): tratamento obrigatório no outono e na primavera. Medicamentos Apivar, Bayvarol ou métodos orgânicos (ácido oxálico)',
          'Aethina tumida (pequeno escaravelho das colmeias): em Portugal não é crítico, mas requer monitorização',
    ...
    {
      id: 'selling-honey',
      title: 'Venda de mel — uma história à parte',
      content: [
        { kind: 'paragraph', text: 'Se quiser vender mel, há mais requisitos:' },
        { kind: 'checklist', items: [
          'O registo de apicultor já está feito',
          'Abra atividade nas Finanças (serviço fiscal) com o código CIRS 1311 — apicultura',
          'Registe a sala de extração na DGAV — o local onde extrai o mel (requisitos HACCP)',
          'O espaço deve ser adequado à produção alimentar: superfícies laváveis, proteção contra insetos, controlo de temperatura',
          'Análises laboratoriais dos lotes de mel (humidade, HMF, diástase) pelo menos uma vez por época: 30-80 € por análise',
          'Rotulagem de acordo com os requisitos da UE: nome, NIF do apicultor, número do lote, país de origem, massa, prazo de validade',
          'Venda em mercados — autorização do município (Câmara Municipal)',
          'Venda online — IVA obrigatório se o volume de negócios for > 14 500 € por ano (a partir de 2025 podem existir alterações)',
          'IGP (Indicação Geográfica Protegida): Mel da Serra de Aire, Mel do Alentejo, Mel de Trás-os-Montes — segmento premium, exige registo adicional'
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'FNAP — cursos para iniciantes em Lisboa, Évora, Porto, Algarve',
          'Cursos para iniciantes: 16-30 horas, 100-300 €',
          'Temas avançados: extração, combate à Vespa velutina, criação de rainhas, produção de pólen',
          'CONFAGRI (confederação de cooperativas) organiza cursos regionais através de cooperativas',
          'Universidade do Algarve (Faro) — por vezes organiza cursos técnicos',
          'Associações locais: Associação dos Apicultores do Algarve (AAA), Associação dos Apicultores de Trás-os-Montes',
          'Grupos no Telegram/WhatsApp: chats regionais para iniciantes',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'Subsídio à transumância: cerca de 2-5 € por colmeia',
          'Apoio à recuperação de colónias após perdas causadas pela Vespa velutina',
          'Investimento em equipamento de extração: cofinanciamento até 50%',
  ...
  costs: [
    ...
    { label: 'Curso para iniciantes da FNAP', amountEURMin: 100, amountEURMax: 300 },
    ...
    { label: 'Sala de extração — investimento inicial', amountEURMin: 1000, amountEURMax: 5000, note: 'Se tenciona vender' }
  ],
  sources: [
    ...
    { title: 'Portaria 9/2021 — distâncias de colmeias', url: 'https://dre.pt/dre/detalhe/portaria/9-2021-153700104', kind: 'law', language: 'pt', lastRetrieved: '2026-05-03' },
