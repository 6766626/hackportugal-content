      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'l1', title: 'Mercado da Ribeira / Time Out Market', content: [
            { kind: 'paragraph', text: 'Cais do Sodré. De manhã — mercado tradicional: peixe, carne. Do meio-dia até à noite — Time Out Market com mais de 30 quiosques de comida de chefs portugueses de topo. Muito turístico, mas com qualidade elevada.' },
          ]},
          { id: 'l2', title: 'Mercado de Campo de Ourique', content: [
            { kind: 'paragraph', text: 'Menos turístico, mais «para locais». À noite também há food court. O bairro de Campo de Ourique é agradável para passear.' }
          ]},
          { id: 'l3', title: 'Mercado 31 de Janeiro', content: [
            { kind: 'paragraph', text: 'Saldanha. Grande, autêntico, económico. Os locais gostam dele. Tem metro perto.' }
          ]},
          { id: 'l4', title: 'Mercado de Arroios', content: [
            { kind: 'paragraph', text: 'O bairro de Arroios é multicultural. Há muitos vendedores asiáticos, indianos e brasileiros.' }
          ]},
          { id: 'l5', title: 'Feira da Ladra (mercado de velharias)', content: [
            { kind: 'paragraph', text: 'Às terças-feiras e sábados, no Campo de Santa Clara. Mercado de velharias — de antiguidades a tralha. Com vista para o Panteão Nacional.' }
          ]}
        ]}
      ]
    },
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'p1', title: 'Mercado do Bolhão', content: [
            { kind: 'paragraph', text: 'Lendário. Depois da renovação de 2022 — limpo, mas manteve a alma. Peixe fresco, carne, pão, flores, queijos. De manhã é autêntico.' }
          ]},
          ...
          { id: 'p3', title: 'Mercado do Bom Sucesso', content: [
            { kind: 'paragraph', text: 'Boavista. Food hall moderno com lojas, parecido com o Time Out. Bom sítio para almoçar.' }
          ]},
          { id: 'p4', title: 'Feira da Vandoma', content: [
            { kind: 'paragraph', text: 'Mercado de velharias do Porto, normalmente aos sábados de manhã; é melhor confirmar a localização e os horários no site da Câmara Municipal do Porto, pois o espaço pode mudar.' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Mercado Municipal de Abrantes — mercado municipal; confirme os horários e dias de mercado no site do Município de Abrantes',
          'Mercado de Loulé (Algarve) — estilo mourisco surreal, sábado',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Se você for residente fiscal em Portugal e entregar IRS, peça fatura com NIF: as compras de produtos alimentares normalmente entram nas despesas gerais familiares, e cafés/restaurantes — numa categoria separada do e-Fatura',
          'Os vendedores muitas vezes falam apenas português — vocabulário básico será útil',
