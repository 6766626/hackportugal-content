export default {
  ...
  tldr: 'Em Lisboa e no Porto há lojas com produtos da CEI (Slavianka, Bazar Russo, Euromercado), restaurantes georgianos e supermercados brasileiros (Brasa, Brasileirinho). Entrega a partir de Espanha — Tiendas de Rusia (Madrid): prazos e custos dependem da morada/peso/promoções, confirme no momento da encomenda. Em alguns Continente/Pingo Doce de maior dimensão encontram-se por vezes alguns produtos da Europa de Leste, mas a disponibilidade é instável. Vinho georgiano aparece por vezes em garrafeiras especializadas e em promoções temporárias do Lidl/outras cadeias; consulte o folheto actual.',
  ...
  steps: [
        ...
        { kind: 'substeps', items: [
          { id: 'r1', title: 'Lisboa', content: [
            { kind: 'checklist', items: [
              '**Slavianka** (Av. Almirante Reis, Arroios) — a maior loja. Arenque, trigo-sarraceno, tvorog, natas azedas, enchidos, bombons, vodka Stolichnaya',
              '**Bazar Russo** (Rua Gonçalo Mendes da Maia, Picoas) — mais pequena, mas mais perto do centro',
              '**Euromercado** (Amadora) — loja grande com uma ampla variedade, preços mais baixos',
              '**Sortido mínimo**: em alguns Continente/Pingo Doce de maior dimensão encontram-se por vezes alguns produtos da Europa de Leste, mas a disponibilidade é instável; para trigo-sarraceno/arenque é mais fiável ir a lojas especializadas',
              'Preços típicos: trigo-sarraceno 4-6 €/kg, arenque 8-10 €/kg, caviar preto (imitação) 5-15 €/frasco, bombons 15-25 €/kg'
            ]}
          ]},
          { id: 'r2', title: 'Porto', content: [
            { kind: 'checklist', items: [
              ...
              'Em Braga, Coimbra — escolha limitada, trazem de Lisboa/Porto'
            ]}
          ]},
          { id: 'r3', title: 'Algarve', content: [
            { kind: 'paragraph', text: 'No Algarve não há uma grande loja russa completa — muitos expats encomendam online de Lisboa com entrega CTT. Confirme os pontos actuais em grupos locais de Facebook/Telegram antes da deslocação.' }
          ]},
          { id: 'r4', title: 'Online e entregas', content: [
            { kind: 'checklist', items: [
              ...
              '**Amazon PT/ES** — algumas marcas (espadilhas fumadas, compotas)',
              '**Glovo** — a Slavianka tem entrega num raio de 5-10 km'
            ]}
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'A diáspora georgiana em Portugal é relativamente pequena, mas activa — há 5-7 restaurantes abertos em Lisboa e no Porto.' },
        { kind: 'substeps', items: [
          ...
          { id: 'g3', title: 'Produtos georgianos', content: [
            { kind: 'checklist', items: [
              'Especiarias (khmeli-suneli, utskho-suneli): na Slavianka, lojas orientais de Martim Moniz',
              'Polpa de tomate, adjika: nos mesmos locais',
              '**Vinhos georgianos**: aparecem por vezes em garrafeiras especializadas e em promoções temporárias do Lidl/outras cadeias; consulte o folheto actual',
              'Tkemali (ameixa), Adjika — em lojas online + secção gourmet do Continente',
              'Massa pronta/semipreparados para khachapuri são raros; mais frequentemente fazem-se de raiz ou usa-se massa levedada/folhada comum do supermercado'
            ]}
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Os brasileiros são a maior comunidade estrangeira em Portugal; a dimensão actual exacta deve ser confirmada junto da AIMA/INE. Há produtos e restaurantes em todo o lado.' },
        { kind: 'checklist', items: [
          ...
          '**Nos Continente/Pingo Doce de maior dimensão** há frequentemente alguns produtos brasileiros: farofa, tapioca, feijão preto, guaraná, pão de queijo mix, mandioca, caju; o sortido depende da loja',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '🇺🇦 **Ucranianos**: em muitas lojas russas (ingredientes para borscht, queijo "Korolivskyi"). Loja separada "Ukraina" em Almada',
          '🇮🇳 **Indianas**: Martim Moniz / Intendente — ~10 lojas (masala, dal, basmati, paneer). Restaurantes por todo o lado',
          ...
          '🇵🇰 **Paquistanesas / bangladechianas**: Martim Moniz, carne halal',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '💰 **Preços**: produtos étnicos ~30-70% mais caros do que no país de origem (custos de importação)',
          '🚚 **Encomendas grandes** de Espanha (Madrid) — muitas vezes são trazidas de autocarro/através de viagens partilhadas de carro, poupança de 20-30%',
          '📱 **Grupos no Facebook**: "Produtos russos em Portugal", "Georgian Community Portugal" — venda/troca',
          '🍷 **Vinho georgiano** aparece por vezes no Lidl/outras cadeias no âmbito de promoções temporárias de vinho; consulte o folheto e a aplicação Lidl Plus'
        ]}
      ]
    }
  ],
