export default {
  ...
  steps: [
    {
      id: 'how-to-pick',
      title: 'Como escolher um parque',
      content: [
        { kind: 'paragraph', text: 'Os parques em Portugal dividem-se em três tipos: “cidade das profissões” (KidZania), parques de diversões clássicos (Magikland, Família Park) e temáticos/científicos (Dino Parque, Sea Life, Zoomarine). Cada um tem o seu próprio foco etário.' },
        { kind: 'checklist', items: [
          '👶 Até aos 3 anos: apenas o Zoomarine e pequenas zonas da KidZania para crianças mais pequenas; para a maioria dos parques de diversões ainda é cedo',
          '🎈 3–6 anos: KidZania (apenas 3-4 anos para a versão simplificada), Dino Parque, Família Park, Sea Life',
          '🎢 7–12 anos: auge da KidZania, Magikland, Zoomarine',
          '🎯 13+: Magikland (montanhas-russas maiores), Zoomarine (espetáculos + diversões)',
          '👴 65+: gratuito no Magikland a partir dos 76 anos — um excelente bónus para avós'
        ]},
        { kind: 'warning', text: 'Não confunda: Zoomarine = parque marinho-zoológico com espetáculos de golfinhos; É DIFERENTE dos parques aquáticos (Slide & Splash, Aqualand). No Zoomarine há água, mas não é um “parque aquático” em sentido estrito.' }
      ]
    },
    {
      id: 'kidzania',
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          '💶 Crianças 3–4 anos: 15,50 €',
          '💶 Crianças 0–2: gratuito',
          '💶 Adultos (acompanhantes): ~9–10 € (depende da época)',
          '⏱️ Sessão de 4 horas (o bilhete de entrada dá 4 horas no recinto)',
          '🎟️ Compre em bol.pt / FNAC / Odisseias — há frequentemente promoções de -10-20%',
          '🗓️ Aberto de quarta-feira a domingo durante o período escolar, diariamente nas férias'
        ]},
        { kind: 'paragraph', text: 'Dica prática: chegue à abertura, às 10:00 — as profissões mais populares (bombeiro, piloto, videoblogger) esgotam em 30 minutos. Se chegar mais tarde — terá de escolher as menos populares.' }
      ]
    },
    {
      id: 'dino-parque',
      title: 'Dino Parque Lourinhã — dinossauros em tamanho real',
      content: [
        { kind: 'paragraph', text: 'Parque ao ar livre com 10 hectares e mais de 180 modelos de dinossauros em tamanho real. Fica na Lourinhã — centro mundial de paleontologia (aqui foram encontrados os maiores vestígios de dinossauros da Europa).\n\nAlém dos modelos — museu paleontológico com fósseis reais, laboratório onde é possível ver o trabalho dos cientistas.' },
        { kind: 'checklist', items: [
          '📍 Rua Vale dos Dinossauros, 25 Abelheira, 2530-059 Lourinhã (~70 km a norte de Lisboa)',
          '💶 Adultos (13+): 16 €',
          '💶 Crianças 4–12 anos: 12 €',
          '💶 Crianças 0–3 anos: gratuito',
          '👨‍👩‍👧‍👦 Pacotes familiares: 2 adultos + 1 criança 38 €, +2 crianças 48 €, +3 crianças 59 € (apenas na bilheteira)',
          '💸 Desconto online de 10% (bilheteiraonline.dinoparque.pt)',
          '🕐 Outubro-março: 10:00-17:00; abril-maio, setembro: 10:00-18:00; junho-agosto: 10:00-19:00',
          '📞 +351 261 243 160'
        ]},
        { kind: 'paragraph', text: 'Reserve 3-4 horas. O parque é exterior, ao ar livre — no verão leve obrigatoriamente boné/chapéu, no outono impermeável/roupa quente.' }
      ]
    },
    {
      id: 'magikland',
      title: 'Magikland — parque de diversões em Penafiel',
      content: [
    ...
    {
      id: 'sea-life',
      title: 'Sea Life Porto — oceanário',
      content: [
        ...
        { kind: 'paragraph', text: 'Alternativa: para uma experiência mais completa — Oceanário de Lisboa (Parque das Nações), um dos maiores oceanários da Europa, 22 € adultos. Ver guia separado sobre jardins zoológicos e aquários.' }
      ]
    },
    {
      id: 'zoomarine',
      title: 'Zoomarine Algarve — parque marinho com golfinhos',
      content: [
        ...
        { kind: 'warning', text: 'Questão ética: manter golfinhos em cativeiro é tema de debate. Se isto for importante para si — escolha o Sea Life ou o Oceanário, onde existem apenas animais marinhos tradicionalmente mantidos em oceanários. O Zoomarine cumpre todos os padrões europeus, mas continuam a ser golfinhos numa piscina.' }
      ]
    },
    {
      id: 'less-known',
      title: 'Parques menos conhecidos',
      content: [
        { kind: 'checklist', items: [
          '🎈 Família Park (Mafra, ~40 km de Lisboa) — pequeno parque com carrosséis e quinta pedagógica, mais barato do que todos os outros, preços ~8-12 €',
          '🦖 Parque dos Pequeninos (Coimbra) — Portugal em miniatura, parque tradicional de "monumentos em tamanho reduzido", muito atmosférico para famílias',
          '🦓 Badoca Safari Park (Vila Nova de Santo André, centro-sul) — parque safari-zoológico, percurso pelo recinto com animais selvagens',
          '🏰 Quintas de Sintra (Quinta da Regaleira, Pena, etc.) — formalmente não é um "parque temático", mas para famílias com crianças é uma excelente alternativa (ver guia separado)',
          '⚓ Submarino S.Roque (Cacilhas) — verdadeiro submarino-museu, muito interessante para crianças 6+, entrada apenas 5 €'
        ]}
      ]
    }
  ],
  ...
  sources: [
    ...
    { title: 'Dino Parque Lourinhã — Preparar Visita (site oficial)', url: 'https://www.dinoparque.pt/preparar-visita/', kind: 'official', language: 'pt', lastRetrieved: '2026-05-17' },
    { title: 'Magikland — informações úteis (site oficial)', url: 'https://magikland.pt/informacoes-uteis/', kind: 'official', language: 'pt', lastRetrieved: '2026-05-17' },
