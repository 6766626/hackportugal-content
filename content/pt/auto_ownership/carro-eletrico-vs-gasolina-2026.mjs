  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Total cost of ownership é a compra menos a futura revenda, mais energia, impostos, seguro, manutenção, pneus, estacionamento e infraestrutura de carregamento.\n\nEm Portugal, a principal diferença em 2026: o carro elétrico é mais caro na compra, mas mais barato por cada quilómetro e quase sempre mais barato em impostos.' },
        { kind: 'checklist', items: [
          'BEV novo: normalmente 30 000–50 000 €; modelos urbanos por vezes abaixo, SUV familiares frequentemente 40 000 €+.',
          ...
          'O gasóleo pode ser mais barato do que a gasolina em autoestrada, mas mais caro em riscos: DPF, AdBlue, viagens urbanas curtas e futuras restrições.'
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Cenário-base: 75 000 km em 5 anos. Um carro elétrico por 38 000 € contra um carro a gasolina por 28 000 €. Sem contar crédito e revenda, o carro a gasolina é 10 000 € mais barato à entrada, mas tem despesas anuais mais elevadas.' },
        { kind: 'checklist', items: [
          'BEV 70% em casa + 30% público: energia média cerca de 4,5–6 €/100 km = 3 375–4 500 € por 75 000 km.',
          ...
          'A diferença nas despesas operacionais ao longo de 5 anos é normalmente de 3 000–7 000 € a favor do BEV, mais se conduzir muito e carregar em casa.'
        ] },
        { kind: 'paragraph', text: 'Conclusão: se o carro elétrico custar mais 10 000 €, se fizer 10 000 km/ano e carregar sobretudo em postos públicos, a amortização pode não acontecer. Se fizer 20 000 km/ano, carregar em casa e obtiver 4 000 € do Fundo Ambiental, o BEV torna-se frequentemente mais barato em 4–6 anos.' }
      ]
    },
    {
      id: 'charging-reality',
      ...
      content: [
        { kind: 'paragraph', text: 'O modelo de propriedade mais barato é apartamento/casa com tarifa noturna e possibilidade de instalar uma wallbox ou uma tomada dedicada normal.\n\nEm Portugal isto é especialmente importante: a rede pública Mobi.E é conveniente, mas a tarifa é pouco transparente para principiantes, porque a fatura resulta de várias componentes.' },
        { kind: 'checklist', items: [
          'Em casa: verifique a potência contratada; para wallbox são muitas vezes necessários 6,9 kVA ou mais.',
          ...
          'Em público: é necessário um contrato CEME ou aplicação/cartão; o preço final depende do operador, potência, tempo e tarifa.',
          'Carregamentos rápidos DC são convenientes em autoestrada, mas são os mais caros e aceleram o desgaste da bateria se usados constantemente.',
          'Nas autoestradas A1/A2/A8/A22, planeie os carregamentos com antecedência: no verão e em feriados as filas são reais.',
          'Se não tiver carregamento em casa ou no trabalho, não considere 3–5 €/100 km, mas sim mais próximo de 6–9 €/100 km.'
        ] },
        { kind: 'warning', text: 'Não compre um BEV calculando apenas o “custo do kWh em casa” se vive numa casa arrendada sem lugar de estacionamento. Neste cenário, a poupança face à gasolina cai fortemente e o incómodo diário aumenta.' }
      ]
    },
    {
      id: 'taxes-incentives',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Em 2026, o elemento mais incerto do TCO é o valor residual. Os carros elétricos desvalorizam mais depressa com a chegada de novas baterias e guerras de preços entre marcas, mas modelos populares com bateria decente e garantia vendem-se bem. Nos carros a gasolina, o mercado é mais familiar, mas futuras restrições ambientais e o ciclo caro do combustível pressionam o valor.' },
        { kind: 'checklist', items: [
          ...
          'Os pneus de um BEV desgastam-se mais depressa devido ao peso e ao binário; conte com um conjunto a cada 30 000–50 000 km.',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'O carro elétrico é financeiramente mais forte quando conduz muito, carrega em casa/no trabalho e compra um modelo dentro do limite do Fundo Ambiental. A gasolina é mais racional se o orçamento de compra for rígido, a quilometragem for baixa, não houver carregamento ou se o carro for uma simples “primeira compra portuguesa” para 1–2 anos.' },
        { kind: 'checklist', items: [
          ...
          'Não escolha um BEV caro “para poupar” se vai carregar quase só em postos DC.',
          'Para um SUV familiar, faça as contas à parte: a diferença de compra pode ser 15 000 €+, e o combustível nem sempre a compensa.',
          'Para uma empresa/trabalhador independente, peça ao contabilista para calcular IVA, amortização e tributação autónoma — o resultado pode diferir da propriedade particular.'
        ] }
      ]
    }
  ],
  costs: [
    { label: 'BEV novo do segmento generalista', amountEURMin: 30000, amountEURMax: 50000, note: 'Antes de descontos do concessionário e eventual Fundo Ambiental; modelos premium são mais caros.' },
