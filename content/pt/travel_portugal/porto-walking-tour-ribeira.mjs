export default {
  ...
  "tldr": "Percurso de 2,5 km em 3 horas: da Torre dos Clérigos, passando pela Livraria Lello, pela Sé e pela estação de São Bento, até à Ribeira e à Ponte Luís I. O centro histórico está classificado pela UNESCO. Há muitas descidas e escadarias de pedra — o calçado faz a diferença. No fim — travessia para Vila Nova de Gaia, até às caves de vinho.",
  "tags": [
    "porto",
    "ribeira",
    "passeio a pé",
  ...
  "steps": [
      ...
      "content": [
        {
          ...
          "points": [
            ...
            },
            {
              ...
              "description": "Livraria de 1906 em estilo neogótico e art nouveau. A lendária escadaria de madeira em espiral: provável protótipo para Hogwarts, embora Rowling o negue. Entrada — 8 €, valor descontado na compra de um livro.",
              "wikipedia": {
            ...
            },
            {
              ...
              "description": "Dois templos fundidos numa só fachada, separados pela casa mais estreita do Porto, com 1 m de largura. A parede lateral está totalmente revestida por um painel de azulejos de 1912.",
              "wikipedia": {
            ...
            },
            {
              ...
              "description": "Estação ferroviária de 1916. O átrio está revestido com 20 000 azulejos: cenas da história de Portugal, a batalha de Arcos de Valdevez, a entrada do rei João I no Porto.",
              "wikipedia": {
            ...
            {
              "name": "5. Sé do Porto",
              "description": "Catedral fortificada do século XII. Claustro com azulejos do século XVIII, altar de prata na capela do Santíssimo Sacramento. Ao lado — monumento a Vimara Peres, primeiro conde de Portucale.",
              "wikipedia": {
            ...
            },
            {
              ...
              "description": "Rua pedonal com cafés, boutiques e fluxo turístico. A Igreja da Misericórdia é do século XVI; ao lado fica um museu com a obra-prima «Fons Vitae», de mestres flamengos.",
              "wikipedia": {
            ...
            },
            {
              ...
              "description": "Palácio neoclássico da bolsa, de 1850. O Salão Árabe é uma imitação da Alhambra; a pintura levou 18 anos. Visitas guiadas em português, inglês, espanhol e francês.",
              "wikipedia": {
            ...
            },
            {
              ...
              "description": "Marginal com casas coloridas — UNESCO. Ponte Luís I, de 1886, projectada por Théophile Seyrig, discípulo de Eiffel. A pé, pode atravessar pelo tabuleiro superior até Vila Nova de Gaia ou seguir junto ao rio pelo tabuleiro inferior. As vistas da ponte parecem um postal.",
              "wikipedia": {
      ...
      "content": [
        {
          "kind": "checklist",
          "items": [
            "👟 Descidas íngremes dos Clérigos até à Ribeira — é necessário calçado com sola antiderrapante",
            "🎟️ Lello — entrada por faixas horárias, reservar online com antecedência",
    ...
    },
    {
      ...
      "content": [
        {
          "kind": "paragraph",
          "text": "A cidade deu nome ao país («Portucale») e ainda hoje partilha com Lisboa uma função informal de “capital”. No século XIX — centro industrial. O centro histórico foi inscrito na UNESCO em 1996."
        },
        {
          "kind": "wikiLink",
          "title": "Centro Histórico do Porto (UNESCO)",
          "urls": {
  ...
  "sources": [
    {
      "title": "Visit Porto — Centro Histórico",
      "url": "https://www.visitporto.travel/",
      "kind": "official",
      "language": "pt",
      "lastRetrieved": "2026-04-22"
    },
    {
      "title": "UNESCO — Centro Histórico do Porto",
