export default {
  ...
  steps: [
        ...
        { kind: 'substeps', items: [
          { id: 't1', title: '🔴⚪ GR (Grande Rota) — de vários dias', content: [
            { kind: 'checklist', items: [
              ...
              'GR 22 — Aldeias Históricas — 540 km por 12 aldeias históricas'
            ]}
          ]},
          ...
          { id: 't3', title: '💧 Levadas (Madeira) — único', content: [
            { kind: 'checklist', items: [
              'Levadas — canais de irrigação dos séculos XVI-XX, com trilhos ao longo deles',
              '350 km de trilhos sinalizados',
              ...
              'Época: todo o ano',
              'Equipamento: botas antiderrapantes, lanterna (para os túneis), roupa impermeável'
            ]}
          ]}
        ]}
      ]
    ...
    {
      id: 'top-regions',
      title: '🏔️ Principais regiões para caminhadas',
      content: [
        { kind: 'substeps', items: [
          { id: 'r1', title: 'Serra da Estrela (centro)', content: [
            { kind: 'checklist', items: [
              'O maciço mais alto de Portugal continental (1 993 m, Torre)',
              'No inverno há neve, no verão é fresco',
              'Percurso principal: PR 1 MTG — Vale do Zêzere, 14 km, vistas excelentes',
          ...
          { id: 'r2', title: 'Parque Nacional da Peneda-Gerês (noroeste)', content: [
            { kind: 'checklist', items: [
              ...
              'Trilho dos Currais — 8 km por pastagens',
          ...
          { id: 'r3', title: 'Algarve — Rota Vicentina', content: [
            { kind: 'checklist', items: [
              ...
              'Caminho Histórico — percurso interior, 263 km por aldeias',
              'Pode ser feito em etapas diárias de 10-20 km, pernoitando em casas rurais',
              'Baías bonitas, menos turistas do que no sul do Algarve',
              'Melhor época: abril-junho, setembro-outubro'
            ]}
          ]},
          { id: 'r4', title: 'Açores — nove ilhas com carácter diferente', content: [
            { kind: 'checklist', items: [
              'São Miguel: Lagoa do Fogo, Sete Cidades, águas termais das Fumarolas',
              'Pico: subida à Montanha do Pico (2 351 m) — o ponto mais alto de Portugal. Difícil, com guia, 7-9 horas',
              'Flores: «a mais verde» — cascatas, desfiladeiros',
              'Faial, Terceira — paisagens vulcânicas',
              'Todos os trilhos são sinalizados, GPX em trails.visitazores.com',
              'Vento e chuva são frequentes — prepare-se'
            ]}
          ]},
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'g1', title: 'Básico (para um PR de um dia)', content: [
            { kind: 'checklist', items: [
              'Botas ou calçado de trekking (não sapatilhas urbanas)',
              'Mochila de 15-25 l',
              'Água: 1.5-2 l por pessoa',
              'Snacks, sandes',
              'Casaco corta-vento/impermeável (mesmo com sol — as condições podem mudar)',
              'SPF 50 + boné',
              'Telemóvel com percurso GPX, bateria externa',
          ...
          { id: 'g3', title: 'Onde comprar', content: [
            { kind: 'checklist', items: [
              ...
              'Sport Zone — promoções regulares',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🦵 Calçado: 80% dos problemas no trilho resultam de calçado inadequado; é fácil torcer o tornozelo em terreno pedregoso'
        ]}
      ]
    }
  ],
  costs: [
    { label: 'Entrada em parques (NP Gerês, Estrela)', amountEUR: 0 },
    { label: 'Alguns trilhos privados / quintas vinícolas', amountEURMin: 5, amountEURMax: 20 },
