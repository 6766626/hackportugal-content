export default {
  ...
  tldr: 'A CP é o operador ferroviário público. Tipos de comboios: Alfa Pendular (rápidos Lisboa — Porto em 2,5 h), Intercidades (médios), Regional (lentos), Urbanos (suburbanos). Cartões de desconto: Cartão Jovem, Cartão Amigo. Lisboa — Porto no Alfa Pendular: cerca de 25–40 €, Intercidades: cerca de 20–30 €. Reservar em cp.pt.',
  ...
  steps: [
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 't1', title: 'Alfa Pendular (AP)', content: [
            { kind: 'paragraph', text: 'O topo de gama da CP. Comboios rápidos com pendulação da caixa. Lisboa — Porto em 2,5 h. Wi-Fi, tomadas, carruagem-bar. 2 classes: Conforto (classe económica), Primeira (primeira classe). Rotas: Lisboa — Coimbra — Porto — Braga, Lisboa — Algarve.' }
          ]},
          { id: 't2', title: 'Intercidades (IC)', content: [
            { kind: 'paragraph', text: 'Comboios de longo curso, 30–50 min mais lentos do que o AP e 20–30% mais baratos. As mesmas rotas principais, mais ramais. Confortáveis.' }
          ]},
    ...
    {
      id: 'key-routes',
      title: 'Rotas principais (preços 2026)',
      content: [
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'b1', title: '1. Site da CP ou aplicação', content: [
            { kind: 'paragraph', text: 'cp.pt ou a aplicação CP. Registo, NIF (preferencialmente), cartão de pagamento.' },
          ...
          { id: 'b3', title: '3. Bilhete no telemóvel', content: [
            { kind: 'paragraph', text: 'PDF ou na aplicação. O revisor lê o código QR. Se for Alfa Pendular, o lugar fica reservado.' }
          ]},
        ...
        { kind: 'substeps', items: [
          { id: 's1', title: 'Lisboa', content: [
            { kind: 'checklist', items: [
              ...
              'Entrecampos — comboios de longo curso para sul'
            ]}
          ]},
