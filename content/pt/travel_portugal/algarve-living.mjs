export default {
  ...
  tldr: 'Costa sul. Sol 300 dias por ano, +18–28°C durante todo o ano. Faro — a principal cidade e aeroporto. Locais populares para viver: Tavira (autêntica), Lagos (activa), Albufeira (turística), Portimão (prática). Sazonalidade: no Verão os preços são 3 vezes mais altos, no Inverno fica vazio. Comunidade internacional, o inglês é suficiente.',
  ...
  steps: [
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'c2', title: 'Tavira', content: [
            { kind: 'paragraph', text: 'A mais autêntica — ruas piscatórias tradicionais, pontes, salinas. Mais tranquila. T1 600–1000 €.' }
          ]},
          ...
          { id: 'c4', title: 'Albufeira', content: [
            { kind: 'paragraph', text: 'Capital turística. No Verão, multidões de britânicos. Para férias em família. T1 700–1200 € fora da época alta.' }
          ]},
          { id: 'c5', title: 'Portimão', content: [
            { kind: 'paragraph', text: 'Cidade grande e prática. Hospitais, escolas, Continente, tudo por perto. Muitos expats. T1 700–1100 €.' }
          ]},
          { id: 'c6', title: 'Sagres / Vila do Bispo', content: [
            { kind: 'paragraph', text: 'Extremo ocidental. Natureza selvagem, surf. Remoto. T1 500–800 € nas aldeias.' }
          ]}
        ]}
      ]
    },
    {
      id: 'why-live',
      title: 'Vantagens de viver aqui',
      content: [
        { kind: 'checklist', items: [
          'Clima: 300 dias de sol, Inverno ameno +15–18°C',
          'Praias: entre as melhores da Europa',
          'Comunidade internacional — britânicos, alemães, escandinavos, falantes de russo',
          'Inglês disponível em todo o lado — fácil no primeiro ano',
          'Menos burocracia nas cidades mais pequenas',
          'Campos de golfe de nível mundial',
          'Medicina: clínicas privadas de bom nível (HPA Health Group)',
          'Arrendamento mais barato do que em Lisboa',
          'Voos internos baratos Lisboa — Faro'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Sazonalidade: no Verão o arrendamento é 3 vezes mais caro, restaurantes cheios',
          ...
          'Educação infantil: menos escolas internacionais do que em Lisboa/Porto',
          'Medicina: hospital SNS em Faro, mas cirurgias complexas — em Lisboa'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '👴 Reformados D7 — ideal',
          '💻 Nómadas digitais D8 — excelente para o Verão, mas no Inverno pode ser tranquilo demais',
          ...
          '💼 NÃO é adequado para uma carreira em IT/sector empresarial — melhor Lisboa/Porto'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '✈️ Aeroporto de Faro: Ryanair / EasyJet / TAP — voos directos para Reino Unido/Alemanha/Países Baixos/França',
