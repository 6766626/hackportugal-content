  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Caminho de ferro nacional. Cobre as rotas Lisboa — Porto — Braga, Lisboa — Alentejo — Algarve, Coimbra, rotas de montanha do Douro. Não cobre as ilhas.' },
        { kind: 'substeps', items: [
          { id: 'cp1', title: 'Tipos de comboios', content: [
            { kind: 'checklist', items: [
              ...
              'Comboios Históricos — Douro (sazonal)'
            ]}
          ]},
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'b2', title: 'FlixBus', content: [
            { kind: 'paragraph', text: 'Rede internacional. Em Portugal: Lisboa–Porto (10–25 €), Lisboa–Faro (15–35 €). Para o estrangeiro: Portugal–Espanha (Madrid 35 €), Portugal–França (Paris 100 €). Vantagem: preços baixos; desvantagem: menos serviços do que a Rede Expressos.' }
          ]},
          ...
          { id: 'b5', title: 'Regionais / locais', content: [
            { kind: 'paragraph', text: 'Rodonorte (norte), Rodoviária do Alentejo, Rodoviária do Tejo, entre outras. Para aldeias e povoações remotas — muitas vezes o único transporte.' }
          ]}
        ]}
      ]
    },
    {
      id: 'domestic-flights',
      title: 'Voos domésticos — apenas para as ilhas',
      content: [
        { kind: 'checklist', items: [
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '⛴️ Atlanticoline — ferries interilhas nos Açores. São Miguel ↔ Terceira ↔ Faial, entre outras. A partir de 15 €',
