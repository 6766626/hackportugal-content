export default {
  ...
  "steps": [
    {
      ...
      "content": [
        {
          "kind": "paragraph",
          "text": "Caminho de ferro nacional. Cobre as rotas Lisboa — Porto — Braga, Lisboa — Alentejo — Algarve, Coimbra, rotas de montanha do Douro. Não cobre as ilhas."
        },
        {
          "kind": "substeps",
          "items": [
              ...
              "content": [
                {
                  ...
                  "items": [
                    ...
                    "Comboios Históricos — Douro (época sazonal)"
                  ]
                }
              ]
            },
              ...
              "content": [
                {
                  "kind": "checklist",
                  "items": [
                    "Lisboa–Porto Alfa: 30–45 € (com antecedência) / 50–70 € (no dia da viagem)",
                    "Lisboa–Faro: 20–30 €",
                    "Lisboa–Coimbra: 15–25 €",
                    "Porto–Braga: 5–8 €",
                    "Descontos: 50% para crianças dos 4 aos 13 anos, 25-50% para estudantes, 50% para pensionistas 65+",
          ...
          "items": [
            ...
            },
            {
              ...
              "content": [
                {
                  "kind": "paragraph",
                  "text": "Rede internacional. Em Portugal: Lisboa–Porto (10–25 €), Lisboa–Faro (15–35 €). Para o estrangeiro: Portugal–Espanha (Madrid 35 €), Portugal–França (Paris 100 €). Vantagem: preços baixos; desvantagem: menos serviços do que a Rede Expressos."
                }
              ]
            },
            {
              ...
              "content": [
                {
                  "kind": "paragraph",
                  "text": "Operador espanhol, rotas Portugal–Espanha. Lisboa–Madrid, Porto–Santiago. A partir de 25 €."
                }
              ]
            },
            {
              "id": "b4",
              "title": "EVA Transportes",
              "content": [
                {
                  "kind": "paragraph",
                  "text": "Algarve. Faro–Lagos, Albufeira e rotas rurais. 5–15 €."
                }
              ]
            },
            {
              "id": "b5",
              "title": "Regionais / locais",
              "content": [
                {
                  "kind": "paragraph",
                  "text": "Rodonorte (norte), Rodoviária do Alentejo, Rodoviária do Tejo e outros. Para aldeias e povoações remotas — muitas vezes o único transporte."
                }
              ]
            }
          ]
      ...
      "content": [
        {
          "kind": "checklist",
          "items": [
            "⛴️ Atlanticoline — ferries interilhas nos Açores. São Miguel ↔ Terceira ↔ Faial e outros. A partir de 15 €",
      ...
      "content": [
        {
          ...
          "items": [
            ...
            "🔍 Rome2Rio — rotas com transbordos",
  ...
  "costs": [
    {
      "label": "Lisboa–Porto Alfa Pendular",
      "amountEURMin": 30,
      "amountEURMax": 70
    },
    {
      "label": "Lisboa–Porto Rede Expressos",
      "amountEUR": 22
    },
    {
      "label": "Lisboa–Faro (comboio)",
      "amountEURMin": 20,
      "amountEURMax": 30
    },
    {
      "label": "Lisboa–Funchal (avião)",
      "amountEURMin": 50,
      "amountEURMax": 150
    },
    {
      "label": "Lisboa–Ponta Delgada (avião)",
      "amountEURMin": 80,
      "amountEURMax": 200
    }
  ],
  "sources": [
    ...
    {
      "title": "Atlanticoline — ferries nos Açores",
