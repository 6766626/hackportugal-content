export default {
  ...
  title: 'Belém — roteiro da Era dos Descobrimentos',
  tldr: 'Roteiro de 4 km para 4 horas, com ou sem visitas a museus — do Mosteiro dos Jerónimos, passando pelo Padrão dos Descobrimentos, até à Torre de Belém. O bairro de Belém guarda monumentos da “idade de ouro” da navegação: Vasco da Gama, Infante D. Henrique, Magalhães. Pelo caminho — a lendária pastelaria Pastéis de Belém (desde 1837).',
  tags: ['lisboa', 'belém', 'passeio a pé', 'descobrimentos', 'unesco'],
  ...
  steps: [
        ...
        { kind: 'walkingRoute', distanceKm: 4.0, durationMinutes: 240, difficulty: 'easy', points: [
          {
            ...
            description: 'Mosteiro manuelino do século XVI, Património Mundial da UNESCO desde 1983. Foi financiado pelo comércio de especiarias da Índia. Aqui encontram-se os túmulos de Vasco da Gama e de Luís de Camões. O claustro é uma joia do estilo manuelino.',
            wikipedia: {
          ...
          },
          {
            ...
            description: 'Pastéis — antecessores dos pastéis de nata, preparados segundo a receita original dos monges jerónimos desde 1837. A fila para levar anda depressa, mas é melhor tomar um café na sala com painéis de azulejo.',
            wikipedia: {
          ...
          },
          {
            ...
            description: 'Museu contemporâneo sob uma cobertura ondulante em forma de prancha de surf, desenhada por Amanda Levete. No interior — exposições de design e videoarte; em cima — panorâmica sobre o rio Tejo.',
            wikipedia: {
          ...
          },
          {
            ...
            description: 'Monumento com 52 m de altura, em forma de caravela, com 33 figuras de pioneiros: Infante D. Henrique, Magalhães, Vasco da Gama, entre outros. Na praça — uma rosa dos ventos em mármore (oferta da África do Sul, 1960).',
            wikipedia: {
          ...
          },
          {
            ...
            description: 'Jardim com fonte entre o Mosteiro dos Jerónimos e o Tejo. À volta da fonte — 32 brasões das antigas províncias. Excelente local para um piquenique antes da Torre de Belém.',
            wikipedia: {
          ...
          },
          {
            ...
            description: 'Fortaleza-farol do século XVI, Património Mundial da UNESCO. Historicamente recebia os navios que regressavam da Índia. Símbolo de Lisboa. No interior — um rinoceronte em pedra (a primeira escultura europeia deste animal).',
            wikipedia: {
          ...
          },
          {
            ...
            description: 'Opcional. A maior coleção de coches reais do mundo. Peças barrocas luxuosas dos séculos XVII–XIX, com douramento e pintura.',
            wikipedia: {
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Nos séculos XV–XVI, Portugal era uma superpotência. Vasco da Gama descobriu o caminho marítimo para a Índia (1498), Pedro Álvares Cabral — o Brasil (1500), Magalhães deu a volta ao mundo (1519–1522). A riqueza das especiarias financiou este bairro.' },
        { kind: 'wikiLink', title: 'Era dos Descobrimentos — visão geral', urls: {
  ...
  sources: [
    ...
    { title: 'UNESCO — Mosteiro dos Jerónimos e Torre de Belém', url: 'https://whc.unesco.org/en/list/263/', kind: 'official', language: 'en', lastRetrieved: '2026-04-22' },
    { title: 'Património Cultural PT', url: 'https://www.patrimoniocultural.gov.pt/', kind: 'official', language: 'pt', lastRetrieved: '2026-04-22' }
  ],
