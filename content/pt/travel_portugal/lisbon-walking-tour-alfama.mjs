export default {
  ...
  "tldr": "Percurso de 3 km para 2,5–3,5 horas pelo coração da Lisboa medieval. Início — Sé de Lisboa, fim — Miradouro da Graça. Subida tranquila por ruas estreitas empedradas, castelo, 3 miradouros, Museu do Fado. Combina bem com um jantar numa das tavernas locais com fado ao vivo.",
  "tags": [
    "lisboa",
    "alfama",
    "visita pedonal",
  ...
  "steps": [
      ...
      "content": [
        {
          ...
          "points": [
            {
              "name": "1. Sé de Lisboa",
              "description": "Catedral do século XII, a igreja mais antiga da cidade. Sobreviveu a 3 terramotos. No interior — um claustro com escavações arqueológicas das épocas romana e visigótica.",
              "wikipedia": {
            ...
            },
            {
              ...
              "description": "Construída no local onde nasceu Santo António de Pádua, em 1195. Na cave — a cripta. A 13 de junho, a cidade celebra a festa com uma maratona de casamentos mesmo junto à igreja.",
              "wikipedia": {
            ...
            },
            {
              ...
              "description": "Miradouro com painel de azulejos «A Tomada de Lisboa aos Mouros» (1147). Daqui tem-se a melhor vista para os telhados de telha de Alfama e para o Tejo. Brisa, bancos, pérgula florida.",
              "wikipedia": {
            ...
            },
            {
              ...
              "description": "50 m mais acima — as «Portas do Sol». Estátua de São Vicente, padroeiro da cidade, com o corvo. Daqui vê-se a cúpula de São Vicente de Fora e o Campo de Santa Clara, com a Feira da Ladra às terças-feiras e aos sábados.",
              "wikipedia": {
            ...
            },
            {
              ...
              "description": "Fortaleza mourisca no topo da colina. Muralhas do século XI, cidadela reconstruída, 11 torres. Pavões passeiam pelo recinto. Panorama de 360° sobre toda Lisboa.",
              "wikipedia": {
            ...
            },
            {
              ...
              "description": "Museu do fado português — canção urbana incluída na lista do património cultural imaterial da UNESCO. Biografias de fadistas, discos antigos, atuações.",
              "wikipedia": {
            ...
            },
            {
              ...
              "description": "Miradouro final sob pinheiros, com vista para o castelo e para o rio. Ao lado — a igreja da Graça e uma das melhores tavernas locais do bairro, «Damas». Ao fim da tarde — pôr do sol sobre o castelo.",
              "wikipedia": {
      ...
      "content": [
        {
          ...
          "items": [
            ...
            "🎵 À noite em Alfama — dezenas de tavernas locais com fado ao vivo (jantar + vinho ~35–50 €/pessoa)"
          ]
        }
      ]
    },
    {
      ...
      "content": [
        {
          "kind": "paragraph",
          "text": "Alfama é um dos poucos bairros que sobreviveram ao terramoto de 1755. O nome deriva do árabe «al-hamma» («fonte quente»). Antes da Reconquista era um bairro mourisco; mais tarde, um bairro de pescadores. Hoje é uma zona histórica protegida pela UNESCO, com uma arquitetura única, onde convivem becos estreitos, casas com varandas floridas e filas de azulejos."
        },
        {
          "kind": "wikiLink",
          "title": "Terramoto de 1755 — contexto do bairro",
          "urls": {
  ...
  "sources": [
    {
      "title": "Visit Lisboa — o que ver em Alfama",
    ...
    {
      "title": "Câmara Municipal de Lisboa — Património",
    ...
    {
      "title": "UNESCO — património imaterial: fado",
