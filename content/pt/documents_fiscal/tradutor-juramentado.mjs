export default {
  ...
  tldr: 'Em Portugal não existe um estatuto estatal único de «tradutor juramentado» como em Espanha ou na Alemanha. Para visto, AIMA, Conservatória e Finanças, normalmente é necessária uma tradução para português com certificação: por Notário, advogado/solicitador, Câmara de Comércio e Indústria Portuguesa ou no Consulado. Um pacote típico «certidão/certificado apostilado de 1–3 páginas + certificação» custa 55–120 €, urgente — 80–180 €.\n\nPrazo: 2–5 dias úteis, urgente 24–48 horas.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Consulado de Portugal no estrangeiro — pode certificar a tradução ou a assinatura, se o serviço estiver disponível',
          ...
          'Agência de tradução — é aceitável se organizar a certificação correcta, e não se limitar a colocar o seu carimbo'
        ] },
        { kind: 'warning', text: 'Um carimbo de «tradução certificada» de uma agência privada sem Notário/advogado/solicitador/Câmara/Consulado pode não ser aceite na AIMA ou na Conservatória. Antes de pagar, peça uma amostra do pacote final.' }
      ]
    },
    {
      id: 'when-needed',
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Comprovativos de rendimentos, pensão, tempo de serviço',
        ...
        { kind: 'paragraph', text: 'Para visto num consulado de Portugal fora do país, os requisitos podem diferir dos requisitos da AIMA dentro de Portugal. O consulado pode aceitar tradução para a língua do país de submissão ou para inglês, mas para a autorização de residência posterior na AIMA é mais seguro ter uma tradução certificada em português.' }
      ]
    },
    {
      id: 'apostille-first',
      ...
      content: [
        { kind: 'paragraph', text: 'Para documentos de países da Convenção da Haia, normalmente coloca-se primeiro a Apostila de Haia no país emissor e depois traduz-se todo o documento juntamente com a apostila. Se traduzir apenas o certificado principal sem a apostila, a AIMA ou a Conservatória pode pedir que seja refeito.' },
        { kind: 'checklist', items: [
          ...
          'Coloque a apostila no país emissor, se o documento se destinar a Portugal',
          ...
          'Peça para traduzirem selos, carimbos, anotações manuscritas e o QR/número da apostila',
          'Verifique a transliteração do nome: deve coincidir com o passaporte e com o registo na AIMA',
          'No final, receba a tradução + declaração/certificação + cópia do documento original, cosidas ou unidas num único pacote',
          'Para submissões online, guarde o PDF de todo o pacote, e não apenas o texto da tradução'
        ] },
        { kind: 'warning', text: 'Não plastifique os originais nem destaque a apostila. Se a apostila estiver anexada ao documento, todo o conjunto é traduzido como um único documento.' }
      ]
    },
    {
      id: 'where-to-find',
      title: 'Onde encontrar um tradutor e como verificar',
      content: [
        { kind: 'paragraph', text: 'Não procure apenas «tradutor de russo Portugal», mas sim um prestador que indique claramente de que forma certifica a tradução: Notário, advogado, solicitador, Câmara de Comércio e Indústria Portuguesa ou Consulado. Para a AIMA, a certificação correcta é mais importante do que um papel timbrado bonito.' },
        { kind: 'checklist', items: [
          ...
          'Peça que traduzam a partir do original/digitalização com apostila, e não a partir de uma fotografia incompleta',
          ...
          'Não pague 100% a uma pessoa particular desconhecida sem recibo/fatura ou contrato claro'
        ] },
        { kind: 'paragraph', text: 'A Câmara de Comércio e Indústria Portuguesa / CCIP é uma das vias claras para traduções certificadas em Lisboa. O serviço é pago; convém confirmar prazos e formato para a língua e o documento concretos.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'O mercado depende muito da língua. Russo, ucraniano, inglês e espanhol são normalmente mais baratos e rápidos; línguas raras são mais caras. A AIMA não fixa tarifas de tradutores — trata-se de um serviço privado acrescido de certificação notarial/jurídica.' },
        { kind: 'checklist', items: [
          ...
          'Urgência 24–48 horas: normalmente +30–100% sobre o preço',
        ...
        { kind: 'warning', text: 'Se o preço for «10 € por documento com certificação», confirme que não se trata de tradução automática com carimbo da agência. Um erro no nome, data de nascimento ou número de passaporte pode custar uma nova marcação na AIMA e meses de espera.' }
      ]
    },
    {
      id: 'final-check',
      ...
      content: [
        { kind: 'paragraph', text: 'Antes da submissão, verifique a tradução como documento jurídico. O funcionário da AIMA não tem obrigação de adivinhar que Ivanov/Ivanov/Ivanoff são a mesma pessoa se o pacote não coincidir com o passaporte.' },
        { kind: 'checklist', items: [
          ...
          'Existe assinatura do tradutor ou do requerente da tradução, certificada por pessoa competente',
          'Existem dados do Notário/advogado/solicitador/Câmara/Consulado',
          'A tradução e a cópia do documento original estão fisicamente unidas ou relacionam-se inequivocamente entre si',
          'O documento não expirou à data da submissão: sobretudo o certificado de registo criminal',
          'Você tem o PDF e o original em papel da tradução certificada'
        ] },
        { kind: 'paragraph', text: 'Se a AIMA pedir «tradução certificada», não discuta a terminologia «juramentado». Na prática, precisam de uma tradução certificada por um dos métodos reconhecidos.' }
      ]
    }
  ],
  costs: [
    { label: 'Tradução de 1 página de documento standard', amountEURMin: 20, amountEURMax: 45, note: 'Sem urgência; o preço depende da língua e da complexidade' },
    ...
    { label: 'Tradução urgente 24–48 horas', amountEURMin: 80, amountEURMax: 180, note: 'Normalmente inclui taxa de urgência e certificação' },
    { label: 'Certificação notarial/jurídica da tradução', amountEURMin: 20, amountEURMax: 40, note: 'Frequentemente calculada em separado da tradução; o IVA pode não estar incluído' }
  ],
  sources: [
    {
