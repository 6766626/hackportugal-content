export default {
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 't2', title: 'Seguro de Recheio (apenas para arrendatários)', content: [
            { kind: 'checklist', items: [
              'Os seus bens (móveis, equipamentos, objetos de valor)',
              ...
              'Recomendado se os seus equipamentos, no total, valerem mais de 3 000 €'
            ]}
          ]},
          { id: 't3', title: 'Seguro contra incêndio (obrigatório por lei)', content: [
            { kind: 'checklist', items: [
              ...
              'NÃO cobre o conteúdo interior da habitação (recheio) — para isso é necessário um multirriscos separado com recheio'
            ]}
          ]},
    ...
    {
      id: 'choose',
      title: '🎯 Como escolher a seguradora',
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'c3', title: 'O que verificar', content: [
            { kind: 'checklist', items: [
              ...
              '  - Joias > 5 000 € (avaliação separada, declaração)'
            ]}
          ]}
        ]}
      ]
        ...
        { kind: 'substeps', items: [
          ...
          { id: 's2', title: 'Documentos', content: [
            { kind: 'checklist', items: [
              ...
              'Recibos de reparações / compras do bem danificado',
              'Declaração do vizinho / síndico, se forem testemunhas'
            ]}
          ]},
          { id: 's3', title: 'Perito', content: [
            { kind: 'paragraph', text: 'A seguradora envia um perito em 3-7 dias. Recomenda-se estar em casa, mostrar tudo e discutir os detalhes. Pode chamar um perito independente (100-300 €), se a seguradora subavaliar os danos.' }
          ]},
  ...
  costs: [
    ...
    { label: 'Seguro de recheio (arrendatário)', amountEURMin: 50, amountEURMax: 150, note: '€/ano' },
    { label: 'Assistência domiciliária (extra)', amountEURMin: 10, amountEURMax: 30, note: '€/ano' },
    { label: 'Perito independente (avaliador)', amountEURMin: 100, amountEURMax: 300 }
  ],
  sources: [
