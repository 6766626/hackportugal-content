export default {
  ...
  tldr: 'Em Portugal, um litígio com o senhorio deve ser tratado por etapas: reclamação escrita → DECO/mediação → Julgados de Paz, se o valor for até 15 000 € e não se tratar de despejo → tribunal. O BNA não serve para “fazer queixa” do senhorio: é um canal eletrónico para o Procedimento Especial de Despejo, normalmente utilizado pelo senhorio para despejar o inquilino. Se recebeu uma notificação do BNA, os prazos são curtos: normalmente 15 dias para oposição; o melhor é falar imediatamente com um advogado.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'A caução não é devolvida — primeiro, exigência escrita; depois, DECO/mediação ou Julgados de Paz, se o valor for até 15 000 €.',
          'O senhorio não faz reparações urgentes — notificação escrita com prazo; depois, Julgados de Paz ou Tribunal Judicial; se houver risco para a saúde, também Câmara Municipal.',
          'Aumento ilegal da renda — verificar o contrato, o prazo, o índice de 2026 para a atualização anual normal: 2,16%; depois, oposição escrita.',
          'O senhorio entra sem autorização — proibição escrita; em caso de ameaças ou arrombamento, chame a PSP/GNR.',
          'Notificação de denúncia ou resolução do contrato — verifique a forma, o prazo e o fundamento; não saia apenas por causa de um pedido verbal.',
          'Recebeu uma carta do BNA ou de um agente de execução — isto já é um procedimento de despejo; os prazos são curtos, é necessária oposição através de jurista.',
          'O valor do litígio é superior a 15 000 € ou o litígio é complexo — normalmente Tribunal Judicial, não Julgados de Paz.',
          'O despejo enquanto pedido não é apreciado nos Julgados de Paz: para despejo utiliza-se o BNA ou o tribunal.'
        ] },
        { kind: 'warning', text: 'Não retenha a última renda “por conta da caução” sem verificação jurídica. Isto dá frequentemente ao senhorio um argumento formal de mora no pagamento.' }
      ]
    },
    {
      id: 'direct-letter',
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Quanto às reparações, indique separadamente se o defeito impede a habitação normal ou cria risco para a saúde.',
          ...
          'Guarde proof of delivery, capturas de ecrã e ficheiros enviados em PDF.'
        ] },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Calcule separadamente o valor do pedido: caução, despesas de reparação, renda cobrada em excesso, juros, danos.',
          'Peça à DECO que avalie se o litígio é adequado para os Julgados de Paz ou se é necessário Tribunal Judicial.',
          'Se o senhorio aceitar negociar, fixe o resultado por escrito: valor, prazo de pagamento, IBAN, data da reparação.'
        ] },
        { kind: 'warning', text: 'A DECO não substitui um advogado se já recebeu uma notificação do BNA, uma citação judicial ou uma carta de um agente de execução. Nestes casos, a mediação pode já ser tardia.' }
      ]
    },
    {
      id: 'julgados-de-paz',
      ...
      content: [
        { kind: 'paragraph', text: 'Os Julgados de Paz são “tribunais de paz” simplificados para pequenos litígios civis. Nos termos da Lei 78/2001, podem apreciar litígios de arrendamento urbano até 15 000 €, exceto as próprias ações de despejo. Casos típicos do inquilino: devolução da caução, pequenos danos, reparações não realizadas, litígios sobre pagamentos.' },
        { kind: 'checklist', items: [
          'Verifique a competência territorial: o Julgado de Paz deve servir o município onde se encontra o apartamento ou onde o requerido tem morada.',
          'O valor do pedido deve ser até 15 000 €.',
          'Um pedido de despejo não é apresentado aí — isso é BNA ou Tribunal Judicial.',
          'Normalmente, advogado não é obrigatório, mas é útil em litígios sobre a cessação do contrato ou valores elevados.',
          'O processo começa com um requerimento: quem é você, quem é o requerido, factos, valor, provas.',
          'Normalmente, é proposta primeiro a mediação; se não houver acordo, o processo segue para julgamento.',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'BNA — Balcão Nacional do Arrendamento. Não é um serviço de proteção de inquilinos, mas um canal eletrónico do Ministério da Justiça para o Procedimento Especial de Despejo. Normalmente é utilizado pelo senhorio quando pretende cessar o contrato e recuperar o imóvel: por exemplo, por falta de pagamento da renda, termo do contrato ou resolução válida.' },
        { kind: 'checklist', items: [
          'O BNA só é utilizado com fundamentos e documentos formais: contrato escrito, notificações, provas da dívida ou da cessação do contrato.',
          'Se o senhorio não registou o contrato nas Finanças, isso pode dificultar-lhe o procedimento, mas nem sempre “salva” o inquilino.',
          ...
          'A oposição deve ter fundamento jurídico: notificação incorreta, dívida já paga, valor errado, resolução inválida, incumprimento de prazos.',
          'Se for apresentada oposição, o processo passa normalmente para o Tribunal Judicial.',
        ...
        { kind: 'warning', text: 'O despejo de facto sem procedimento legal — mudança de fechaduras, corte de água/eletricidade, remoção de bens — é ilegal. Nessa situação, chame a PSP/GNR, recolha provas e contacte urgentemente um advogado.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Nos litígios de arrendamento, não ganha quem se queixa mais alto, mas quem tem uma pasta de provas organizada. Prepare-a antes da consulta: poupa dinheiro e reduz o risco de perder um prazo.' },
        { kind: 'checklist', items: [
          ...
          'Cronologia numa página: datas, eventos, valores, referências às provas.',
          'Cálculo do pedido em €: principal, juros, despesas, valores já pagos.'
        ] },
        { kind: 'paragraph', text: 'Se o litígio estiver relacionado com unsafe housing — bolor, risco elétrico, colapso, esgotos — também pode contactar a Câmara Municipal em paralelo. A vistoria municipal não substitui uma ação pecuniária, mas um relatório oficial reforça a sua posição.' }
      ]
    }
  ],
  costs: [
    ...
    { label: 'Consulta de advogado sobre arrendamento', amountEURMin: 60, amountEURMax: 150, note: 'Referência para uma primeira consulta; em Lisboa e em caso de BNA urgente pode ser mais caro.' },
    { label: 'Apoio judiciário', amountEUR: 0, note: 'Apoio jurídico gratuito ou parcialmente gratuito através da Segurança Social em caso de baixo rendimento; a decisão não é imediata.' }
  ],
  sources: [
