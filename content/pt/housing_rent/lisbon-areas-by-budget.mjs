export default {
  ...
  tldr: 'Em 2026, na Greater Lisbon não se escolhe apenas “Lisboa ou não”, mas sim a combinação orçamento + escola/escritório + transportes. Para uma pessoa: 900–1 300 €/mês — Almada, Amadora, Loures, Sintra; 1 300–1 800 € — Oeiras, Benfica, Telheiras; 1 800 €+ — centro de Lisboa/Cascais. Para uma família com criança, um T2/T3 exige normalmente um orçamento de 1 500–2 800 €/mês. Rendas: Lisboa 20–25 €/m², Oeiras 16–20 €/m², Cascais 18–24 €/m², Almada/Sintra/Loures 11–16 €/m².',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'Se o escritório fica em Saldanha/Marquês/Campo Pequeno — veja o metro de Lisboa, Oeiras pela Cascais line, Loures/Odivelas por metro/autocarro.',
          'Se o escritório fica no Parque das Nações — Moscavide, Olivais, Sacavém, Loures e a linha de Vila Franca são convenientes.',
          'Se o escritório fica em Oeiras/Lagoas Park/Taguspark — é melhor Oeiras, Carcavelos, Paço de Arcos, Massamá, Cacém; a partir do centro de Lisboa demora muitas vezes mais.',
          'Se a escola é internacional — verifique antecipadamente Cascais/Oeiras/Sintra: há mais escolas privadas e international schools, mas as rendas são mais altas.',
          'Se precisa de praia sem carro — Cascais line: Algés, Oeiras, Carcavelos, Parede, Cascais.',
          'Se o orçamento é mais importante do que a imagem — Almada, Seixal, Amadora, Sintra e Loures dão mais m² pelo mesmo dinheiro.',
          'Se não tem carro — escolha no máximo 10–12 minutos a pé até ao metro/CP/Fertagus; depender de autocarro piora muito o dia a dia.'
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'As referências abaixo são para arrendamento de longa duração sem despesas, com base em anúncios e negócios no mercado na primavera de 2026. Bons apartamentos desaparecem depressa; os senhorios pedem frequentemente 2 cauções + 1–2 meses adiantados e comprovativo de rendimentos.' },
        { kind: 'checklist', items: [
          'Até 1 000 €/mês: estúdio/T0 ou T1 pequeno na Amadora, Loures, Sintra, Margem Sul; em Lisboa é quase sempre um compromisso no estado do imóvel ou na zona.',
          ...
          '1 700–2 200 €/mês: T2 normal para casal ou família em Oeiras, Almada premium, Cascais longe do mar, anel exterior de Lisboa.',
          '2 200–3 000 €/mês: T2/T3 em Cascais/Oeiras/boas zonas de Lisboa; já é possível escolher escola, estacionamento e estado do imóvel.',
          '3 000 €+/mês: Cascais, Estoril, Chiado, Príncipe Real, Avenidas Novas, Parque das Nações, T3/T4 familiares com garagem.'
        ] },
        { kind: 'warning', text: 'Não planeie um orçamento “mesmo no limite”. À renda, acrescente 120–250 €/mês para electricidade/gás/água/internet para um casal e 200–350 €/mês para uma família, mais o condomínio, que por vezes está incluído e por vezes não.' }
      ]
    },
    {
      id: 'areas',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'single-couple', title: 'Uma pessoa ou casal sem filhos', content: [
            { kind: 'paragraph', text: 'O critério principal é o caminho até ao trabalho e a vida ao fim do dia. Se quer cidade: Avenidas Novas, Arroios, Anjos, Alameda, Campo de Ourique, Benfica. Se quer mais barato: Amadora, Damaia, Odivelas, Loures, Almada.' },
            { kind: 'checklist', items: [
              ...
              'Almada/Cacilhas: 12–16 €/m²; ferry/metro sul + vista para Lisboa, boa opção para o centro e Santos/Cais do Sodré.',
              'Amadora/Odivelas/Loures: 11–15 €/m²; prático, mas verifique a rua concreta à noite e os transportes.',
              'Sintra line: 10–14 €/m²; mais área, mas o commute pode facilmente passar para 45–70 minutos.'
            ] }
          ] },
          { id: 'family-kids', title: 'Família com criança', content: [
            { kind: 'paragraph', text: 'Para uma família, normalmente contam a escola, o parque, o estacionamento, o elevador, o ruído e a saúde. As zonas mais fáceis de entender: Oeiras, Carcavelos, Parede, Cascais, Benfica, Telheiras, Parque das Nações, Alfragide, algumas partes de Almada e Sintra.' },
            { kind: 'checklist', items: [
              'Oeiras: 16–20 €/m²; forte equilíbrio entre escolas, mar, parques, escritórios e Cascais line.',
              'Cascais/Estoril/Parede: 18–24 €/m²; mais caro, mas com escolas, praia, ambiente de expatriados e segurança.',
              'Benfica/Telheiras: 17–22 €/m²; familiar, metro/CP, parques, mais barato do que o centro.',
              'Parque das Nações: 20–25 €/m²; conveniente, moderno, mas um T3 com garagem fica frequentemente em 2 500 €+.',
              'Sintra: 10–14 €/m²; mais moradias e T3/T4, mas viver sem carro e perto do comboio é mais difícil.',
          ...
          { id: 'remote-workers', title: 'Trabalho remoto e digital nomad', content: [
            { kind: 'paragraph', text: 'Para trabalho remoto, importam mais a qualidade do apartamento, a internet, o ruído e o acesso ao aeroporto/centro 1–2 vezes por semana. Não pague a mais pelo centro se não vai lá todos os dias.' },
            { kind: 'checklist', items: [
              'Cascais: caro, mas confortável, mar, coworkings, ambiente anglófono.',
              'Oeiras/Carcavelos: compromisso preço/mar/comboio; bom para quem se desloca tanto a Lisboa como a Cascais.',
              ...
              'Sintra: bonita e mais barata por m², mas humidade, casas frias e commute são surpresas frequentes.',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Compare não a distância no mapa, mas o percurso door-to-door: a pé até à estação + espera + comboio/metro + transbordo + caminho desde a estação. Na hora de ponta, o carro perde muitas vezes para o comboio.' },
        { kind: 'checklist', items: [
          ...
          'Loures/Sacavém → Saldanha/Oriente: autocarro/comboio/metro 30–60 minutos, dependendo da morada.'
        ] },
        { kind: 'warning', text: 'Se o apartamento fica “a 15 minutos de Lisboa” — confirme: até que estação, a que hora e por que meio. Na A5, IC19, 2ª Circular e ponte 25 de Abril, 15 minutos transformam-se facilmente em 45–70.' }
      ]
    },
    {
      id: 'shortlist',
      title: 'Shortlist rápido por cenário',
      content: [
        { kind: 'checklist', items: [
          ...
          'Precisa de oceano: Cascais line ou Costa da Caparica; verifique a humidade, o aquecimento e o estacionamento.',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Em Portugal, corrigir um erro de zona sai caro: rescisão do contrato, nova caução, mudança, comissão de agência, escola. Antes da caução, faça um percurso-teste de manhã e outro ao fim do dia.' },
        { kind: 'checklist', items: [
          ...
          'Estacionamento: em Lisboa e Cascais, sem garagem, isto é um problema à parte; verifique EMEL/licenças municipais.',
          'Internet: confirme se existe fibra MEO/NOS/Vodafone na morada concreta, não apenas “na zona”.',
          'Supermercado, farmácia, Centro de Saúde, escola/infantário — a pé ou apenas de carro.',
        ...
        { kind: 'warning', text: 'Não transfira a caução apenas com base em vídeo e não acredite num preço “bom demais”. É normal pedir a Caderneta Predial, identificação do senhorio e draft contrato antes de pagar.' }
      ]
    }
  ],
  costs: [
    ...
    { label: 'T1/T2 em Almada/Sintra/Loures', amountEURMin: 900, amountEURMax: 1600, note: 'Mais m² pelo orçamento, mas o commute e o carro tornam-se determinantes.' }
  ],
  sources: [
