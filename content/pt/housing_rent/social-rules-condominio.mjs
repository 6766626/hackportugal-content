export default {
  ...
  title: 'Vida num prédio — vizinhos, ruído, queixas',
  tldr: 'Portugal é um país de protocolo quotidiano silencioso, mas há vizinhos de todo o tipo. Regras de ruído: Regulamento Geral do Ruído (DL 9/2007) — período nocturno **23:00-07:00**, diurno 07:00-20:00, entardecer 20:00-23:00 (definições padrão; os municípios podem acrescentar regras locais).\n\nOnde apresentar queixa: GNR/PSP (incidente pontual) → Câmara Municipal (infração persistente) → tribunal. Coimas por ruído: 200-2500 € para pessoa singular. Num condomínio, a assembleia geral aprova as regras internas; a assembleia realiza-se pelo menos 1 vez por ano. O Fundo Comum de Reserva é obrigatório.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'n2', title: 'O que conta como infração', content: [
            { kind: 'checklist', items: [
              'Música / televisão alta, audível nos apartamentos vizinhos durante o período nocturno (23:00-07:00)',
              'Festas com ruído durante o período nocturno',
              'Obras / reparações em horários proibidos (normalmente 9:00-19:00 seg-sex, 10:00-18:00 sáb, proibido dom e feriados)',
              'Gritos, discussões, choro de bebé (crianças — exceção razoável em tribunal)',
              'Cão a ladrar na varanda (o dono é responsável)',
              'Ruído de água no duche depois das 23:00 (mais raro, mas há queixas em edifícios antigos)',
        ...
        { kind: 'substeps', items: [
          { id: 'c1', title: 'Passo 1: Diálogo com o vizinho (recomendado)', content: [
            { kind: 'checklist', items: [
              ...
              'Explicar que o problema não é pessoal, mas de bem-estar comum',
              'Dar 1-2 semanas para haver reação',
              '📝 80% dos casos resolvem-se sem passos adicionais'
            ]}
          ]},
          ...
          { id: 'c3', title: 'Passo 3: GNR / PSP — chamar a polícia', content: [
            { kind: 'checklist', items: [
              'Para um problema **pontual** (festa ruidosa neste momento) — GNR (regiões) ou PSP (cidades)',
              '**112** — apenas se não houver outro número / agressão',
              'Número local da PSP / GNR — procure no Google "posto territorial + nome da zona"',
              'A polícia virá, pedirá para baixar o ruído — normalmente resolve no local',
          ...
          { id: 'c5', title: 'Passo 5: Tribunal', content: [
            { kind: 'checklist', items: [
              'Se tudo o resto falhar e houver dano (não consegue dormir, saúde)',
              ...
              'Raramente usado para ruído — mais frequente para obras / casos graves'
            ]}
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Em Portugal, a Lei 8/2022 regula a propriedade horizontal — cada prédio é um condomínio.' },
        { kind: 'substeps', items: [
          ...
          { id: 'cd2', title: 'Assembleia', content: [
            { kind: 'checklist', items: [
              ...
              'Votação: conforme o tamanho do apartamento (permilagens). 1 apartamento ≠ 1 voto',
              'As decisões são aprovadas por maioria das permilagens; algumas (grandes reparações) — 2/3',
              'Os proprietários-senhorios votam; os inquilinos — não'
            ]}
          ]},
          { id: 'cd3', title: 'Contribuições mensais', content: [
            { kind: 'checklist', items: [
              ...
              'Cobre: limpeza, luz das zonas comuns, manutenção dos elevadores, seguro do edifício, administração, Fundo Reserva',
              'O proprietário é obrigado a pagar, o inquilino — apenas se estiver indicado no contrato (mais frequentemente paga o proprietário)',
          ...
          { id: 'cd4', title: 'Infrações ao regulamento', content: [
            { kind: 'checklist', items: [
              ...
              'Alterações grandes no apartamento (derrubar paredes): aprovação pela assembleia',
              ...
              'Colunas, festas — geralmente proibidas depois das 22:00'
            ]}
          ]}
        ]}
      ]
    ...
    {
      id: 'rental-tenant',
      title: '🏠 Se você é inquilino — os seus direitos',
      content: [
        { kind: 'checklist', items: [
          '**Uso tranquilo**: Lei 6/2006 (NRAU) — o proprietário garante o gozo tranquilo',
          ...
          '**Obras nos vizinhos**: o proprietário deve avisar com 8 dias de antecedência sobre obras planeadas',
          '**Zonas comuns**: tem o direito de as usar em igualdade com os proprietários (jardim, piscina, etc.)',
          '**Assembleia**: não vota, mas pode estar presente e intervir',
          '⚠️ **Carregamento VE**: tem o direito de instalar no seu lugar de estacionamento (Lei 39/2021) — o proprietário não pode recusar, apenas impor condições'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '**O cão do vizinho ladra todo o dia** → Câmara Municipal + veterinário municipal (possível apreensão por motivos de bem-estar)',
          '**Vizinhos fumam na varanda, o fumo entra no seu apartamento** → não é uma infração direta (fumar numa varanda privada é permitido); mas se o condomínio o proibiu — coima',
          '**Obras por baixo de si duram há mais de 3 meses** → verificação das licenças no município, muitas vezes é ilegal',
          '**Hostel vizinho / arrendamento de curta duração — ruído constante** → AL (Alojamento Local) tem regras especiais; queixa na Câmara + ASAE; em algumas zonas (Bairro Alto, Baixa Lisbon) o AL é limitado',
          '**Infiltração pelo teto**: notificação escrita ao vizinho, depois condomínio, depois seguradora',
          '**Vizinho agressor**: PSP 112 em caso de ameaça física; Provedor de Justiça em conflito repetido'
        ]}
      ]
    }
  ],
