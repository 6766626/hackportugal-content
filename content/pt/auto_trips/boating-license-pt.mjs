export default {
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'Não confunda “saber conduzir uma embarcação” com “ter direito a ser skipper”. Em Portugal, a falta de uma Carta de navegador de recreio adequada numa fiscalização da AMN/Polícia Marítima pode resultar em coima e na proibição de continuar a saída.' }
      ]
    },
    {
      id: 'eu-recognition',
      ...
      content: [
        { kind: 'paragraph', text: 'Portugal reconhece documentos de governo de embarcações de recreio emitidos por Estados da UE/EEE, sem troca obrigatória por cartão português. Pode governar dentro dos direitos conferidos pela licença original: comprimento da embarcação, afastamento da costa, dia/noite, motor/vela, jet ski.' },
        { kind: 'checklist', items: [
          ...
          'Se a licença não estiver em PT/EN, é útil ter uma tradução ou International Certificate of Competence, se o seu país o emitir.',
          'Para empresas de aluguer no Algarve e em Cascais, muitas vezes não importa apenas a lei, mas também as regras do seguro: podem exigir ICC ou uma categoria específica.',
          'Licenças do UK após o Brexit não são “automaticamente UE”; confirme previamente junto da DGRM, Capitania ou empresa de charter.',
          'Documentos russos, ucranianos, israelitas, turcos e outros documentos não-UE não devem ser considerados automaticamente válidos: é necessária uma verificação separada de reconhecimento.'
        ] },
        { kind: 'warning', text: 'O reconhecimento automático de uma licença da UE não significa o direito automático de governar qualquer embarcação portuguesa. Se a sua licença alemã/francesa/polaca permitir apenas inland waters ou baixa potência, em Portugal continua dentro desses limites.' }
      ]
    },
    {
      id: 'how-to-get',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'choose-school', title: '1. Escolher uma escola certificada pela DGRM', content: [
            { kind: 'paragraph', text: 'Procure uma entidade formadora de navegadores de recreio registada na DGRM. Nas marinas de Cascais, Oeiras, Setúbal, Lagos, Vilamoura e Porto normalmente há escolas com cursos em PT e, por vezes, em EN.' }
          ] },
          { id: 'medical', title: '2. Obter um atestado médico', content: [
            { kind: 'paragraph', text: 'Para a admissão é necessário um atestado médico de aptidão física e psíquica, incluindo visão e audição. Normalmente é emitido pelo médico de família, numa clínica privada ou por um médico com quem a escola trabalha.' },
            { kind: 'checklist', items: [
              'Passaporte ou autorização de residência.',
              'NIF para a fatura e inscrição na escola.',
              'Óculos/lentes, se os utilizar.',
              'Informação sobre doenças crónicas e medicação.',
              'O atestado deve estar válido à data da submissão; a escola normalmente verifica o formato antes do exame.'
            ] }
          ] },
          { id: 'course', title: '3. Fazer a teoria e a prática', content: [
            { kind: 'paragraph', text: 'O curso abrange regras de abalroamento, sinais, luzes, rádio VHF, cartas, marés, meteorologia, segurança, man overboard, entrada/saída da marina, amarração e mecânica básica. Para Patrão de Costa acrescentam-se exercícios de navegação, traçado de rumo e trabalho com carta náutica.' }
          ] },
          { id: 'exam-card', title: '4. Passar no exame e aguardar o cartão', content: [
            { kind: 'paragraph', text: 'O exame decorre através de um sistema ligado à DGRM: teoria e, para as categorias em que é exigido, componente prática. Após aprovação, é emitida a Carta de navegador de recreio.\n\nO prazo de emissão depende da escola e da carga da DGRM; na prática, conte com algumas semanas.' }
          ] }
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'A escolha não depende de “prestígio”, mas do percurso real. Para alugar uma pequena embarcação a motor numa lagoa e fazer saídas curtas, Marinheiro pode ser suficiente. Para uma embarcação própria em Cascais/Algarve, é muitas vezes mais sensato ir logo para Patrão Local: dá mais liberdade e é melhor aceite por marinas e seguradoras. Patrão de Costa faz sentido se planear travessias mais longas ao longo da costa.' },
        { kind: 'checklist', items: [
          'Vai usar um pequeno barco apenas de dia e perto da costa — veja Marinheiro.',
          ...
          'Se houver VHF, EPIRB, jangada salva-vidas e outro equipamento a bordo, este deve corresponder à zona de navegação da embarcação, e não apenas à sua licença.',
          'Para transporte comercial, paid skipper, tours turísticos e charter with crew, a carta de recreio amadora não é suficiente — aplicam-se outros requisitos.'
        ] },
        { kind: 'warning', text: 'O erro mais comum de um proprietário expat: comprar uma embarcação orientando-se pela potência do motor e esquecer a zona de certificação da embarcação, o seguro, o mandatory safety equipment e os limites da licença. Numa fiscalização, a AMN olha para o conjunto completo.' }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Lista de safety equipment obrigatório para a zona de navegação: coletes salva-vidas, extintor, pirotecnia/sinais, âncora, vertedouro/bomba, luzes.',
          'Documentos de rádio e direito de utilização do VHF, se a estação de rádio estiver instalada e for utilizada.',
        ...
        { kind: 'warning', text: 'Álcool na água é uma má ideia jurídica e praticamente. A AMN pode mandar parar a embarcação, e a seguradora pode contestar o pagamento em caso de acidente se o skipper não estivesse em condições de governar em segurança.' }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Guarde uma cópia digital da licença, do seguro e do registo da embarcação no telefone, mas é melhor ter os originais a bordo.',
          'Depois de obter Marinheiro, pode subir de categoria através de novo curso e exame.',
          'Se fala mal português, procure uma escola com apoio em inglês; os termos oficiais continuarão, ainda assim, em PT.',
  ...
  costs: [
    ...
    { label: 'Curso Patrão Local', amountEURMin: 350, amountEURMax: 650, note: 'Escolha típica para o proprietário de uma pequena embarcação a motor em Cascais/Algarve.' },
