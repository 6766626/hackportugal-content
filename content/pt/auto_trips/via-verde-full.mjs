  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'A Via Verde Portugal é uma concessão Brisa / Ascendi / IP (Infraestruturas de Portugal). É o principal sistema de pagamento eletrónico de portagens: um pequeno dispositivo (identificador) no para-brisas, que debita automaticamente a portagem ao passar sob o pórtico sem parar.' },
        { kind: 'checklist', items: [
          ...
          'Funciona em Espanha (Bip&Drive) e França (TIS) com o mesmo dispositivo',
          'Tarifa específica para motociclos',
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'g2', title: 'B. Não residente / turista (Via Verde Visitors)', content: [
            { kind: 'paragraph', text: 'Tarifa especial para turistas. Pode ser obtida nos aeroportos de Lisboa/Porto/Faro ou em terminais CTT. A associação é feita a um cartão bancário. Pagamento de acordo com as passagens efetuadas, sem subscrição.' }
          ]},
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'As tarifas são atualizadas anualmente em 1 de janeiro. A tabela de preços atualizada está apenas em `viaverde.pt`.' }
      ]
    },
    {
      id: 'no-via-verde',
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'n2', title: 'B. Autoestradas clássicas (A1, A2, A5 — com cabines)', content: [
            { kind: 'paragraph', text: 'Pode pagar em numerário ou com cartão na cabine. Circule pela via com o sinal «Outras Vias». Não confunda com «Via Verde» (via verde) — essa é APENAS para quem tem dispositivo, caso contrário há coima.' }
          ]},
          { id: 'n3', title: 'C. Carro de aluguer', content: [
            { kind: 'paragraph', text: 'Todas as grandes empresas de rent-a-car (Europcar, Avis, Sixt, Goldcar, Drivalia) oferecem aluguer de Via Verde. Preço médio — 3–5 €/dia + valor das passagens. Nas antigas SCUT não convém recusar — caso contrário, a rent-a-car irá cobrar-lhe as coimas.' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🅿️ Pagamento de estacionamentos (EMEL Lisboa, SABA, Estrela do Norte)',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Classe do veículo incorreta → formulário de reclamação em `viaverde.pt` + fotografia do Documento Único Automóvel',
          'Débito duplicado → normalmente regularização automática em 5 dias',
          'Coima com identificador a funcionar corretamente → contestação através da AT Ascendi / Brisa',
          'Pórtico sem funcionar → no pórtico negro é feita uma fotografia emulada; contestar através de `portagens.ctt.pt`'
        ]},
