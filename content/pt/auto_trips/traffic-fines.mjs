export default {
  ...
  tldr: 'As multas da ANSR (Autoridade Nacional de Segurança Rodoviária) dividem-se em leves, graves e muito graves. O condutor tem 12 pontos no sistema «carta por pontos» — estes são retirados por infrações. Com 0 pontos — cassação do título.\n\nDefesa/contestação — no prazo de 15 dias úteis para o endereço/segundo o procedimento indicado na notificação.',
        ...
        { kind: 'substeps', items: [
          { id: 't1', title: 'Leve', content: [
            { kind: 'checklist', items: [
              ...
              'Exemplo: não utilização do cinto, pisar/atravessar linha contínua, não cedência de passagem a peão',
              'Sem perda de pontos'
            ]}
          ]},
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '💊 Drogas: muito grave, normalmente 500–2500 €, −5 pontos, inibição de 2 meses–2 anos; a responsabilidade criminal é possível se for comprovada a incapacidade de conduzir em segurança',
          '🚨 A recusa/esquiva à fiscalização ou o abandono do local de um acidente podem implicar consequências administrativas/criminais graves; não existe uma regra geral de «0 pontos imediatos»'
        ]}
      ]
    },
    {
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '⚖️ Pague apenas após decisão definitiva, se esta for desfavorável',
