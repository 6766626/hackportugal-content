export default {
  ...
  tldr: 'Licenciatura — 3 anos, mestrado — 2 anos, PhD (doutoramento) — 3–4 anos. Acesso — através do Concurso Nacional de Acesso (para residentes em Portugal) ou do Concurso Especial para Estudantes Internacionais (apenas para cidadãos fora da UE). Custos: residentes da UE pagam como os portugueses — 700–1400 €/ano em instituições públicas, não UE — 2000–7000 €/ano em instituições públicas, 3500–15000 €/ano em privadas. Instituições de topo: Universidade de Lisboa, Universidade do Porto, Universidade Nova de Lisboa, Universidade de Coimbra (5 no mundo no top 500). Erasmus+ — acesso completo. D4 Student Visa para cidadãos não UE.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '**Pós-graduação**: cursos curtos especializados (6–12 meses)'
        ]}
      ]
    },
    {
        ...
        { kind: 'substeps', items: [
          { id: 'a1', title: 'Cidadãos PT/UE/EEE/Suíça e alguns residentes non-EU (CNA)', content: [
            { kind: 'checklist', items: [
              ...
              'CNA also applies to non-EU residents com residência legal em Portugal **>2 anos consecutivos em 1 de janeiro do ano de candidatura** (sem contar o tempo apenas com student permit) ou com estatuto de igualdade',
              'Exames de acesso (Exames Nacionais) no 12.º ano — obrigatórios para o concurso',
              'Seriação por nota: nota do secundário + provas de ingresso (ponderações por curso na DGES)',
              'PT/EU em licenciatura pública: propina **até ~697 €/ano no máximo**',
              'Se tiver um diploma escolar estrangeiro — é necessária equivalência + realizar local exam'
            ]}
          ]},
          { id: 'a2', title: 'Cidadãos não UE', content: [
            { kind: 'checklist', items: [
              '**Concurso Especial para Estudantes Internacionais** (CEIE)',
              'Processo separado do CNA — cada universidade decide autonomamente',
              'Requisitos: diploma do ensino secundário, adequado para acesso ao ensino superior no país de origem + certificado de equivalência (1–3 meses para obter através da DGES)',
              'Frequentemente — exames de acesso próprios da universidade / portefólio / entrevista',
              'Prazos de candidatura: normalmente fevereiro–abril (para início em setembro)',
              'Propinas para não UE: 2000–7000 €/ano em instituições públicas, 3500–15000 € em privadas',
              '⚠️ Algumas faculdades de medicina e veterinária têm quota apenas para cidadãos portugueses/UE — cidadãos não UE não podem entrar'
            ]}
          ]},
          { id: 'a3', title: 'Maiores de 23 (para adultos)', content: [
            { kind: 'paragraph', text: 'Concurso separado para pessoas com mais de 23 anos sem diploma padrão. Testes próprios na universidade. Funciona para estrangeiros com experiência pré-universitária.' }
          ]},
          { id: 'a4', title: 'Transferência de outra universidade', content: [
            { kind: 'checklist', items: [
              ...
              'Os créditos ECTS são transferidos (se a instituição for acreditada)',
              'Processo: regresso ao ensino superior',
              'É preferível transferir-se para o 2.º ou 3.º ano numa instituição portuguesa'
            ]}
          ]}
        ]}
      ]
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'u3', title: 'Regiões', content: [
            { kind: 'checklist', items: [
              ...
              '**Universidade do Algarve** — ciências do mar, turismo',
        ...
        { kind: 'substeps', items: [
          { id: 'c1', title: 'Universidades públicas', content: [
            { kind: 'checklist', items: [
              ...
              '**Não UE (CEEI, Estudante Internacional)**: international propinas são definidas por cada universidade/curso — consulte o edital do curso específico',
          ...
          { id: 'c3', title: 'Despesas adicionais', content: [
            { kind: 'checklist', items: [
              '📚 Manuais: 100–300 €/semestre (pode comprar usados em grupos de Facebook)',
              ...
              '💳 Cartão Acedo (estudante): descontos em transportes, alimentação, bilhetes'
            ]}
          ]}
        ]}
      ]
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'b1', title: 'DGES — bolsas nacionais', content: [
            { kind: 'checklist', items: [
              'Para residentes em Portugal: o montante depende do rendimento e da tabela da DGES — confirme os valores atuais em dges.gov.pt e nos Serviços de Ação Social da sua instituição',
              'Candidatura: anualmente segundo o calendário da DGES após a colocação',
              'Através dos Serviços de Ação Social de cada universidade',
              'A condição de insuficiência económica é calculada através do rendimento per capita do agregado — confirme a fórmula em dges.gov.pt'
            ]}
          ]},
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Cursos de português para estrangeiros são gratuitos na maioria das instituições'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Prazo: 1–3 meses',
          'Visto → entrada → na AIMA para autorização de residência D4 (mais uma taxa AIMA separada — tabela em vigor desde 01.03.2026)',
          '**Após terminar**: pode pedir **autorização de residência para procura de trabalho ou criação de empresa** — normalmente até 12 meses (Lei 23/2007 art. 122). Este **não** é o mesmo procedimento que o visto para procura de trabalho externo de 120+60 dias',
          'Ou transição para D3 / D8 / D2 após obter contrato / abrir empresa',
          'Para nacionalidade: ao abrigo da lei em vigor não existe coeficiente 0,5 — os anos com título de residência de estudante válido contam normalmente como residência legal comum (Lei 37/81 art. 6). ⚠️ **Decreto AR 48/XVII promulgado pelo Presidente Seguro em 03.05.2026** — a reforma da Lei da Nacionalidade aguarda publicação no DRE; as regras podem mudar após a entrada em vigor'
        ]}
      ]
    }
  ],
