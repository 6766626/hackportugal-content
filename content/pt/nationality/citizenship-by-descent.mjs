export default {
  ...
  tldr: 'Existem vias directas para filhos de portugueses e para netos de portugueses. Para um neto, trata-se de nacionalidade por origem, formalizada por pedido/declaração no IRN/Conservatória, cumprindo as condições do art. 1 Lei 37/81 (incluindo conhecimento suficiente da língua portuguesa). Para bisnetos NÃO existe categoria directa: primeiro, o progenitor ou avô/avó deve obter a nacionalidade; depois, o requerente apresenta o pedido já como filho/neto. Caso contrário, restam as vias comuns (naturalização após residência legal).',
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'd2', title: 'Neto de cidadão português', content: [
            { kind: 'paragraph', text: 'Trata-se de nacionalidade por origem, mas NÃO é “automática”: é necessário apresentar uma declaração/pedido no IRN ou na Conservatória e cumprir as condições do art. 1.º Lei da Nacionalidade. Na prática, a prova-chave da ligação à comunidade portuguesa é o conhecimento suficiente da língua portuguesa, normalmente nível A2 (CIPLE ou equivalente reconhecido/dispensa). Apenas “ligações culturais” normalmente não são suficientes. Também são verificados fundamentos de exclusão criminais/de segurança.' }
          ]},
          { id: 'd3', title: 'Bisneto e gerações seguintes — NÃO existe via directa', content: [
            { kind: 'paragraph', text: 'Não existe categoria directa de “bisneto” na Lei 37/81. A sequência habitual: primeiro, a geração intermédia (progenitor ou avô/avó) obtém a nacionalidade; depois, o requerente verifica se pode apresentar o pedido como filho ou neto de cidadão português. Se não for possível construir a cadeia, restam as vias comuns, sobretudo a naturalização após 5 anos de residência legal (ao abrigo da nova lei, após a publicação do Decreto AR 48/XVII no DRE — 7 anos para CPLP/UE, 10 anos para os restantes).' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Certidão de nascimento do progenitor através de quem se confirma o parentesco',
          ...
          'Em determinados regimes de aquisição, o Ministério Público pode deduzir oposição (oposição) em caso de serviço militar voluntário a Estado estrangeiro ou exercício de funções públicas não técnicas para Estado estrangeiro — isto NÃO é uma checklist comum, mas é relevante em casos raros'
        ]},
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'p1', title: '1. Reunir a genealogia', content: [
            { kind: 'paragraph', text: 'Apostila/legalização de todas as certidões estrangeiras + tradução para português, devidamente certificada (notário em Portugal, consulado, advogado/solicitador ou outro meio aceite pelo IRN). Os registos portugueses procuram-se por local e período: Conservatória/IRN para registo civil, Arquivo Distrital para muitos registos antigos, Torre do Tombo para determinados fundos. É melhor começar pelo concelho/freguesia e ano exactos.' }
          ]},
  ...
  sources: [
    ...
    { title: 'Decreto-Lei n.º 26/2022 — reforço dos requisitos da via sefardita a partir de 01.09.2022 (alteração do Regulamento)', url: 'https://diariodarepublica.pt/dr/detalhe/decreto-lei/26-2022-180773692', kind: 'law', language: 'pt', lastRetrieved: '2026-05-17' },
