export default {
  ...
  tldr: 'Existem vias directas para filhos de portugueses e para netos de portugueses. Para um neto, trata-se de nacionalidade por origem, formalizada por pedido/declaração no IRN/Conservatória mediante o cumprimento das condições do art. 1 Lei 37/81 (incluindo conhecimento suficiente da língua portuguesa). Para bisnetos NÃO existe uma categoria directa: primeiro, o progenitor ou avô/avó deve obter a nacionalidade, após o que o requerente apresenta o pedido já como filho/neto. Caso contrário, restam as vias comuns (naturalização após residência legal).',
  ...
  steps: [
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'd2', title: 'Neto de cidadão português', content: [
            { kind: 'paragraph', text: 'Trata-se de nacionalidade por origem, mas NÃO é “automática”: é necessário apresentar uma declaração/pedido ao IRN ou à Conservatória e cumprir as condições do art. 1.º Lei da Nacionalidade.\n\nNa prática, a prova-chave de ligação à comunidade portuguesa é o conhecimento suficiente da língua portuguesa, normalmente nível A2 (CIPLE ou equivalente reconhecido/dispensa). Só “ligações culturais” normalmente não bastam. Também são verificados fundamentos de exclusão criminais/de segurança.' }
          ]},
          { id: 'd3', title: 'Bisneto e seguintes — NÃO existe via directa', content: [
            { kind: 'paragraph', text: 'Não existe uma categoria directa de “bisneto” na Lei 37/81. A sequência habitual: primeiro, a geração intermédia obtém a nacionalidade (progenitor ou avô/avó); depois, o requerente verifica se pode apresentar o pedido como filho ou neto de cidadão português. Se não for possível construir a cadeia — restam as vias comuns, sobretudo a naturalização após 5 anos de residência legal (pela nova lei, após publicação do Decreto AR 48/XVII no DRE — 7 anos para CPLP/EU, 10 anos para os restantes).' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Certidão de nascimento do requerente (forma completa, com apostilha/legalização e tradução)',
          ...
          'Confirmação da nacionalidade portuguesa do antepassado (assento de nascimento na Conservatória, Cartão de Cidadão, passaporte ou registo histórico)',
          ...
          'Certificados de registo criminal dos países de nacionalidade e dos países de residência após os 16 anos (com apostilha/legalização e tradução). A certidão do registo criminal portuguesa pode ser obtida pelo próprio IRN mediante autorização do requerente',
          ...
          'Em regimes específicos de aquisição, o Ministério Público pode opor-se (oposição) em caso de serviço militar voluntário a Estado estrangeiro ou exercício de funções públicas não técnicas para Estado estrangeiro — isto NÃO é uma checklist comum, mas é relevante em casos raros'
        ]},
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'p1', title: '1. Reunir a genealogia', content: [
            { kind: 'paragraph', text: 'Apostilha/legalização de todas as certidões estrangeiras + tradução para português, devidamente certificada (notário em Portugal, consulado, advogado/solicitador ou outro meio aceite pelo IRN).\n\nOs registos portugueses procuram-se por local e período: Conservatória/IRN para o registo civil, Arquivo Distrital para muitos registos antigos, Torre do Tombo para determinados fundos. É melhor começar pelo concelho/freguesia exactos e pelo ano.' }
          ]},
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'A via sefardita evoluiu em três etapas: (1) **Lei Orgânica n.º 1/2013** introduziu-a na Lei da Nacionalidade (detalização — Decreto-Lei 30-A/2015); (2) **Decreto-Lei n.º 26/2022** (01.09.2022) tornou o Regulamento mais rigoroso e exigiu provas de ligação a Portugal; (3) **Lei Orgânica n.º 1/2024 de 5 de março de 2024** (entrou em vigor em 01.04.2024) alterou materialmente a própria lei: introduziu a obrigatoriedade de **residência legal em Portugal ≥ 3 anos (consecutive ou interpolated)** + avaliação por comissão especial junto do Ministério da Justiça (investigadores + representantes das comunidades judaicas com estatuto de religious legal entity em PT).\n\nApós a 1/2024, a via sefardita “à distância” ficou, na prática, encerrada.' },
        { kind: 'paragraph', text: '**03.05.2026 o Presidente Seguro promulgou o Decreto AR 48/XVII** (após passagem pelo TC, renumerado a partir de 17/XVII) — a lei **revoga totalmente** a via sefardita, mesmo no formato actual com residência de 3 anos. Entra em vigor no dia seguinte ao da publicação no Diário da República; **publicada como **Lei Orgânica n.º 1/2026**, DR 18.05.2026, em vigor desde 19.05.2026**. O texto da lei contém uma disposição transitória — aos processos administrativos em tramitação à data da em vigor aplica-se a redacção anterior da Lei 37/81 (a proposta do PS de garantias transitórias mais amplas foi rejeitada). Seguro, no discurso de 03.05.2026, também pediu publicamente que os processos já apresentados fossem apreciados pelas regras antigas por razões de segurança jurídica.\n\nAté 19.05.2026, a via sefardita funciona tecnicamente no regime posterior à LO 1/2024 (residência ≥ 3 anos + comissão).' },
        { kind: 'warning', text: 'Se planeia apresentar o pedido — faça-o COM URGÊNCIA, antes da publicação do Decreto 48/XVII no DRE. A apresentação fixa o processo no regime antigo (disposição transitória da lei + pedido do Presidente ao IRN).\n\nApós a publicação, a nova lei eliminará completamente esta via para novos requerentes.' }
      ]
    }
  ],
  costs: [
    ...
    { label: 'Traduções + apostilhas', amountEURMin: 200, amountEURMax: 600 }
  ],
  timelineDaysMin: 180,
  timelineDaysMax: 720,
  sources: [
    ...
    { title: 'Decreto-Lei n.º 26/2022 — agravamento da via sefardita a partir de 01.09.2022 (alteração do Regulamento)', url: 'https://diariodarepublica.pt/dr/detalhe/decreto-lei/26-2022-180773692', kind: 'law', language: 'pt', lastRetrieved: '2026-05-17' },
