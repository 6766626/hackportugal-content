export default {
  ...
  changeSummary: 'Clarificado o estatuto da condenação criminal como presunção ilidível (art. 6.º n.º 14/15). Lei Orgânica n.º 1/2026 (em vigor desde 19.05.2026): o prazo mínimo de casamento / união de facto para pedir a nacionalidade MANTÉM-SE em 3 anos (art. 3 não alterado). A reforma endurece não o prazo, mas o regime de oposição: o prazo do Ministério Público para deduzir oposição passa de 1 ano para 2 anos, e a avaliação da «ligação efetiva» passa a ponderar língua/cultura/integração. A presunção de ausência de oposição continua a aplicar-se a partir de >6 anos de casamento/união ou havendo filhos comuns com nacionalidade portuguesa. Os procedimentos iniciados ANTES de 19.05.2026 continuam a reger-se pela versão anterior. 🔴 O Decreto 49/XVII conexo (perda da nacionalidade como pena criminal) — em 08.05.2026 o TC declarou-o inconstitucional por UNANIMIDADE; em 12.05.2026 o Presidente Seguro devolveu-o ao Parlamento; em 03.07.2026 o Parlamento rejeitou definitivamente o decreto (152–56) — a norma não passou a lei.',
  steps: [
    {
      id: 'universal',
