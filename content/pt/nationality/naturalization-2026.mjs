export default {
  ...
  tldr: 'Caminho padrão: residência legal 5 anos + conhecimento de português A2 + ausência de condenações. A «ligação a Portugal» oficialmente NÃO é requisito obrigatório (a lei não a menciona); o IRN pode avaliá-la em casos duvidosos, mas o próprio facto de 5 anos de residência legal já é considerado suficiente. Importante: no momento da entrega do pedido você ainda não tem o Cartão de Cidadão — só é emitido após obter a nacionalidade. Anexa-se o título de residência. **03.05.2026 o Presidente Seguro promulgou o Decreto AR 48/XVII** — reforma da Lei da Nacionalidade. Em 13.05.2026 a lei AINDA NÃO foi publicada no DRE (passaram 10 dias). Após a entrada em vigor: prazo de naturalização 7 anos para CPLP+UE / 10 anos para os restantes, o tempo de espera pela primeira autorização de residência deixa de contar, teste cultural obrigatório, limiar de antecedentes criminais reduzido de 5 para 3 anos de prisão. IMPORTANTE: o próprio texto da lei contém disposição transitória — aos procedimentos administrativos pendentes à data da entrada em vigor aplica-se a redação ANTERIOR da Lei 37/81 (a proposta do PS para garantias transitórias mais amplas foi rejeitada). O Decreto 49/XVII conexo (perda da nacionalidade como pena): em 08.05.2026 o TC declarou-o por UNANIMIDADE inconstitucional (violação dos princípios da igualdade e proporcionalidade; relatora Mariana Canotilho), em 12.05.2026 Seguro devolveu-o ao Parlamento; o PSD não confirmará, o Chega vai insistir.',
  ...
  changeSummary: '12.05.2026 o Presidente Seguro devolveu ao Parlamento o Decreto 49/XVII (perda da nacionalidade como pena) por inconstitucionalidade, após o TC ter declarado em 08.05.2026 por UNANIMIDADE inconstitucional (relatora Mariana Canotilho, violação dos princípios da igualdade e proporcionalidade). O PSD anunciou que não confirmará, o Chega vai insistir. O Decreto AR 48/XVII principal (reforma da Lei da Nacionalidade), promulgado em 03.05.2026, em 13.05.2026 AINDA NÃO foi publicado no DRE (10 dias desde a promulgação). O texto da lei contém disposição transitória: aos processos pendentes aplica-se a redação anterior da Lei 37/81.',
  variants: [
    {
      id: 'cplp',
