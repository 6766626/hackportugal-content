export default {
  ...
  categoryId: 'animals',
  title: 'Adotar um animal em Portugal — abrigos e processo',
  tldr: 'Em Portugal, a adoção num abrigo é gratuita ou tem uma contribuição simbólica (10-50 €) para cobrir a esterilização e o chip. Principais fontes: CRO municipais (Centro de Recolha Oficial), associações privadas (União Zoófila, ANIMAL, Bianca, CB), Animais de Rua (Lisboa), Casa dos Animais Lisboa. No site adopt.cao.pt há uma base nacional. A lei exige chip + registo no SIAC + seguro (para cães de raças perigosas). A esterilização está normalmente incluída.',
  tags: ['adoção', 'abrigo', 'cão', 'gato', 'cro', 'animal'],
  ...
  steps: [
        ...
        { kind: 'substeps', items: [
          { id: 'w1', title: 'Abrigos municipais (CRO)', content: [
            { kind: 'checklist', items: [
              ...
              '⚠️ Muitas vezes estão sobrelotados — os animais esperam muito tempo pela adoção'
            ]}
          ]},
          { id: 'w2', title: 'Associações privadas', content: [
            { kind: 'checklist', items: [
              ...
              '✅ Muitas vezes fazem avaliação e identificam problemas comportamentais antecipadamente'
            ]}
          ]},
          { id: 'w3', title: 'Plataformas de pesquisa', content: [
            { kind: 'checklist', items: [
              ...
              '📱 **Adopta Lisboa** — aplicação para adoção',
              '📱 **Pawsome** — aplicação económica para consultar animais'
            ]}
          ]},
          { id: 'w4', title: 'Achados ocasionais', content: [
            { kind: 'checklist', items: [
              '🚨 Animal sem dono na rua — ligar para o 112 (se estiver em perigo) ou para o CRO local',
              '⚖️ Animal encontrado — a lei exige tentar encontrar o dono (foto nas redes sociais, anúncio)',
              '🔢 Ler o chip em qualquer clínica veterinária (ID — pet-id.pt)',
              '⏰ Se em 30 dias o dono não for encontrado — pode adotar oficialmente'
            ]}
          ]}
        ]}
      ]
        ...
        { kind: 'substeps', items: [
          { id: 'p1', title: 'Passo 1 — Candidatura', content: [
            { kind: 'checklist', items: [
              ...
              '🆔 Cartão de Cidadão / autorização de residência + comprovativo de morada',
              '🏠 Descrição da habitação: apartamento/casa, dimensão, varanda, se animais são permitidos',
          ...
          { id: 'p2', title: 'Passo 2 — Visita e escolha', content: [
            { kind: 'checklist', items: [
              ...
              '⏰ Passeio de teste para cães (25-30 min a passear, observar o temperamento)',
              '🐱 Teste de contacto para gatos (interação, reação ao toque)',
          ...
          { id: 'p3', title: 'Passo 3 — Verificação da habitação (para cães)', content: [
            { kind: 'checklist', items: [
              '🏠 Muitos abrigos fazem uma verificação da habitação — um voluntário desloca-se ao local',
              '✅ Verifica: varanda/quintal seguro, ausência de janelas abertas, espaço para uma cama',
          ...
          { id: 'p4', title: 'Passo 4 — Contrato e recolha', content: [
            { kind: 'checklist', items: [
              '📜 Assinar o «Termo de Adoção» (contrato de adoção)',
              '💰 Pagar a taxa (se existir)',
              '📋 Receber os documentos: passaporte do animal, Caderneta Sanitária, cartão do chip',
              '🪪 O chip já está registado no SIAC em seu nome (ou é-lhe entregue para fazer a alteração de registo)',
          ...
          { id: 'p5', title: 'Passo 5 — Registo no SIAC', content: [
            { kind: 'checklist', items: [
              ...
              '📝 Transferência/alteração do titular no SIAC — dentro do prazo estabelecido (normalmente 15 dias após a entrega). Confirme se o CRO/associação trata disso de imediato ou se tem de ir ao veterinário',
              '🆔 NIF, Cartão de Cidadão, informação sobre o animal',
              '💰 Gratuito',
              '🚨 Sem alteração de registo = coima até 500 €'
            ]}
          ]}
        ]}
      ]
    ...
    {
      id: 'after',
      title: '🏠 Depois da adoção',
      content: [
        { kind: 'checklist', items: [
          '🎓 **Primeiros 30 dias de adaptação**: ambiente tranquilo, não receber muitos convidados, dê tempo',
          '🩺 Primeira consulta de rotina no veterinário (o seu, não o do abrigo) — 2 semanas após a adoção',
          ...
          '📸 Redes sociais: ajude o abrigo — publique fotos, recomende',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Decreto-Lei 315/2009, alterado pela Lei 110/2015; lista de raças potencialmente perigosas — Portaria 422/2004. Para a adoção são exigidas condições adicionais.' },
        { kind: 'checklist', items: [
          ...
          '⚠️ Mais difícil de adotar — os abrigos são exigentes',
  ...
  costs: [
    { label: 'Taxa de adoção', amountEURMin: 0, amountEURMax: 100 },
