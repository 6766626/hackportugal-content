export default {
  ...
  steps: [
    {
      id: 'register',
      title: '📝 Registo do cão — passos obrigatórios',
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'r2', title: '2. Licença Canina (licença municipal)', content: [
            { kind: 'checklist', items: [
          ...
          { id: 'r3', title: '3. Vacinações', content: [
            { kind: 'checklist', items: [
              'Raiva — obrigatória anualmente (confirmada pelo veterinário)',
              'Combinada (DHPPi+L) — recomendada anualmente',
              'Tosse do canil — para cães activos / cães que frequentam o groomer com frequência',
              'O veterinário também verifica o título de anticorpos à entrada a partir de países fora da UE'
            ]}
          ]}
        ]}
      ]
    ...
    {
      id: 'dangerous-breeds',
      title: '⚠️ Cão perigoso (categoria H) e potencialmente perigoso (categoria G)',
      content: [
        { kind: 'paragraph', text: 'O DL 315/2009 define «perigoso» e «potencialmente perigoso» — regras especiais de registo, seguro e maneio.' },
        { kind: 'substeps', items: [
          { id: 'd1', title: 'Cão potencialmente perigoso — lista de raças (categoria G)', content: [
            { kind: 'checklist', items: [
          ...
          { id: 'd4', title: 'Coimas', content: [
            { kind: 'checklist', items: [
              'Sem licença: 50-1 000 €',
              'Sem seguro: 500-3 000 €',
              'Sem açaime na rua: 500-1 500 €',
              'Ataque (mesmo sem consequências graves): 1 000-3 750 €',
              'Infracções repetidas: apreensão do cão, proibição de detenção durante 5 anos'
            ]}
          ]}
        ]}
      ]
    ...
    {
      id: 'abandoned',
      title: '🆘 O que fazer com um cão abandonado',
      content: [
        { kind: 'checklist', items: [
          'Telefonar para o canil municipal: cada município tem o seu',
          'Ou GNR SEPNA (polícia de protecção da natureza) 217 653 100 — para animais selvagens / casos potencialmente perigosos',
          'Ajuda: União Zoófila (Lisboa), SOS Animal, Associação Animais de Rua — ONG',
          'Em parques / em trilhos, cão sem acompanhante — comunicar ao SEPNA ou aos bombeiros',
          'Abandonar um cão em Portugal é crime, se for provada a intenção (até 3 anos de prisão segundo a Lei 69/2014)'
        ]}
      ]
    },
    {
    ...
    {
      id: 'lost-found',
      title: '🔍 Animal de companhia desaparecido',
      content: [
        { kind: 'checklist', items: [
          'Imediatamente: comunicar ao SIAC (siac.dgav.pt) — estado "desaparecido"',
          'Canil municipal — verificar a cada 2-3 dias (os cães são frequentemente levados para lá)',
          'Redes sociais: grupo de Facebook «Animais Perdidos» na sua região',
          'Afixar anúncios na zona — com fotografia, nome do animal, telefone (não revelar que há recompensa)',
          'Ao encontrar um cão de outra pessoa: fazer leitura do chip no veterinário (todas as clínicas veterinárias têm leitor)',
          'Não é permitido ficar com um cão encontrado — é furto perante a lei'
        ]}
      ]
    }
  ],
