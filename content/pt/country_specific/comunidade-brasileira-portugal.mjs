export default {
  ...
  tldr: 'Os brasileiros são a maior comunidade estrangeira em Portugal: em 2026, fala-se de mais de 500 000 residentes e de um círculo ainda maior de pessoas com nacionalidade portuguesa, estatuto CPLP ou a aguardar a AIMA. O principal ponto de entrada é a Casa do Brasil de Lisboa, a mais antiga associação brasileira de imigrantes. Em Lisboa, procure a rede em Arroios, Anjos, Intendente, Amadora, Odivelas e Sintra; no Porto — Bonfim, Campanhã, Paranhos, Gaia e Matosinhos.',
  ...
  costs: [
    ...
    { label: 'Serviços consulares do Brasil', amountEURMin: 0, amountEURMax: 120, note: 'Depende do serviço: passaporte, procuração, registo civil, CPF. Verifique a tabela de emolumentos no site do consulado específico.' },
