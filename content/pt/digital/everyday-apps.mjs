export default {
          ...
          "items": [
            {
              ...
              "content": [
                {
                  "kind": "paragraph",
                  "text": "CMD (Chave Móvel Digital) — assinatura electrónica do Estado. Sem ela, não funcionam: Portal AT, serviços online da AIMA, SNS 24, IRN, Segurança Social Direta. Activação: autenticacao.gov.pt → Aderir CMD → NIF + número de telefone português. Código SMS para cada operação."
                }
              ]
            },
            {
              ...
              "content": [
                {
                  ...
                  "items": [
                    ...
                    "Videochamada com profissional de saúde",
                    "Histórico electrónico de vacinas",
                    "Marcação no serviço de urgência ou Centro de Saúde",
                    "Teste para verificar sintomas"
                  ]
                }
              ]
            },
            ...
            },
            {
              ...
              "content": [
                {
                  "kind": "paragraph",
                  "text": "Portal único de todos os serviços públicos — alteração de morada, certificados, licenças. Mais de 500 serviços num só lugar. Utiliza CMD ou CC para assinatura."
                }
              ]
            },
            {
              "id": "g5",
              "title": "AIMA Renovações",
              "content": [
                {
                  "kind": "paragraph",
                  "text": "Portal para renovação da autorização de residência — portal-renovacoes.aima.gov.pt. Através da CMD. O principal local onde ficará o seu estatuto de imigração a partir de 2026."
                }
              ]
            }
          ]
      ...
      "content": [
        {
          ...
          "items": [
            ...
            {
              "id": "m2",
              "title": "Revolut / Wise / N26",
              "content": [
                {
                  "kind": "checklist",
                  "items": [
                    "**Revolut** (desde 2024 fornece IBAN português gratuitamente) — conta multimoeda, criptomoeda, acções",
                    "**Wise** (IBAN BE) — a melhor para transferências multimoeda, mais de 20 moedas",
            ...
            {
              "id": "m3",
              "title": "Banco do seu banco português",
              "content": [
                {
                  "kind": "paragraph",
                  "text": "ActivoBank, Millennium BCP, Caixa, Novobanco, Santander — todos têm aplicações. Transferências SEPA, controlo de cartões, extractos, depósitos. Os bancos portugueses não são os mais práticos, mas são necessários."
                }
              ]
            }
          ]
      ...
      "content": [
        {
          "kind": "checklist",
          "items": [
            "**Continente Siga** — cartão digital, cupões, scanner de preços na loja",
            "**Pingo Doce** — semelhante",
            "**Lidl Plus** — raspadinhas, catálogos de promoções, cupões",
            "**Folhetos.pt** — agregador dos descontos semanais de todas as cadeias",
            "**Too Good To Go** — comida com desconto de lojas/restaurantes no fim do dia (pode poupar 50-70%)",
            "**Glovo** — entrega de comida, produtos alimentares, artigos",
      ...
      "content": [
        {
          "kind": "checklist",
          "items": [
            "**CTT** — acompanhamento de encomendas, marcação numa estação, desalfandegamento online",
  ...
  "sources": [
    ...
    {
      "title": "SNS 24 — aplicação e portal",
    ...
    {
      "title": "Portal das Finanças — aplicação AT",
    ...
    {
      "title": "ePortugal — portal único de serviços públicos",
