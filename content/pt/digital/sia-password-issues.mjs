export default {
  ...
  tldr: 'Se se esqueceu da palavra-passe da AT (Portal das Finanças / SIA): através de portaldasfinancas.gov.pt → «Recuperar Senha» → SMS ou carta por correio (5-7 dias). Alternativa: presencialmente num Espaço Cidadão ou num serviço de Finanças. Com CMD (Chave Móvel Digital) pode iniciar sessão SEM palavra-passe. Para repor a CMD — ePortugal.gov.pt → reemissão de códigos de utilização única. Se perdeu tudo — Conservatória/Espaço Cidadão com CC.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'O cenário mais comum. A AT (Autoridade Tributária) utiliza a «Senha de Acesso» — uma palavra-passe de 8 dígitos para entrar no Portal das Finanças.' },
        { kind: 'substeps', items: [
          { id: 'p1', title: 'Método 1 — SMS (rápido, se tiver o número)', content: [
            { kind: 'checklist', items: [
              ...
              '⚠️ Se o SMS não chegar — o número de telemóvel não está registado na AT'
            ]}
          ]},
          { id: 'p2', title: 'Método 2 — por correio (se não tiver número de telemóvel na AT)', content: [
            { kind: 'checklist', items: [
              '🌐 No mesmo local → escolher a opção «Por carta»',
              '📮 A carta chegará à morada oficial da AT (a que consta no Portal das Finanças)',
              '⏱️ 5-7 dias úteis',
              '⚠️ Se a morada estiver desactualizada — a carta não chegará. Primeiro, actualize a morada presencialmente num serviço de Finanças'
            ]}
          ]},
          { id: 'p3', title: 'Método 3 — presencialmente num serviço de Finanças', content: [
            { kind: 'checklist', items: [
              ...
              '🔐 Receber uma palavra-passe temporária em papel e alterá-la após o primeiro início de sessão',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'A CMD é a «chave única» do Estado para entrar em todos os serviços públicos. Esquecer o código = ter de aguardar pela recuperação.' },
        { kind: 'substeps', items: [
          { id: 'c1', title: 'Formas de entrada através da CMD', content: [
            { kind: 'checklist', items: [
              ...
              '⚠️ Se os SMS não chegarem — o telefone não está associado ou não funciona em roaming'
            ]}
          ]},
          { id: 'c2', title: 'Reposição do PIN ou substituição do telefone', content: [
            { kind: 'checklist', items: [
              '🌐 ePortugal.gov.pt → «Chave Móvel Digital» → «Recuperar PIN»',
              '🆔 Autenticação através de CC + código PIN do CC (não CMD!)',
              '🔢 Criar um novo PIN',
          ...
          { id: 'c3', title: 'Recuperação completa da CMD (se perdeu tudo)', content: [
            { kind: 'checklist', items: [
              ...
              '🔄 A CMD antiga é desactivada e é emitida uma nova'
            ]}
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          '📤 **Repor completamente** (se o PIN foi esquecido e bloqueado): Loja CC, cerca de 10 €, no dia da visita',
          '⚠️ A carta de códigos («carta de PINs») — chega quando o CC é emitido. Guarde-a!',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '🔴 «Não há número de telemóvel associado ao NIF» — o número de telemóvel não está associado. Presencialmente num serviço de Finanças',
          ...
          '🔴 «A carta não chegou» — contactar o serviço de Finanças local, farão a reemissão',
          '🔴 «A aplicação CMD não funciona em roaming» — o telefone deve estar em PT para receber SMS',
          '🔴 «O iPhone Face ID não reconhece a CMD» — actualizar a aplicação autenticacao.gov.pt',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '🔐 Utilizar um gestor de palavras-passe (1Password, Bitwarden) — assim não se esquece',
          ...
          '💼 Se tiver uma empresa/Lda: um representante (advogado) pode actuar em seu nome com procuração',
          '⏰ Prevenção: verificar a morada e o número de telemóvel no Portal das Finanças a cada 6 meses',
  ...
  costs: [
    ...
    { label: 'Reposição completa do PIN do CC', amountEURMin: 10, amountEURMax: 15 }
  ],
  sources: [
