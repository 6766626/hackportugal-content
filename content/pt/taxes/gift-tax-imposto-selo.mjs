  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'O Imposto do Selo aplica-se a transmissões gratuitas — transferências gratuitas de património: dinheiro, imóveis, quotas, valores mobiliários, automóveis, direitos de crédito e outros ativos. O imposto é pago por quem recebe o presente, não por quem o oferece.' },
        ...
        { kind: 'checklist', items: [
          ...
          'Presentes sociais normais de pequeno valor geralmente não são um problema fiscal prático, mas é melhor documentar valores elevados.',
          'Normalmente não se paga IRS sobre um presente: não é salário nem rendimento de atividade empresarial, mas o Imposto do Selo é um imposto separado.'
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'A taxa base para transmissões gratuitas é de 10% pela verba 1.2 Tabela Geral do Imposto do Selo. A matéria coletável é normalmente igual ao valor do ativo oferecido.' },
        { kind: 'paragraph', text: 'Se for doado um imóvel em Portugal, aplica-se separadamente 0,8% pela verba 1.1 sobre a transmissão do direito de propriedade. Por isso, para um beneficiário não isento, a doação de um imóvel gera normalmente uma carga total de 10,8%: 10% + 0,8%.' },
        { kind: 'checklist', items: [
          'Presente de 30 000 € de um amigo: referência — 3 000 € de Imposto do Selo.',
          'Presente de 30 000 € de um progenitor a um filho: os 10% não são pagos, mas pode haver obrigação declarativa.',
          'Apartamento de 300 000 € de um irmão: referência — 30 000 € pelos 10% + 2 400 € pelos 0,8%.',
          'Apartamento de 300 000 € de um progenitor a um filho: isenção dos 10%, mas os 0,8% normalmente mantêm-se — 2 400 €.',
          ...
          'O pagamento do imposto é normalmente necessário antes do registo/formalização do ato, se a doação for realizada perante notário, solicitador ou advogado.'
        ] },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'A isenção refere-se aos 10% pela verba 1.2, mas nem sempre elimina os 0,8% no caso de imóveis.'
        ] },
        { kind: 'warning', text: 'Para expatriados, a prova do parentesco é crítica: certidões de nascimento/casamento, apostille/legalização, tradução se necessário. As Finanças e o notário não são obrigados a aceitar uma “explicação por carta” se a cadeia de parentesco não estiver documentada.' }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Indique quem oferece — doador — e o grau de parentesco.',
          ...
          'Se houver isenção, assinale o fundamento: cônjuge/unido de facto, ascendente ou descendente.',
          'Guarde o comprovativo de entrega e eventual nota de liquidação.'
        ] },
        { kind: 'warning', text: 'Se a submissão online falhar devido a um documento estrangeiro, campo em falta ou ativo complexo, dirija-se ao Serviço de Finanças da área do seu domicílio fiscal. Não espere pelo fim do prazo: a coima por falhar a declaração pode ser mais cara do que a deslocação.' }
      ]
    },
    {
      id: 'cross-border',
      title: 'Transferências internacionais: o que é importante para expatriados',
      content: [
        { kind: 'paragraph', text: 'O Imposto do Selo português está ligado à jurisdição fiscal portuguesa: localização do ativo, formalização do negócio, contas/direitos portugueses e outras ligações a Portugal. Se os pais de outro país transferirem dinheiro para a sua conta em Portugal, o banco pode pedir a origem dos fundos, e as Finanças podem interessar-se pela natureza da entrada.' },
        { kind: 'checklist', items: [
          ...
          'Guarde os extratos bancários do remetente e do beneficiário.',
          'Para pais/filhos, anexe certidões de nascimento com apostilha e tradução, se necessário.',
          'Não chame “loan” a um presente se não houver empréstimo: mais tarde, o banco ou as Finanças podem pedir o contrato e o plano de reembolso.',
          'Se o dinheiro se destinar à compra de imóvel, o notário e o banco quase certamente pedirão a origem dos fundos.',
          'Verifique as consequências fiscais no país do doador: Portugal pode isentar, mas outro país pode não o fazer.'
        ] },
        { kind: 'warning', text: '“É um presente da minha mãe do estrangeiro, por isso em Portugal não é preciso nada” — é uma simplificação perigosa. Para família próxima, muitas vezes não há 10%, mas a declaração para valores acima de 5 000 € e os documentos sobre a origem dos fundos continuam a ser importantes.' }
      ]
    },
    {
      id: 'common-mistakes',
      title: 'Erros comuns e esquema seguro',
      content: [
        { kind: 'checklist', items: [
          'Erro: um irmão oferece dinheiro e o beneficiário considera-o “close family” para efeitos de isenção. Para Imposto do Selo, o irmão não integra a linha direta isenta.',
          'Erro: formalizar um presente elevado como “empréstimo privado”, mas sem contrato, juros e reembolso.',
          'Erro: não declarar um presente dos pais acima de 5 000 €, porque o imposto é 0 €.',
          'Erro: esquecer os 0,8% numa doação de imóvel, mesmo dentro da família em linha direta.',
          'Erro: fazer várias transferências fracionadas para parecer ficar abaixo do limiar. Isso pode parecer pior do que uma operação única e transparente.',
          'Erro: não traduzir nem legalizar documentos estrangeiros de parentesco antes da operação.',
          'Erro: misturar presente com pagamento de serviços. Se for remuneração por trabalho, já é um risco de IRS/IVA/NISS, não um presente familiar.'
        ] },
        { kind: 'paragraph', text: 'Esquema seguro para um presente familiar elevado em 2026: declaração de doação curta, transferência bancária com descrição clara, documentos de parentesco, verificação da obrigação de Modelo 1 IS, conservação dos comprovativos durante pelo menos vários anos. Para imóveis — notário/advogado antes da assinatura, cálculo dos 0,8% e registo na Conservatória.' }
      ]
    }
  ],
  sources: [
