  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Para despesas de 2025, a data-chave é 25 de fevereiro de 2026: até essa data deve confirmar as faturas pendentes, atribuir a categoria e corrigir erros. A declaração de IRS de 2025 é entregue de 1 de abril a 30 de junho de 2026.' },
    ...
    {
      id: 'validate',
      title: 'Validação até 25 de fevereiro: em que clicar',
      content: [
        { kind: 'substeps', items: [
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Os vendedores normalmente comunicam as faturas até ao dia 5 do mês seguinte, mas podem existir atrasos. Se em fevereiro a fatura não aparecer, pode registá-la manualmente através de “Registar Faturas”, mas guarde o original: as Finanças podem pedir comprovativo.' },
        { kind: 'checklist', items: [
          ...
          'Depois de 25 de fevereiro, as correções são mais difíceis: parte dos dados pode ser contestada mais tarde durante o período de reclamação, mas é melhor não contar com isso.'
        ] },
