export default {
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Se houver risco para a vida, a saúde, bens ou a segurança pública — não procure o número do quartel local. Ligue 112. O operador determinará quem enviar: Bombeiros, INEM, PSP, GNR, Proteção Civil ou vários serviços ao mesmo tempo.' },
        { kind: 'checklist', items: [
          ...
          'Depois da chamada, mantenha o telefone disponível: a equipa pode voltar a ligar'
        ] },
        { kind: 'warning', text: 'Não transporte no seu carro uma pessoa com sinais de AVC, enfarte, traumatismo grave ou perda de consciência, se for possível ligar 112. O transporte por conta própria pode fazer perder tempo e privar o doente de assistência precoce.' }
      ]
    },
    {
      id: 'what-is-free',
      ...
      content: [
        { kind: 'paragraph', text: 'As operações de emergência através do 112 para a população não são pagas no local: combate a incêndios, salvamento, intervenção em acidente rodoviário, assistência médica urgente, evacuação quando há ameaça à vida. Não lhe devem cobrar pelo facto de os bombeiros terem chegado por causa de uma emergência real.' },
        { kind: 'paragraph', text: 'Normalmente são pagos os serviços sem carácter urgente: transporte de doentes não-urgente, acompanhamento médico de eventos, presença de viatura de bombeiros num evento privado, apoio preventivo de segurança, alguns serviços técnicos a pedido.' },
        { kind: 'checklist', items: [
          'Gratuito: incêndio, acidente rodoviário, salvamento, assistência médica urgente através do 112',
          'Gratuito: evacuação em caso de cheia, derrocada, incêndio florestal por decisão da Proteção Civil',
          ...
          'Pago: piquete de bombeiros num evento, se exigido pela Câmara Municipal ou pela licença',
          'Pago: serviços a pedido não relacionados com perigo imediato',
          'Pode ser pago pelo SNS: transporte médico não urgente por prescrição médica e mediante cumprimento dos critérios do SNS'
        ] },
        { kind: 'warning', text: 'Se a situação estiver no limite, ligue 112 na mesma. Não tente decidir antecipadamente se é “urgente o suficiente”. Errar por chamar os serviços de emergência é mais seguro do que atrasar a resposta em caso de AVC, incêndio ou fuga de gás.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'O transporte não urgente é quando o doente precisa de transporte sentado, deitado ou com acompanhamento, mas não existe ameaça imediata à vida.\n\nPor exemplo: deslocação para hemodiálise, fisioterapia, exame, alta hospitalar para casa, transporte de uma pessoa idosa entre casa e a clínica.' },
        { kind: 'substeps', items: [
          ...
          { id: 'confirm-price', title: '3. Confirme o preço antes da viagem', content: [
            { kind: 'paragraph', text: 'Uma referência típica para pagamento particular em 2026 é 40–80 € por uma deslocação local, mas a tarifa depende da distância, espera, maca, oxigénio, horário noturno e regras da associação concreta.' }
          ] }
        ] },
        { kind: 'checklist', items: [
          'NIF do doente para recibo/fatura',
          'Número de utente, se a deslocação estiver ligada ao SNS',
          'Morada com andar, código da porta e com elevador/sem elevador',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Para um concerto, corrida desportiva, feira, evento empresarial ou filmagem, a Câmara Municipal, a PSP/GNR ou a licença do evento podem exigir plano de segurança, equipa de socorro ou viatura dos bombeiros no local. Isto não é 112, mas sim um serviço contratado.' },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Numa situação de emergência, fale de forma breve. A morada e o tipo de ocorrência são mais importantes do que a gramática perfeita.' },
        { kind: 'checklist', items: [
        ...
        { kind: 'warning', text: 'Uma chamada falsa para os serviços de emergência pode implicar responsabilidade. Mas uma chamada de boa-fé perante um receio real pela vida, incêndio, gás ou acidente rodoviário é uma atitude normal e correta.' }
      ]
    }
  ],
  costs: [
    ...
    { label: 'Transporte de doentes não-urgente', amountEURMin: 40, amountEURMax: 80, note: 'Referência para uma deslocação particular local em 2026; a tarifa exata é definida pela associação/corporação local.' },
    { label: 'Piquete médico ou de bombeiros num evento', amountEURMin: 0, amountEURMax: 0, note: 'Preço apenas por orçamento: depende das horas, risco, viaturas, pessoal e requisitos da Câmara Municipal.' }
  ],
  sources: [
