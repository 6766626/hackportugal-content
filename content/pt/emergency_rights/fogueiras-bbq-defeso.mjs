export default {
  ...
  title: 'Fogo, grelhador, fogo-de-artifício no verão — período crítico e coimas',
  tldr: 'De 1 de julho a 30 de setembro, está em vigor em Portugal o período crítico (período de maior perigo de incêndio).\n\nQualquer fogo aberto fora de locais especialmente equipados é proibido: grelhadores no quintal, fogo-de-artifício, fogueiras, queima de lixo e de sobrantes vegetais. Coimas para pessoas singulares: 280-10 000 €. Se o seu fogo provocar um incêndio florestal — responsabilidade criminal até 5 anos de prisão. Quando é permitido: a) em zonas municipais de piquenique com grelhadores (Parques de Merendas com autorização), b) em lareiras dentro de restaurantes, c) em casa — numa cozinha devidamente equipada. O fogo-de-artifício exige uma licença separada da Câmara Municipal durante todo o ano. Importante: mesmo no inverno, a queima de sobrantes vegetais exige licença.',
  tags: ['fogueira', 'churrasco', 'incêndio', 'período-crítico', 'icnf'],
  estimatedReadMinutes: 5,
  steps: [
    {
      id: 'periodo-critico',
      title: 'Período crítico — o que é e quando',
      content: [
        { kind: 'paragraph', text: 'Período crítico é o período oficial de maior perigo de incêndio. É declarado anualmente pelo ICNF (Instituto da Conservação da Natureza e das Florestas de Portugal) e pelo MAI. Normalmente decorre de 1 de julho a 30 de setembro, mas em anos de seca pode ser prolongado até 15 de outubro.' },
        { kind: 'checklist', items: [
          'Lei: Decreto-Lei 124/2006 (Sistema Nacional de Defesa da Floresta contra Incêndios)',
          'Restrições adicionais em dias de nível de perigo vermelho/laranja (estado de alerta especial nível vermelho/laranja) — IPMA (serviço meteorológico) + ICNF',
          'Atualizações diárias no site do ICNF e na aplicação do IPMA — normalmente até às 9:00',
    ...
    {
      id: 'what-banned',
      title: 'O que é proibido no período crítico',
      content: [
        { kind: 'checklist', items: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'Um grelhador a gás ou elétrico no seu terraço não é automaticamente legal. Em Cascais, Sintra, Mafra e Odemira existem regras locais que proíbem qualquer «churrasco» ao ar livre no período crítico, exceto em zonas municipais especialmente equipadas.' }
      ]
    },
    {
      id: 'fines',
      ...
      content: [
        { kind: 'checklist', items: [
          'Fogueira/grelhador na natureza no período crítico (pessoa singular): 280-10 000 €',
          'Fogueira na natureza em caso de nível de perigo vermelho: 1 500-10 000 € + responsabilidade criminal',
          'Fogo-de-artifício no período crítico: 1 500-3 000 €',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'No período crítico, em regra, as licenças não são emitidas',
          'Casamento/festa em agosto com fogo-de-artifício — não é permitido. Em outubro, após o fim do período crítico — é possível com licença',
          'Categorias F3/F4 — apenas para empresas licenciadas, não para particulares',
          'Sem licença: 1 000-3 000 € + apreensão'
        ] },
        { kind: 'paragraph', text: 'Onde comprar F1/F2: quiosques de tabaco, lojas especializadas, supermercados antes do Ano Novo e do Carnaval. As estrelinhas são permitidas apenas em espaços interiores e com medidas de segurança contra incêndio; na rua, durante o período crítico — não são permitidas.' }
      ]
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'Queima (queima em amontoado): em zonas rurais exige licença da Câmara Municipal durante todo o ano',
          'Queimada (fogo controlado num campo): exige licença e a presença de uma equipa de bombeiros',
          'No período crítico — quase sempre proibida, exceto em operações de emergência para prevenção de incêndios',
          'No âmbito do Sistema de Gestão Integrada de Fogos Rurais existem programas especiais',
          'Pedido: online através de autoriza.pt ou na Junta de Freguesia (freguesia/conselho local)',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'No inverno (outubro—junho), um grelhador doméstico no terraço é normalmente permitido, desde que sejam cumpridas as medidas de segurança',
  ...
  sources: [
    ...
    { title: 'autoriza.pt — licenças de queima online', url: 'https://autoriza.pt', kind: 'official', language: 'pt', lastRetrieved: '2026-05-03' },
