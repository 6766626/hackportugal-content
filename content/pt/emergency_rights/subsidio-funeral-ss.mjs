export default {
  ...
  tldr: 'O Subsídio de Funeral é uma prestação única da Segurança Social para cobrir parte das despesas de funeral: em 2026, o valor padrão é 219,96 €. O pedido deve ser apresentado no prazo de 6 meses após o óbito, através da Segurança Social Direta / gov.pt ou num balcão da Segurança Social. Para cônjuge, filhos, pais e outros familiares em linha reta, não é uma prova de insuficiência económica: importam o parentesco, o facto de ter pago o funeral e o estatuto da pessoa falecida como beneficiário da Segurança Social.',
  tags: ['funeral', 'segurança-social', 'subsídio', 'niss'],
  estimatedReadMinutes: 5,
  steps: [
    {
      id: 'what-it-is',
      title: 'O que é esta prestação',
      content: [
        { kind: 'paragraph', text: 'O Subsídio de Funeral não é uma compensação pelo custo total do funeral, mas sim um apoio único e fixo da Segurança Social. Em abril de 2026, o valor indicado na página oficial da Segurança Social é 219,96 €.' },
        { kind: 'paragraph', text: 'Normalmente, é pedido pela pessoa que pagou o funeral da pessoa falecida beneficiário da Segurança Social: cônjuge/parceiro em união de facto, filho, pai/mãe ou outro familiar em linha reta. Para estes familiares próximos, a prestação não é means-tested: a Segurança Social não avalia o seu rendimento como condição de acesso.' },
        { kind: 'warning', text: 'Não confunda com o subsídio por morte nem com o reembolso de despesas de funeral. O subsídio por morte é uma prestação separada, de valor mais elevado, paga aos familiares sobrevivos em caso de morte de uma pessoa segurada/pensionista. O reembolso de despesas de funeral aplica-se noutros cenários e depende das despesas efetivas. Se tiver dúvidas, faça o pedido através do serviço gov.pt/Segurança Social: o sistema e o funcionário encaminharão para o formulário correto.' }
      ]
    },
    {
      id: 'who-can-apply',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Assento de óbito / certidão de óbito ou outro documento oficial comprovativo do óbito.',
          'Fatura e recibo da agência funerária: idealmente com o NIF do requerente e os dados da pessoa falecida.',
          ...
          'Se atuar através de representante: procuração e documento de identificação do representante.',
          'Se os documentos não forem portugueses: tradução e, quando exigido, apostila / legalização.'
        ] },
        { kind: 'warning', text: 'O erro principal é a fatura do funeral estar em nome de outra pessoa. A Segurança Social paga a quem comprovou as despesas. Se foi você que pagou, peça à agência funerária que emita logo a fatura/recibo com o seu NIF.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'O pedido deve ser apresentado no prazo de 6 meses após o óbito. Não espere pelo fim dos procedimentos sucessórios: a prestação está ligada às despesas de funeral e ao prazo de apresentação, não à partilha de herança.' },
        { kind: 'substeps', items: [
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Após a aprovação, o dinheiro é transferido para o IBAN do requerente. O prazo de processamento depende da zona e da completude dos documentos: se estiver tudo carregado corretamente, costuma ser mais rápido; se faltar recibo, prova de parentesco ou IBAN, a Segurança Social enviará um pedido de correção.' },
        { kind: 'checklist', items: [
          ...
          'Verifique se a família não tem direito, em alternativa, ao subsídio por morte.',
          'Se a pessoa falecida recebia pensão, esclareça a cessação da pensão e eventuais survivor benefits.',
          'Guarde as funeral invoices durante pelo menos alguns anos: podem ser necessárias para questões sucessórias ou fiscais.'
        ] },
        { kind: 'warning', text: 'A prestação é pequena — 219,96 €, e a funeral agency invoice média em Portugal é frequentemente bastante mais elevada. Não planeie o funeral assumindo que a Segurança Social cobrirá as despesas na totalidade.' }
      ]
    }
  ],
  costs: [
    { label: 'Subsídio de Funeral', amountEUR: 219.96, note: 'Prestação única fixa da Segurança Social em abril de 2026.' },
    { label: 'Apresentação do pedido', amountEUR: 0, note: 'Através de gov.pt/Segurança Social Direta ou de um balcão da Segurança Social, não é cobrada taxa.' }
  ],
  sources: [
    {
