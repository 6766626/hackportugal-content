export default {
  ...
  tldr: 'A portabilidade de número entre operadores portugueses ao abrigo do DL 56/2010 é GRATUITA, demora 1 dia útil e é feita através de pedido junto do novo operador (que trata directamente com o operador antigo). Para obter o **Código de Validação da Portabilidade (CVP)**: envie um SMS com o texto **«CVP»** para o número curto **1696** a partir do SIM antigo (para números móveis). O comando padrão dos operadores portugueses é exactamente «CVP», não «PORT». A portabilidade NÃO anula a fidelização com o operador antigo — se houver penalização, terá de ser paga.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          '📲 O número mantém-se o mesmo, o SIM muda para um novo (do novo operador)',
        ...
        { kind: 'substeps', items: [
          ...
          { id: 'p3', title: '3. Dia da portabilidade', content: [
            { kind: 'checklist', items: [
              ...
              '🔁 Se a portabilidade não ocorrer em 24 horas — ligue ao novo operador para escalamento'
            ]}
          ]},
          { id: 'p4', title: '4. Encerrar a conta antiga', content: [
            { kind: 'checklist', items: [
              '📝 O operador antigo encerra automaticamente a conta após a portabilidade',
              '💸 A factura final chega pelos dias até à portabilidade (proporcionalmente)',
              '⚠️ Se havia fidelização no contrato antigo — a penalização aparecerá na factura final',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '🛑 A fidelização com o operador antigo NÃO é anulada — se faltarem 6 meses × 20 € até ao fim do contrato — a penalização será cerca de 60 € (50%)',
          ...
          '🛑 Se tinha pós-pagamento no operador antigo — a última factura pelos dias «não encerrados» chega 2–3 semanas depois',
          '🛑 Por vezes o novo operador pede para «pagar o SIM à parte» (≈ 10 €) — formalmente isto é ilegal para clientes MNP',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Tem 14 dias para desistir de um novo contrato celebrado à distância, ao abrigo do DL 24/2014. Voltar ao operador antigo é um procedimento separado de portabilidade (1 dia).' },
        { kind: 'checklist', items: [
          '📞 O número antigo não funciona há mais de 24 horas — ligar ao novo operador e à ANACOM',
  ...
  costs: [
    ...
    { label: 'Penalização de fidelização (se o contrato estiver activo)', amountEURMin: 0, amountEURMax: 300, note: 'depende do prazo restante' }
  ],
  sources: [
