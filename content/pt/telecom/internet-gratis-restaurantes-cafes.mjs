export default {
  ...
  tldr: 'Em Portugal, o Wi‑Fi gratuito em cafés é um serviço comum, mas não garantido. Nas redes McDonald’s, Starbucks, A Padaria Portuguesa, FNAC e em muitos centros comerciais, normalmente existe; nas pequenas pastelarias, a password é muitas vezes dada depois de fazer o pedido. Pergunte de forma educada: “Tem WiFi?” ou “Qual é a password do WiFi, por favor?”. Para bancos, Finanças, AIMA, SNS e e-mail de trabalho, use VPN ou internet móvel: as redes públicas não são seguras. Os clientes MEO podem usar MEO WiFi fora de casa.',
  tags: ['wifi', 'cafés', 'segurança', 'meo'],
  estimatedReadMinutes: 5,
  steps: [
    {
      id: 'where-to-find',
      title: 'Onde normalmente há Wi‑Fi gratuito',
      content: [
        ...
        { kind: 'checklist', items: [
          'McDonald’s — normalmente há Wi‑Fi, muitas vezes através de captive portal com confirmação dos termos',
          'Starbucks — normalmente há Wi‑Fi para clientes, especialmente em Lisboa, no Porto e em zonas turísticas',
          'A Padaria Portuguesa — em muitas lojas há Wi‑Fi para clientes, e a password é muitas vezes pedida na caixa',
          'FNAC — nas lojas e zonas de café há frequentemente Wi‑Fi disponível, prático para trabalhar por pouco tempo',
          'Centros comerciais: Colombo, Vasco da Gama, NorteShopping, ArrábidaShopping — há frequentemente Wi‑Fi geral para convidados',
          'Hotéis e hostels — o Wi‑Fi é normalmente apenas para hóspedes, mas no lobby café por vezes dão acesso depois de fazer um pedido',
          'Pequenos cafés/pastelarias — a password pode estar no talão, no balcão ou ser dada pelo empregado',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Se ficar muito tempo — peça outro café, água ou comida; é normal e mais barato do que um conflito'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'O Wi‑Fi público num café é uma rede gerida por um router ou captive portal que você não conhece. O risco não é que “todos roubem imediatamente os dados”, mas sim a interceção de tráfego, páginas de phishing, redes falsas com nome semelhante e a ligação automática do dispositivo a uma rede insegura.' },
        { kind: 'checklist', items: [
          'Não entre nas Finanças, Segurança Social Direta, AIMA, SNS 24, banco e bolsas de criptomoedas sem VPN',
          ...
          'Ative 2FA: uma aplicação Authenticator é melhor do que SMS, se houver opção',
          'Não aceite ficheiros AirDrop/Bluetooth de pessoas desconhecidas',
          'Não instale “certificados”, “perfis” ou aplicações que a página de Wi‑Fi do café proponha',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'A MEO tem o serviço MEO WiFi: os clientes MEO podem ligar-se a pontos de acesso fora de casa onde a rede MEO WiFi esteja disponível. Não substitui uma internet fixa doméstica normal, mas é prático na cidade, junto a estações, em cafés e em locais públicos, se a rede tiver melhor sinal do que a internet móvel.' },
        { kind: 'checklist', items: [
          ...
          'A rede pode exigir credenciais de cliente MEO ou uma configuração especial',
          'A velocidade depende do ponto de acesso e da ocupação',
          'Para trabalho confidencial, use VPN na mesma',
          'Se não for cliente MEO, esta opção normalmente não está disponível — é mais simples usar eSIM/tarifário com um pacote de dados grande'
        ] }
      ]
    },
    {
      id: 'work-etiquette',
      title: 'Se trabalha a partir de cafés',
      content: [
        { kind: 'paragraph', text: 'Portugal é amigável para remote work, mas um café não é um escritório gratuito. Em Lisboa e no Porto, alguns estabelecimentos começaram a limitar portáteis durante as horas de almoço, porque as mesas são necessárias para refeições. A regra: quanto menor for o pedido e maior a mesa ocupada, maior a probabilidade de olharem de lado para si.' },
        { kind: 'checklist', items: [
          'Escolha horas fora de pico: 10:00–12:00 ou 15:00–18:00 é melhor do que almoço 12:30–14:30',
          'Pergunte se pode estar com portátil, se o estabelecimento for pequeno',
          'Não ocupe sozinho uma mesa para 4 pessoas se a sala estiver a encher',
          'Faça chamadas com voz baixa e auscultadores; um Zoom alto numa pastelaria irrita toda a gente',
          'Não estenda cabos pela passagem — é um risco para o pessoal e para os clientes',
  ...
  costs: [
    ...
    { label: 'VPN', amountEURMin: 3, amountEURMax: 12, note: 'Por mês com pagamento anual; as VPN gratuitas são muitas vezes lentas e também recolhem dados.' }
  ],
  sources: [
    {
