export default {
  ...
  tldr: 'O e-Balcão é o sistema de tickets online da Autoridade Tributária no Portal das Finanças: Suporte → e-Balcão. Em 2026, é realisticamente possível resolver através dele a maioria dos assuntos sem ir às Finanças: morada associada ao NIF, IRS, recibos verdes, IVA, IMI, IUC, certidões, erros em declarações, notificações. A resposta chega normalmente em 5–10 dias úteis; assuntos urgentes devem ser reforçados com uma chamada para o CAT. Cada pedido recebe uma referência: com ela acompanha o estado e anexa documentos.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Para um expat, é a principal forma de comunicar com as Finanças sem marcação numa repartição. Praticamente todos os assuntos não urgentes sobre NIF, IRS, atividade, recibos verdes, IVA, IMI, IUC e notificações podem começar através do e-Balcão.' },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Abra portaldasfinancas.gov.pt. O acesso é feito com NIF e senha de acesso, através da Chave Móvel Digital (CMD), ou com Cartão de Cidadão. Depois de entrar: menu Suporte → e-Balcão → Registar Nova Questão.' },
        { kind: 'checklist', items: [
          'Confirme que está a entrar com o NIF correto: o seu NIF pessoal, não o NIF da empresa nem o do cônjuge',
          ...
          'Se o pedido estiver relacionado com uma notificação da AT, anexe a própria notificação e indique o número do processo ou documento',
          'Escreva em português; uma tradução automática curta é melhor do que um texto longo noutra língua'
        ] },
        { kind: 'warning', text: 'O e-Balcão está dentro do Portal das Finanças. Não envie NIF, senha de acesso nem documentos fiscais através de ligações recebidas por SMS/WhatsApp/email. Sites de phishing copiam frequentemente a interface das Finanças.' }
      ]
    },
    {
      id: 'create-ticket',
      ...
      content: [
        { kind: 'paragraph', text: 'O erro principal é escolher um tema demasiado geral e escrever “ajudem-me”. O funcionário da AT responde estritamente dentro da categoria selecionada. Quanto mais precisos forem o tema, as datas, os valores e os documentos anexados, maior é a probabilidade de obter uma solução útil logo à primeira.' },
        { kind: 'substeps', items: [
          {
            id: 'choose-topic',
            title: '1. Escolha o tema e a subcategoria',
            content: [
              { kind: 'paragraph', text: 'No e-Balcão, começa por escolher o Imposto ou a área: IRS, IVA, IMI, IUC, Atividade, Cadastro, Pagamentos, Cobrança, Património, Benefícios fiscais. Se tiver dúvidas, escolha a categoria pelo imposto, e não “Outros”.' }
            ]
          },
          {
            id: 'write-request',
            ...
            content: [
              { kind: 'checklist', items: [
                ...
                'Indique valores em euros, se a divergência for sobre pagamento, reembolso, liquidação',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Se o prazo de uma notificação estiver a terminar, não fique à espera em silêncio: telefone para o CAT e, se necessário, marque atendimento num serviço de finanças',
          'Descarregue ou guarde em PDF/captura de ecrã a resposta da AT, sobretudo se ela afetar IRS, IVA ou uma coima',
        ...
        { kind: 'warning', text: 'A resposta do e-Balcão nem sempre é uma binding tax ruling. Para uma interpretação fiscal oficial e vinculativa, utiliza-se um pedido de informação vinculativa nos termos da Lei Geral Tributária, e não um ticket normal do e-Balcão.' }
      ]
    },
    {
      id: 'use-cases',
      ...
      content: [
        { kind: 'paragraph', text: 'Se acabou de se mudar, o e-Balcão é frequentemente necessário ainda antes do primeiro IRS. É uma forma conveniente de deixar as questões por escrito quando não há marcações nas repartições das Finanças ou quando o funcionário ao balcão dá uma resposta verbal contraditória.' },
        { kind: 'checklist', items: [
          'NIF e morada fiscal: esclarecer o estado da morada, representante fiscal, confirmação da residência fiscal',
          'IRS: porque não foram pré-preenchidos rendimentos, renda, dependentes, despesas gerais familiares, saúde, educação',
          ...
          'Pagamentos: referência Multibanco perdida, pagamento em duplicado, pedido de reembolso',
          'Notificações: o que significa uma carta da AT e qual é o prazo de resposta'
        ] },
        { kind: 'paragraph', text: 'Para questões técnicas simples, pode primeiro tentar a pesquisa no Portal das Finanças e as FAQ. Mas se o assunto estiver relacionado com um prazo, um valor, uma coima ou o seu estatuto de residente fiscal, é melhor criar um pedido no e-Balcão: o registo escrito é mais importante do que um conselho verbal.' }
      ]
    },
    {
      id: 'limits',
      ...
      content: [
        { kind: 'paragraph', text: 'O e-Balcão é útil, mas não substitui todos os procedimentos. Algumas ações exigem um formulário próprio, confirmação através da CMD/Cartão de Cidadão, identificação presencial ou submissão noutra entidade.' },
        { kind: 'checklist', items: [
          ...
          'A entrega de IRS, declaração periódica IVA e emissão de recibos verdes são feitas nas respetivas áreas do portal; o e-Balcão apenas ajuda com problemas',
  ...
  sources: [
    {
      title: 'Portal das Finanças — acesso e entrada no e-Balcão',
