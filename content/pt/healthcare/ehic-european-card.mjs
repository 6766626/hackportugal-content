  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'O CESD complementa, não substitui, o seguro de viagem. Para uma viagem confortável (repatriamento, clínicas privadas, bagagem), compre ainda uma apólice de 10-30 € junto de uma seguradora.' }
      ]
    },
    {
      id: 'how-get',
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'g2', title: '2. Menu "Família" → "Cartão Europeu de Seguro de Doença"', content: [
            { kind: 'paragraph', text: 'Ou pesquise por "CESD" na barra. Será aberto o estado do cartão — existe / expira / não existe.' }
          ]},
          { id: 'g3', title: '3. Pedir o cartão', content: [
            { kind: 'checklist', items: [
              'Indicar a morada de entrega (normalmente é puxada do perfil)',
              'Adicionar dependentes (será perguntado sobre eles)',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'O valor da taxa moderadora/comparticipação depende do país e do tipo de serviço: em alguns países os cuidados ambulatórios são gratuitos, noutros paga-se primeiro parte da tarifa ou uma taxa fixa. Antes da viagem, verifique as regras do país específico no Your Europe / no site nacional de saúde',
          'Se pagou do próprio bolso (o médico não reconheceu o cartão / não o tinha à mão) — guarde todos os recibos; o reembolso é feito através da Segurança Social após o regresso',
