export default {
  ...
  tldr: 'O SAD é apoio social ao domicílio para pessoas idosas, pessoas com deficiência ou em situação de dependência temporária: alimentação, higiene, limpeza, lavandaria, acompanhamento ao médico, supervisão da vida diária. Normalmente é tratado através de IPSS/Misericórdia/município com acordo de cooperação e pagamento de acordo com o rendimento do agregado familiar: frequentemente 100–400 €/mês, por vezes menos em caso de baixo rendimento. Não é uma urgência nem um lar ERPI: para situações não agudas, o SAD é muitas vezes mais rápido do que a lista de espera para ERPI.',
  tags: ['sad', 'idosos', 'apoio social', 'ipss'],
  estimatedReadMinutes: 5,
  steps: [
    {
      id: 'what-sad-is',
      title: 'O que é o SAD e para quem é indicado',
      content: [
        { kind: 'paragraph', text: 'Serviço de Apoio Domiciliário é uma resposta social em que a pessoa continua a viver em casa, mas recebe apoio regular.\n\nEm Portugal, o SAD é normalmente prestado por IPSS, Santa Casa da Misericórdia, entidades paroquiais/municipais ou empresas privadas licenciadas.' },
        ...
        { kind: 'checklist', items: [
          ...
          'ajuda com higiene pessoal, vestir-se, levantar-se da cama',
          'limpeza ligeira da zona habitacional e mudança de roupa de cama',
          'lavandaria e cuidado da roupa',
          ...
          'contacto social: visitas, monitorização do estado, aviso à família',
          'por vezes teleassistência ou botão de alarme, se o prestador tiver esse serviço'
        ] },
        { kind: 'warning', text: 'O SAD não substitui o SNS, o médico, o enfermeiro ou o Serviço de Urgência. Pensos, injecções, cuidados paliativos e reabilitação são prestados através do SNS, UCC/ECCI ou medicina privada. Em caso de queda, dor no peito, AVC, confusão aguda — 112.' }
      ]
    },
    {
      id: 'where-to-apply',
      ...
      content: [
        { kind: 'paragraph', text: 'Comece pela zona de residência efectiva. O SAD é territorial: uma IPSS normalmente serve freguesias específicas e não aceita uma morada fora do seu percurso.' },
        { kind: 'checklist', items: [
          ...
          'Centro de Saúde: pedir a um social worker / assistente social para avaliar a situação',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'extractos bancários/IBAN, se a instituição exigir avaliação financeira',
        ...
        { kind: 'warning', text: 'Não assine um contrato de prestação de serviços que não inclua o horário das visitas, a composição dos serviços, o preço, as regras de cancelamento e a responsabilidade por chaves/acesso à casa. Peça uma cópia do regulamento interno.' }
      ]
    },
    {
      id: 'pricing',
      ...
      content: [
        { kind: 'paragraph', text: 'No SAD através de IPSS, o preço chama-se comparticipação familiar. É calculado pela instituição de acordo com o rendimento por pessoa, despesas e regulamento interno. Em 2026, o intervalo típico para um pacote básico é de cerca de 100–400 €/mês: por exemplo, entrega de refeições + higiene de manhã + limpeza ligeira várias vezes por semana.' },
        ...
        { kind: 'checklist', items: [
          ...
          'peça por escrito o cálculo da comparticipação familiar',
          'compare IPSS e opção privada: por vezes a privada começa em 48–72 horas, mas fica em 15–25 €/hora'
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'O SAD é muitas vezes mais rápido do que uma ERPI — lar/residência para pessoas idosas. Nas ERPI, as listas de espera em concelhos populares podem durar meses ou mais; o SAD é mais fácil de escalar se o percurso já passar perto.' },
        { kind: 'checklist', items: [
          'a prioridade é maior se a pessoa vive sozinha e existe risco de quedas',
          'após internamento, peça ao hospital discharge social worker que contacte a IPSS',
          'em caso de demência, junte relatório médico: isso influencia a frequência das visitas',
          'se a família precisar de se ausentar, trate antecipadamente de temporary reinforcement, não no último dia',
        ...
        { kind: 'warning', text: 'Não espere por uma crise. Quando já há quedas, recusa alimentar ou deambulação nocturna, o SAD pode ser insuficiente: é necessária avaliação por médico de família, neurologia/psiquiatria, apoio informal estruturado ou ERPI.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Um SAD normal funciona com um plano de cuidados individual: dias, horas, tarefas, alimentação, riscos, contacto da família. Peça uma revisão do plano ao fim de 30 dias: muitas vezes a necessidade real só fica clara depois do início.' },
        { kind: 'checklist', items: [
          ...
          'se entregar chaves, formalize por escrito',
          'verifique a qualidade da comida e o cumprimento da dieta',
          'comunique imediatamente nódoas negras, quedas, visitas falhadas ou alteração do estado de saúde',
          'a cada 3–6 meses, reveja o pacote: mais/menos visitas, alimentação, limpeza, acompanhamento'
        ] },
        { kind: 'paragraph', text: 'Se o serviço não corresponder ao contrato, comece por reclamar junto do coordenador da instituição. Se for uma resposta social licenciada e o problema for grave, pode contactar a Segurança Social/ISS e utilizar o Livro de Reclamações.' }
      ]
    }
  ],
  costs: [
    { label: 'SAD através de IPSS, pacote básico', amountEURMin: 100, amountEURMax: 400, note: 'Referência do mercado social em 2026; a comparticipação familiar efectiva depende do rendimento e do regulamento interno.' },
