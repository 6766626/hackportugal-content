export default {
  ...
  timelineDaysMax: 1,
  sources: [
    { title: 'ePortugal — registo de cidadão da União Europeia', url: 'https://www.gov.pt/servicos/registar-cidadao-uniao-europeia', kind: 'official', language: 'pt', lastRetrieved: '2026-04-22' },
