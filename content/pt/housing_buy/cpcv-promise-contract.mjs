export default {
  ...
  tldr: 'CPCV — contrato-promessa de compra e venda: contrato preliminar que normalmente é assinado 2–8 semanas antes da escritura. O comprador paga um sinal, muitas vezes 10–20% do preço. Nos termos do art. 442 Código Civil: se o comprador falhar — perde o sinal; se o vendedor falhar — devolve o sinal em dobro. Em 2026, um CPCV seguro deve incluir condições de crédito, verificações de licenças/dívidas e, sempre que possível, registo provisório de aquisição.',
  tags: ['cpcv', 'sinal', 'compra', 'imobiliário'],
  estimatedReadMinutes: 6,
  steps: [
    {
      id: 'what-is-cpcv',
      title: 'O que é um CPCV e porque é assinado',
      content: [
        ...
        { kind: 'paragraph', text: 'Em Portugal, o CPCV é assinado antes do negócio final porque o banco precisa de tempo para mortgage approval, valuation, seguros e preparação da escritura. Mesmo numa compra sem crédito, o CPCV também é usado: o vendedor retira o imóvel do mercado e o comprador ganha tempo para due diligence.' },
        { kind: 'warning', text: 'Não assine um CPCV “com o modelo da agência” se os documentos do imóvel não tiverem sido verificados. Depois da assinatura, a perda do sinal pode ser legal, mesmo que tenha simplesmente mudado de ideias.' }
      ]
    },
    {
      id: 'sinal-rules',
      ...
      content: [
        { kind: 'paragraph', text: 'O sinal é um montante que confirma a seriedade do negócio. No mercado habitacional, muitas vezes pedem 10–20% do preço, mas a lei não estabelece uma percentagem obrigatória. Para imóveis caros e negócios com crédito, é possível negociar um sinal mais baixo, por exemplo 5–10%, se o vendedor concordar.' },
        { kind: 'checklist', items: [
          ...
          'Estas consequências resultam do art. 442 Código Civil, se as partes não tiverem previsto outro mecanismo admissível.',
    ...
    },
    {
      ...
      title: 'O que deve ficar obrigatoriamente previsto no CPCV',
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Prazo-limite da escritura: por exemplo até 60 ou 90 dias, com mecanismo de prorrogação por motivo imputável ao banco/Conservatória.',
          ...
          'Lista de documentos do vendedor: caderneta predial, certidão permanente, licença de utilização ou legal exemption, ficha técnica da habitação, certificado energético, declaração do condomínio.',
          'Garantia de inexistência de dívidas: IMI, condomínio, utilities, hipoteca, arrestos, penhoras, usufruto, arrendamento.',
          'Quem paga IMT, Imposto do Selo, escritura, registo, liquidação da hipoteca do vendedor.',
          'Estado do imóvel e bens incluídos: mobiliário, electrodomésticos, ar condicionado, solar panels, estacionamento.',
        ...
        { kind: 'warning', text: 'Se comprar com hipoteca, a clause “subject to mortgage approval” é crítica. A aprovação preliminar do banco não equivale à aprovação final após a avaliação. Sem esta ressalva, a recusa do banco pode não salvar o sinal.' }
      ]
    },
    {
      id: 'due-diligence',
      title: 'Verificações antes da assinatura: mínimo para um expatriado',
      content: [
        { kind: 'paragraph', text: 'Antes do CPCV, é necessário verificar não só o vendedor, mas também o próprio imóvel. Em Portugal, existem anexos sem licença, águas-furtadas não legalizadas, dívidas de condomínio e limitações na Conservatória.' },
        { kind: 'checklist', items: [
          ...
          'Licença de utilização ou confirmação de que o imóvel está dispensado dela por idade/regime.',
          ...
          'Declaração de condomínio: sem dívidas, mensalidade e planned works claros.',
          'Verificação na Câmara Municipal: licenças, works, urbanismo, especialmente para moradia, anexos, attic, basement.',
          'Se o vendedor for uma empresa: certidão comercial, poderes de quem assina, nuances de IVA/fiscais.',
          'Se o vendedor for não residente: quem assina, se existe procuração, se é necessário reter imposto em casos especiais.'
        ] },
        { kind: 'warning', text: 'O agente imobiliário trabalha para o negócio, não para a protecção jurídica do comprador. Para um CPCV de centenas de milhares de euros, é prática normal contratar um advogado ou solicitador antes da assinatura, e não na véspera da escritura.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'O registo provisório de aquisição é o registo preliminar da futura compra na Conservatória do Registo Predial. Torna a sua posição visível para terceiros e reduz o risco de o vendedor voltar a vender o imóvel ou onerá-lo antes da escritura.' },
        { kind: 'paragraph', text: 'Normalmente, o pedido é apresentado por advogado, solicitador, notário ou conservador através dos serviços de registo. Para o registo, é necessário um CPCV com identificação suficiente do imóvel e das partes; por vezes é exigido reconhecimento presencial das assinaturas.' },
        { kind: 'checklist', items: [
          'É especialmente útil se entre o CPCV e a escritura passarem mais de 30–45 dias.',
          'É recomendado em compras a promotor imobiliário, em cadeias de venda complexas ou se o vendedor estiver sob pressão financeira.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'warning', text: 'Se o vendedor pedir para “entregar as chaves depois do CPCV”, isso já é um risco de posse sem propriedade. São necessárias clauses separadas: quem paga condomínio, utilities, seguro, obras, e o que acontece se a escritura falhar.' }
      ]
    }
  ],
  costs: [
    ...
    { label: 'Verificação jurídica do CPCV', amountEURMin: 300, amountEURMax: 1500, note: 'Referência de mercado para advogado/solicitador; negócios complexos, promotores imobiliários e hipoteca custam mais.' },
    { label: 'IMT e Imposto do Selo', amountEURMin: 0, amountEURMax: 0, note: 'Normalmente pagos antes da escritura. O montante depende do preço, do VPT, do tipo de imóvel e do estatuto do comprador; não é uma taxa pelo CPCV.' }
  ],
  sources: [
    {
