export default {
  ...
  tldr: 'Se a casa não estiver ligada à rede pública de saneamento, é necessário um sistema autónomo de tratamento de águas residuais.\n\nEm Portugal, isto significa uma fossa séptica clássica (fossa séptica) com poço absorvente, ou uma ETAR compacta moderna de tratamento biológico. Volume: ~3 m³ para 4–5 residentes. Distâncias mínimas: ≥30 m de um furo/poço, ≥10 m de casas vizinhas, ≥5 m do limite do terreno. A instalação exige projecto de engenheiro, autorização na Câmara Municipal, vistoria técnica após a montagem e licença de utilização.\n\nPreço: fossa séptica clássica 1 500-4 000 €, ETAR 5 000-15 000 €. Limpeza por camião limpa-fossas a cada 1–3 anos (80-200 €).',
  tags: ['fossa', 'séptica', 'saneamento', 'etar', 'água-residual'],
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'checklist', items: [
          '🏠 Casa fora da cidade sem ligação ao saneamento: é necessária fossa séptica ou ETAR',
          ...
          '🏠 Conversão de anexo (anexo) em casa de hóspedes ou Alojamento Local (arrendamento turístico): normalmente é exigida ETAR',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Solo argiloso: melhor ETAR (o poço absorvente funciona mal em argila)',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'A norma principal é o Decreto Regulamentar 23/95 (Regulamento de Distribuição de Água). A Câmara Municipal pode tornar os requisitos mais exigentes.' },
        { kind: 'checklist', items: [
          ...
          'De rios e ribeiros: ≥ 30 m (zona de protecção)',
        ...
        { kind: 'warning', text: 'Se a fossa séptica ou o poço absorvente estiver demasiado perto do furo/poço, a água potável pode ficar contaminada. É um risco sério: pode haver fiscalização da GNR (patrulha ambiental SEPNA) e da APA (agência do ambiente), coimas, encerramento do furo/poço e custos de remediação de 5 000-30 000 €.' }
      ]
    },
    {
      id: 'process',
      ...
      content: [
        { kind: 'substeps', items: [
          {
            id: 's1',
            title: 'Projecto (para construção nova ou remodelação significativa)',
            content: [
              { kind: 'checklist', items: [
                'Engenheiro civil: projecto de saneamento — parte do projecto de arquitectura geral',
                'Estudo geotécnico: que solo existe — permeável? argila ou areia?',
                'Projecto: tipo, dimensão, distâncias, campo de infiltração',
          ...
          {
            id: 's2',
            title: 'Obtenção de autorização na Câmara Municipal',
            content: [
              { kind: 'paragraph', text: 'Através do portal online PEDU ou presencialmente na Câmara Municipal. São entregues:' },
              { kind: 'checklist', items: [
                'Caderneta predial (certidão/informação do imóvel)',
          ...
          },
          {
            ...
            content: [
              { kind: 'checklist', items: [
                ...
                'Ligação ao sistema de esgotos da casa',
          ...
          },
          {
            ...
            content: [
              { kind: 'paragraph', text: 'Após a instalação, a Câmara Municipal pode enviar um inspector para verificar a conformidade com o projecto. Com base no resultado, é emitida a licença de utilização. Sem ela, a casa não é juridicamente considerada concluída: não pode ser vendida, não pode ser registada como Alojamento Local, e o banco também a exigirá para a hipoteca.' }
            ]
          }
        ] }
      ]
    ...
    {
      id: 'maintenance',
      title: 'Manutenção — despesas regulares',
      content: [
        { kind: 'paragraph', text: 'A fossa séptica tem de ser limpa periodicamente. Caso contrário — transbordo, mau cheiro, contaminação do solo.' },
        { kind: 'checklist', items: [
          'Fossa séptica clássica: limpeza a cada 1–3 anos, dependendo da carga',
          'Preço da limpeza: 80-200 € (vem um camião limpa-fossas, aspira e transporta para a estação municipal de tratamento)',
          ...
          'Contrato de manutenção de ETAR: 100-300 €/ano com empresa especializada',
          'Substituição de bioarrancadores (bactérias para lamas activadas): 30-50 € a cada 1–2 anos',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Inspecção anual do município ou da DGS (serviço de saúde)',
          'Em caso de problemas — a licença AL é suspensa até à correcção',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Subsídios municipais para substituição de fossa séptica clássica por ETAR — informe-se junto do seu município, especialmente no Algarve e Alentejo',
          'Dedução fiscal em IRS (imposto sobre o rendimento) por obras na habitação própria permanente: 30% até 1 500 €/ano',
          ...
          'Comunidade de Energia Renovável (CER): o pacote com painéis solares inclui frequentemente modernização do saneamento'
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Fossa séptica com violação das distâncias (por exemplo, junto a um furo/poço): 1 000-10 000 € + custos de remediação',
