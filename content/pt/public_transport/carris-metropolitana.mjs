export default {
  ...
  tldr: 'A Carris Metropolitana é a rede unificada de autocarros suburbanos da Área Metropolitana de Lisboa, lançada por fases desde 2022. Não é a Carris Lisboa urbana: o operador cobre 15 municípios à volta de Lisboa, incluindo Sintra, Loures, Mafra, Oeiras, Almada, Setúbal, Montijo. Em 2026, a principal forma de pagamento é o Navegante: 30 € pelo pass municipal ou 40 € pelo metropolitano. As carreiras têm quatro dígitos; verifique frequentemente os horários na aplicação ou no site.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'O lançamento decorreu por fases desde 2022. Por isso, entre residentes antigos e no Google Maps ainda podem aparecer nomes antigos de linhas, paragens e operadores. Em 2026, oriente-se por carrismetropolitana.pt, pela aplicação Carris Metropolitana e pelo Navegante.' },
        { kind: 'checklist', items: [
          ...
          'Cascais é servida sobretudo pela rede separada MobiCascais, embora deslocações para zonas vizinhas possam cruzar-se com o Navegante',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Cascais: verifique MobiCascais e CP Linha de Cascais',
          'Barreiro: verifique TCB e as ligações fluviais'
        ] },
        { kind: 'warning', text: 'Não compre o pass apenas pelo nome da cidade. Se vive em Sintra e trabalha em Lisboa, quase sempre precisa do Navegante Metropolitano por 40 €, e não do pass municipal por 30 €.' }
      ]
    },
    {
      id: 'tickets',
      ...
      content: [
        { kind: 'paragraph', text: 'Em 2026, a Carris Metropolitana está integrada no sistema Navegante. O cenário mais simples para um expat: pedir um cartão Navegante personalizado, carregar um pass mensal e validar o cartão sempre que entra no autocarro.' },
        { kind: 'checklist', items: [
          ...
          'O carregamento é possível nas máquinas do Metro/CP, Payshop, alguns quiosques e através de aplicações/multibancos suportados, consoante o cartão',
          'Os bilhetes ocasionais comprados ao motorista são normalmente menos vantajosos e podem não permitir transbordo em condições',
          'Para deslocações diárias entre municípios, o pass de 40 € é quase sempre mais vantajoso do que bilhetes separados'
        ] },
        { kind: 'warning', text: 'Se o validador não funcionar, não ignore. Numa fiscalização, o argumento “tenho pass, mas não encostei o cartão” pode acabar em multa. Experimente outro validador ou informe imediatamente o motorista.' }
      ]
    },
    {
      id: 'route-numbers',
      ...
      content: [
        { kind: 'paragraph', text: 'Depois da transição para a Carris Metropolitana, muitos números antigos desapareceram. As novas linhas têm normalmente 4 dígitos. A mesma paragem pode ter plataformas diferentes por sentido, e o mesmo destino pode ter variantes por bairros diferentes.' },
        { kind: 'checklist', items: [
          ...
          'Verifique o horário separadamente para dias úteis, sábado, domingo e feriado',
          'À noite, ao domingo e nos feriados, os intervalos podem aumentar bastante',
          'Nos subúrbios, o último autocarro pode sair muito mais cedo do que em Lisboa',
          'O Google Maps é útil, mas, em caso de divergência com o site oficial, confie na Carris Metropolitana'
        ] },
        { kind: 'paragraph', text: 'Erro típico de principiante: escolher a carreira pela paragem mais próxima, mas não reparar que o autocarro segue no sentido contrário ou faz uma volta longa por bairros vizinhos. Nos subúrbios, isto pode acrescentar 30–50 minutos.' }
      ]
    },
    {
      id: 'daily-use',
        ...
        { kind: 'substeps', items: [
          { id: 'before-moving', title: 'Antes de arrendar casa', content: [
            ...
            { kind: 'checklist', items: [
              ...
              'Verifique o domingo e os feriados',
              'Veja a ligação à CP, Metro, Fertagus ou barco',
              'Compare o tempo às 08:00 e às 22:00',
              'Verifique se precisa apenas do pass municipal ou do metropolitano'
            ] }
          ] },
          { id: 'commuting', title: 'Para a deslocação diária', content: [
            { kind: 'paragraph', text: 'Guarde 2–3 percursos alternativos. Nos subúrbios, uma única supressão pode estragar toda a cadeia de transbordos, sobretudo se depois tiver um comboio da CP ou um ferry da Transtejo/Soflusa.' },
            { kind: 'checklist', items: [
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'A Carris Metropolitana publica regularmente alterações de percursos, desvios temporários, supressão de paragens devido a obras e ajustes de horários. Isto é especialmente visível em zonas novas, junto a escolas, zonas industriais e em obras rodoviárias da Câmara Municipal.' },
        { kind: 'checklist', items: [
          'Verifique os avisos em carrismetropolitana.pt',
          ...
          'Se o atraso for crítico, construa o percurso através de CP/Metro/Fertagus, onde os intervalos são normalmente mais previsíveis'
        ] },
        { kind: 'warning', text: 'Nos subúrbios, não planeie atos jurídicos, AIMA, Finanças, exames IMT ou consultas médicas “à justa” dependendo de apenas um autocarro. Reserve pelo menos 30–45 minutos de margem.' }
      ]
    }
  ],
  costs: [
