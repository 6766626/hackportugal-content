export default {
  ...
  tldr: 'O Ascensor da Bica, o da Glória, o do Lavra e o Elevador de Santa Justa não são atrações de museu, mas sim linhas da Carris. O Navegante é válido nelas: com o Navegante Municipal mensal de 30 € ou o Metropolitano de 40 €, a viagem está incluída sem pagamento adicional. Os bilhetes avulso comprados ao motorista são caros: os funiculares custam cerca de 4,20 € por 2 viagens, e Santa Justa cerca de 6,10 € para ida e volta; zapping/Navegante pré-carregado costuma compensar mais. Nas horas de ponta e junto a Santa Justa há filas — muitas vezes é mais rápido subir a pé.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: ['Ascensor da Bica: Rua de São Paulo / Cais do Sodré ↔ Bairro Alto, uma das subidas mais fotogénicas', 'Ascensor da Glória: Restauradores ↔ São Pedro de Alcântara / Bairro Alto, o mais prático para subir a partir da Baixa', 'Ascensor do Lavra: Largo da Anunciada ↔ Rua Câmara Pestana, o mais antigo e geralmente menos turístico', 'Elevador de Santa Justa: Baixa ↔ Largo do Carmo / Chiado, elevador vertical com vista e uma grande fila', 'São linhas curtas: a viagem demora cerca de 2–5 minutos, mas a espera em Santa Justa no verão pode ser de 30–60 minutos'] }
      ]
    },
    {
      id: 'how-to-pay',
