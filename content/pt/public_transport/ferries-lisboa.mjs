export default {
  ...
  "tldr": "Transtejo/Soflusa — ferries pelo Tejo: Lisboa—Cacilhas (10 min, 1,40 €), Cais do Sodré—Trafaria—Porto Brandão, Belém—Trafaria, Terreiro do Paço—Barreiro/Montijo. Aceitam o cartão Navegante. Para turistas — Tejo Boat Tour. Para quem gosta de praias — Cacilhas + autocarro 124 até à Costa da Caparica. No inverno, os horários são reduzidos; confirme antecipadamente em ttsl.pt.",
  "tags": [
    "ferry",
    "transtejo",
    "soflusa",
      ...
      "content": [
        {
          ...
          "items": [
            {
              "id": "cacilhas",
              "title": "Cais do Sodré ↔ Cacilhas (a mais popular)",
              "content": [
                {
                  "kind": "checklist",
                  "items": [
            ...
            {
              "id": "porto-brandao",
              "title": "Cais do Sodré ↔ Porto Brandão (via Trafaria)",
              "content": [
                {
                  "kind": "checklist",
                  "items": [
            ...
            {
              "id": "barreiro",
              "title": "Terreiro do Paço ↔ Barreiro / Montijo (Soflusa)",
              "content": [
                {
                  "kind": "checklist",
                  "items": [
              ...
              "content": [
                {
                  ...
                  "items": [
                    ...
                    "🔁 Durante esse período, pode fazer transbordo para metro ou autocarro (uma tarifa)"
                  ]
                }
              ]
            },
              ...
              "content": [
                {
                  ...
                  "items": [
                    ...
                    "⚓ **Lisboa Sailing Tour** — cruzeiro privado, desde 50 €/pessoa",
      ...
      "content": [
        {
          "kind": "checklist",
          "items": [
            "🚲 Bicicletas no ferry são gratuitas — excelente plano: «Cacilhas + bicicleta até à Costa da Caparica»",
            "🐶 Animais pequenos em transportadora — gratuito",
            "⛅ No inverno, os horários são reduzidos; ferries nocturnos só de sexta-feira a domingo",
            "🌊 Tempestade >2 m: os ferries podem ser cancelados (raro, normalmente apenas Belém—Trafaria)",
            "🥪 Não há bar a bordo — leve comida consigo",
            "📸 Pôr do sol ideal: ferry Cacilhas → Cais do Sodré às 19:00 no verão",
            "⚠️ Greve nos transportes — ferries são cancelados; acompanhe os meios de comunicação na véspera"
          ]
        }
      ]
    }
  ...
  "costs": [
    {
      "label": "Cacilhas/Trafaria ocasional",
      "amountEUR": 1.4
    },
    {
      "label": "Barreiro ocasional",
      "amountEUR": 2.5
    },
    {
      "label": "Montijo ocasional",
      "amountEUR": 3.3
    },
    {
      "label": "Tejo 24h turístico",
      "amountEUR": 6
    },
    {
      "label": "Navegante Metropolitano (ilimitado)",
      "amountEUR": 30,
      "note": "€/mês"
    }
  ],
  "sources": [
    {
      "title": "Transtejo / Soflusa — site oficial",
      "url": "https://ttsl.pt/",
      "kind": "official",
      "language": "pt",
    ...
    {
      "title": "Carris Metropolitana — Navegante",
