export default {
  ...
  tldr: 'Navegante é o passe único para a região de Lisboa: metro, autocarros Carris, comboios CP, barcos fluviais Transtejo, Fertagus, MTS. Dois tipos principais: mensal Metropolitano (por 40 €) ou Municipal (30 €). Crianças até aos 12 anos — gratuito (desde 2024), jovens dos 13 aos 18 anos e estudantes — 20 €. Compra-se numa máquina do metro, nos balcões da Carris ou através da aplicação.',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 't1', title: 'Navegante Metropolitano (40 €/mês)', content: [
            { kind: 'paragraph', text: 'Funciona em TODA a área metropolitana de Lisboa (Lisboa + Sintra + Cascais + Almada + Loures + Odivelas + Vila Franca + Mafra + 10 outros). Abrange metro, Carris, comboios suburbanos CP, Transtejo, Fertagus, MTS Seixal. A melhor escolha se se desloca entre municípios.' }
          ]},
          { id: 't2', title: 'Navegante Municipal (30 €/mês)', content: [
            { kind: 'paragraph', text: 'Apenas no SEU município. Para residente em Lisboa — apenas Lisboa (incluindo metro + Carris). Para residente em Cascais — apenas Cascais + CP dentro do município. NÃO funciona fora dos limites do município.' }
          ]},
          { id: 't3', title: 'Navegante Social / benefícios',
            content: [
          ...
          { id: 't4', title: 'Zapping — pagamento por viagem', content: [
            { kind: 'paragraph', text: 'Saldo pré-pago no cartão Navegante. Viagem — cerca de 1,80 € no metro, 2 € no autocarro. Desconto de 15 % face à tarifa normal. Para viagens pouco frequentes.' }
          ]}
        ]}
      ]
    },
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'g1', title: '1. Cartão Navegante físico (cartão de plástico)', content: [
            { kind: 'checklist', items: [
              'Ir a qualquer quiosque do Metro Lisboa ou balcão da Carris',
          ...
          { id: 'g2', title: '2. Navegante através do Viva Viagem / cartão amarelo', content: [
            { kind: 'paragraph', text: 'Sistema antigo. Cartão em papel por 50 cêntimos, carregado com Zapping ou passe de 24 horas (6,80 €). Adequado para turistas.' }
          ]},
          { id: 'g3', title: '3. Navegante através da aplicação (digital)', content: [
            { kind: 'paragraph', text: 'Descarregar a aplicação «Navegante» (Android / iOS). Associar um cartão existente através de NFC ou criar uma carteira digital. Carregamento por MB WAY, cartão.' }
          ]},
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '🏃 No metro, passe uma pessoa por cartão; aproxime-o da zona de leitura — é imediato',
          '📱 Nos autocarros Carris — valide à ENTRADA',
          '🚆 CP — valide à ENTRADA na estação, por vezes também à saída',
          '🎒 Multa por viajar sem bilhete: 120 € de imediato (reduzida para 60 € se pagar no prazo de 20 dias)',
  ...
  costs: [
    ...
    { label: 'Multa por viajar sem bilhete', amountEURMin: 60, amountEURMax: 120 }
  ],
  sources: [
