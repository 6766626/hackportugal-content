export default {
  ...
  tldr: 'Desde 2024, está em vigor o enquadramento nacional do Decreto-Lei 1-A/2024: os passes mensais de transporte público são financiados pelo Estado através do sistema passes.pt, com um limite/apoio nacional até 40 €/mês e passes metropolitanos separados de cerca de 20 €/mês nas zonas aplicáveis. Não é um bilhete universal único para tudo: as regras dependem da AML, AMP, CIM/município, operador e tipo de viagens. Em 2026, compre através do cartão local: Navegante, Andante, CP/passe municipal.',
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Comece por olhar não para a lei, mas para o mapa das suas deslocações: onde vive, onde trabalha/estuda e que operadores utiliza realmente. Em Portugal, o passe está associado ao território e ao sistema tarifário.' },
        { kind: 'checklist', items: [
          ...
          'Se se desloca entre regiões, procure uma opção nacional/inter-regional em passe.pt ou junto da CP'
        ] }
      ]
    },
    {
      id: 'buy-card',
      title: '2. Peça o cartão e compre o passe mensal',
      content: [
        { kind: 'paragraph', text: 'Normalmente é necessário um suporte físico ou digital: Navegante, Andante, cartão CP ou cartão municipal. Para um expat adulto comum, a autorização de residência muitas vezes não é necessária: basta um documento de identificação e, por vezes, NIF/morada. Para descontos — estudante, jovem, pensionista, tarifa social — são necessários mais documentos.' },
        { kind: 'checklist', items: [
          'Passaporte, Cartão de Cidadão ou autorização de residência',
          'NIF, se o sistema exigir associação a um perfil de cliente',
          ...
          'Verificação da validade: o passe mensal normalmente é válido por mês civil, não por 30 dias a partir da compra'
        ] },
        { kind: 'warning', text: 'Uma compra nos dias 28–31 pode ser para o mês civil seguinte ou para o actual — depende do terminal. Antes de pagar, confirme o mês de activação no ecrã do Multibanco/máquina.' }
      ]
    },
    {
      id: 'where-to-check',
      ...
      content: [
        { kind: 'paragraph', text: 'passe.pt é o ponto de entrada nacional para informação sobre passes apoiados. Aí verifica-se o tipo de passe, a região, o operador e o desconto aplicável. Em 2026, é a forma mais segura de não pagar a mais por uma opção local quando existe uma opção metropolitana ou nacional.' },
        { kind: 'checklist', items: [
          ...
          'Veja as excepções: express, long-distance, tourist, airport shuttle',
          ...
          'Ao mudar-se para outro concelho, peça um novo passe — o antigo pode deixar de ser a opção mais adequada'
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'lisbon', title: 'Lisboa: Cascais/Sintra/Almada/Setúbal ↔ Lisboa', content: [
            { kind: 'paragraph', text: 'Quase sempre comece pelo Navegante. Se as viagens forem dentro da Área Metropolitana de Lisboa, o passe metropolitano é frequentemente mais vantajoso do que um conjunto separado de CP + metro + autocarro. Confirme a inclusão da Fertagus ou do ferry, se atravessar o Tejo.' }
          ] },
          { id: 'porto', title: 'Porto: Gaia/Matosinhos/Maia/Gondomar ↔ Porto', content: [
            { kind: 'paragraph', text: 'Consulte o Andante e as zonas necessárias. Um erro de principiante é comprar uma zona demasiado pequena e receber uma coima ao atravessar a fronteira. Para deslocações diárias, a opção metropolitana costuma ser mais simples do que o mínimo zonal.' }
          ] },
          { id: 'small-city', title: 'Cidade pequena ou mudança para o interior', content: [
            { kind: 'paragraph', text: 'Verifique o passe municipal, a CIM e a CP regional. Em cidades pequenas, o desconto pode não ser tratado numa máquina do metro, mas sim na Câmara Municipal, Loja do Cidadão, junto do operador de autocarros ou através do serviço escolar/social.' }
          ] }
        ] }
      ]
    },
    {
      id: 'fines-and-proof',
      title: 'Coimas, validação e comprovativo de pagamento',
      content: [
        { kind: 'paragraph', text: 'O passe deve ser validado à entrada, mesmo sendo mensal. O fiscal verifica não só o pagamento, mas também a zona correcta, a personalização do cartão e o estatuto de desconto.' },
        { kind: 'checklist', items: [
          'Valide sempre o cartão no metro, autocarro, eléctrico, comboio e ferry',
          'Tenha consigo um documento de identificação se o cartão for personalizado',
          ...
          'Não empreste um passe personalizado a outra pessoa',
          'Confirme que o passe mensal foi carregado no cartão, e não apenas pago',
          'Depois de um carregamento por Multibanco, por vezes é necessária activação no validador/terminal',
          'Em caso de coima, peça o auto de notícia e as instruções para reclamação'
        ] },
  ...
  sources: [
    { title: 'Decreto-Lei 1-A/2024 — enquadramento jurídico nacional de apoio aos passes', url: 'https://dre.pt/dre/detalhe/decreto-lei/1-a-2024', kind: 'law', language: 'pt', lastRetrieved: '2026-04-28' },
