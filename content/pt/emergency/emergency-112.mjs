export default {
  ...
  tldr: 'O número único 112 é para ambulância, bombeiros e polícia. SNS24 (808 24 24 24) — aconselhamento médico por telefone. INEM (112) — emergência médica. PSP/GNR — polícia. Os números são universais e gratuitos.',
  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          '1. Localização — rua, número de porta, cidade, freguesia (administração local)',
          '2. O que aconteceu — ambulância / incêndio / polícia',
          '3. Quantas pessoas feridas, estado',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'l1', title: 'Passaporte da Federação Russa', content: [
            { kind: 'paragraph', text: 'Consulado da Rússia em Lisboa (R. Pinheiro Chagas 37) — apresentar imediatamente uma declaração de perda e obter um certificado de regresso.' }
          ]},
          ...
          { id: 'l3', title: 'Autorização de residência (título de residência)', content: [
            { kind: 'paragraph', text: 'Participação na PSP (auto policial) → marcação na AIMA para substituição → taxa de 82 € → espera de 30-60 dias.' }
          ]},
    ...
    },
    {
      ...
      title: 'Seguro e SNS',
      content: [
        { kind: 'paragraph', text: 'A assistência de emergência no SNS é prestada a todos sem exceção (incluindo pessoas sem estatuto legal e turistas). Para cuidados programados e confirmação de despesas, é necessário um Número de Utente (número de utente do SNS). Um seguro privado reduz as listas de espera para casos não urgentes.' }
      ]
    }
  ],
  sources: [
