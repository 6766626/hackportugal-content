export default {
  ...
  title: 'Como não ficar o dia todo na urgência',
  tldr: 'A urgência em Portugal funciona segundo o Manchester Triage System — a cor depende da gravidade da situação. Vermelho — imediato, laranja — ≤ 10 min, amarelo — ≤ 60 min, verde — ≤ 120 min, azul — ≤ 240 min. Para reduzir a espera: (1) primeiro SNS 24 (**808 24 24 24**) — triagem de enfermagem com algoritmos clínicos (não é um médico ao telefone), encaminha para o nível adequado; (2) Atendimento Complementar no Centro de Saúde (à noite/fim de semana); (3) urgências privadas (CUF, Lusíadas, Luz) — 20–80 €; (4) aplicação «Tempos de Espera SNS» para verificar a fila.\n\n⚠️ Os números 808 são tarifados de acordo com o tarifário do assinante: cartões SIM móveis e estrangeiros podem ser pagos.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'SNS 24 (**808 24 24 24**) — linha médica pública, funciona 24/7. Triagem de enfermagem com algoritmos clínicos (não é uma conversa com um médico). O serviço em si é gratuito, mas o número 808 é tarifado de acordo com o tarifário do assinante: cartões SIM móveis e estrangeiros podem ser cobrados ao minuto:' },
        { kind: 'checklist', items: [
          ...
          'Idiomas: PT + EN (diga «English please»)',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          '🟠 **Laranja (laranja) — MUITO URGENTE**: em **≤ 10 min**. Dor forte no peito, dificuldade respiratória, hemorragia importante',
          ...
          '⚪ **Branco** — não requer cuidados urgentes (deve ir ao médico de família) — enviam-no para casa'
        ]},
        { kind: 'warning', text: '80% dos pacientes em Portugal chegam com cor amarela/verde/azul — e esperam 2–4 horas. Se lhe atribuíram azul — é mais realista marcar consulta no Centro de Saúde ou ir a uma clínica privada.' }
      ]
    },
    {
      id: 'shortcuts',
        ...
        { kind: 'substeps', items: [
          { id: 's1', title: '1. Centro de Saúde — Atendimento Complementar', content: [
            { kind: 'checklist', items: [
              ...
              'Gratuito — as taxas moderadoras nos cuidados primários do SNS foram abolidas (reforma Decreto-Lei 37/2022)'
            ]}
          ]},
          { id: 's2', title: '2. Hospital Urgência — menos sobrecarregado', content: [
            { kind: 'checklist', items: [
              'Em Lisboa: Hospital Beatriz Ângelo (Loures) — normalmente mais rápido do que Santa Maria',
              'Hospital de Cascais (se vive em Cascais/Estoril) — muitas vezes mais calmo',
          ...
          { id: 's3', title: '3. Manhã de segunda a quinta-feira', content: [
            { kind: 'checklist', items: [
              'Horas mais sobrecarregadas: noite (18:00–23:00) e fim de semana',
              'Horas mais livres: segunda–quinta 9:00–12:00',
              'Evite: domingo à noite (tudo o que não abriu ao fim de semana vai parar ali)',
          ...
          { id: 's4', title: '4. Urgência privada', content: [
            { kind: 'checklist', items: [
              ...
              'As receitas podem ser levadas imediatamente à farmácia (por exemplo, Lusíadas Farmácia ao lado)'
            ]}
          ]},
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '📇 **Número de Utente (SNS)** — sem ele atendem-no na mesma, mas o processo será mais demorado',
          ...
          '🗣️ **Dicionário PT / tradutor**: 90% dos médicos compreendem EN, mas o pessoal auxiliar muitas vezes não'
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '📝 **Receita**: o médico de família passa receitas para 3–6 meses em doenças crónicas — não precisa de ir sempre à urgência',
          '📞 **Primeiro SNS 24, sempre** — eles próprios decidem se é necessária urgência',
          '💻 **Portal MySNS** (mysns.min-saude.pt): ver as suas receitas, marcações, resultados de análises',
          '🚑 **INEM (112)**: apenas para situações que ameaçam realmente a vida. As chamadas falsas são multadas',
          '🌙 **Horas noturnas na urgência**: se puder esperar até de manhã — espere. 2–4 da manhã — é a altura mais difícil'
        ]}
      ]
    }
  ],
