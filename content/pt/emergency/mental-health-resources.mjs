export default {
  ...
  "tldr": "Em crise: **SNS 24 → opção 4** (apoio psicológico do SNS, 24/7) ou **SOS Voz Amiga 213 544 545** (linha de prevenção do suicídio, 16:00-24:00). ⚠️ Os números 808 são cobrados de acordo com o tarifário do assinante (cartões SIM móveis/estrangeiros podem ter custos). Através do SNS — o médico de família encaminha para psicólogo/psiquiatra (gratuito, lista de espera 1-3 meses). Psicólogo privado 50-90 €/sessão, psiquiatra 80-150 €. Especialistas anglófonos — na CUF, Lusíadas, Luz. Online: BetterHelp, ePsicólogos. Linha Vida 1414 — para dependências, tem horário de funcionamento (NÃO é 24/7).",
  "tags": [
    "psicologia",
    "psiquiatra",
    "crise",
  ...
  "steps": [
      ...
      "content": [
        {
          "kind": "checklist",
          "items": [
            "☎️ **112** — serviço de emergência, em caso de intenção suicida / risco de vida",
            "☎️ **SNS 24: 808 24 24 24** → opção 4 — apoio psicológico do SNS, 24/7. O serviço em si é gratuito, mas o número 808 é cobrado de acordo com o tarifário do assinante (cartões SIM móveis/estrangeiros podem ser cobrados ao minuto)",
            ...
            "☎️ **Linha Vida (ICAD/SICAD): 1414** — para dependências (drogas/álcool). Tem horário de funcionamento — NÃO funciona 24 horas por dia. Gratuita",
    ...
    },
    {
      ...
      "content": [
        {
          "kind": "paragraph",
          "text": "A medicina pública em Portugal cobre apoio psicológico e psiquiátrico, mas o acesso é lento."
        },
        {
          "kind": "substeps",
          "items": [
            {
              "id": "s1",
              "title": "1. Médico de família",
              "content": [
                {
                  "kind": "checklist",
                  "items": [
                    "Marcar consulta através da aplicação SNS 24 ou do Centro de Saúde",
                    "Descrever sintomas: ansiedade, depressão, problemas de sono, ataques de pânico",
                    "O médico de família pode: prescrever indutores do sono / ansiolíticos, encaminhar para especialista",
            ...
            {
              "id": "s2",
              "title": "2. Psicólogo no SNS",
              "content": [
                {
                  "kind": "checklist",
                  "items": [
                    "Lista de espera: normalmente 1-3 meses, até 6 meses nas capitais",
                    "6-12 sessões como padrão",
                    "A terapia cognitivo-comportamental é a mais comum",
                    "Gratuito",
                    "Frequentemente apenas em português; psicólogos anglófonos são raros nas grandes cidades"
                  ]
                }
              ]
            },
              ...
              "content": [
                {
                  ...
                  "items": [
                    ...
                    "**INSPIRA Saúde** — rede independente, anglófona",
              ...
              "content": [
                {
                  ...
                  "items": [
                    ...
                    "⚠️ Doenças pré-existentes (diagnóstico ANTES de contratar): frequentemente excluídas"
                  ]
                }
              ]
            }
      ...
      "content": [
        {
          ...
          "items": [
            ...
            "**Mindler.pt** — teleterapia sediada em Portugal",
            ...
            "É mais fácil encontrar terapeutas online anglófonos do que presenciais"
          ]
        }
      ]
    },
      ...
      "content": [
        {
          ...
          "items": [
            ...
            "**Barreira linguística no médico**: significativa para uma ajuda de qualidade na área da saúde mental. Um psicólogo anglófono é mais caro, mas mais eficaz",
            "**Psicólogos russófonos em Portugal**: lista limitada, procurar em chats de Telegram de comunidades de expatriados",
            "**Instabilidade financeira** (espera pelo visto, gasto de poupanças) = gatilhos sérios para ansiedade",
            "**Isolamento**: nos primeiros meses, a rede social é fraca. Solução — encontros, intercâmbios linguísticos, grupos de expatriados",
            "**Adaptação das crianças**: mudança de escola / língua → as crianças podem regredir. Acompanhamento regular com pediatra ou psicólogo escolar"
          ]
        }
      ]
    },
      ...
      "content": [
        {
          ...
          "items": [
            ...
            "**Anonymous Alcoholics Portugal** — reuniões diárias, EN/PT/RU",
      ...
      "content": [
        {
          ...
          "items": [
            ...
            "Se trabalha através de recibos verdes: despesas de terapia para stress profissional podem contar como despesa de actividade (consulte um contabilista)"
          ]
        }
      ]
    }
  ...
  "costs": [
    {
      "label": "Psicólogo no SNS",
      "amountEUR": 0
    },
    {
      "label": "Psicólogo privado",
      "amountEURMin": 50,
      "amountEURMax": 90,
      "note": "€/sessão"
    },
    {
      "label": "Primeira consulta com psiquiatra",
      "amountEURMin": 100,
      "amountEURMax": 150
    },
    {
      "label": "Terapia online (BetterHelp)",
      "amountEURMin": 60,
      "amountEURMax": 90,
      "note": "€/semana"
    },
    {
      "label": "Pacote de seguro para saúde mental",
      "amountEURMin": 200,
      "amountEURMax": 400,
      "note": "€/ano"
    }
