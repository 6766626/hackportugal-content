  ...
  steps: [
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Referência para a licença marítima em Portugal continental: a licença apeada diária começa aproximadamente a partir de 2 €, a embarcada — cerca de 3 €, a submarina — cerca de 5 €; as opções anuais são mais caras e dependem do tipo. Veja sempre o valor final no BMar antes do pagamento.' },
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          'Não venda o pescado — a recreational fishing não confere direito comercial.',
          ...
          'Em águas interiores, verifique invasive species e native species: algumas espécies não podem ser devolvidas, outras não podem ser levadas — depende das regras ICNF.',
