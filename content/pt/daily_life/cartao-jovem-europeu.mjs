export default {
  ...
  tldr: 'Cartão Jovem Europeu é a versão portuguesa do European Youth Card para residentes em Portugal dos 12 aos 29 anos inclusive. Em 2026 o cartão base (Clássico) é emitido gratuitamente através do IPDJ/cartaojovem.pt e da aplicação myEYC e dá acesso a mais de 60 000 descontos em Portugal e na Europa: normalmente 25% na CP para viagens, museus, cinema, restaurantes, hostels, desporto e serviços online. São necessários registo com NIF/documento; o cartão é digital e é apresentado na aplicação/área pessoal juntamente com um documento de identificação.',
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'O Cartão Jovem Europeu não é um cartão bancário nem um documento de autorização de residência. É um cartão de descontos do IPDJ, ligado à rede European Youth Card Association. Funciona em Portugal e noutros países participantes da EYCA.' },
        { kind: 'paragraph', text: 'A principal vantagem para um expat com menos de 30 anos é poupar em comboios da CP, museus, eventos culturais, restaurantes, hostels, desporto e parceiros locais. Os descontos dependem do parceiro: nalguns casos basta mostrar o cartão, noutros é necessário um código promocional ou comprar através de um site específico.' },
        { kind: 'checklist', items: [
          'Idade: normalmente dos 12 aos 29 anos inclusive',
          'Preço em 2026: o cartão base (Clássico) é gratuito, com validade de 1 ano',
          'Formato: cartão digital na área pessoal/aplicação myEYC',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'O método de pagamento só é necessário para versões pagas (por exemplo, Mega); o cartão base é gratuito',
    ...
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 'pay', title: '3. Confirmar a emissão', content: [
            { kind: 'paragraph', text: 'O cartão base (Clássico) é emitido gratuitamente — não é preciso pagar. Só paga se escolher deliberadamente uma versão paga como o Mega Cartão Jovem; nesse caso estão disponíveis cartão bancário ou opções portuguesas como Multibanco/MB WAY.' }
          ] },
          { id: 'activate', title: '4. Ativar e guardar o cartão', content: [
            { kind: 'paragraph', text: 'Depois da emissão, o cartão aparece em formato digital. Guarde o acesso à conta e instale a aplicação myEYC, se estiver disponível para o seu dispositivo. Na bilheteira ou ao embarcar, apresente o cartão juntamente com um documento de identificação.' }
          ] }
        ] }
      ]
    },
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          'Trate do cartão antes da primeira viagem CP: o cartão base é gratuito e o desconto de 25% aplica-se de imediato',
        ...
        { kind: 'paragraph', text: 'Para a maioria dos jovens expats, esta é a forma “do dia a dia” mais vantajosa de poupar em Portugal: o cartão base é gratuito, burocracia mínima e utilidade clara para transportes e lazer.' }
      ]
    }
  ],
  costs: [
    { label: 'Emissão do Cartão Jovem Europeu (Clássico)', amountEUR: 0, note: 'Em 2026 o cartão base é gratuito através do IPDJ/cartaojovem.pt; a versão paga Mega custa cerca de 14 €/ano + imposto de selo' },
