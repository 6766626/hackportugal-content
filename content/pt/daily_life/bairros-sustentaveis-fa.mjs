export default {
  ...
  steps: [
    ...
    },
    {
      ...
      title: 'Como verificar a sua morada',
      content: [
        { kind: 'substeps', items: [
          { id: 'find-official-list', title: '1. Encontre a lista oficial', content: [
            { kind: 'paragraph', text: 'Abra o site do Fundo Ambiental e a secção do programa concreto, por exemplo o E-LAR. Procure anexos, lista de Bairros + Sustentáveis, FAQ ou o campo “Bairro + Sustentável” no formulário de candidatura.' }
          ] },
          { id: 'compare-address', title: '2. Compare a morada literalmente', content: [
            { kind: 'checklist', items: [
              'Município',
              'Freguesia',
              'Nome do bairro',
              'Rua / avenida / praça',
              'Número de polícia',
              'Lote, bloco, cave, esquerdo/direito — se indicado',
              'Código postal',
              'O nome do proprietário ou o contrato de arrendamento não substituem a verificação da morada'
            ] }
          ] },
  ...
  costs: [
    { label: 'Verificação da morada nas listas oficiais', amountEUR: 0, note: 'Os sites do Fundo Ambiental e do Portal da Habitação são gratuitos' },
    { label: 'Atestado de residência na Junta de Freguesia', amountEURMin: 0, amountEURMax: 15, note: 'O custo depende da freguesia; por vezes é gratuito para uma simples confirmação de morada' },
    { label: 'Submissão de candidatura ao Fundo Ambiental', amountEUR: 0, note: 'Normalmente não há taxa pública; os custos surgem com documentos, equipamento ou instalação' }
  ],
  sources: [
    {
      title: 'Fundo Ambiental — avisos, candidaturas e medidas de apoio à eficiência energética',
    ...
    {
      title: 'Portal da Habitação — programas de habitação, bairros e reabilitação',
