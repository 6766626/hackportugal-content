export default {
  ...
  steps: [
    {
      id: 'reality-check',
      title: '1. Perceber o problema: em Portugal o frio não está lá fora, está dentro de casa',
      content: [
        { kind: 'paragraph', text: 'Em muitas casas não há aquecimento central, o isolamento térmico é fraco, as janelas são simples e a humidade é elevada. No inverno, na rua pode estar +10…+15 °C, mas dentro de um apartamento antigo é fácil manterem-se 14–17 °C. Isto é desconfortável e acelera o aparecimento de bolor.' },
        { kind: 'checklist', items: [
          ...
          'Mantenha a humidade por volta de 40–60%; acima de 65% aumenta o risco de bolor',
          'Verifique as janelas: frestas, estores antigos, ausência de vedantes',
          'Verifique a existência de chaminé, se está a pensar num recuperador ou numa salamandra',
          'Num apartamento, confirme as regras do condomínio antes de qualquer intervenção na chaminé ou na fachada',
        ...
        { kind: 'warning', text: 'Não tape as grelhas de ventilação da cozinha/casa de banho se em casa houver um esquentador a gás ou uma caldeira. O monóxido de carbono não tem cheiro; instale um detetor de CO por 20–40 €.' }
      ]
    },
    {
      id: 'compare-options',
      title: '2. Escolher o tipo de aquecimento em função da casa, não da publicidade',
      content: [
        { kind: 'substeps', items: [
          { id: 'electric', title: 'Aquecedores elétricos: rápidos e baratos de comprar', content: [
            { kind: 'paragraph', text: 'Um radiador a óleo, convetor ou termoventilador custa 20–120 € e não exige instalação. O ponto negativo é o consumo elevado: um aparelho de 2 kW durante 5 horas consome 10 kWh. Com o preço doméstico da eletricidade, isto transforma-se facilmente em dezenas de euros por mês para uma só divisão.' }
          ] },
          ...
          { id: 'wood', title: 'Recuperador de calor: inserível de lareira a lenha', content: [
            { kind: 'paragraph', text: 'Um recuperador de calor é instalado numa lareira existente ou com uma nova chaminé. Pode aquecer uma divisão, condutas de ar ou água para radiadores. O orçamento típico com instalação começa nos 1 500 €, frequentemente 2 000–4 000 € com uma instalação adequada.' }
          ] },
          { id: 'pellets', title: 'Salamandra a pellets: mais prática do que lenha, mas mais cara', content: [
            { kind: 'paragraph', text: 'Uma salamandra a pellets alimenta automaticamente o combustível, mantém a temperatura e é mais prática para utilização diária. O orçamento com instalação costuma começar nos 2 000 €; modelos com circuito hidráulico para radiadores são claramente mais caros.' }
          ] },
          { id: 'gas', title: 'Esquentador a gás: não confunda com aquecimento de divisões', content: [
            { kind: 'paragraph', text: 'Um esquentador a gás é um aquecedor instantâneo de água a gás para o duche e a cozinha. Não aquece divisões. Para aquecimento através de radiadores é necessária uma caldeira a gás ou um sistema com água quente, o que implica um projeto separado, tubagens, radiadores, inspeção de gás e manutenção.' }
          ] }
        ] }
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Peça ao instalador que demonstre experiência específica com chaminés e combustíveis sólidos',
          'Não faça sair a tubagem pela fachada sem aprovação do condomínio e, se necessário, da Câmara Municipal',
          ...
          'Para equipamentos a gás, recorra a um técnico certificado e guarde o relatório/declaração',
          'Se a casa for arrendada, obtenha autorização por escrito do senhorio antes de instalar equipamento fixo'
        ] },
        { kind: 'warning', text: 'Aquecedores portáteis a gás com botija sem boa ventilação são perigosos: libertam humidade e produtos de combustão. Em quartos pequenos e casas de banho, é preferível não os utilizar.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'A compra mais barata nem sempre significa o inverno mais barato. Um convetor elétrico de 40 € pode custar mais durante a estação do que um split AC eficiente. Um recuperador a lenha é bom quando existe chaminé, espaço para guardar lenha e quando realmente o vai acender todas as noites.' },
        { kind: 'checklist', items: [
          ...
          'Salamandra a pellets: mais prática do que lenha, mas depende do preço e da entrega de pellets',
          'Caldeira a gás: faz sentido se já existirem radiadores e uma infraestrutura de gás segura',
          'Desumidificador 150–300 € não substitui o aquecimento, mas melhora muito a sensação de conforto térmico',
          'Cortinados térmicos, vedantes e tapetes dão muitas vezes um efeito rápido por 20–150 €',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Não conte com pagamento imediato: o processamento das candidaturas pode demorar meses'
        ] }
      ]
    }
  ],
  costs: [
    ...
    { label: 'Desumidificador', amountEURMin: 150, amountEURMax: 300, note: 'Ajuda contra humidade e bolor, mas não substitui o aquecimento' },
    { label: 'Split AC / bomba de calor para uma divisão', amountEURMin: 700, amountEURMax: 1800, note: 'Valor indicativo com instalação; depende da potência, da marca e do percurso das tubagens' },
