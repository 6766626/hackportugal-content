export default {
  ...
  tldr: 'Lisboa, Porto e Madeira são grandes hubs de nómadas digitais.\n\nPreços: 150-400 €/mês por lugar flexível, 250-800 €/mês por lugar fixo. Grandes redes: Second Home (premium), LACS, Avila Spaces, Impact Hub, WorkIO. Digital Nomads Village Ponta do Sol (Madeira) — coworking gratuito para trabalhadores remotos registados.\n\nNo Porto: Porto i/o, Village Underground, Selina Cowork. Wi-Fi 100-1000 Mbit, salas para chamadas a partir de 10 €/hora.',
  ...
  steps: [
        ...
        { kind: 'substeps', items: [
          { id: 'l1', title: '💎 Premium (300-800 €/mês)', content: [
            { kind: 'checklist', items: [
              ...
              'The Hub (Saldanha) — escritórios colectivos operacionais, 400-700 €/mês'
            ]}
          ]},
          { id: 'l2', title: '🏢 Preço médio (150-350 €/mês)', content: [
            { kind: 'checklist', items: [
          ...
          { id: 'l4', title: '☕ Cafés-coworking', content: [
            { kind 'paragraph', text: 'Hello, Kristof, Dear Breakfast, Fauna & Flora, Heim Café — cafés tranquilos com Wi-Fi estável, que recebem pessoas a trabalhar. Não expulsam ninguém do lugar ao fim de uma hora, 5-15 € por visita com café e almoço.' }
          ]}
        ]}
      ]
    },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Ponta do Sol (15 km do Funchal) funciona desde 2021 como a primeira “aldeia de nómadas digitais” da Europa. Regista-se em digitalnomads.startupmadeira.eu — recebe um passe gratuito para o coworking de Ponta do Sol, eventos da comunidade e um chat no Slack com outros trabalhadores remotos (1000+ participantes).' },
        { kind: 'checklist', items: [
    ...
    {
      id: 'what-to-look',
      title: 'O que avaliar ao escolher',
      content: [
        { kind: 'checklist', items: [
          '🌐 Wi-Fi: >100 Mbit — é a norma, não aceite menos',
          '🔊 Isolamento acústico — zonas silenciosas separadas para chamadas',
          '🪑 Ergonomia — cadeira ajustável, monitor',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Para recibos verdes no regime simplificado, as despesas não são deduzidas directamente a 100%: o rendimento tributável é calculado por coeficientes (frequentemente 75% para serviços), mas parte das despesas com facturas pode reduzir a base. Para contabilidade organizada e pessoas colectivas, o coworking é contabilizado como despesa de trabalho. A dedução do IVA só é possível para actividades sujeitas a IVA, com a documentação correcta. Peça sempre factura com NIF; guarde os recibos durante pelo menos 4 anos.' },
        { kind: 'checklist', items: [
          ...
          'Coworking como morada jurídica — alguns permitem (Avila Spaces, Impact Hub); isto é útil para registo, mas não é uma condição obrigatória para recibos verdes',
