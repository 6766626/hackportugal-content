export default {
  ...
  steps: [
    {
      ...
      content: [
        { kind: 'paragraph', text: 'O Cartão Viver Cascais é o cartão de benefícios municipais da Câmara Municipal de Cascais. No dia a dia, é frequentemente chamado Cascais Card ou Viva Cascais, porque o acesso aos serviços é feito através da conta digital Cascais ID, do site e das aplicações do município.' },
        { kind: 'paragraph', text: 'O cartão não substitui a autorização de residência, o Cartão de Cidadão, o NIF, o Navegante ou um cartão bancário. É um passe local para descontos e tarifas especificamente no concelho de Cascais: Cascais, Estoril, Carcavelos, Parede, Alcabideche, São Domingos de Rana.' },
        { kind: 'checklist', items: [
          'Para residentes em Cascais — pela morada de residência no município',
          'Para trabalhadores em Cascais — se o local de trabalho estiver no município',
          'Para estudantes em Cascais — se o estabelecimento de ensino estiver no município',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Estacionamento: condições de residente e condições bonificadas nas zonas Cascais Próxima, se a sua morada/zona se enquadrar nas regras de estacionamento',
        ...
        { kind: 'warning', text: 'Não planeie o orçamento partindo do princípio de que “é tudo gratuito”. A gratuitidade ou o desconto depende do serviço concreto, do seu estatuto e das condições em vigor. Antes de viajar, estacionar ou comprar um bilhete, verifique a tarifa na MobiCascais/Cascais Próxima ou em cm-cascais.pt.' }
      ]
    },
    {
      id: 'documents',
      ...
      content: [
        { kind: 'paragraph', text: 'Normalmente, o pedido é feito online. O sistema pede para identificar a pessoa e comprovar a ligação a Cascais. Para uma pessoa estrangeira, servem os documentos portugueses habituais: NIF, autorização de residência ou passaporte, comprovativo de morada/trabalho/estudo.' },
        { kind: 'checklist', items: [
          'NIF',
        ...
        { kind: 'warning', text: 'O atestado de residência da Junta de Freguesia é útil se não tiver contrato de arrendamento em seu nome ou faturas de serviços. Para emitir o atestado, a Junta normalmente pede documento de identificação, NIF, comprovativo de morada e, por vezes, duas testemunhas da freguesia.' }
      ]
    },
    {
      id: 'how-to-apply',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'create-cascais-id', title: '1. Crie o Cascais ID', content: [
            { kind: 'paragraph', text: 'Aceda ao site da Câmara Municipal de Cascais e crie uma conta pessoal. Use um email ao qual tenha acesso permanente: é para lá que são enviadas as confirmações e notificações relativas ao pedido.' }
          ] },
          { id: 'choose-profile', title: '2. Escolha o perfil', content: [
            { kind: 'paragraph', text: 'No pedido, escolha o fundamento: residente/munícipe, trabalhador ou estudante. Isto determina os documentos que serão pedidos e os benefícios que serão ativados.' }
          ] },
          { id: 'upload-documents', title: '3. Carregue os documentos', content: [
            { kind: 'paragraph', text: 'O scan ou a fotografia devem ser legíveis: o nome, NIF, morada, data e assinatura/logótipo da entidade devem estar visíveis. É preferível preparar os ficheiros em PDF ou JPG.' }
          ] },
          { id: 'wait-validation', title: '4. Aguarde a validação', content: [
            { kind: 'paragraph', text: 'O município verifica os documentos. Se faltar alguma coisa, o pedido será devolvido para correção. O prazo depende da carga do serviço; na prática, conte com alguns dias úteis e, antes de um estacionamento urgente ou da compra de uma assinatura, não deixe o pedido para o último momento.' }
          ] },
          { id: 'use-digital-card', title: '5. Use o cartão digital', content: [
            { kind: 'paragraph', text: 'Após a aprovação, o cartão fica disponível em formato digital. Para autocarros, estacionamento e descontos, podem ser usadas diferentes aplicações/serviços do ecossistema municipal, por isso confirme onde exatamente é necessário associar o Cartão Viver Cascais.' }
          ] }
        ] }
      ]
    },
    {
      ...
      title: 'Transportes e estacionamento: onde há mais erros',
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Uma coima de estacionamento não é anulada apenas por ter o cartão: é importante ativar o regime correto antes de estacionar',
          'Ao mudar de morada, trabalho ou estudo, atualize os dados no cartão; caso contrário, os benefícios podem ser desativados'
        ] },
        { kind: 'warning', text: 'Se acabou de se mudar para Cascais e está à espera da confirmação do cartão, não parta do princípio de que os benefícios produzem efeitos retroativos. Até à validação, pague transportes e estacionamento à tarifa normal.' }
      ]
    },
    {
      id: 'renewal-problems',
      ...
      content: [
        { kind: 'paragraph', text: 'O cartão está associado à atualidade dos seus dados. Se saiu de Cascais, mudou de empregador, terminou os estudos ou alterou a morada dentro do município, atualize o perfil. Para parte dos benefícios, a Câmara pode pedir periodicamente novo comprovativo.' },
        { kind: 'checklist', items: [
          'Verifique o prazo de validade e o estado do cartão na área pessoal',
          'Guarde PDF/scans do contrato de arrendamento, atestado, declaração da entidade patronal e matrícula',
          'Em caso de recusa, abra a mensagem da Câmara: normalmente indica que documento está ilegível ou não é aceite',
  ...
  costs: [
    ...
    { label: 'Atestado de residência na Junta de Freguesia', amountEURMin: 0, amountEURMax: 10, note: 'A tarifa depende da freguesia e do tipo de declaração; só é necessário se não houver outro comprovativo de morada.' }
  ],
  sources: [
    {
