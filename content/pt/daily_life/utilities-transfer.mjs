export default {
  ...
  tldr: 'Em Portugal há 3 serviços obrigatórios: eletricidade, água, gás (se estiver ligado).\n\nA eletricidade e o gás estão num mercado liberalizado: pode escolher o fornecedor, por exemplo EDP, Galp, Iberdrola, Endesa e outros. A água é sempre um serviço municipal (EPAL em Lisboa).\n\nA mudança de fornecedor é gratuita e decorre sem interrupções. A transferência de contratos para uma nova morada em caso de mudança de casa demora 5–15 dias, sem penalização, ao abrigo do Decreto-Lei 38/2017.',
  tags: ['eletricidade', 'gás', 'água', 'edp', 'galp', 'iberdrola'],
  ...
  steps: [
    ...
    {
      id: 'choose-supplier',
      title: 'Como escolher um fornecedor',
      content: [
        { kind: 'substeps', items: [
          { id: 's1', title: '1. Conhecer o consumo', content: [
            { kind: 'paragraph', text: 'Apartamento médio de 70 m² para 2 pessoas: 150–250 kWh/mês (eletricidade), 50 m³ de gás no inverno. Famílias numerosas — mais de 500 kWh.' }
          ]},
          { id: 's2', title: '2. Escolher a potência (potência)', content: [
            { kind: 'checklist', items: [
              '3.45 kVA — apartamento pequeno sem aparelhos potentes',
          ...
          { id: 's3', title: '3. Tarifa (tarifa)', content: [
            { kind: 'checklist', items: [
              ...
              'Tri-horária — ponta / cheia / vazio (para indústria)'
            ]}
          ]},
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '📝 Necessário: NIF, CPE / CUI (na fatura), IBAN',
    ...
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'm1', title: 'Manter o fornecedor antigo, mas mudar a morada', content: [
          ...
          { id: 'm2', title: 'Novo fornecedor na nova casa', content: [
            { kind: 'paragraph', text: 'Se o morador anterior deixou um contrato ativo, você encerra-o através de um pedido e celebra imediatamente o seu. Sem atrasos.' }
          ]},
          { id: 'm3', title: 'Serviço desligado após uma longa interrupção', content: [
  ...
  costs: [
    { label: 'Eletricidade, apartamento médio de 70 m²', amountEURMin: 40, amountEURMax: 80, note: '€/mês' },
    ...
    { label: 'Nova ligação de um serviço desligado', amountEURMin: 50, amountEURMax: 100 }
  ],
  sources: [
