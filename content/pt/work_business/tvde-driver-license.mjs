export default {
  ...
  tldr: 'TVDE é trabalho legal como motorista através da Uber, Bolt e outras plataformas eletrónicas. Em 2026, o motorista precisa de um certificado de motorista TVDE do IMT: carta B há mais de 3 anos, curso de formação inicial 50h, aptidão médica e psicológica, registo criminal e pedido ao IMT. O carro deve estar registado para TVDE no DUA/Certificado de Matrícula, ter seguro específico, inspeção e dístico TVDE. Só é possível trabalhar através de um operador TVDE licenciado e com registo na plataforma.',
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'A lei de base é a Lei 45/2018. Na prática, em 2026 o esquema é o seguinte: o motorista obtém o certificado de motorista TVDE, o veículo é registado como TVDE, o operador tem licença TVDE, e a Uber/Bolt verificam os documentos antes de ativar a conta.' },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Sem o certificado de motorista TVDE, a plataforma não ativa o motorista. O certificado é emitido pelo IMT após o curso e a verificação dos requisitos. Normalmente é válido por 5 anos; a renovação é feita antes do fim da validade através de formação contínua/renovação e de um novo pedido.' },
        { kind: 'substeps', items: [
          ...
          { id: 'course', title: '2. Fazer o curso TVDE 50h', content: [
            { kind: 'paragraph', text: 'O curso decorre num centro de formação reconhecido pelo IMT. O programa é regulado pela Portaria 293/2018 e inclui segurança, atendimento a passageiros, regras TVDE, comportamento rodoviário, acessibilidade para passageiros com limitações e utilização de plataformas.' },
            { kind: 'warning', text: 'Não compre um “certificado pronto”. As plataformas confirmam o documento com o IMT, e um certificado falso pode fechar o acesso à Uber/Bolt e criar riscos criminais.' }
          ] },
          { id: 'imt-application', title: '3. Submeter o pedido ao IMT', content: [
            { kind: 'paragraph', text: 'Após o curso, a escola normalmente emite uma declaração/certificado de formação. Com esse documento, submete-se o pedido de certificado de motorista TVDE através dos serviços do IMT ou segundo as instruções da escola. O prazo depende da carga de trabalho do IMT e da completude dos documentos.' },
            { kind: 'checklist', items: [
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'O motorista, por si só, não presta o serviço TVDE à plataforma. Segundo a Lei 45/2018, o transporte é realizado por um operador TVDE registado no IMT. Por isso, há dois caminhos: entrar/ligar-se a um operador TVDE existente ou criar o seu próprio operador.' },
        { kind: 'checklist', items: [
          'Através de operador de terceiros: início mais rápido, mas a comissão/aluguer/horário dependem do contrato',
          'Operador próprio: mais controlo, mas são necessários atividade/empresa, licença IMT, contabilidade, seguros e documentos do veículo',
        ...
        { kind: 'warning', text: '“Alugo conta Uber/Bolt” e trabalhar no perfil de outra pessoa são riscos de bloqueio, problemas com o seguro e responsabilidade em caso de acidente. O motorista na viagem deve coincidir com o motorista registado na plataforma.' }
      ]
    },
    {
      id: 'vehicle-documents',
      title: 'Preparar o veículo: DUA, seguro, inspeção, dístico',
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'Via Verde é, na prática, quase indispensável, mas não substitui os documentos TVDE'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Após o certificado do IMT e a preparação do veículo, o motorista carrega os documentos na Uber Driver, Bolt Driver ou na área do operador. A verificação não é instantânea: a plataforma confirma a identidade, o certificado, a carta, o veículo, o seguro e a ligação ao operador.' },
        { kind: 'checklist', items: [
          'Perfil de motorista com nome real e fotografia',
          'Carta de condução',
          'Certificado de motorista TVDE do IMT',
          'Documento de identidade e direito ao trabalho',
          'Registo criminal, se a plataforma pedir atualização',
          'Dados do operador TVDE e comprovativo da ligação a ele',
          'DUA/Certificado de Matrícula do veículo',
          'Seguro TVDE',
          'Inspeção válida',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'O TVDE parece “entrar e conduzir”, mas a economia depende da comissão da plataforma, da comissão do operador, do aluguer do veículo, do combustível, do seguro e dos impostos. Se for trabalhador independente ou tiver o seu próprio operador, configure antecipadamente recibos verdes/faturação, Segurança Social e registo de despesas.' },
        { kind: 'checklist', items: [
          ...
          'Multas do IMT/ANSR/plataforma por documentos e comportamento podem ser superiores à receita de um dia'
        ] },
        { kind: 'warning', text: 'Não considere a receita na aplicação como “salário”. Dela ainda saem comissão, operador, veículo, combustível, seguro, Segurança Social e IRS/IRC. Antes de alugar um veículo, peça ao operador um cálculo líquido depois de todas as retenções.' }
      ]
    }
  ],
  costs: [
    { label: 'Curso motorista TVDE 50h', amountEURMin: 150, amountEURMax: 350, note: 'Preço de mercado das escolas; depende da cidade e do formato' },
    ...
    { label: 'Seguro automóvel TVDE', amountEURMin: 700, amountEURMax: 1800, note: 'Intervalo anual varia muito consoante o veículo, a experiência e a seguradora' }
  ],
  sources: [
