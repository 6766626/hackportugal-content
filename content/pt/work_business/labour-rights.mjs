export default {
  ...
  tldr: 'As relações laborais em Portugal são reguladas pelo Código do Trabalho (Lei 7/2009).\n\nO essencial: semana de 40 horas (máx. 48 horas com horas extraordinárias), férias de 22 dias úteis + 13 feriados, licença parental de 120-180 dias com pagamento de 90-100%, o despedimento exige fundamento + compensação (limite de 12-20 meses de salário), salário mínimo de 920 €/mês em 2026. Período experimental: 90 dias (geral), 180 (cargos de responsabilidade), 240 (cargos de direcção).\n\nOs sindicatos são activos: CGTP-IN e UGT. As queixas por violações dos direitos laborais são apresentadas à ACT (Autoridade para as Condições do Trabalho).',
        ...
        { kind: 'substeps', items: [
          { id: 'c1', title: 'Contrato sem termo (sem prazo)', content: [
            { kind: 'checklist', items: [
              ...
              'Despedimento pelo empregador: exige fundamento (despedimento por justa causa, extinção, inadequação) + compensação',
              'Denúncia pelo trabalhador: aviso prévio de 30 dias (até 2 anos na empresa) ou 60 dias (mais)'
            ]}
          ]},
          { id: 'c2', title: 'Contrato a termo certo (com prazo e data fixa)', content: [
            { kind: 'checklist', items: [
              'Data de fim concreta. Após a Agenda do Trabalho Digno (Lei 13/2023): máximo geral — **2 anos** (incluindo renovações). O mínimo depende do fundamento; para casos típicos — 6 meses',
              'Apenas por razões objectivas enumeradas no Código do Trabalho (conjuntura, projecto temporário, substituição de trabalhador, etc.)',
          ...
          { id: 'c3', title: 'Contrato a termo incerto (com prazo sem data fixa)', content: [
            { kind: 'paragraph', text: 'Contrato com prazo sem data fixa (até à conclusão do projecto / substituição de alguém em licença parental). Máximo de **4 anos** (após a Lei 13/2023). A compensação segue as mesmas regras gerais do termo certo.' }
          ]},
          { id: 'c4', title: 'Contrato de prestação de serviços / recibos verdes', content: [
            { kind: 'paragraph', text: 'Formato semelhante a trabalhador independente.\n\nPaga os impostos por si através do Anexo B. Não tem os direitos laborais de trabalhador ao abrigo do Código do Trabalho — férias pagas pelo empregador, subsídios de férias/Natal, protecção contra despedimento. Mas, com contribuições para a Segurança Social, o trabalhador independente pode ter acesso a algumas prestações sociais (doença, parentalidade) sob certas condições. Para sua protecção, o contrato deve reflectir um estatuto independente real; caso contrário, trata-se de «falso recibo verde» — pode levar ao reconhecimento de contrato de trabalho, acertos de contribuições para a Segurança Social e coimas da ACT (o valor depende da categoria da infracção).' }
          ]}
        ]}
      ]
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          '**Subsídio de alimentação**: não é obrigatório, mas é comum. 6-9 €/dia útil. Até 6 €/dia não é sujeito a IRS se pago em dinheiro; com cartão/vale refeição o limite é superior — 10,20 €/dia',
          '**Horas extraordinárias (horas extras)**: +25% na primeira hora, +37,5% depois',
          '**Trabalho nocturno** (22:00-07:00): +25% adicional',
          '**Trabalho em descanso semanal/feriado**: normalmente +50% por cada hora; em alguns casos também há direito a descanso compensatório. A convenção colectiva pode prever condições melhores (Código do Trabalho arts. 268, 269)',
    ...
    },
    {
      ...
      content: [
        { kind: 'checklist', items: [
          ...
          'Pausa para almoço: 1-2 horas, mínimo 1 hora se o dia de trabalho for >6 horas',
          ...
          '**Teletrabalho (teletrabalho)**: regulado pela Lei 83/2021 — contrato escrito, pagamento de electricidade/comunicações pelo empregador, direito a desligar'
        ]}
      ]
    },
    {
      id: 'leave',
      title: '🏖️ Férias e baixas médicas',
      content: [
        { kind: 'substeps', items: [
          { id: 'l1', title: 'Férias (férias anuais)', content: [
            { kind: 'checklist', items: [
              '**22 dias úteis** (padrão) = cerca de 31 dias de calendário',
              '+ 3 dias adicionais se houver ≤ 3 dias de faltas por doença no ano',
          ...
          { id: 'l3', title: 'Licença parental', content: [
            { kind: 'checklist', items: [
              ...
              '**150 dias**: 80% (se repartida com o parceiro)',
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'd1', title: 'Despedimento por justa causa (por culpa do trabalhador)', content: [
            { kind: 'paragraph', text: 'O empregador deve provar uma infracção grave: absentismo, furto, conflito grave, incumprimento sistemático de deveres. Notificação escrita + direito de defesa (direito de audiência prévia).\n\nSe o tribunal considerar o despedimento ilícito — compensação + reintegração.' }
          ]},
          { id: 'd2', title: 'Despedimento colectivo / extinção (redução de pessoal)', content: [
            { kind: 'checklist', items: [
              'Razões objectivas: económicas, de mercado, tecnológicas',
          ...
          { id: 'd3', title: 'Abandono do trabalho', content: [
            { kind: 'paragraph', text: 'Se o trabalhador desaparecer por > 10 dias úteis sem motivo justificativo — o empregador pode considerar isso como cessação por iniciativa do trabalhador. Isto elimina o direito a compensação + Subsídio de desemprego.' }
          ]}
        ]}
      ]
    },
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'r1', title: 'Sindicatos', content: [
            { kind: 'checklist', items: [
              '**CGTP-IN** — a maior, de esquerda, 600 000 membros',
              '**UGT** — centrista, 400 000',
              '**FESAP**, **STE** — para funcionários públicos',
              'Quota sindical: 0,5-1% do salário',
              'Protecção: negociação de convenções colectivas, apoio jurídico, greves'
            ]}
          ]},
          { id: 'r2', title: 'ACT — inspecção do trabalho', content: [
            { kind: 'checklist', items: [
              ...
              'A ACT verifica: condições de trabalho, salários, horas extraordinárias, segurança no trabalho, falsos recibos verdes',
