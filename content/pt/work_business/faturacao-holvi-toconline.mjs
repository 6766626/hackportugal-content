export default {
  ...
  steps: [
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'As séries de documentos devem ser comunicadas à AT antes de serem utilizadas, para obter o código de validação.',
          'As faturas devem ser comunicadas à AT através de SAF-T/PT ou webservice dentro dos prazos definidos.',
    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'paragraph', text: 'Se estiver em isenção de IVA ao abrigo do art. 53 CIVA, deve indicar no documento o respetivo motivo de isenção. Para 2026, a referência do regime pequeno é 15 000 € de volume de negócios anual; se estiver a aproximar-se do limite, discuta antecipadamente com um contabilista a passagem para IVA.' }
      ]
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'toconline', title: 'ToConline — a opção mais “portuguesa”', content: [
            ...
            { kind: 'checklist', items: [
              'Bom para recibos verdes com clientes B2B regulares.',
              'Adequado se o contabilista já trabalha em ToConline.',
              'Inclui gestão de clientes, produtos/serviços e relatórios.',
              'Verifique o tarifário: algumas funcionalidades podem estar nos planos pagos.',
              'A melhor escolha se quiser o mínimo de “exotismo estrangeiro” e o máximo de conformidade PT.'
            ] }
          ] },
          { id: 'holvi', title: 'Holvi — banco + invoices, mas confirme a conformidade fiscal', content: [
            { kind: 'paragraph', text: 'Holvi é prático como business account com cartão, IBAN, categorias de despesas e emissão de invoices para clientes. Mas, para Portugal, a questão principal não é o design do PDF, e sim o certificado da AT, ATCUD, QR e comunicação à AT.' },
            { kind: 'warning', text: 'Se o produto Holvi específico da sua conta não constar da lista de programas de faturação certificados pela AT, use o Holvi para gestão bancária e lembretes, e emita a fiscal invoice/recibo no Portal das Finanças ou num programa certificado.' }
          ] },
          { id: 'visee-faturalia-moloni', title: 'Visee, Faturalia, MOLONI — serviços PT económicos', content: [
            { kind: 'paragraph', text: 'Visee, Faturalia e MOLONI são normalmente escolhidos pela faturação simples, arranque rápido e preço na faixa de 0–30 €/mês. Para trabalhadores independentes, o importante não são “faturas bonitas”, mas sim a certificação da AT, campos fiscais corretos e exportação SAF-T.' },
            { kind: 'checklist', items: [
              'Verifique o número do certificado da AT no site do serviço e na lista do Portal das Finanças.',
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Antes do primeiro documento, configure não o logótipo, mas os parâmetros fiscais. Um erro no IVA ou na retenção corrige-se depois com nota de crédito ou anulação, e o cliente terá de alterar a sua contabilidade.' },
        { kind: 'checklist', items: [
          ...
          'Guarde os PDFs e os dados pelo menos durante o prazo de inspeção fiscal; não dependa apenas do email do cliente.'
        ] },
    ...
    },
    {
      ...
      content: [
        { kind: 'paragraph', text: 'Para a maioria dos freelancers expatriados, a escolha é simples: até algumas faturas por mês — Portal das Finanças por 0 €. Se tiver muitos clientes, IVA, clientes da UE, recurring invoices ou se o contabilista pedir SAF-T — escolha um programa português certificado.' },
        { kind: 'checklist', items: [
          ...
          'Holvi faz sentido se business banking, cartão e controlo de despesas forem importantes para si.',
          'ToConline faz sentido se o contabilista em Portugal já o utilizar.',
          'MOLONI/Faturalia/Visee fazem sentido se precisar de certified invoicing simples sem contabilidade pesada.',
          'Não compre um tarifário anual antes de verificar AT certification, ATCUD, QR e SAF-T num documento real.'
        ] },
  ...
  costs: [
    ...
    { label: 'Programa básico de faturação', amountEURMin: 5, amountEURMax: 15, note: 'Normalmente suficiente para um pequeno número de clientes e SAF-T/ATCUD simples.' },
