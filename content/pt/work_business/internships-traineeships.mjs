export default {
  ...
  steps: [
      ...
      content: [
        { kind: 'substeps', items: [
          ...
          { id: 't2', title: 'Estágios de Inserção / CEI+ (para categorias diferentes)', content: [
            { kind: 'checklist', items: [
              'Estágios de Inserção — medida do IEFP para pessoas com deficiência e incapacidade, com duração, elegibilidade e bolsa próprias',
              'Para desempregados de longa duração, o IEFP oferece outras medidas — Contrato Emprego-Inserção / CEI+; não é um estágio remunerado comum, mas sim uma medida ocupacional, com condições de pagamento diferentes',
              'Confirme as medidas actuais em iefp.pt — os programas são actualizados periodicamente',
              'Algumas medidas estão ligadas à transição para emprego permanente'
            ]}
          ]},
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'a1', title: '1. Registo no centro de emprego', content: [
            { kind: 'checklist', items: [
              'Qualquer centro de emprego da área de residência',
          ...
          { id: 'a3', title: '3. Aprovação pelo IEFP', content: [
            { kind: 'checklist', items: [
              'Empresa + estagiário + IEFP assinam um acordo tripartido',
              'Plano de formação: o que irá aprender',
              'É designado um orientador da empresa',
              'A data de início fica fixada'
            ]}
          ]},
          { id: 'a4', title: '4. Durante o estágio', content: [
            { kind: 'checklist', items: [
              ...
              'É possível terminar antecipadamente pela empresa (com justificação) ou por si (sem penalização)'
            ]}
          ]},
    ...
    },
    {
      ...
      content: [
        { kind: 'substeps', items: [
          { id: 'f1', title: 'Cidadãos da UE', content: [
            { kind: 'checklist', items: [
              'Igualdade total de direitos com os residentes em Portugal',
              'Registo CRUE: ≥ 90 dias de residência',
              'Candidatura a estágio IEFP em igualdade de condições com os portugueses',
              'Erasmus+ — principal via para estudantes'
            ]}
          ]},
          ...
          { id: 'f3', title: 'CPLP', content: [
            { kind: 'paragraph', text: 'Brasileiros ao abrigo da mobilidade CPLP têm direitos plenos de trabalho, incluindo estágio. Frequentemente candidatam-se ao IEFP em igualdade de condições com os portugueses.' }
          ]}
        ]}
      ]
    },
