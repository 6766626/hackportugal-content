export default {
  ...
  timelineDaysMax: 150,
  sources: [
    { title: 'Vistos MNE — виза D2', url: 'https://vistos.mne.gov.pt/pt/vistos-nacionais/informacoes-gerais/tipos-de-visto', kind: 'official', language: 'pt', lastRetrieved: '2026-04-22' },
