    ...
    },
    {
      ...
      content: [
        ...
        { kind: 'checklist', items: [
          ...
          'По новому закону (Decreto AR 17/XVII, повторно принят парламентом 01.04.2026 после вето Марселу и неконституционности TC Acórdão 1133/2025) — 7 лет для CPLP+EU / 10 лет для остальных. Ждёт подписания Президентом Сегуру',
